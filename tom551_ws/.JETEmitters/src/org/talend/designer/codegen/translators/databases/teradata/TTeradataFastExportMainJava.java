...
public class TTeradataFastExportMainJava
{
  ...
  protected final String TEXT_101 = " = new java.io.File(";
  protected final String TEXT_102 = "+";
  protected final String TEXT_103 = "+\".script\");";
  protected final String TEXT_104 = NL + "\tjava.io.File file_";
  ...
  protected final String TEXT_109 = NL + "\t" + NL + "try{" + NL + "\tjava.io.FileWriter fw_";
  protected final String TEXT_110 = " = new java.io.FileWriter(file_";
  protected final String TEXT_111 = ");" + NL + "\tStringBuilder script_";
  protected final String TEXT_112 = " = new StringBuilder();" + NL + "\tfw_";
  protected final String TEXT_113 = ".write(\".LOGTABLE \"+";
  ...
  protected final String TEXT_125 = ".write(\".LOGON \"+";
  ...
  protected final String TEXT_133 = ".write(\".BEGIN EXPORT SESSIONS 8;\"+\"";
  protected final String TEXT_134 = "\");" + NL + "\t";
  protected final String TEXT_135 = NL + "\t\tfw_";
  protected final String TEXT_136 = ".write(\"SELECT ";
  protected final String TEXT_137 = "CAST(('' ||";
  protected final String TEXT_138 = "\"+\"";
  protected final String TEXT_139 = "\");" + NL + "\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\t\tfw_";
  protected final String TEXT_141 = ".write(\"TRIM(COALESCE(CAST(";
  protected final String TEXT_142 = " AS CHAR(";
  protected final String TEXT_143 = ")),'')) || '\"+";
  protected final String TEXT_144 = "+\"' ||\"+\"";
  protected final String TEXT_145 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\tfw_";
  protected final String TEXT_147 = ".write(\"cast( ";
  protected final String TEXT_148 = " as CHAR(";
  protected final String TEXT_149 = ")),\"+\"";
  protected final String TEXT_150 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\tfw_";
  protected final String TEXT_153 = ".write(\"TRIM(COALESCE(CAST(";
  protected final String TEXT_154 = " AS VARCHAR(";
  protected final String TEXT_155 = ")),''))) AS CHAR(";
  protected final String TEXT_156 = "))\"+\"";
  protected final String TEXT_157 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\tfw_";
  protected final String TEXT_159 = ".write(\"cast( ";
  protected final String TEXT_160 = " as CHAR(";
  protected final String TEXT_161 = "))\"+\"";
  protected final String TEXT_162 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t";
  protected final String TEXT_164 = NL + "\t" + NL + "\t\tfw_";
  protected final String TEXT_165 = ".write(\"FROM \"+ ";
  ...
  protected final String TEXT_175 = ".write(\".EXPORT OUTFILE \\\"\"+";
  protected final String TEXT_176 = "+\".data\\\" FORMAT TEXT mode record;\"+\"";
  protected final String TEXT_177 = "\");" + NL + "\tfw_";
  protected final String TEXT_178 = ".write(\".END EXPORT;\"+\"";
  protected final String TEXT_179 = "\");" + NL + "\tfw_";
  protected final String TEXT_180 = ".write(\".LOGOFF;\"+\"";
  protected final String TEXT_181 = "\");" + NL + "\t" + NL + "\t";
  protected final String TEXT_182 = NL + "\tfw_";
  protected final String TEXT_183 = ".close();" + NL + "\t" + NL + "\t";
  protected final String TEXT_184 = NL + "\tString sb__";
  protected final String TEXT_185 = " = null;" + NL + "\t";
  protected final String TEXT_186 = NL + "\tsb__";
  protected final String TEXT_187 = " = \"fexp < \\\"\"+";
  protected final String TEXT_188 = "+";
  protected final String TEXT_189 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_190 = "+\"\\\" 2>&1\";" + NL + "\tString[] sb_";
  protected final String TEXT_191 = " = {\"cmd\",\"/c\", sb__";
  protected final String TEXT_192 = "};" + NL + "\t";
  protected final String TEXT_193 = NL + "\tsb__";
  protected final String TEXT_194 = " = \"fexp < \"+";
  protected final String TEXT_195 = "+";
  protected final String TEXT_196 = "+\".scr\"+\" > \\\"\"+";
  protected final String TEXT_197 = "+\"\\\" 2>&1\";" + NL + "\tString[] sb_";
  protected final String TEXT_198 = " = {\"sh\",\"-c\",sb__";
  protected final String TEXT_199 = "};" + NL + "\t";
  protected final String TEXT_200 = NL + "\t";
  protected final String TEXT_201 = NL + "\t\tlog.info(\"";
  protected final String TEXT_202 = " - Execting '\" + sb__";
  protected final String TEXT_203 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_204 = NL + "\tfinal Process process_";
  protected final String TEXT_205 = " = Runtime.getRuntime().exec(sb_";
  protected final String TEXT_206 = ");" + NL + "\t" + NL + "\tThread normal_";
  protected final String TEXT_207 = " = new Thread() {" + NL + "\t    public void run() {" + NL + "\t    \ttry {" + NL + "\t    \t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_208 = ".getInputStream()));" + NL + "\t    \t\tString line = \"\";" + NL + "\t    \t\t" + NL + "\t    \t\ttry {" + NL + "\t    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t    \t\t\t\tSystem.out.println(line);" + NL + "\t    \t        }" + NL + "\t    \t    } finally {" + NL + "\t    \t         reader.close();" + NL + "\t    \t    }" + NL + "\t        }catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_210 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_211 = NL + "\t    \t\tioe.printStackTrace();" + NL + "\t    \t}" + NL + "\t    }" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_212 = ".start();" + NL + "\t" + NL + "\tThread error_";
  protected final String TEXT_213 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_214 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\tSystem.err.println(line); " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_216 = " - \" + ioe.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_217 = NL + "\t\t\t   ioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_218 = ".start();" + NL + "\t" + NL + "\tprocess_";
  protected final String TEXT_219 = ".waitFor();" + NL + "\t" + NL + "\tnormal_";
  protected final String TEXT_220 = ".interrupt();" + NL + "\t" + NL + "\terror_";
  protected final String TEXT_221 = ".interrupt();" + NL + "\t" + NL + "\t";
  protected final String TEXT_222 = NL + "\t\tlog.info(\"";
  protected final String TEXT_223 = " - Excute '\" + sb__";
  protected final String TEXT_224 = " + \"' has succeeded.\");" + NL + "\t   \tlog.info(\"";
  protected final String TEXT_225 = " - Has finished.\");" + NL + "\t";
  protected final String TEXT_226 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_227 = ".delete();" + NL + "\t}catch(Exception e_";
