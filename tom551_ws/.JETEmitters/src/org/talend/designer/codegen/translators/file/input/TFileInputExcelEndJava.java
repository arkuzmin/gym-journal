...
public class TFileInputExcelEndJava
{
  ...
  protected final String TEXT_45 = NL + "\t\t\ttry {" + NL + "\t\t\t\tif(excelReader_";
  protected final String TEXT_46 = "!=null) {" + NL + "\t\t\t\t\texcelReader_";
  protected final String TEXT_47 = ".handleException();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_48 = ") {" + NL + "\t\t\t\tif(!(e_";
  protected final String TEXT_49 = ".getCause() instanceof com.talend.excel.xssf.event.EnoughDataException))" + NL + "\t\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_52 = " - \" + e_";
  protected final String TEXT_53 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\tthrow(e_";
  protected final String TEXT_55 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_58 = " - \" + e_";
  protected final String TEXT_59 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\tSystem.err.println(e_";
  ...
  protected final String TEXT_68 = NL + "\t\t} finally { " + NL + "\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\tif(!(source_";
  protected final String TEXT_70 = " instanceof java.io.InputStream)){" + NL + "\t\t\t\t\t\tworkbook_";
  protected final String TEXT_71 = ".close();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_72 = NL + "  \t\t\t\tif(!(source_";
  protected final String TEXT_73 = " instanceof java.io.InputStream)){" + NL + "  \t\t\t\t\tworkbook_";
  protected final String TEXT_74 = ".getPackage().revert();" + NL + "  \t\t\t\t}" + NL + "\t\t\t\t";
