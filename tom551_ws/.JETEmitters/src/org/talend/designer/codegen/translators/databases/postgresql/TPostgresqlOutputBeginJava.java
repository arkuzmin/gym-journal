...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_59 = NL + NL + "    String dbPwd_";
  protected final String TEXT_60 = " = decryptedPassword_";
  protected final String TEXT_61 = ";" + NL + "    " + NL + "    conn_";
  ...
  protected final String TEXT_65 = ");" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_66 = "\", conn_";
  protected final String TEXT_67 = ");";
  protected final String TEXT_68 = NL + "    \tjava.sql.Savepoint  sp_";
  ...
  protected final String TEXT_77 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\"); " + NL + "    }";
  protected final String TEXT_78 = NL;
  protected final String TEXT_79 = NL + "   int batchSize_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_82 = "=0;";
  protected final String TEXT_83 = " " + NL;
  protected final String TEXT_84 = NL + "int count_";
  protected final String TEXT_85 = "=0;";
  protected final String TEXT_86 = "            " + NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_90 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_96 = " - Drop table '\" + tableName_";
  protected final String TEXT_97 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_103 = " - Creating table '\" + tableName_";
  protected final String TEXT_104 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_106 = ".execute(((\"";
  protected final String TEXT_107 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = ", \"";
  protected final String TEXT_110 = "\"))+\")";
  protected final String TEXT_111 = "\")";
  protected final String TEXT_112 = ".toUpperCase()";
  ...
  protected final String TEXT_119 = " - Create table '\" + tableName_";
  protected final String TEXT_120 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_125 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_126 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_127 = " - Creating table '\" + tableName_";
  protected final String TEXT_128 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_130 = ".execute(((\"";
  protected final String TEXT_131 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = ", \"";
  protected final String TEXT_134 = "\"))+\")";
  protected final String TEXT_135 = "\")";
  protected final String TEXT_136 = ".toUpperCase()";
  ...
  protected final String TEXT_143 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_148 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_149 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_150 = "+\"][\"+";
  protected final String TEXT_151 = "+\"][\"+";
  protected final String TEXT_152 = "+\"][\"+";
  protected final String TEXT_153 = "+\"][\"+";
  protected final String TEXT_154 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_155 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_156 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_159 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_160 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_161 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_162 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_163 = ")== null){";
  protected final String TEXT_164 = "              ";
  protected final String TEXT_165 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_168 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_169 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_170 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_171 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_172 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_177 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_178 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_179 = " = tableNameForSearch_";
  protected final String TEXT_180 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_181 = " = tableNameForSearch_";
  protected final String TEXT_182 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_183 = " = dbMetaData_";
  protected final String TEXT_184 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_185 = ", tableNameForSearch_";
  protected final String TEXT_186 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_187 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_188 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_189 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_221 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_235 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_296 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_312 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_321 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_327 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_334 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_355 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_361 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_367 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_380 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_389 = " - Truncate table '\" + tableName_";
  protected final String TEXT_390 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_407 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_416 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_512 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_513 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_514 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_515 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_516 = " = true;" + NL + "    \t";
