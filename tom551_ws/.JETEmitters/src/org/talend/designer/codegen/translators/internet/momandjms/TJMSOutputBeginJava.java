...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_29 = ".start();" + NL + "" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_30 = " = connection_";
  protected final String TEXT_31 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_32 = " = session_";
  protected final String TEXT_33 = ".create";
  protected final String TEXT_34 = "(";
  protected final String TEXT_35 = ");" + NL + "" + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_36 = " = session_";
  protected final String TEXT_37 = ".createProducer(dest_";
  protected final String TEXT_38 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_39 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_40 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_41 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
