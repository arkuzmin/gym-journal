...
public class TOracleSPBeginJava
{
  ...
  protected final String TEXT_33 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_44 = ".put(\"user\",";
  protected final String TEXT_45 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_46 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_49 = ".getBytes()));" + NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_50 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_60 = "\t" + NL + "\t\tstmtNLS_";
  protected final String TEXT_61 = ".execute(\"ALTER SESSION SET NLS_TERRITORY=\" +\"";
  protected final String TEXT_62 = "\" );";
  protected final String TEXT_63 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_64 = " = connection_";
  protected final String TEXT_65 = ".prepareCall(\"{";
  protected final String TEXT_66 = "call \" + ";
  protected final String TEXT_67 = " + \"(";
  protected final String TEXT_68 = "?";
  protected final String TEXT_69 = ",?";
  protected final String TEXT_70 = ")}\");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_71 = ";" + NL + "String tmpString_";
