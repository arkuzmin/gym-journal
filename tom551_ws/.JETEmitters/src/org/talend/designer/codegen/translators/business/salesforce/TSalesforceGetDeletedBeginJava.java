...
public class TSalesforceGetDeletedBeginJava
{
  ...
  protected final String TEXT_89 = ".getCalendar();" + NL + "\t\t\t" + NL + "\t        " + NL + "\t        org.talend.salesforce.SforceManagement sfMgr_";
  ...
  protected final String TEXT_147 = "\t\t\t\t" + NL + "\t\t\tcom.salesforce.soap.partner.GetDeletedResult gdr_";
  protected final String TEXT_148 = " = sfMgr_";
  protected final String TEXT_149 = ".getDeleted(";
  protected final String TEXT_150 = ", startCal_";
  protected final String TEXT_151 = ", endCal_";
  protected final String TEXT_152 = ");" + NL + "    \t\tcom.salesforce.soap.partner.QueryResult qr_";
  protected final String TEXT_153 = " = null;" + NL + "    \t\tcom.salesforce.soap.partner.DeletedRecord[] drs_";
  protected final String TEXT_154 = " = gdr_";
  protected final String TEXT_155 = ".getDeletedRecords();" + NL + "    \t\t" + NL + "    \t\tif (drs_";
  protected final String TEXT_156 = " != null && drs_";
  protected final String TEXT_157 = ".length > 0) {" + NL + "    \t\t\tint batchSize_";
  protected final String TEXT_158 = " = 500;" + NL + "    \t\t\tint count_";
  protected final String TEXT_159 = " = 0;" + NL + "    \t\t\tStringBuilder soql_";
  protected final String TEXT_160 = " = new StringBuilder();" + NL + "    \t\t\tString soqlBase_";
  protected final String TEXT_161 = " = \"SELECT \" + \"";
  protected final String TEXT_162 = "\" + \" FROM \" + ";
  protected final String TEXT_163 = " + \" WHERE \";" + NL + "\t\t\t\tfor(com.salesforce.soap.partner.DeletedRecord dr_";
  protected final String TEXT_164 = " : drs_";
  protected final String TEXT_165 = "){" + NL + "\t\t\t\t\tcount_";
  protected final String TEXT_166 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_167 = " ++;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_168 = ".append(\"Id='\"+dr_";
  protected final String TEXT_169 = ".getId().getID()+\"'\");" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_170 = ".append(\" or \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_171 = NL + "\t\t\t\t\tif((soql_";
  protected final String TEXT_172 = ".length() > (10000 - 23 - soqlBase_";
  protected final String TEXT_173 = ".length())) || count_";
  protected final String TEXT_174 = " == drs_";
  protected final String TEXT_175 = ".length){" + NL + "\t\t\t\t\t\tsoql_";
  protected final String TEXT_176 = ".delete(soql_";
  protected final String TEXT_177 = ".length() - 4, soql_";
  protected final String TEXT_178 = ".length());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\t\t\t\t\tSystem.out.println(soqlBase_";
  protected final String TEXT_180 = " + soql_";
  protected final String TEXT_181 = ".toString());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\t\t\tqr_";
  protected final String TEXT_183 = " = sfMgr_";
  protected final String TEXT_184 = ".queryAll(soqlBase_";
  protected final String TEXT_185 = " + soql_";
  protected final String TEXT_186 = ".toString(),batchSize_";
  protected final String TEXT_187 = ");" + NL + "" + NL + "\t\t\t\t\t\tboolean bContinue_";
  protected final String TEXT_188 = " = true;" + NL + "\t\t\t\t\t\twhile (bContinue_";
  protected final String TEXT_189 = " && qr_";
  protected final String TEXT_190 = " != null && qr_";
  protected final String TEXT_191 = ".getRecords() != null) {" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t        \t\t    for(int i_";
  protected final String TEXT_192 = " = 0; i_";
  protected final String TEXT_193 = " < qr_";
  protected final String TEXT_194 = ".getRecords().length; i_";
  protected final String TEXT_195 = "++){" + NL + "\t\t\t        \t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_196 = " = qr_";
  protected final String TEXT_197 = ".getRecords()[i_";
  protected final String TEXT_198 = "].getExtraElement();" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\tint len_";
  protected final String TEXT_199 = " = fields_";
  protected final String TEXT_200 = ".length;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_201 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_202 = " < len_";
  protected final String TEXT_203 = " && fields_";
  protected final String TEXT_204 = "[";
  protected final String TEXT_205 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_206 = "[";
  protected final String TEXT_207 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_209 = ".";
  protected final String TEXT_210 = " = fields_";
  protected final String TEXT_211 = "[";
  protected final String TEXT_212 = "].getText();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_216 = "[";
  protected final String TEXT_217 = "].getText(), ";
  protected final String TEXT_218 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_220 = ".";
  protected final String TEXT_221 = " = fields_";
  protected final String TEXT_222 = "[";
  protected final String TEXT_223 = "].getText().getBytes();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_224 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_225 = ".";
  protected final String TEXT_226 = " = ParserUtils.parseTo_";
  protected final String TEXT_227 = "(fields_";
  protected final String TEXT_228 = "[";
  protected final String TEXT_229 = "].getText());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_230 = "\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t";
