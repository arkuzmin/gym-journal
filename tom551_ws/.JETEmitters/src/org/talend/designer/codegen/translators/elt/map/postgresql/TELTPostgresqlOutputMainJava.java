...
public class TELTPostgresqlOutputMainJava
{
  ...
  protected final String TEXT_31 = "String decryptedPassword_";
  ...
  protected final String TEXT_48 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_49 = "+\"(";
  protected final String TEXT_50 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_51 = " = conn_";
  protected final String TEXT_52 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_53 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_54 = "+\" SET ";
  ...
  protected final String TEXT_59 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_60 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_61 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  ...
  protected final String TEXT_82 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_83 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_84 = NL + NL + "pstmt_";
  protected final String TEXT_85 = ".close();" + NL;
  protected final String TEXT_86 = NL + "    if(conn_";
  protected final String TEXT_87 = " != null && !conn_";
  protected final String TEXT_88 = ".isClosed()) {" + NL + "        conn_";
  protected final String TEXT_89 = " .close();" + NL + "    }";
  protected final String TEXT_90 = NL + "nb_line_";
  protected final String TEXT_91 = " = nb_line_update_";
  protected final String TEXT_92 = " + nb_line_inserted_";
