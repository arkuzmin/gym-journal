...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_230 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_231 = " + \":\" + ";
  protected final String TEXT_232 = " + \"/\" + ";
  protected final String TEXT_233 = ";";
  protected final String TEXT_234 = NL + "\t\t            url_";
  protected final String TEXT_235 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_236 = " + \":\" + ";
  protected final String TEXT_237 = " + \"/\" + ";
  protected final String TEXT_238 = ";";
  protected final String TEXT_239 = NL + "\t\t            url_";
  protected final String TEXT_240 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_241 = " + \":\" + ";
  protected final String TEXT_242 = " + \"/\" + ";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "\t\t            url_";
  protected final String TEXT_245 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_246 = " + \":\" + ";
  protected final String TEXT_247 = " + \"/\" + ";
  protected final String TEXT_248 = ";";
  protected final String TEXT_249 = NL + "\t\t        url_";
  protected final String TEXT_250 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_251 = " + \"/\" + ";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "\t\t\t\turl_";
  protected final String TEXT_254 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_255 = " ;";
  protected final String TEXT_256 = NL + "\t\t\t\turl_";
  protected final String TEXT_257 = " += \";\" + ";
  protected final String TEXT_258 = ";";
  protected final String TEXT_259 = NL + "    " + NL + "\t";
  protected final String TEXT_260 = NL + "\t\t    int nb_line_";
  protected final String TEXT_261 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_262 = " = null;";
  protected final String TEXT_263 = NL + "\t\t        conn_";
  protected final String TEXT_264 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_265 = "\");";
  protected final String TEXT_266 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_267 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_268 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_269 = " = dataSources_";
  protected final String TEXT_270 = ".get(";
  protected final String TEXT_271 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_272 = "\", conn_";
  protected final String TEXT_273 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_274 = NL + "\t\t\t\t";
  protected final String TEXT_275 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_276 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_277 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_278 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_279 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_280 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_281 = NL + NL + "\t\t    ";
  protected final String TEXT_282 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ";";
  protected final String TEXT_285 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_286 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_287 = " + \"'.\");";
  protected final String TEXT_288 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_289 = "_QUERY\",dbquery_";
  ...
  protected final String TEXT_314 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_315 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setName(rsmd_";
  protected final String TEXT_317 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_326 = ".getColumnTypeName(i));";
  protected final String TEXT_327 = NL + "                \tdcm_";
  protected final String TEXT_328 = ".setFormat(";
  protected final String TEXT_329 = ");";
  protected final String TEXT_330 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_331 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_332 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_333 = ".setLength(rsmd_";
  protected final String TEXT_334 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_335 = ".setLength(rsmd_";
  protected final String TEXT_336 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_337 = NL + "\t\t\tdcm_";
  protected final String TEXT_338 = ".setLength(rsmd_";
  protected final String TEXT_339 = ".getPrecision(i));";
  protected final String TEXT_340 = NL + "                \tdcm_";
  protected final String TEXT_341 = ".setPrecision(rsmd_";
  protected final String TEXT_342 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_343 = ".setNullable(rsmd_";
  protected final String TEXT_344 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_345 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_346 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_347 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_348 = ".metadatas.add(dcm_";
  protected final String TEXT_349 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_350 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_351 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_352 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_353 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_354 = NL + "\t\t    ";
  protected final String TEXT_355 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_356 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_387 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_388 = ".getObject(";
  protected final String TEXT_389 = "column_index_";
  protected final String TEXT_390 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_391 = NL + "                                    ";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = " = new Geometry(wktValue);";
  protected final String TEXT_394 = NL + "                                        ";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = ".setEPSG(";
  protected final String TEXT_397 = ");";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_399 = NL + "                                  ";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = "=dcg_";
  protected final String TEXT_402 = ";";
  protected final String TEXT_403 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_404 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_405 = " = ";
  protected final String TEXT_406 = "; i_";
  protected final String TEXT_407 = "  <= rsmd_";
  protected final String TEXT_408 = ".getColumnCount(); i_";
  protected final String TEXT_409 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_410 = ".getColumnTypeName(i_";
  protected final String TEXT_411 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_412 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_413 = ".getClob(i_";
  protected final String TEXT_414 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_415 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_416 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_417 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_418 = ".add(tNTextImpl_";
  protected final String TEXT_419 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_420 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_421 = ".";
  protected final String TEXT_422 = ", rs_";
  protected final String TEXT_423 = ", fixedColumnCount_";
  protected final String TEXT_424 = ",list_";
  protected final String TEXT_425 = ");";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_436 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_437 = ".getObject(";
  protected final String TEXT_438 = "column_index_";
  protected final String TEXT_439 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_448 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_449 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_450 = NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_452 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_453 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_454 = " - Content of the record \" + nb_line_";
  protected final String TEXT_455 = " + \": \" + log4jSb_";
  protected final String TEXT_456 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_457 = ".delete(0,log4jSb_";
  protected final String TEXT_458 = ".length());" + NL + "\t\t\t\t\t";
