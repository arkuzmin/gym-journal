...
public class TPaloCubeListBeginJava
{
  ...
  protected final String TEXT_34 = ");" + NL + "" + NL + "if(pDB_";
  protected final String TEXT_35 = " == null){" + NL + "\t throw new RuntimeException (\"Database '\" + ";
  protected final String TEXT_36 = " + \"' not found. exiting...\");" + NL + "}" + NL + NL;
  protected final String TEXT_37 = NL + "for(int i_";
  protected final String TEXT_38 = "=0;i_";
  protected final String TEXT_39 = "<4;i_";
  protected final String TEXT_40 = "++){" + NL + "\torg.talend.jpalo.palocubes pCUBs_";
  protected final String TEXT_41 = " = pDB_";
  protected final String TEXT_42 = ".getCubes(i_";
  protected final String TEXT_43 = ");" + NL + "\tfor(int j_";
  protected final String TEXT_44 = "=0;j_";
  protected final String TEXT_45 = "< pCUBs_";
  protected final String TEXT_46 = ".getNumberOfCubes();j_";
  protected final String TEXT_47 = "++){" + NL + "\t\torg.talend.jpalo.palocube pCUB_";
  protected final String TEXT_48 = "=pCUBs_";
  protected final String TEXT_49 = ".getCube(j_";
  protected final String TEXT_50 = ");" + NL + "\t\tNB_CUBES";
  protected final String TEXT_51 = "++;";
  protected final String TEXT_52 = "\t\t" + NL + "\t\t\t";
  protected final String TEXT_53 = ".cube_id=pCUB_";
  protected final String TEXT_54 = ".getCubeId();" + NL + "\t\t\t";
  protected final String TEXT_55 = ".cube_name=pCUB_";
  protected final String TEXT_56 = ".getName();" + NL + "\t\t\t";
  protected final String TEXT_57 = ".cube_dimensions=pCUB_";
  protected final String TEXT_58 = ".getNumberOfDimensions();" + NL + "\t\t\t";
  protected final String TEXT_59 = ".cube_cells=pCUB_";
  protected final String TEXT_60 = ".getNumberOfCells();" + NL + "\t\t\t";
  protected final String TEXT_61 = ".cube_filled_cells=pCUB_";
  protected final String TEXT_62 = ".getNumberOfFilledCells();" + NL + "\t\t\t";
  protected final String TEXT_63 = ".cube_status=pCUB_";
  protected final String TEXT_64 = ".getCubeStatus();" + NL + "\t\t\t";
  protected final String TEXT_65 = ".cube_type=pCUB_";
  protected final String TEXT_66 = ".getCubeType();";
  protected final String TEXT_67 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_68 = "_CUBEID\", pCUB_";
  protected final String TEXT_69 = ".getCubeId());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_70 = "_CUBENAME\", pCUB_";
  protected final String TEXT_71 = ".getName());" + NL + "\t\t";
