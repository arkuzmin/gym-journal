...
public class TIngresSCDBeginJava {
  ...
  protected final String TEXT_30 = NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_31 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_32 = " = null;    ";
  protected final String TEXT_33 = NL + "        String searching_";
  protected final String TEXT_34 = " = \"";
  protected final String TEXT_35 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_36 = " = connection_";
  protected final String TEXT_37 = ".prepareStatement(searching_";
  protected final String TEXT_38 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_39 = " = null;";
  protected final String TEXT_40 = NL + "        String search_";
  protected final String TEXT_41 = " = \"";
  protected final String TEXT_42 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_43 = " = connection_";
  protected final String TEXT_44 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_45 = " = statement_";
  protected final String TEXT_46 = ".executeQuery(search_";
  protected final String TEXT_47 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_48 = ", SCDStruct_";
  protected final String TEXT_49 = "> cache_";
  protected final String TEXT_50 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_51 = ", SCDStruct_";
  protected final String TEXT_52 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_53 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_54 = " sk_";
  protected final String TEXT_55 = " = new SCDSK_";
  protected final String TEXT_56 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_57 = " row_";
  protected final String TEXT_58 = " = new SCDStruct_";
  protected final String TEXT_59 = "();";
  protected final String TEXT_60 = NL + "                    tmpValue_";
  protected final String TEXT_61 = " = resultSet_";
  protected final String TEXT_62 = ".getString(";
  protected final String TEXT_63 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_64 = " != null && tmpValue_";
  protected final String TEXT_65 = ".length() > 0) {";
  protected final String TEXT_66 = NL + "                        ";
  protected final String TEXT_67 = ".";
  protected final String TEXT_68 = " = tmpValue_";
  protected final String TEXT_69 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_70 = NL + "                            if(tmpValue_";
  protected final String TEXT_71 = " == null) {";
  protected final String TEXT_72 = NL + "                                ";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = " = null;" + NL + "                            } else {";
  protected final String TEXT_75 = NL + "                                ";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_78 = NL + "                            if(tmpValue_";
  protected final String TEXT_79 = "(\"\").equals()) {";
  protected final String TEXT_80 = NL + "                                ";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_83 = "' in '";
  protected final String TEXT_84 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_85 = NL + "                    }";
  protected final String TEXT_86 = NL + "                    timestamp_";
  ...
  protected final String TEXT_98 = NL + "                    if(resultSet_";
  ...
  protected final String TEXT_107 = NL + "            cache_";
  protected final String TEXT_108 = ".put(sk_";
  protected final String TEXT_109 = ", row_";
  protected final String TEXT_110 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_111 = ".close();" + NL + "        statement_";
  protected final String TEXT_112 = ".close();";
  protected final String TEXT_113 = NL + "            System.out.println(\"[";
  protected final String TEXT_114 = "] comparison cache loaded\");";
  protected final String TEXT_115 = NL + "        ";
  protected final String TEXT_116 = " nextSurrogateKey_";
  protected final String TEXT_117 = " = 1;";
  protected final String TEXT_118 = NL + "            if(cache_";
  protected final String TEXT_119 = ".size() > 0) {";
  protected final String TEXT_120 = NL + "        String tmpQuery_";
  protected final String TEXT_121 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_122 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_123 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_124 = " = connection_";
  protected final String TEXT_125 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_126 = " = tmpStmt_";
  protected final String TEXT_127 = ".executeQuery(tmpQuery_";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "        if(tmpRS_";
  protected final String TEXT_130 = ".next() && tmpRS_";
  protected final String TEXT_131 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_132 = " = tmpRS_";
  protected final String TEXT_133 = ".get";
  protected final String TEXT_134 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_135 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_136 = ".close();";
  protected final String TEXT_137 = NL + "            }            ";
  protected final String TEXT_138 = NL + "    String insertionSQL_";
  protected final String TEXT_139 = " = \"";
  protected final String TEXT_140 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_141 = " = connection_";
  protected final String TEXT_142 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_143 = ");";
  protected final String TEXT_144 = NL + "            insertionStatement_";
  protected final String TEXT_145 = ".setTimestamp(";
  protected final String TEXT_146 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_147 = "\")));";
  protected final String TEXT_148 = NL + "            insertionStatement_";
  protected final String TEXT_149 = ".setNull(";
  protected final String TEXT_150 = ", java.sql.Types.DATE);";
  protected final String TEXT_151 = NL + "            insertionStatement_";
  protected final String TEXT_152 = ".setTimestamp(";
  protected final String TEXT_153 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_154 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_155 = NL + "        String updateSQLForType1_";
  protected final String TEXT_156 = " = \"";
  protected final String TEXT_157 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_158 = " = connection_";
  protected final String TEXT_159 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_160 = ");        ";
  protected final String TEXT_161 = NL + "        String updateSQLForType2_";
  protected final String TEXT_162 = " = \"";
  protected final String TEXT_163 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_164 = " = connection_";
  protected final String TEXT_165 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_166 = ");";
  protected final String TEXT_167 = NL + "            updateForType2_";
  protected final String TEXT_168 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_169 = "\")));";
  protected final String TEXT_170 = NL + "        String updateSQLForType3_";
  protected final String TEXT_171 = " = \"";
  protected final String TEXT_172 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_173 = " = connection_";
  protected final String TEXT_174 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "    ";
  protected final String TEXT_177 = NL + "        SCDSK_";
  protected final String TEXT_178 = " lookUpKey_";
  protected final String TEXT_179 = " = null;        ";
  protected final String TEXT_180 = NL + "    SCDStruct_";
  protected final String TEXT_181 = " lookUpValue_";
