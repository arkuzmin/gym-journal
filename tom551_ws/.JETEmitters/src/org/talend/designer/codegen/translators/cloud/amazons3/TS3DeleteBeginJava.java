...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_45 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_48 = "!=null && key_";
  protected final String TEXT_49 = ".trim().length()>0){" + NL + "\t\t\tconn_";
  protected final String TEXT_50 = ".deleteObject(";
  protected final String TEXT_51 = ", key_";
  protected final String TEXT_52 = ");" + NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_53 = "){";
  protected final String TEXT_54 = NL + "\t\tthrow(e_";
  protected final String TEXT_55 = ");";
  protected final String TEXT_56 = NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_57 = ".getMessage());";
  protected final String TEXT_58 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_59 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_60 = ".shutdown();" + NL + "\t\t}";
