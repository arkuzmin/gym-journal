...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_36 = NL + "    String tableName_";
  protected final String TEXT_37 = " = ";
  protected final String TEXT_38 = ";" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_46 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_58 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_59 = " = conn_";
  protected final String TEXT_60 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_61 = " = dbMetaData_";
  protected final String TEXT_62 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  ...
  protected final String TEXT_69 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_79 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_80 = " = conn_";
  protected final String TEXT_81 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_82 = ".execute(\"";
  protected final String TEXT_83 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_84 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_92 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_93 = ".executeUpdate(\"";
  protected final String TEXT_94 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_95 = ".close();";
  protected final String TEXT_96 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_99 = ".executeUpdate(\"";
  protected final String TEXT_100 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_101 = ".close();";
  protected final String TEXT_102 = NL + "        System.out.println(\"[";
  protected final String TEXT_103 = "] table action ";
  protected final String TEXT_104 = " done\\n\");";
  protected final String TEXT_105 = NL + "    ";
  protected final String TEXT_106 = NL + "        String updateForType1_";
  protected final String TEXT_107 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_108 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_109 = " + \"` t SET ";
  protected final String TEXT_110 = " WHERE ";
  protected final String TEXT_111 = " AND (";
  protected final String TEXT_112 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_113 = " = conn_";
  protected final String TEXT_114 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_115 = ".executeUpdate(updateForType1_";
  protected final String TEXT_116 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_117 = ".close();";
  protected final String TEXT_118 = NL + "            System.out.println(\"[";
  protected final String TEXT_119 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_120 = " + \"\\ndone\");";
  protected final String TEXT_121 = "        " + NL + "        String changeDateTime_";
  protected final String TEXT_122 = " = (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_123 = "\"))).toString();" + NL + "\t";
  protected final String TEXT_124 = NL + "        String changeDateTime_";
  protected final String TEXT_125 = "_begin = changeDateTime_";
  protected final String TEXT_126 = ";" + NL + "        String changeDateTime_";
  protected final String TEXT_127 = "_end = changeDateTime_";
  protected final String TEXT_128 = ";" + NL + "        ";
  protected final String TEXT_129 = NL + "\t\t        changeDateTime_";
  protected final String TEXT_130 = "_begin = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_131 = "\").getDateString(\"";
  protected final String TEXT_132 = "\",\"";
  protected final String TEXT_133 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_134 = "\"),";
  protected final String TEXT_135 = ");" + NL + "\t\t";
  protected final String TEXT_136 = NL + "        \t\tchangeDateTime_";
  protected final String TEXT_137 = "_end = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_138 = "\").getDateString(\"";
  protected final String TEXT_139 = "\",\"";
  protected final String TEXT_140 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_141 = "\"),";
  protected final String TEXT_142 = ");";
  protected final String TEXT_143 = NL + "        String updateForType2_";
  protected final String TEXT_144 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_145 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_146 = " + \"` t SET `";
  protected final String TEXT_147 = "` = '\" + (changeDateTime_";
  ...
  protected final String TEXT_154 = "` IS NULL\"; " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_157 = ".executeUpdate(updateForType2_";
  protected final String TEXT_158 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_159 = ".close();";
  protected final String TEXT_160 = NL + "        \tString updateForType2_";
  protected final String TEXT_161 = "_debug = \"UPDATE `\" + tableName_";
  protected final String TEXT_162 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_163 = " + \"` t SET `";
  protected final String TEXT_164 = "` = '\" + (changeDateTime_";
  protected final String TEXT_165 = "_end) + \"'";
  ...
  protected final String TEXT_171 = "` IS NULL\"; " + NL + "            System.out.println(\"[";
  protected final String TEXT_172 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_173 = "_debug + \"\\ndone\");";
  protected final String TEXT_174 = NL + "        String insertForType2_";
  protected final String TEXT_175 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_176 = " + \"`(";
  protected final String TEXT_177 = ") SELECT t.";
  protected final String TEXT_178 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_179 = ") + \"', NULL";
  protected final String TEXT_180 = ", 1";
  protected final String TEXT_181 = ", d.`";
  protected final String TEXT_182 = "` + 1";
  protected final String TEXT_183 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_184 = " + \"` t, `\" + tableName_";
  protected final String TEXT_185 = " + \"` d WHERE ";
  protected final String TEXT_186 = " AND (";
  protected final String TEXT_187 = ") AND d.`";
  protected final String TEXT_188 = "` = '\" + (changeDateTime_";
  protected final String TEXT_189 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_192 = ".executeUpdate(insertForType2_";
  protected final String TEXT_193 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_194 = ".close();";
  protected final String TEXT_195 = NL + "\t\t\tString insertForType2_";
  protected final String TEXT_196 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_197 = " + \"`(";
  protected final String TEXT_198 = ") SELECT t.";
  protected final String TEXT_199 = ", '\" + (changeDateTime_";
  protected final String TEXT_200 = "_begin) + \"', NULL";
  protected final String TEXT_201 = ", 1";
  protected final String TEXT_202 = ", d.`";
  protected final String TEXT_203 = "` + 1";
  protected final String TEXT_204 = " FROM `\" + sourceTable_";
  protected final String TEXT_205 = " + \"` t, `\" + tableName_";
  protected final String TEXT_206 = " + \"` d WHERE ";
  protected final String TEXT_207 = " AND (";
  protected final String TEXT_208 = ") AND d.`";
  protected final String TEXT_209 = "` = '\" + (changeDateTime_";
  protected final String TEXT_210 = "_end) + \"'\";" + NL + "            System.out.println(\"[";
  protected final String TEXT_211 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_212 = "_debug + \"\\ndone\");";
  protected final String TEXT_213 = NL + "    String insert_";
  protected final String TEXT_214 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_215 = " + \"`(";
  protected final String TEXT_216 = ") SELECT t.";
  protected final String TEXT_217 = "\"";
  protected final String TEXT_218 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_219 = ") + \"', NULL\"";
  protected final String TEXT_220 = NL + "    + \"";
  protected final String TEXT_221 = ", 1";
  protected final String TEXT_222 = ", 1";
  protected final String TEXT_223 = " FROM `\" + " + NL + "    sourceTable_";
  protected final String TEXT_224 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_225 = " + \"` d ON ";
  protected final String TEXT_226 = " WHERE (";
  protected final String TEXT_227 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_230 = ".executeUpdate(insert_";
  protected final String TEXT_231 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_232 = ".close();";
  protected final String TEXT_233 = NL + "    \tString insert_";
  protected final String TEXT_234 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_235 = " + \"`(";
  protected final String TEXT_236 = ") SELECT t.";
  protected final String TEXT_237 = "\"";
  protected final String TEXT_238 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_239 = "_begin) + \"', NULL\"";
  protected final String TEXT_240 = " + \"";
  protected final String TEXT_241 = ", 1";
  protected final String TEXT_242 = ", 1";
  protected final String TEXT_243 = " FROM `\" + sourceTable_";
  protected final String TEXT_244 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_245 = " + \"` d ON ";
  protected final String TEXT_246 = " WHERE (";
  protected final String TEXT_247 = ")\";" + NL + "        System.out.println(\"[";
  protected final String TEXT_248 = "] new rows sql\\n\" + insert_";
  protected final String TEXT_249 = "_debug + \"\\ndone\");";
