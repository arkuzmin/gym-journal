...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_9 = NL + "    StringBuffer command_";
  protected final String TEXT_10 = " = new StringBuffer();" + NL + "    command_";
  protected final String TEXT_11 = ".append(";
  protected final String TEXT_12 = ")" + NL + "    \t.append(\" \\\"\")" + NL + "    \t.append(";
  protected final String TEXT_13 = ")" + NL + "    \t.append(\"\\\" queryout \\\"\")" + NL + "    \t.append(";
  protected final String TEXT_14 = ")" + NL + "    \t.append(\"\\\" \")" + NL + "    \t.append(\"";
  protected final String TEXT_15 = "\")";
  protected final String TEXT_16 = NL + "    \t.append(\" -S\")" + NL + "    \t.append(";
  protected final String TEXT_17 = ")";
  protected final String TEXT_18 = NL + "    \t.append(\" -T\")";
  protected final String TEXT_19 = NL + "    \t.append(\" -U\")" + NL + "    \t.append(";
  protected final String TEXT_20 = ")" + NL + "    \t.append(\" -P\")" + NL + "    \t.append(decryptedPassword_";
  protected final String TEXT_21 = ")";
  protected final String TEXT_22 = NL + "    \t.append(\" -t\")" + NL + "    \t.append(";
  protected final String TEXT_23 = ")" + NL + "    \t.append(\" -r\")" + NL + "    \t.append(";
  protected final String TEXT_24 = ");" + NL + "    " + NL + "    Runtime runtime_";
  protected final String TEXT_25 = " = Runtime.getRuntime();" + NL + "    final Process ps";
  protected final String TEXT_26 = " = runtime_";
  protected final String TEXT_27 = ".exec(command_";
  protected final String TEXT_28 = ".toString());" + NL + "    Thread normal_";
  protected final String TEXT_29 = " = new Thread() {" + NL + "        public void run() {" + NL + "            try {" + NL + "                java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_30 = ".getInputStream()));" + NL + "                String line = \"\";" + NL + "                try {" + NL + "                    while((line = reader.readLine()) != null) {";
  protected final String TEXT_31 = NL + "                            System.out.println(line);";
  protected final String TEXT_32 = NL + "                            globalMap.put(\"";
  protected final String TEXT_33 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_34 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_35 = NL + "                    }" + NL + "                } finally {" + NL + "                    reader.close();" + NL + "                }" + NL + "            } catch(java.io.IOException ioe) {" + NL + "                ioe.printStackTrace();" + NL + "            }" + NL + "        }" + NL + "    };" + NL + "    normal_";
  protected final String TEXT_36 = ".start();" + NL + "    Thread error_";
  protected final String TEXT_37 = " = new Thread() {" + NL + "        public void run() {" + NL + "            try {" + NL + "                java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_38 = ".getErrorStream()));" + NL + "                String line = \"\";" + NL + "                try {" + NL + "                    while((line = reader.readLine()) != null) {";
  protected final String TEXT_39 = NL + "                            System.err.println(line);";
  protected final String TEXT_40 = NL + "                            globalMap.put(\"";
  protected final String TEXT_41 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_42 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_43 = NL + "                    }" + NL + "                } finally {" + NL + "                    reader.close();" + NL + "                }" + NL + "            } catch(java.io.IOException ioe) {" + NL + "                ioe.printStackTrace();" + NL + "            }" + NL + "        }" + NL + "    };" + NL + "    error_";
  protected final String TEXT_44 = ".start();" + NL + "    ps";
  protected final String TEXT_45 = ".waitFor();" + NL + "    normal_";
  protected final String TEXT_46 = ".interrupt();" + NL + "    error_";
  protected final String TEXT_47 = ".interrupt();";
  ...
  protected final String TEXT_58 = ";" + NL + "    java.lang.Class.forName(\"net.sourceforge.jtds.jdbc.Driver\");" + NL + "    String port_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "    String dbname_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = " ;" + NL + "    String url_";
  protected final String TEXT_63 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_64 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_65 = ")) {" + NL + "    \turl_";
  protected final String TEXT_66 = " += \":\" + ";
  protected final String TEXT_67 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_68 = ")) {" + NL + "    \turl_";
  protected final String TEXT_69 = " += \"//\" + ";
  protected final String TEXT_70 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_71 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_81 = NL + "    String dbPwd_";
  ...
  protected final String TEXT_88 = NL + "    String tableName_";
  protected final String TEXT_89 = " = null;    " + NL + "    if(dbschema_";
  protected final String TEXT_90 = " == null || dbschema_";
  protected final String TEXT_91 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "    } else {" + NL + "        tableName_";
  ...
  protected final String TEXT_103 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_119 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_120 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_121 = " = tableNameForSearch_";
  protected final String TEXT_122 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_123 = " = tableNameForSearch_";
  protected final String TEXT_124 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_125 = " = dbMetaData_";
  protected final String TEXT_126 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_127 = ", tableNameForSearch_";
  protected final String TEXT_128 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_129 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_130 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_131 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_141 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_142 = " = rsTable_";
  protected final String TEXT_143 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_144 = ".equalsIgnoreCase(";
  protected final String TEXT_145 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_146 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_147 = ") || dbschema_";
  protected final String TEXT_148 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_149 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_159 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_163 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_164 = ".equals(schema_";
  protected final String TEXT_165 = ") || (schema_";
  protected final String TEXT_166 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_167 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_176 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_177 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_178 = " == null || dbschema_";
  protected final String TEXT_179 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_182 = " = stmtSchema_";
  protected final String TEXT_183 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_184 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_185 = " = rsSchema_";
  protected final String TEXT_186 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_187 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_188 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_203 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_208 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_218 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_226 = NL + "                if(!whetherExist_";
  protected final String TEXT_227 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_233 = NL + "                if(whetherExist_";
  protected final String TEXT_234 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_237 = ".execute(\"";
  protected final String TEXT_238 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_239 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_267 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_268 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_269 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_270 = NL + "        java.sql.Statement stmtBulkInsert_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".createStatement();" + NL + "        stmtBulkInsert_";
  protected final String TEXT_273 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_274 = " + \"] FROM '\" + ";
  protected final String TEXT_275 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_276 = " + \"',DATAFILETYPE='";
  protected final String TEXT_277 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_278 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_279 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_280 = "+\"')\");" + NL + "        stmtBulkInsert_";
  protected final String TEXT_281 = ".close();        ";
  protected final String TEXT_282 = NL + "            int keyCount_";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_285 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_286 = " = tableName_";
  protected final String TEXT_287 = ";" + NL + "            tableName_";
  protected final String TEXT_288 = " = \"tmp_";
  protected final String TEXT_289 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_290 = " = conn_";
  protected final String TEXT_291 = ".createStatement();" + NL + "            stmtCreateTmp_";
  protected final String TEXT_292 = ".execute(\"";
  protected final String TEXT_293 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_294 = ".close();" + NL + "            java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".createStatement();" + NL + "            stmtTmpBulk_";
  protected final String TEXT_297 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_298 = " + \"] FROM '\" + ";
  protected final String TEXT_299 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_300 = " + \"',DATAFILETYPE='";
  protected final String TEXT_301 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_302 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_303 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_304 = "+\"')\");" + NL + "            stmtTmpBulk_";
  protected final String TEXT_305 = ".close();" + NL + "            tableName_";
  protected final String TEXT_306 = " = tmpTableName_";
  protected final String TEXT_307 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_308 = " = \"tmp_";
  protected final String TEXT_309 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_310 = " = conn_";
  protected final String TEXT_311 = ".createStatement();" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_312 = ".executeUpdate(\"";
  protected final String TEXT_313 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_314 = ".close();" + NL + "            tableName_";
  protected final String TEXT_315 = " = \"tmp_";
  protected final String TEXT_316 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_319 = ".execute(\"";
  protected final String TEXT_320 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_321 = ".close();";
  protected final String TEXT_322 = NL + "        if(conn_";
  protected final String TEXT_323 = " != null && !conn_";
  protected final String TEXT_324 = ".isClosed()) {" + NL + "            conn_";
