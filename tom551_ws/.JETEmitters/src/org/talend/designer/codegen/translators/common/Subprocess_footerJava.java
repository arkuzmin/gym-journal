...
public class Subprocess_footerJava
{
  ...
  protected final String TEXT_7 = NL + "\t\t\t\t}//end the resume" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_8 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_9 = "Process(globalMap);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_10 = NL + "\t\t\t\t    \t\t\tif(resumeEntryMethodName == null || globalResumeTicket){" + NL + "\t\t\t\t    \t\t\t\tresumeUtil.addLog(\"CHECKPOINT\", \"CONNECTION:";
  protected final String TEXT_11 = ":";
  protected final String TEXT_12 = ":";
  protected final String TEXT_13 = "\", \"\", Thread.currentThread().getId() + \"\", \"\", \"\", \"\", \"\", \"\");" + NL + "\t\t\t\t\t\t\t\t}\t    \t\t\t\t    \t\t\t" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_14 = NL + "\t\t\t\t\t\t\t\tif(execStat){    \t" + NL + "\t\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_15 = "\", 0, \"ok\");" + NL + "\t\t\t\t\t\t\t\t} " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_16 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_17 = "Process(globalMap); " + NL + "\t\t\t\t\t\t";
  protected final String TEXT_18 = NL + NL + NL + NL + "\t" + NL + "\t\t\t}catch(java.lang.Exception e){\t" + NL + "\t\t\t\t";
  protected final String TEXT_19 = NL + "\t\t\t\t\tlog.error(currentComponent + \" \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_20 = NL + "\t\t\t\tTalendException te = new TalendException(e, currentComponent, globalMap);" + NL + "\t\t\t\t";
  protected final String TEXT_21 = NL + "\t\t\t\t\tte.setVirtualComponentName(currentVirtualComponent);" + NL + "\t\t\t\t";
  protected final String TEXT_22 = NL + "\t\t\t\t\t\t\tif(resourceMap.get(\"finish_";
  protected final String TEXT_23 = "\") == null){" + NL + "\t\t\t\t\t\t\t\tif(resourceMap.get(\"start_";
  protected final String TEXT_24 = "\") != null){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_25 = NL + "\t\t\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_26 = "[\" + Thread.currentThread().getName() + \"] - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_27 = NL + "\t\t\t\t\t\t\t\t\tglobalMap.put(\"THREADS_HAVE_ERROR\", e);" + NL + "\t\t\t\t\t\t\t\t\treturn;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_28 = NL + "\t\t\t\tthrow te;" + NL + "\t\t\t}catch(java.lang.Error error){\t" + NL + "\t\t\t\t";
  protected final String TEXT_29 = NL + "\t\t\t\t\trunStat.stopThreadStat();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_34 = "[\" + Thread.currentThread().getName() + \"] - \" + error.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\t\t\t\t\t\tglobalMap.put(\"THREADS_HAVE_ERROR\",error);" + NL + "\t\t\t\t\t\t\t\t\treturn;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_36 = NL + "\t\t\t\tthrow error;" + NL + "\t\t\t}finally{" + NL + "\t\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\t\t\t\t\t//free memory for \"";
  protected final String TEXT_38 = "\"" + NL + "\t\t\t\t\t\t\tglobalMap.remove(\"";
  protected final String TEXT_39 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\t     \t\t\t//free memory for \"";
  protected final String TEXT_41 = "\"" + NL + "\t\t\t\t\t     \t\t\tglobalMap.remove(\"tHash_Lookup_";
  protected final String TEXT_42 = "\"); " + NL + "\t\t\t\t     \t\t\t";
  protected final String TEXT_43 = "      \t" + NL + "\t\t\t\t\t      \t\t\t//free memory for \"";
  protected final String TEXT_44 = "\"" + NL + "\t\t\t\t\t\t\t\t\tglobalMap.remove(\"tHash_";
  protected final String TEXT_45 = "\");" + NL + "\t\t\t\t      \t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t}catch(java.lang.Exception e){\t" + NL + "\t\t\t\t\t//ignore" + NL + "\t\t\t\t}catch(java.lang.Error error){" + NL + "\t\t\t\t\t//ignore" + NL + "\t\t\t\t}" + NL + "\t\t\t\tresourceMap = null;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_48 = NL + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_49 = "_SUBPROCESS_STATE\", 1);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_50 = NL + "\t\t/**" + NL + "\t\t * End of Function: ";
  protected final String TEXT_51 = "Process " + NL + "\t\t\t */" + NL + " \t\t";
