...
public class TMysqlSCDBeginJava {
  ...
  protected final String TEXT_46 = ".getMetaData();";
  protected final String TEXT_47 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_48 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_49 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_50 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_51 = " = ((String)";
  protected final String TEXT_52 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_53 = " = schema_";
  protected final String TEXT_54 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_57 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_58 = " = tableName4Search_";
  protected final String TEXT_59 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_60 = " = tableName4Search_";
  protected final String TEXT_61 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_62 = " = dbMetaData_";
  protected final String TEXT_63 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_64 = ", tableName4Search_";
  protected final String TEXT_65 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_66 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_67 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_68 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_87 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_88 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_89 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_90 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_91 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_92 = " = calendarYear0_";
  protected final String TEXT_93 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_94 = " = calendar_";
  protected final String TEXT_95 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_96 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_97 = " = calendar_";
  protected final String TEXT_98 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_99 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_100 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_101 = " = null;    ";
  protected final String TEXT_102 = NL + "        String searching_";
  protected final String TEXT_103 = " = \"";
  protected final String TEXT_104 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_105 = " = connection_";
  protected final String TEXT_106 = ".prepareStatement(searching_";
  protected final String TEXT_107 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_108 = " = null;";
  protected final String TEXT_109 = NL + "        String search_";
  protected final String TEXT_110 = " = \"";
  protected final String TEXT_111 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_112 = " = connection_";
  protected final String TEXT_113 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_114 = " = statement_";
  protected final String TEXT_115 = ".executeQuery(search_";
  protected final String TEXT_116 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_117 = ", SCDStruct_";
  protected final String TEXT_118 = "> cache_";
  protected final String TEXT_119 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_120 = ", SCDStruct_";
  protected final String TEXT_121 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_122 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_123 = " sk_";
  protected final String TEXT_124 = " = new SCDSK_";
  protected final String TEXT_125 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_126 = " row_";
  protected final String TEXT_127 = " = new SCDStruct_";
  protected final String TEXT_128 = "();";
  protected final String TEXT_129 = NL + "                    tmpValue_";
  protected final String TEXT_130 = " = resultSet_";
  protected final String TEXT_131 = ".getString(";
  protected final String TEXT_132 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_133 = " != null && tmpValue_";
  protected final String TEXT_134 = ".length() > 0) {";
  protected final String TEXT_135 = NL + "                        ";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = " = tmpValue_";
  ...
  protected final String TEXT_147 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_148 = ")) {";
  protected final String TEXT_149 = NL + "                                ";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_155 = NL + "                    dateStr_";
  protected final String TEXT_156 = " = resultSet_";
  protected final String TEXT_157 = ".getString(";
  protected final String TEXT_158 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_159 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_160 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_161 = ")) {";
  protected final String TEXT_162 = NL + "                            ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = new java.util.Date(resultSet_";
  protected final String TEXT_165 = ".getTimestamp(";
  protected final String TEXT_166 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_167 = NL + "                            ";
  protected final String TEXT_168 = ".";
  protected final String TEXT_169 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_170 = ".clone();" + NL + "                        }" + NL + "                    } else {";
