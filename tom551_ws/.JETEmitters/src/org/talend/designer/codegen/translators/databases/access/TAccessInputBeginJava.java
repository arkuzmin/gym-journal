...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_229 = ";";
  protected final String TEXT_230 = NL + "\t            String url_";
  protected final String TEXT_231 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  protected final String TEXT_232 = ";            ";
  protected final String TEXT_233 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_234 = "\");" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t        String dbUser_";
  ...
  protected final String TEXT_246 = " = decryptedPassword_";
  ...
  protected final String TEXT_253 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_256 = " = atnParams_";
  protected final String TEXT_257 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_258 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_259 = ".put(\"user\",dbUser_";
  protected final String TEXT_260 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_261 = ".put(\"password\",dbPwd_";
  protected final String TEXT_262 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_263 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_264 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_265 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_266 = ", atnParamsPrope_";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_269 = " = rs_";
  protected final String TEXT_270 = ".getTimestamp(";
  protected final String TEXT_271 = "column_index_";
  protected final String TEXT_272 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_273 = " != null) {";
  protected final String TEXT_274 = NL + "                ";
  protected final String TEXT_275 = ".";
  protected final String TEXT_276 = " = new java.util.Date(timestamp_";
  protected final String TEXT_277 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_278 = NL + "                ";
  protected final String TEXT_279 = ".";
  protected final String TEXT_280 = " =  null;" + NL + "            }";
  protected final String TEXT_281 = NL + "\t        Object value = rs_";
  protected final String TEXT_282 = ".getObject(";
  protected final String TEXT_283 = "column_index_";
  protected final String TEXT_284 = ");" + NL + "\t        if(value != null) {";
  protected final String TEXT_285 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_286 = "(";
  protected final String TEXT_287 = ".parse";
  protected final String TEXT_288 = "(value.toString()));";
  protected final String TEXT_289 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_290 = "(";
  protected final String TEXT_291 = ".parse";
  protected final String TEXT_292 = "(value.toString()));";
  protected final String TEXT_293 = NL + "\t \t   \t\t \t\t";
  protected final String TEXT_294 = ".";
  protected final String TEXT_295 = " = (";
  protected final String TEXT_296 = ")value;" + NL + "\t                } else {";
  protected final String TEXT_297 = NL + "\t                ";
  protected final String TEXT_298 = ".";
  protected final String TEXT_299 = " = null;";
  protected final String TEXT_300 = "    " + NL + "\t                throw new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_301 = NL + "\t        }";
  protected final String TEXT_302 = NL + "    " + NL + "\t";
  protected final String TEXT_303 = NL + "\t\t    int nb_line_";
  protected final String TEXT_304 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_305 = " = null;";
  protected final String TEXT_306 = NL + "\t\t        conn_";
  protected final String TEXT_307 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_308 = "\");";
  protected final String TEXT_309 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_310 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_311 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_312 = " = dataSources_";
  protected final String TEXT_313 = ".get(";
  protected final String TEXT_314 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_319 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_320 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_321 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_322 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_323 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_324 = NL + NL + "\t\t    ";
  protected final String TEXT_325 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_326 = " = ";
  protected final String TEXT_327 = ";";
  protected final String TEXT_328 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_329 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_330 = " + \"'.\");";
  protected final String TEXT_331 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_332 = "_QUERY\",dbquery_";
  protected final String TEXT_333 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_334 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_335 = " = stmt_";
  protected final String TEXT_336 = ".executeQuery(dbquery_";
  protected final String TEXT_337 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_338 = " = rs_";
  protected final String TEXT_339 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_340 = " = rsmd_";
  protected final String TEXT_341 = ".getColumnCount();" + NL;
  protected final String TEXT_342 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_343 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_344 = ".setDbmsId(\"";
  protected final String TEXT_345 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_346 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_347 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_348 = ".add(\"";
  protected final String TEXT_349 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_350 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_351 = " = ";
  protected final String TEXT_352 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_353 = "; i <= rsmd_";
  protected final String TEXT_354 = ".getColumnCount()-";
  protected final String TEXT_355 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_356 = ".contains(rsmd_";
  protected final String TEXT_357 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_358 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_359 = ".setName(rsmd_";
  protected final String TEXT_360 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_361 = ".setDbName(rsmd_";
  protected final String TEXT_362 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_363 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_364 = "\", rsmd_";
  protected final String TEXT_365 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_366 = ".getPrecision(i), rsmd_";
  protected final String TEXT_367 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_368 = ".setDbType(rsmd_";
  protected final String TEXT_369 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_398 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_399 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_400 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_401 = NL + "\t\t    while (rs_";
  protected final String TEXT_402 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_403 = "++;" + NL + "\t\t        ";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_405 = " = ";
  protected final String TEXT_406 = " + dcg_";
  protected final String TEXT_407 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_409 = " = ";
  protected final String TEXT_410 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_413 = " < ";
  protected final String TEXT_414 = "column_index_";
  protected final String TEXT_415 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = " = ";
  protected final String TEXT_418 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_425 = " = (List)rs_";
  protected final String TEXT_426 = ".getObject(";
  protected final String TEXT_427 = "column_index_";
  protected final String TEXT_428 = ");";
  protected final String TEXT_429 = NL + "\t\t                         ";
  protected final String TEXT_430 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_431 = ".getObject(";
  protected final String TEXT_432 = "column_index_";
  protected final String TEXT_433 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_434 = NL + "                                    ";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = " = new Geometry(wktValue);";
  protected final String TEXT_437 = NL + "                                        ";
  protected final String TEXT_438 = ".";
  protected final String TEXT_439 = ".setEPSG(";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_442 = NL + "                                  ";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = "=dcg_";
  protected final String TEXT_445 = ";";
  protected final String TEXT_446 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_447 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_448 = " = ";
  protected final String TEXT_449 = "; i_";
  protected final String TEXT_450 = "  <= rsmd_";
  protected final String TEXT_451 = ".getColumnCount(); i_";
  protected final String TEXT_452 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_453 = ".getColumnTypeName(i_";
  protected final String TEXT_454 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_455 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_456 = ".getClob(i_";
  protected final String TEXT_457 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_458 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_459 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_460 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_461 = ".add(tNTextImpl_";
  protected final String TEXT_462 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_463 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = ", rs_";
  protected final String TEXT_466 = ", fixedColumnCount_";
  protected final String TEXT_467 = ",list_";
  protected final String TEXT_468 = ");";
  protected final String TEXT_469 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_470 = ".";
  protected final String TEXT_471 = ", rs_";
  protected final String TEXT_472 = ", fixedColumnCount_";
  protected final String TEXT_473 = ");";
  protected final String TEXT_474 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_475 = ".";
  protected final String TEXT_476 = ", rs_";
  protected final String TEXT_477 = ", fixedColumnCount_";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_480 = ".getObject(";
  protected final String TEXT_481 = "column_index_";
  protected final String TEXT_482 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_483 = ".";
  protected final String TEXT_484 = " = new Geometry(sb.toString());";
  protected final String TEXT_485 = NL + "\t\t                          ";
  protected final String TEXT_486 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_487 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_488 = ".append(";
  protected final String TEXT_489 = ".";
  protected final String TEXT_490 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_491 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_492 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_493 = NL + "\t\t\t\t\t";
  protected final String TEXT_494 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_495 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_496 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_497 = " - Content of the record \" + nb_line_";
  protected final String TEXT_498 = " + \": \" + log4jSb_";
  protected final String TEXT_499 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_500 = ".delete(0,log4jSb_";
  protected final String TEXT_501 = ".length());" + NL + "\t\t\t\t\t";
