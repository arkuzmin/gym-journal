...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_45 = NL + "int nb_bucket_";
  protected final String TEXT_46 = " = 0;" + NL + "java.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_47 = " = conn_";
  protected final String TEXT_48 = ".listBuckets();";
  protected final String TEXT_49 = NL + "try{";
  protected final String TEXT_50 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_51 = " : buckets_";
  protected final String TEXT_52 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_53 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_54 = " = bucket_";
  protected final String TEXT_55 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_56 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
