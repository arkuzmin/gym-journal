...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_230 = NL + "                stmt_";
  protected final String TEXT_231 = ".setFetchSize(";
  protected final String TEXT_232 = ");";
  protected final String TEXT_233 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_234 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_235 = ") {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_236 = " = dataSources_";
  protected final String TEXT_237 = ".get(";
  protected final String TEXT_238 = ").getConnection();" + NL + "\t\t\t\t} else {";
  protected final String TEXT_239 = NL + "\t\t\t\t\tjava.lang.Class.forName(";
  protected final String TEXT_240 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\tString dbUser_";
  protected final String TEXT_242 = " = ";
  protected final String TEXT_243 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t";
  protected final String TEXT_245 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_246 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_247 = ");";
  protected final String TEXT_248 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_249 = " = ";
  protected final String TEXT_250 = "; ";
  protected final String TEXT_251 = NL + "\t\t\t\t\tString dbPwd_";
  ...
  protected final String TEXT_255 = ",dbUser_";
  protected final String TEXT_256 = ",dbPwd_";
  protected final String TEXT_257 = ");";
  protected final String TEXT_258 = NL + "\t\t\t\t}";
  protected final String TEXT_259 = NL + "            java.util.Date date_";
  protected final String TEXT_260 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_261 = " = rs_";
  protected final String TEXT_262 = ".getTimestamp(";
  protected final String TEXT_263 = "column_index_";
  protected final String TEXT_264 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_265 = " = rs_";
  protected final String TEXT_266 = ".getDate(";
  protected final String TEXT_267 = "column_index_";
  protected final String TEXT_268 = ");" + NL + "            }";
  protected final String TEXT_269 = NL + "            ";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = " = date_";
  protected final String TEXT_272 = ";";
  protected final String TEXT_273 = NL + "    " + NL + "\t";
  protected final String TEXT_274 = NL + "\t\t    int nb_line_";
  protected final String TEXT_275 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_276 = " = null;";
  protected final String TEXT_277 = NL + "\t\t        conn_";
  protected final String TEXT_278 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_279 = "\");";
  protected final String TEXT_280 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_281 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_282 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_283 = " = dataSources_";
  protected final String TEXT_284 = ".get(";
  protected final String TEXT_285 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_286 = "\", conn_";
  protected final String TEXT_287 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_288 = NL + "\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_290 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_291 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_292 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_293 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_294 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_295 = NL + NL + "\t\t    ";
  protected final String TEXT_296 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  ...
  protected final String TEXT_303 = "_QUERY\",dbquery_";
  protected final String TEXT_304 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_305 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_306 = " = stmt_";
  protected final String TEXT_307 = ".executeQuery(dbquery_";
  protected final String TEXT_308 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  ...
  protected final String TEXT_366 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_367 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_368 = NL + "\t\t    ";
  protected final String TEXT_369 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_370 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_371 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_372 = NL + "\t\t    while (rs_";
  protected final String TEXT_373 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_374 = "++;" + NL + "\t\t        ";
  protected final String TEXT_375 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_376 = " = ";
  protected final String TEXT_377 = " + dcg_";
  protected final String TEXT_378 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_380 = " = ";
  protected final String TEXT_381 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_396 = " = (List)rs_";
  ...
  protected final String TEXT_404 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_405 = NL + "                                    ";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_418 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_440 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = ", rs_";
  protected final String TEXT_443 = ", fixedColumnCount_";
  protected final String TEXT_444 = ");";
  protected final String TEXT_445 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_446 = ".";
  protected final String TEXT_447 = ", rs_";
  protected final String TEXT_448 = ", fixedColumnCount_";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  ...
  protected final String TEXT_458 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_467 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_468 = " - Content of the record \" + nb_line_";
  protected final String TEXT_469 = " + \": \" + log4jSb_";
  protected final String TEXT_470 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_471 = ".delete(0,log4jSb_";
  protected final String TEXT_472 = ".length());" + NL + "\t\t\t\t\t";
