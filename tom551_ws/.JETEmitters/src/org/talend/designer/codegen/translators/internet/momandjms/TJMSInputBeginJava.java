...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_28 = ");" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_29 = " = connection_";
  protected final String TEXT_30 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_31 = " = session_";
  protected final String TEXT_32 = ".create";
  protected final String TEXT_33 = "(";
  protected final String TEXT_34 = ");" + NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_35 = "\t= session_";
  protected final String TEXT_36 = ".createConsumer(dest_";
  protected final String TEXT_37 = ", ";
  protected final String TEXT_38 = ");" + NL + "" + NL + "\tconnection_";
  protected final String TEXT_39 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "" + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_40 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_41 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  protected final String TEXT_42 = " = consumer_";
  protected final String TEXT_43 = ".receive(";
  protected final String TEXT_44 = "*1000)) != null) {";
  protected final String TEXT_45 = NL + "\t\t";
  protected final String TEXT_46 = ".message=message_";
  protected final String TEXT_47 = ";\t";
  protected final String TEXT_48 = NL + "\t\t";
  protected final String TEXT_49 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_50 = ").getObject().toString());";
  protected final String TEXT_51 = NL + "\t\t";
  protected final String TEXT_52 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_53 = ").getText();";
