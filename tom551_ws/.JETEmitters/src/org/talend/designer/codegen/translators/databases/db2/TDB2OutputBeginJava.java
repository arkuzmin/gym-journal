...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_72 = " " + NL + "" + NL + "String tableName_";
  protected final String TEXT_73 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_74 = " == null || dbschema_";
  protected final String TEXT_75 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_76 = " = ";
  protected final String TEXT_77 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_78 = " = dbschema_";
  protected final String TEXT_79 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_80 = ";" + NL + "}" + NL;
  protected final String TEXT_81 = NL + "int count_";
  ...
  protected final String TEXT_87 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_93 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_109 = ".toUpperCase()";
  ...
  protected final String TEXT_133 = ".toUpperCase()";
  ...
  protected final String TEXT_140 = " - Create table '\" + tableName_";
  protected final String TEXT_141 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_142 = NL + "            stmtCreate_";
  protected final String TEXT_143 = ".close();";
  protected final String TEXT_144 = "\t         " + NL + "\t\t    " + NL + "\t\t    ";
  protected final String TEXT_145 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_146 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_153 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_156 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_157 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_158 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_159 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_160 = ")== null){";
  protected final String TEXT_161 = "              ";
  protected final String TEXT_162 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_165 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_166 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_167 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_168 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_169 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_207 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_225 = ".toUpperCase()";
  ...
  protected final String TEXT_284 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_289 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_293 = " - Creating table '\" + tableName_";
  protected final String TEXT_294 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_296 = ".execute(((\"";
  protected final String TEXT_297 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_314 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_318 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_324 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_331 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_347 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_351 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_352 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_358 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_364 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_368 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_369 = " = conn_";
  protected final String TEXT_370 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_371 = " = stmtTruncCount_";
  protected final String TEXT_372 = ".executeQuery(\"";
  protected final String TEXT_373 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_377 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_386 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_391 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_392 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_393 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_404 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_413 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_414 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_415 = NL + "             while(rsTruncCount_";
  protected final String TEXT_416 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_417 = " += rsTruncCount_";
  protected final String TEXT_418 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_419 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_420 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_438 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_441 = " + \"\\\" WHERE ";
  protected final String TEXT_442 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_443 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_444 = " + \"\\\" (";
  protected final String TEXT_445 = ") VALUES (";
  protected final String TEXT_446 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_447 = " = conn_";
  protected final String TEXT_448 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_472 = NL + "\t    String delete_";
  protected final String TEXT_473 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_510 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_511 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_512 = " =null;" + NL + "\t";
  protected final String TEXT_513 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_514 = " = null;" + NL + "\t\t";
  protected final String TEXT_515 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_516 = " = null;";
  protected final String TEXT_517 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_518 = " =  null;";
  protected final String TEXT_519 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_520 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_521 = " = null;";
  protected final String TEXT_522 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_526 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
