...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_229 = " + \":\" + ";
  protected final String TEXT_230 = " + \"/\" + ";
  protected final String TEXT_231 = ";";
  protected final String TEXT_232 = NL + "\t\t\t\tconn_";
  protected final String TEXT_233 = ".setAutoCommit(false); ";
  protected final String TEXT_234 = NL + "                stmt_";
  protected final String TEXT_235 = ".setFetchSize(";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + "\t\t\tif(rs_";
  protected final String TEXT_238 = ".get";
  protected final String TEXT_239 = "(";
  protected final String TEXT_240 = "column_index_";
  protected final String TEXT_241 = ") != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = " = new java.util.Date(rs_";
  protected final String TEXT_244 = ".get";
  protected final String TEXT_245 = "(";
  protected final String TEXT_246 = "column_index_";
  protected final String TEXT_247 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_248 = ".";
  protected final String TEXT_249 = " =  null;" + NL + "\t\t\t}\t\t\t ";
  protected final String TEXT_250 = NL + "    " + NL + "\t";
  protected final String TEXT_251 = NL + "\t\t    int nb_line_";
  protected final String TEXT_252 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_253 = " = null;";
  protected final String TEXT_254 = NL + "\t\t        conn_";
  protected final String TEXT_255 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_256 = "\");";
  protected final String TEXT_257 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_258 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_259 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_260 = " = dataSources_";
  protected final String TEXT_261 = ".get(";
  protected final String TEXT_262 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_263 = "\", conn_";
  protected final String TEXT_264 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_265 = NL + "\t\t\t\t";
  protected final String TEXT_266 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_267 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_268 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_269 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_270 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_271 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_272 = NL + NL + "\t\t    ";
  protected final String TEXT_273 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_274 = " = ";
  protected final String TEXT_275 = ";";
  protected final String TEXT_276 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_277 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_278 = " + \"'.\");";
  protected final String TEXT_279 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_280 = "_QUERY\",dbquery_";
  protected final String TEXT_281 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_282 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_283 = " = stmt_";
  protected final String TEXT_284 = ".executeQuery(dbquery_";
  protected final String TEXT_285 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_286 = " = rs_";
  protected final String TEXT_287 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_288 = " = rsmd_";
  protected final String TEXT_289 = ".getColumnCount();" + NL;
  protected final String TEXT_290 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_291 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_292 = ".setDbmsId(\"";
  protected final String TEXT_293 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_294 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_295 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_296 = ".add(\"";
  protected final String TEXT_297 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_298 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_299 = " = ";
  protected final String TEXT_300 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_301 = "; i <= rsmd_";
  protected final String TEXT_302 = ".getColumnCount()-";
  protected final String TEXT_303 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_304 = ".contains(rsmd_";
  protected final String TEXT_305 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_306 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setName(rsmd_";
  protected final String TEXT_308 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setDbName(rsmd_";
  protected final String TEXT_310 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_311 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_312 = "\", rsmd_";
  protected final String TEXT_313 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_314 = ".getPrecision(i), rsmd_";
  protected final String TEXT_315 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setDbType(rsmd_";
  protected final String TEXT_317 = ".getColumnTypeName(i));";
  protected final String TEXT_318 = NL + "                \tdcm_";
  protected final String TEXT_319 = ".setFormat(";
  protected final String TEXT_320 = ");";
  protected final String TEXT_321 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_322 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_323 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_324 = ".setLength(rsmd_";
  protected final String TEXT_325 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_326 = ".setLength(rsmd_";
  protected final String TEXT_327 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_328 = NL + "\t\t\tdcm_";
  protected final String TEXT_329 = ".setLength(rsmd_";
  protected final String TEXT_330 = ".getPrecision(i));";
  protected final String TEXT_331 = NL + "                \tdcm_";
  protected final String TEXT_332 = ".setPrecision(rsmd_";
  protected final String TEXT_333 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setNullable(rsmd_";
  protected final String TEXT_335 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_337 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_338 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_339 = ".metadatas.add(dcm_";
  protected final String TEXT_340 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_341 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_342 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_343 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_344 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_345 = NL + "\t\t    ";
  protected final String TEXT_346 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_347 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_348 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_349 = NL + "\t\t    while (rs_";
  protected final String TEXT_350 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_351 = "++;" + NL + "\t\t        ";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_353 = " = ";
  protected final String TEXT_354 = " + dcg_";
  protected final String TEXT_355 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_374 = ".getObject(";
  ...
  protected final String TEXT_379 = ".getObject(";
  protected final String TEXT_380 = "column_index_";
  protected final String TEXT_381 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_382 = NL + "                                    ";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_395 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_427 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_428 = ".getObject(";
  protected final String TEXT_429 = "column_index_";
  protected final String TEXT_430 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = " = new Geometry(sb.toString());";
  protected final String TEXT_433 = NL + "\t\t                          ";
  protected final String TEXT_434 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  ...
  protected final String TEXT_442 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_443 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_444 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_445 = " - Content of the record \" + nb_line_";
  protected final String TEXT_446 = " + \": \" + log4jSb_";
  protected final String TEXT_447 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_448 = ".delete(0,log4jSb_";
  protected final String TEXT_449 = ".length());" + NL + "\t\t\t\t\t";
