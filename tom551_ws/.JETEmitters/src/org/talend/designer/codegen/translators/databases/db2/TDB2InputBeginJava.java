...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_229 = " + \":\" + ";
  protected final String TEXT_230 = " + \"/\" + ";
  protected final String TEXT_231 = ";";
  protected final String TEXT_232 = NL + "\t\t\tString url_";
  protected final String TEXT_233 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_254 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_255 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_256 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_257 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_258 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_259 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_260 = NL + NL + "\t\t    ";
  protected final String TEXT_261 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_262 = " = ";
  protected final String TEXT_263 = ";";
  protected final String TEXT_264 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_265 = " - Executing the query: '\" + dbquery_";
  ...
  protected final String TEXT_293 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_305 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_334 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_335 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_366 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_367 = ".getObject(";
  protected final String TEXT_368 = "column_index_";
  protected final String TEXT_369 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_370 = NL + "                                    ";
  protected final String TEXT_371 = ".";
  protected final String TEXT_372 = " = new Geometry(wktValue);";
  protected final String TEXT_373 = NL + "                                        ";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = ".setEPSG(";
  ...
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_383 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_384 = " = ";
  protected final String TEXT_385 = "; i_";
  protected final String TEXT_386 = "  <= rsmd_";
  protected final String TEXT_387 = ".getColumnCount(); i_";
  protected final String TEXT_388 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_389 = ".getColumnTypeName(i_";
  protected final String TEXT_390 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_391 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_392 = ".getClob(i_";
  protected final String TEXT_393 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_394 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_395 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_396 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_397 = ".add(tNTextImpl_";
  protected final String TEXT_398 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_399 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ", rs_";
  protected final String TEXT_402 = ", fixedColumnCount_";
  protected final String TEXT_403 = ",list_";
  ...
  protected final String TEXT_415 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  ...
  protected final String TEXT_423 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_424 = ".append(";
  protected final String TEXT_425 = ".";
  protected final String TEXT_426 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_428 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_431 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_432 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_433 = " - Content of the record \" + nb_line_";
  protected final String TEXT_434 = " + \": \" + log4jSb_";
  protected final String TEXT_435 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_436 = ".delete(0,log4jSb_";
  protected final String TEXT_437 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t\t                            ";
  protected final String TEXT_439 = ".";
  protected final String TEXT_440 = " = ";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = ";" + NL + "\t\t                            ";
  protected final String TEXT_443 = NL + NL + NL;
