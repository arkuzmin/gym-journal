...
public class TFileInputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_54 = "){" + NL + "\t\t\tthrow new java.lang.Exception(\"Data error in file: The cardinality for \" + ";
  ...
  protected final String TEXT_73 = "){" + NL + "\t\t\tthrow new java.lang.Exception(\"Data error in file: The cardinality for \" + ";
  ...
  protected final String TEXT_140 = NL + "\t} catch (java.lang.Exception e) {";
  ...
  protected final String TEXT_309 = ")){" + NL + "\t\t\tthrow new java.lang.Exception(\"Data error in file: The cardinality for \" + ";
  ...
  protected final String TEXT_326 = ")){" + NL + "\t\t\tthrow new java.lang.Exception(\"Data error in file: The cardinality for \" + ";
  ...
  protected final String TEXT_398 = NL + "\t} catch (java.lang.Exception e) {";
