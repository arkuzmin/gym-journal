...
public class TFTPGetEndJava
{
  ...
  protected final String TEXT_56 = ".chdir(rootDir_";
  protected final String TEXT_57 = ");";
  protected final String TEXT_58 = NL + "\t";
  protected final String TEXT_59 = NL + "\t\tlog.info(\"";
  protected final String TEXT_60 = " - Connection to the server closed.\");" + NL + "\t";
  protected final String TEXT_61 = NL + "    ftp_";
  protected final String TEXT_62 = ".disconnect(true);" + NL + "\t";
  protected final String TEXT_63 = NL + "\t\tlog.info(\"";
  protected final String TEXT_64 = " - Connection to the server closed.\");" + NL + "\t";
  protected final String TEXT_65 = NL + "globalMap.put(\"";
  protected final String TEXT_66 = "_NB_FILE\",nb_file_";
  protected final String TEXT_67 = ");";
  protected final String TEXT_68 = NL + "\tlog.info(\"";
  protected final String TEXT_69 = " - Downloaded files count: \" + nb_file_";
  protected final String TEXT_70 = "  + \".\");" + NL + "\tlog.info(\"";
  protected final String TEXT_71 = " - Done.\");";
