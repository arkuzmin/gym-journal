...
public class TAlfrescoOutputBeginJava
{
  ...
  protected final String TEXT_36 = ".setTimeout(5000);" + NL + "\t      // default server : localhost";
  ...
  protected final String TEXT_43 = NL + "\t\t\t      " + NL + "          alfrescoRestClient_";
  protected final String TEXT_44 = ".login(";
  protected final String TEXT_45 = ", decryptedPassword_";
  protected final String TEXT_46 = ");" + NL + "      } catch (fr.openwide.talendalfresco.rest.client.RestClientException e) {" + NL + "         throw new fr.openwide.talendalfresco.rest.client.RestClientException(\"Error initing client\", e);" + NL + "      }" + NL + "      " + NL + "      int nbLine_";
  protected final String TEXT_47 = " = 0;" + NL + "        " + NL + "            ";
