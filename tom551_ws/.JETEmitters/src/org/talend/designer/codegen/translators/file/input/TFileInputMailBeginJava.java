...
public class TFileInputMailBeginJava
{
  ...
  protected final String TEXT_172 = "                " + NL + "\t                if (mpart";
  protected final String TEXT_173 = ".getFileName()!=null" + NL + "\t                    && ((disposition";
  protected final String TEXT_174 = " != null && (disposition";
  protected final String TEXT_175 = ".equals(javax.mail.Part.ATTACHMENT) || disposition";
  protected final String TEXT_176 = ".equals(javax.mail.Part.INLINE)))" + NL + "\t\t\t\t\t\t||  disposition";
  protected final String TEXT_177 = "==null)) {\t";
  protected final String TEXT_178 = NL + "                    attachfileName";
  protected final String TEXT_179 = " = mpart";
  protected final String TEXT_180 = ".getFileName();" + NL + "                    " + NL + "                    if (attachfileName";
  protected final String TEXT_181 = ".indexOf(\"=?\") != -1){" + NL + "                      int m_";
  protected final String TEXT_182 = " = 2, n_";
  protected final String TEXT_183 = ";" + NL + "                      n_";
  protected final String TEXT_184 = " = attachfileName";
  protected final String TEXT_185 = ".indexOf(63, m_";
  protected final String TEXT_186 = "); // the first ? location " + NL + "                      String sCharSet_";
  protected final String TEXT_187 = " = attachfileName";
  protected final String TEXT_188 = ".substring(attachfileName";
  protected final String TEXT_189 = ".indexOf(\"=?\") + 2, n_";
  protected final String TEXT_190 = "); // the character set value         " + NL + "                      m_";
  protected final String TEXT_191 = " = n_";
  protected final String TEXT_192 = " + 1;                      " + NL + "                      n_";
  protected final String TEXT_193 = " = attachfileName";
  protected final String TEXT_194 = ".indexOf(63, m_";
  protected final String TEXT_195 = "); // the second ? location                      " + NL + "                      String flag_";
  protected final String TEXT_196 = " = attachfileName";
  protected final String TEXT_197 = ".substring(m_";
  protected final String TEXT_198 = ", n_";
  protected final String TEXT_199 = ");" + NL + "                      m_";
  protected final String TEXT_200 = " = n_";
  protected final String TEXT_201 = " + 1;" + NL + "                      n_";
  protected final String TEXT_202 = " = attachfileName";
  protected final String TEXT_203 = ".indexOf(\"?=\", m_";
  protected final String TEXT_204 = ");                      " + NL + "                      String sNameCode_";
  protected final String TEXT_205 = " = attachfileName";
  protected final String TEXT_206 = ".substring(m_";
  protected final String TEXT_207 = ", n_";
  protected final String TEXT_208 = ");                  " + NL + "                      java.io.ByteArrayInputStream byteArrIS_";
  protected final String TEXT_209 = " = new java.io.ByteArrayInputStream(sNameCode_";
  protected final String TEXT_210 = ".getBytes());                      " + NL + "                      Object obj_";
  protected final String TEXT_211 = " = null;" + NL + "                      " + NL + "                      if (flag_";
  protected final String TEXT_212 = ".equalsIgnoreCase(\"B\")) {" + NL + "                        obj_";
  protected final String TEXT_213 = " = new com.sun.mail.util.BASE64DecoderStream(byteArrIS_";
  protected final String TEXT_214 = ");                    " + NL + "                      } else if (flag_";
  protected final String TEXT_215 = ".equalsIgnoreCase(\"Q\")) {" + NL + "                        obj_";
  protected final String TEXT_216 = " = new com.sun.mail.util.QDecoderStream(byteArrIS_";
  protected final String TEXT_217 = ");" + NL + "                      }" + NL + "                      " + NL + "                      if (obj_";
  protected final String TEXT_218 = " != null){" + NL + "                        int k_";
  protected final String TEXT_219 = " = byteArrIS_";
  protected final String TEXT_220 = ".available();" + NL + "                        byte[] arrByte_";
  protected final String TEXT_221 = " = new byte[k_";
  protected final String TEXT_222 = "];" + NL + "                        k_";
  protected final String TEXT_223 = " = ((java.io.InputStream) (obj_";
  protected final String TEXT_224 = ")).read(arrByte_";
  protected final String TEXT_225 = ", 0, k_";
  protected final String TEXT_226 = ");" + NL + "                        attachfileName";
  protected final String TEXT_227 = " = new String(arrByte_";
  protected final String TEXT_228 = ", 0, k_";
  protected final String TEXT_229 = ", sCharSet_";
  protected final String TEXT_230 = ");" + NL + "                      }" + NL + "                    }" + NL + "                    " + NL + "                     if(!(";
  protected final String TEXT_231 = ").endsWith(\"/\")){" + NL + "           \t\t\t\t path";
  protected final String TEXT_232 = " = ";
  protected final String TEXT_233 = " + \"/\";" + NL + "        \t\t\t\t}else" + NL + "        \t\t\t\t{" + NL + "        \t\t\t\t\tpath";
  protected final String TEXT_234 = " =";
  protected final String TEXT_235 = ";" + NL + "        \t\t\t\t}" + NL + "                    path";
  protected final String TEXT_236 = " = path";
  protected final String TEXT_237 = " + attachfileName";
  protected final String TEXT_238 = ";" + NL + "                    java.io.File attachFile  = new java.io.File(path";
  protected final String TEXT_239 = ");" + NL + "                    out";
  protected final String TEXT_240 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(attachFile));" + NL + "                    in";
  protected final String TEXT_241 = " = new java.io.BufferedInputStream(mpart";
  protected final String TEXT_242 = ".getInputStream());" + NL + "                    int buffer";
  protected final String TEXT_243 = " = 0;" + NL + "                    while ((buffer";
  protected final String TEXT_244 = " = in";
  protected final String TEXT_245 = ".read()) != -1) {" + NL + "                           out";
  protected final String TEXT_246 = ".write(buffer";
  protected final String TEXT_247 = ");" + NL + "                           out";
  protected final String TEXT_248 = ".flush();" + NL + "                         }   " + NL + "                        out";
  protected final String TEXT_249 = ".close();" + NL + "                        in";
  protected final String TEXT_250 = ".close();    " + NL + "                }" + NL + "            }" + NL + " \t}" + NL + " \t         " + NL + " \t          " + NL + "// for output";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tif(";
  protected final String TEXT_252 = " < list_";
  protected final String TEXT_253 = ".size() && list_";
  protected final String TEXT_254 = ".get(";
  protected final String TEXT_255 = ")!=null){\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\t\t";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = " = (String)list_";
  protected final String TEXT_259 = ".get(";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "\t\t\t\t\t";
  protected final String TEXT_262 = ".";
  protected final String TEXT_263 = " = ParserUtils.parseTo_Date(list_";
  protected final String TEXT_264 = ".get(";
  protected final String TEXT_265 = "), ";
  protected final String TEXT_266 = ");";
  protected final String TEXT_267 = NL + "\t\t\t\t\t";
  protected final String TEXT_268 = ".";
  protected final String TEXT_269 = " = list_";
  protected final String TEXT_270 = ".get(";
  protected final String TEXT_271 = ").getBytes();";
  ...
  protected final String TEXT_278 = NL + "\t\t\t" + NL + "\t\t\t} else { " + NL + "\t\t\t" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_288 = NL + "catch (java.lang.Exception e){" + NL + "//nothing to do, ignore the exception if don't die on error" + NL + "System.err.println(\"Exception in component ";
  protected final String TEXT_289 = ": \" + e.getMessage());" + NL + "}";
  protected final String TEXT_290 = NL + NL + "finally{" + NL + "\tif(fileInput";
