...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_227 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_230 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_231 = " == null || dbProperties_";
  protected final String TEXT_232 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_233 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_234 = " + \"/DATABASE=\" + ";
  protected final String TEXT_235 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_236 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_237 = " + \"/DATABASE=\" + ";
  protected final String TEXT_238 = " + \",\" + ";
  protected final String TEXT_239 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_240 = NL + "                stmt_";
  protected final String TEXT_241 = ".setFetchSize(200000);";
  protected final String TEXT_242 = NL + "    " + NL + "\t";
  protected final String TEXT_243 = NL + "\t\t    int nb_line_";
  protected final String TEXT_244 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_245 = " = null;";
  protected final String TEXT_246 = NL + "\t\t        conn_";
  protected final String TEXT_247 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_248 = "\");";
  protected final String TEXT_249 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_250 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_251 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_252 = " = dataSources_";
  protected final String TEXT_253 = ".get(";
  protected final String TEXT_254 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_255 = "\", conn_";
  protected final String TEXT_256 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_257 = NL + "\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_259 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_260 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_262 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_263 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_264 = NL + NL + "\t\t    ";
  protected final String TEXT_265 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ";";
  protected final String TEXT_268 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_269 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_270 = " + \"'.\");";
  protected final String TEXT_271 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_272 = "_QUERY\",dbquery_";
  protected final String TEXT_273 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_297 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_309 = ".getColumnTypeName(i));";
  protected final String TEXT_310 = NL + "                \tdcm_";
  protected final String TEXT_311 = ".setFormat(";
  protected final String TEXT_312 = ");";
  protected final String TEXT_313 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_314 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_315 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_316 = ".setLength(rsmd_";
  protected final String TEXT_317 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_318 = ".setLength(rsmd_";
  protected final String TEXT_319 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_320 = NL + "\t\t\tdcm_";
  protected final String TEXT_321 = ".setLength(rsmd_";
  protected final String TEXT_322 = ".getPrecision(i));";
  protected final String TEXT_323 = NL + "                \tdcm_";
  protected final String TEXT_324 = ".setPrecision(rsmd_";
  protected final String TEXT_325 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_326 = ".setNullable(rsmd_";
  protected final String TEXT_327 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_329 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_330 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_331 = ".metadatas.add(dcm_";
  protected final String TEXT_332 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_333 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_334 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_335 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_336 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_337 = NL + "\t\t    ";
  protected final String TEXT_338 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_339 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_370 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_371 = ".getObject(";
