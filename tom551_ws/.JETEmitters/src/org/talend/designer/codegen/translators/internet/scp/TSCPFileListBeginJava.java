...
public class TSCPFileListBeginJava
{
  ...
  protected final String TEXT_61 = "     " + NL + "" + NL + "\t\t//initial the command" + NL + "\t\tStringBuilder command_";
  protected final String TEXT_62 = " = new StringBuilder();";
  protected final String TEXT_63 = NL + "         \tif(command_";
  protected final String TEXT_64 = ".length() > 0){" + NL + "         \t\tcommand_";
  protected final String TEXT_65 = ".append(";
  protected final String TEXT_66 = ");" + NL + "         \t} " + NL + "            command_";
  protected final String TEXT_67 = ".append(";
  protected final String TEXT_68 = ");" + NL + "            ";
  protected final String TEXT_69 = NL + "       " + NL + "\t\t/* Create a session */" + NL + "\t\tch.ethz.ssh2.Session sess_";
  protected final String TEXT_70 = " = conn_";
  protected final String TEXT_71 = ".openSession();" + NL + "\t\t" + NL + "\t\t//execute the command" + NL + "\t\tsess_";
  protected final String TEXT_72 = ".execCommand((command_";
  protected final String TEXT_73 = ").toString());" + NL + "\t\t" + NL + "\t\tint nb_line_";
  protected final String TEXT_74 = " = 0;" + NL + "\t\t" + NL + "\t\t//get the return info" + NL + "\t\tjava.io.InputStream stdout_";
  protected final String TEXT_75 = " = sess_";
  protected final String TEXT_76 = ".getStdout();" + NL + "\t\tjava.io.BufferedReader brout_";
  protected final String TEXT_77 = "= new java.io.BufferedReader(new java.io.InputStreamReader(stdout_";
  protected final String TEXT_78 = "));" + NL + "        String line_out_";
  protected final String TEXT_79 = " = \"\";" + NL + "        StringBuilder stringStdout_";
  protected final String TEXT_80 = " =new StringBuilder();" + NL + "\t\twhile((line_out_";
  protected final String TEXT_81 = " = brout_";
  protected final String TEXT_82 = ".readLine()) != null) {";
