...
public class Camel_footerJava
{
  ...
  protected final String TEXT_63 = NL + "      \t\t\t\tconnectionFactoryAdapter";
  protected final String TEXT_64 = ".setPassword(decryptedPassword_";
  protected final String TEXT_65 = ");" + NL + "       \t\t\t\tconnectionFactoryAdapter";
  protected final String TEXT_66 = ".setTargetConnectionFactory(jmsConnectionFactory);" + NL + "       " + NL + "\t\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_67 = "," + NL + "\t\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_68 = "(connectionFactoryAdapter";
  protected final String TEXT_69 = "));";
  protected final String TEXT_70 = NL + "\t\t\t\t\t}";
  protected final String TEXT_71 = NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t  javax.jms.ConnectionFactory jmsConnectionFactory;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_73 = "," + NL + "\t\t\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_74 = "(jmsConnectionFactory));" + NL + "\t\t\t\t\t}";
  protected final String TEXT_75 = NL + "\t\t\t//using Route name as CamelContext ID" + NL + "\t\t\tanswer.put(camelContext.getName(), camelContext);" + NL + "\t\t\treturn answer;" + NL + "\t\t}";
