...
public class TAmazonMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_54 = NL + "\t\tString password_";
  ...
  protected final String TEXT_60 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_61 = ")) {";
  protected final String TEXT_62 = NL + "\t\t";
  protected final String TEXT_63 = NL + "\t\t";
  protected final String TEXT_64 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_65 = "\", conn_";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + "\t}";
  protected final String TEXT_68 = NL + "\tif (null != conn_";
  protected final String TEXT_69 = ") {" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t}";
  protected final String TEXT_71 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_72 = "\",conn_";
  protected final String TEXT_73 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
