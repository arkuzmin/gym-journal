...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_38 = NL + "\tstub_";
  protected final String TEXT_39 = ".setPassword(decryptedPassword_";
  protected final String TEXT_40 = ");";
  protected final String TEXT_41 = NL + "\torg.talend.mdm.webservice.XtentisPort xtentisWS_";
  protected final String TEXT_42 = " = (org.talend.mdm.webservice.XtentisPort)globalMap.get(\"";
  protected final String TEXT_43 = "\");";
  protected final String TEXT_44 = NL + NL + "org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_45 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_46 = " + \"";
  protected final String TEXT_47 = "\");" + NL + "org.talend.mdm.webservice.WSDataModelPK dataModel_";
  protected final String TEXT_48 = " = new org.talend.mdm.webservice.WSDataModelPK(";
  protected final String TEXT_49 = ");" + NL + "" + NL + "String input_";
  protected final String TEXT_50 = ";" + NL + "" + NL + "org.talend.mdm.webservice.WSItemPK[] wspks_";
  protected final String TEXT_51 = ";" + NL + "org.talend.mdm.webservice.WSItemPK wspk_";
  protected final String TEXT_52 = ";" + NL;
  protected final String TEXT_53 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_54 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();" + NL + "\t";
  protected final String TEXT_55 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_56 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<java.util.Map<String,String>>());" + NL + "\t\tint flowNum_";
  protected final String TEXT_57 = " = 0;" + NL + "\t";
  protected final String TEXT_58 = NL + "\tclass ThreadXMLField_";
  protected final String TEXT_59 = " extends Thread {" + NL + "\t\tjava.util.Queue<String> queue;" + NL + "\t\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t\tjava.lang.Exception lastException;" + NL + "\t\tString currentComponent;" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_60 = "(java.util.Queue q) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_61 = "\", queue);" + NL + "\t\t\tlastException = null;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_62 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tthis.flows = l;" + NL + "\t\t\tlastException = null;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_63 = "\", queue);" + NL + "\t\t\tglobalMap.put(\"flows_";
  protected final String TEXT_64 = "\", flows);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic java.lang.Exception getLastException() {" + NL + "\t\t\treturn this.lastException;" + NL + "\t\t}" + NL + "\t\tpublic String getCurrentComponent() {" + NL + "\t\t\treturn this.currentComponent;" + NL + "\t\t}" + NL + "\t" + NL + "\t\t@Override" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_65 = "Process(globalMap);" + NL + "\t\t\t} catch (TalendException te) {" + NL + "\t\t\t\tthis.lastException = te.getException();" + NL + "\t\t\t\tthis.currentComponent = te.getCurrentComponent();" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_66 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  ...
  protected final String TEXT_71 = ", xmlFlowList_";
  protected final String TEXT_72 = ");" + NL + "\t";
  protected final String TEXT_73 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_74 = " txf_";
  protected final String TEXT_75 = " = new ThreadXMLField_";
  protected final String TEXT_76 = "(queue_";
  protected final String TEXT_77 = ");" + NL + "\t";
  protected final String TEXT_78 = NL + "\ttxf_";
  protected final String TEXT_79 = ".start();";
  protected final String TEXT_80 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_81 = " = (java.util.List<java.util.Map<String,String>>)globalMap.get(\"flows_";
  protected final String TEXT_82 = "\");" + NL + "\t\tint flowNum_";
  protected final String TEXT_83 = " = 0;" + NL + "\t";
  protected final String TEXT_84 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_85 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_86 = "\"); ";
  protected final String TEXT_87 = NL + "\tString readFinishMarkWithPipeId_";
  protected final String TEXT_88 = " = \"";
  protected final String TEXT_89 = "_FINISH\"+(queue_";
  protected final String TEXT_90 = "==null?\"\":queue_";
  protected final String TEXT_91 = ".hashCode());" + NL + "\twhile(!globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_92 = ") || !queue_";
  protected final String TEXT_93 = ".isEmpty()) { " + NL + "\t\tif (!queue_";
  protected final String TEXT_94 = ".isEmpty()) {";
