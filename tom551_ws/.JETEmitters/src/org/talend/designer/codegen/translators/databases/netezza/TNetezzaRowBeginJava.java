...
public class TNetezzaRowBeginJava
{
  ...
  protected final String TEXT_31 = NL + NL + "    String dbPwd_";
  protected final String TEXT_32 = " = decryptedPassword_";
  protected final String TEXT_33 = ";" + NL + "    " + NL + "\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_56 = " = false;" + NL + "int nb_";
  protected final String TEXT_57 = " = 0;" + NL + "globalMap.put(\"";
  protected final String TEXT_58 = "_NB_EFFECTED\",nb_";
