...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_74 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_98 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_99 = ".equals(";
  ...
  protected final String TEXT_113 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_121 = " = stmtClearCount_";
  protected final String TEXT_122 = ".executeQuery(\"";
  protected final String TEXT_123 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_126 = ".executeUpdate(\"";
  protected final String TEXT_127 = "\");" + NL + "            while(rsClearCount_";
  protected final String TEXT_128 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_129 = " += rsClearCount_";
  protected final String TEXT_130 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_131 = "\t\t" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_134 = " + \"\\\" (";
  protected final String TEXT_135 = ") VALUES (";
  protected final String TEXT_136 = ")\");";
  protected final String TEXT_137 = NL + "\t\t\tint rowCount";
  protected final String TEXT_138 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_139 = " {";
  protected final String TEXT_140 = NL + "                            ";
  protected final String TEXT_141 = " ";
  protected final String TEXT_142 = ";                ";
  protected final String TEXT_143 = "   " + NL + "\t            " + NL + "\t            public BufferLine_";
  ...
  protected final String TEXT_152 = "   \t                " + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t            " + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_153 = "> exInsertColValueList";
  protected final String TEXT_154 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_155 = " exInsertColValue";
  protected final String TEXT_156 = " = null; " + NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_157 = " = new StringBuilder();" + NL + "\t\t\tfor(int i=0;i < ";
  protected final String TEXT_158 = ";i++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_159 = ".append(\"(";
  protected final String TEXT_160 = ")\");" + NL + "\t\t\t\t if (i!=";
  protected final String TEXT_161 = "-1) extendInsertValueStmt_";
  protected final String TEXT_162 = ".append(\",\");" + NL + "\t\t\t}" + NL + "            " + NL + "\t\t\tString insert_";
  protected final String TEXT_163 = " = \"INSERT INTO \"+";
  protected final String TEXT_164 = "+\" (";
  protected final String TEXT_165 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_166 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_172 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_178 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_179 = " + \"\\\" WHERE ";
  protected final String TEXT_180 = "\");\t" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_187 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_188 = " + \"\\\" SET ";
  protected final String TEXT_189 = " WHERE ";
  protected final String TEXT_190 = "\");\t" + NL + "\t    ";
  protected final String TEXT_191 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_198 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_199 = " + \"\\\" (";
  protected final String TEXT_200 = ") VALUES (";
  protected final String TEXT_201 = ")\");\t\t" + NL + "\t    ";
  protected final String TEXT_202 = "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_205 = " + \"\\\" WHERE ";
  protected final String TEXT_206 = "\");" + NL + "\t    ";
  protected final String TEXT_207 = "    " + NL + "            int commitEvery_";
