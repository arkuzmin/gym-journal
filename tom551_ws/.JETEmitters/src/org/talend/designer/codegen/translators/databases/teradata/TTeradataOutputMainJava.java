...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_548 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_549 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_550 = " = true;";
  protected final String TEXT_551 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_552 = " - \" + e_";
  protected final String TEXT_553 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_554 = NL + "                    throw(e_";
  protected final String TEXT_555 = ");";
  protected final String TEXT_556 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_557 = " - \" + e_";
  protected final String TEXT_558 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_571 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_572 = ").getSQLState();";
  protected final String TEXT_573 = NL + "                        ";
  protected final String TEXT_574 = ".errorMessage = e_";
  protected final String TEXT_575 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_576 = ";";
  protected final String TEXT_577 = NL + "                        System.err.print(e_";
  protected final String TEXT_578 = ".getMessage());";
  protected final String TEXT_579 = NL + "            }" + NL + "            ///////////////////////////    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_589 = ",updateSQLSplits_";
  protected final String TEXT_590 = ");";
  protected final String TEXT_591 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_626 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_630 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_631 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_632 = " = true;";
  protected final String TEXT_633 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_634 = " - \" + e_";
  protected final String TEXT_635 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_636 = NL + "                    throw(e_";
  protected final String TEXT_637 = ");";
  protected final String TEXT_638 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_639 = " - \" + e_";
  protected final String TEXT_640 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_641 = NL + "                        ";
  protected final String TEXT_642 = " = new ";
  protected final String TEXT_643 = "Struct();";
  protected final String TEXT_644 = NL + "                            ";
  protected final String TEXT_645 = ".";
  protected final String TEXT_646 = " = ";
  protected final String TEXT_647 = ".";
  protected final String TEXT_648 = ";";
  protected final String TEXT_649 = NL + "                        rejectedCount_";
  protected final String TEXT_650 = " = rejectedCount_";
  protected final String TEXT_651 = " + 1;";
  protected final String TEXT_652 = NL + "                        ";
  protected final String TEXT_653 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_654 = ").getSQLState();";
  protected final String TEXT_655 = NL + "                        ";
  protected final String TEXT_656 = ".errorMessage = e_";
  protected final String TEXT_657 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_658 = ";";
  protected final String TEXT_659 = NL + "                        System.err.print(e_";
  protected final String TEXT_660 = ".getMessage());";
  protected final String TEXT_661 = NL + "            }" + NL + "            /////////////////////////////////////    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_666 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_667 = " = pstmt_";
  protected final String TEXT_668 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_669 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_670 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_671 = " = rs_";
  protected final String TEXT_672 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_673 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_674 = NL + "                        ";
  protected final String TEXT_675 = NL + "                            query_";
  protected final String TEXT_676 = " = ";
  protected final String TEXT_677 = ";";
  protected final String TEXT_678 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_679 = ",";
  protected final String TEXT_680 = ".";
  protected final String TEXT_681 = ", ";
  protected final String TEXT_682 = ",updateSQLSplits_";
  ...
  protected final String TEXT_711 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_712 = " = updatedCount_";
  protected final String TEXT_713 = " + pstmtUpdate_";
  protected final String TEXT_714 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  protected final String TEXT_715 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_716 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_717 = NL + "    \t                ";
  protected final String TEXT_718 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_719 = " - \" + e_";
  protected final String TEXT_720 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_721 = NL + "    \t                throw(e_";
  protected final String TEXT_722 = ");" + NL + "    \t                ";
  protected final String TEXT_723 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_724 = " - \" + e_";
  protected final String TEXT_725 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_736 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_737 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_738 = ").getSQLState();" + NL + "    \t                    ";
  ...
  protected final String TEXT_743 = ".getMessage());" + NL + "    \t                    ";
  ...
  protected final String TEXT_749 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_750 = ",";
  protected final String TEXT_751 = ".";
  protected final String TEXT_752 = ", ";
  protected final String TEXT_753 = ",insertSQLSplits_";
  protected final String TEXT_754 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_755 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_756 = ".";
  protected final String TEXT_757 = ", pstmtInsert_";
  ...
  protected final String TEXT_764 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_765 = " = insertedCount_";
  protected final String TEXT_766 = " + pstmtInsert_";
  protected final String TEXT_767 = ".executeUpdate();" + NL + "    \t\t\t} catch(java.lang.Exception e_";
  ...
  protected final String TEXT_771 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_772 = " - \" + e_";
  protected final String TEXT_773 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_774 = NL + "    \t                throw(e_";
  protected final String TEXT_775 = ");" + NL + "    \t                ";
  protected final String TEXT_776 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_777 = " - \" + e_";
  ...
  protected final String TEXT_791 = ").getSQLState();" + NL + "    \t                    ";
  protected final String TEXT_792 = ".errorMessage = e_";
  protected final String TEXT_793 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_794 = ";" + NL + "    \t                    ";
  protected final String TEXT_795 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_796 = ".getMessage());" + NL + "    \t                    ";
  ...
  protected final String TEXT_838 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_839 = "=pstmtUpdate_";
  protected final String TEXT_840 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_841 = " = updatedCount_";
  protected final String TEXT_842 = " + updateFlag_";
  protected final String TEXT_843 = ";" + NL + "        \tif(updateFlag_";
  protected final String TEXT_844 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_845 = NL + "\t\t\t\tquery_";
  protected final String TEXT_846 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_855 = ",insertSQLSplits_";
  ...
  protected final String TEXT_869 = ".executeUpdate();" + NL + "             }" + NL + "        \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_870 = ") {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_871 = " = true;" + NL + "        \t\t    ";
  protected final String TEXT_872 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_873 = " - \" + e_";
  protected final String TEXT_874 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_875 = NL + "                        throw(e_";
  protected final String TEXT_876 = ");";
  protected final String TEXT_877 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_878 = " - \" + e_";
  protected final String TEXT_879 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_892 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_893 = ").getSQLState();";
  protected final String TEXT_894 = NL + "                            ";
  protected final String TEXT_895 = ".errorMessage = e_";
  protected final String TEXT_896 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_897 = ";";
  protected final String TEXT_898 = NL + "                            System.err.print(e_";
  protected final String TEXT_899 = ".getMessage());";
  protected final String TEXT_900 = NL + "        \t\t}" + NL + "        \tnb_line_";
  ...
  protected final String TEXT_916 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_917 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_918 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_919 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_920 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_921 = " = deletedCount_";
  protected final String TEXT_922 = " + pstmt_";
  protected final String TEXT_923 = ".executeUpdate();" + NL + "    \t\t} catch(java.lang.Exception e_";
  protected final String TEXT_924 = ") {" + NL + "    \t\t    whetherReject_";
  protected final String TEXT_925 = " = true;" + NL + "    \t\t    ";
  protected final String TEXT_926 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_927 = " - \" + e_";
  protected final String TEXT_928 = ".getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_929 = NL + "                    throw(e_";
  protected final String TEXT_930 = ");";
  protected final String TEXT_931 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_932 = " - \" + e_";
  protected final String TEXT_933 = ".getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_954 = NL + "    \t\t}" + NL + "    \t\t//////////////////////////////////////    \t\t" + NL + "    \t\t";
  protected final String TEXT_955 = NL + "    \t\tnb_line_";
  protected final String TEXT_956 = "++;" + NL + "" + NL + "    \t";
  protected final String TEXT_957 = NL + "                log4jSb_";
  protected final String TEXT_958 = ".append(";
  protected final String TEXT_959 = ".";
  protected final String TEXT_960 = ");";
  protected final String TEXT_961 = NL + "                \tlog4jSb_";
  protected final String TEXT_962 = ".append(\"|\");";
  protected final String TEXT_963 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_964 = " - Writing the record \" + nb_line_";
  protected final String TEXT_965 = " + \" \" + log4jSb_";
  protected final String TEXT_966 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_967 = ".delete(0,log4jSb_";
  protected final String TEXT_968 = ".length());" + NL + "\t\t";
  protected final String TEXT_969 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_980 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_981 = " <= batchSizeCounter_";
  protected final String TEXT_982 = ") {                ";
  protected final String TEXT_983 = "                                                " + NL + "                try {" + NL + "                \t\tbatchSizeCounter_";
  protected final String TEXT_984 = " = 0; " + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_1000 = "                         \t    \t" + NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_1001 = "){" + NL + "                \t";
  protected final String TEXT_1002 = NL + "\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_1003 = " = e_";
  protected final String TEXT_1004 = ";" + NL + "\t\t\t\t\twhile (e2_";
  protected final String TEXT_1005 = " != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_1006 = ".getMessage());" + NL + "\t\t\t\t\t\te2_";
  protected final String TEXT_1007 = " = e2_";
  protected final String TEXT_1008 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1009 = NL + "\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_1010 = " = e_";
  protected final String TEXT_1011 = ";" + NL + "                \tboolean isFailure = false;" + NL + "\t\t\twhile(e_";
  protected final String TEXT_1012 = " != null){" + NL + "\t\t\t\tif(e_";
  protected final String TEXT_1013 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1014 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_1015 = ".printStackTrace();" + NL + "\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if(e_";
  protected final String TEXT_1016 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1017 = ".getMessage());" + NL + "\t\t\t\t\te_";
  protected final String TEXT_1018 = ".printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\te_";
  protected final String TEXT_1019 = " = e_";
  protected final String TEXT_1020 = ".getNextException();" + NL + "\t\t\t}" + NL + "\t\t\tif(isFailure && e_";
  protected final String TEXT_1021 = " != null){" + NL + "\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1022 = ".getMessage());" + NL + "\t\t\t\te_";
  protected final String TEXT_1023 = ".printStackTrace();" + NL + "\t\t\t}" + NL + "                \t";
  protected final String TEXT_1024 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1025 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1026 = " - \" + e3_";
  protected final String TEXT_1027 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1028 = NL + "\t\t\t\tthrow (e3_";
  protected final String TEXT_1029 = ");" + NL + "            \t\t";
  protected final String TEXT_1030 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1031 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1032 = " - \" + e3_";
  protected final String TEXT_1033 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1034 = NL + "\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_1035 = ".getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_1039 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_1040 = " <= commitCounter_";
  protected final String TEXT_1041 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_1042 = NL + "\t\t                try {" + NL + "\t\t                \tcommitCounter_";
  protected final String TEXT_1043 = " = 0;" + NL + "\t\t                \t";
  protected final String TEXT_1044 = NL + "\t\t                \tbatchSizeCounter_";
  protected final String TEXT_1045 = " = 0;  " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1046 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_1047 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1048 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1049 = NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1050 = " - Executing the ";
  protected final String TEXT_1051 = " batch.\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1052 = NL + "\t\t                \t\tint countSum_";
  protected final String TEXT_1053 = " = 0;" + NL + "\t\t\t\t\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_1059 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_1060 = " - The ";
  protected final String TEXT_1061 = " batch execution has succeeded.\");" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_1075 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1076 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_1077 = " + \" records.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1078 = NL + "\t\t\t        \tconn_";
  protected final String TEXT_1079 = ".commit();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1080 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_1081 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1082 = "\t\t                \t" + NL + "\t\t                }catch(java.sql.SQLException e_";
  protected final String TEXT_1083 = "){" + NL + "                    \t\t";
  protected final String TEXT_1084 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1085 = " - \" + e_";
  protected final String TEXT_1086 = ".getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1087 = NL + "\t\t                \t";
  protected final String TEXT_1088 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_1089 = " = e_";
  protected final String TEXT_1090 = ";" + NL + "\t\t\t\t\t\t\twhile (e2_";
  protected final String TEXT_1091 = " != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_1092 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\te2_";
  protected final String TEXT_1093 = " = e2_";
  protected final String TEXT_1094 = ".getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1095 = NL + "\t\t\t\t\tjava.sql.SQLException e3_";
  protected final String TEXT_1096 = " = e_";
  protected final String TEXT_1097 = ";" + NL + "\t\t                \tboolean isFailure = false;" + NL + "\t\t\t\t\twhile(e_";
  protected final String TEXT_1098 = " != null){" + NL + "\t\t\t\t\t\tif(e_";
  protected final String TEXT_1099 = ".getErrorCode() == -2801){" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1100 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1101 = ".printStackTrace();" + NL + "\t\t\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse if(e_";
  protected final String TEXT_1102 = ".getErrorCode() == 1339){" + NL + "\t\t\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1103 = ".getMessage());" + NL + "\t\t\t\t\t\t\te_";
  protected final String TEXT_1104 = ".printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_1105 = " = e_";
  protected final String TEXT_1106 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(isFailure && e_";
  protected final String TEXT_1107 = " != null){" + NL + "\t\t\t\t\t\tSystem.out.println(\" Message: \" + e_";
  protected final String TEXT_1108 = ".getMessage());" + NL + "\t\t\t\t\t\te_";
  protected final String TEXT_1109 = ".printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t                \t";
  protected final String TEXT_1110 = NL + "                   \t\t";
  protected final String TEXT_1111 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_1112 = " - \" + e3_";
  protected final String TEXT_1113 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1114 = NL + "\t\t\t\t\t\tthrow (e3_";
  protected final String TEXT_1115 = ");" + NL + "\t\t                \t";
  protected final String TEXT_1116 = NL + "                   \t\t";
  protected final String TEXT_1117 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_1118 = " - \" + e3_";
  protected final String TEXT_1119 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1120 = NL + "\t\t\t\t\t\tSystem.err.println(e3_";
  protected final String TEXT_1121 = ".getMessage());" + NL + "\t\t                \t";
