...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_52 = NL + NL + "\t\t\t\tString dbPwd_";
  ...
  protected final String TEXT_58 = ");" + NL + "\t\t\t\tresourceMap.put(\"conn_";
  protected final String TEXT_59 = "\", conn_";
  protected final String TEXT_60 = ");" + NL + "\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t" + NL + "if(dbschema_";
  ...
  protected final String TEXT_70 = ".setAutoCommit(false);" + NL + "        " + NL + "int commitEvery_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "        " + NL + "int commitCounter_";
  protected final String TEXT_73 = " = 0;        ";
  protected final String TEXT_74 = NL + "   int batchSize_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_90 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_91 = " + \"_proj (";
  protected final String TEXT_92 = ") AS SELECT ";
  protected final String TEXT_93 = " FROM \" + tableName_";
  ...
  protected final String TEXT_101 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_102 = " + \"_proj (";
  protected final String TEXT_103 = ") AS SELECT ";
  protected final String TEXT_104 = " FROM \" + tableName_";
  ...
  protected final String TEXT_111 = " = false;" + NL + "            String defaultSchema_";
  ...
  protected final String TEXT_116 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_117 = " = stmtSchema_";
  protected final String TEXT_118 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_119 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_120 = " = rsSchema_";
  protected final String TEXT_121 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_122 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_123 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_124 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_125 = " = rsTable_";
  protected final String TEXT_126 = ".getString(\"TABLE_NAME\");" + NL + "                String schema_";
  protected final String TEXT_127 = " = rsTable_";
  protected final String TEXT_128 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_129 = ".equalsIgnoreCase(";
  protected final String TEXT_130 = ") && (schema_";
  protected final String TEXT_131 = ".equals(dbschema_";
  ...
  protected final String TEXT_141 = ".createStatement();" + NL + "                    stmtCreate_";
  protected final String TEXT_142 = ".execute(\"";
  protected final String TEXT_143 = ")\");";
  protected final String TEXT_144 = NL + "            \t\tstmtCreate_";
  protected final String TEXT_145 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_146 = " + \"_proj (";
  protected final String TEXT_147 = ") AS SELECT ";
  ...
  protected final String TEXT_159 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_160 = ".execute(\"";
  protected final String TEXT_161 = ")\");";
  protected final String TEXT_162 = NL + "            \tstmtCreate_";
  protected final String TEXT_163 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_164 = " + \"_proj (";
  protected final String TEXT_165 = ") AS SELECT ";
  protected final String TEXT_166 = " FROM \" + tableName_";
  protected final String TEXT_167 = ");//";
  protected final String TEXT_168 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_171 = " = stmtClear_";
  ...
  protected final String TEXT_182 = NL + "        int batchCount_";
  protected final String TEXT_183 = " = 0;";
  protected final String TEXT_184 = NL + "        String update_";
  protected final String TEXT_185 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_194 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_204 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_212 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_227 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_233 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_234 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_237 = " = \"COPY \" + tableName_";
  protected final String TEXT_238 = " +\" (";
  protected final String TEXT_239 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_240 = "DIRECT";
