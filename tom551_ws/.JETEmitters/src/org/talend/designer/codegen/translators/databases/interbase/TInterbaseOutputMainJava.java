...
public class TInterbaseOutputMainJava {
  ...
  protected final String TEXT_192 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_193 = " == 0) {" + NL + "            \t";
  protected final String TEXT_194 = NL + "\t\t\t\tquery_";
  protected final String TEXT_195 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_206 = ".executeUpdate();  " + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_226 = NL + "                }" + NL + "            nb_line_";
  ...
  protected final String TEXT_240 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_241 = " = deletedCount_";
  protected final String TEXT_242 = " + pstmt_";
  protected final String TEXT_243 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_254 = NL + "                        rejectedCount_";
  protected final String TEXT_255 = " = rejectedCount_";
  ...
  protected final String TEXT_281 = "=0;" + NL + "                " + NL + "                }   " + NL + "            ";
