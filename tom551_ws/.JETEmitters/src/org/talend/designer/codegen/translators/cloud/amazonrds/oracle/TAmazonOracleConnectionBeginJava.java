...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_102 = NL + "\t\tString password_";
  protected final String TEXT_103 = " = decryptedPassword_";
  protected final String TEXT_104 = ";" + NL + "\t";
  protected final String TEXT_105 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_106 = " = null;" + NL;
  protected final String TEXT_107 = NL + "\t";
  protected final String TEXT_108 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_109 = ")) {";
  protected final String TEXT_110 = NL + "\t\t";
  protected final String TEXT_111 = NL + "\t\t";
  protected final String TEXT_112 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_113 = "\", conn_";
  protected final String TEXT_114 = ");";
  protected final String TEXT_115 = NL + "\t}";
  protected final String TEXT_116 = NL + "\tif (null != conn_";
  protected final String TEXT_117 = ") {" + NL + "\t\t";
  protected final String TEXT_118 = NL + "\t}";
  protected final String TEXT_119 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_120 = "\",conn_";
  protected final String TEXT_121 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
  ...
  protected final String TEXT_126 = "\",password_";
