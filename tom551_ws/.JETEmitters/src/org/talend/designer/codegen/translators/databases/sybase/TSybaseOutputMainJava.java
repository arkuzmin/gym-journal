...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_548 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_549 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_550 = " = insertedCount_";
  protected final String TEXT_551 = " + pstmt_";
  protected final String TEXT_552 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_612 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_613 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_614 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_615 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_616 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_617 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_618 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_619 = " = updatedCount_";
  protected final String TEXT_620 = " + pstmt_";
  protected final String TEXT_621 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_636 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_645 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_646 = " = pstmt_";
  protected final String TEXT_647 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_648 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_649 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_650 = " = rs_";
  protected final String TEXT_651 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_663 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_664 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_665 = ".";
  protected final String TEXT_666 = ", pstmtUpdate_";
  ...
  protected final String TEXT_688 = "_QUERY\", query_";
  protected final String TEXT_689 = ".toString().trim());";
  protected final String TEXT_690 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_691 = " = updatedCount_";
  protected final String TEXT_692 = " + pstmtUpdate_";
  protected final String TEXT_693 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_704 = NL + "                            rejectedCount_";
  protected final String TEXT_705 = " = rejectedCount_";
  protected final String TEXT_706 = " + 1;";
  protected final String TEXT_707 = NL + "                            ";
  protected final String TEXT_708 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_709 = NL + "                            ";
  protected final String TEXT_710 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_711 = ";";
  protected final String TEXT_712 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_713 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_726 = ", pstmtInsert_";
  ...
  protected final String TEXT_733 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_734 = " = insertedCount_";
  protected final String TEXT_735 = " + pstmtInsert_";
  protected final String TEXT_736 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_756 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_757 = "++;";
  protected final String TEXT_758 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_768 = ",updateSQLSplits_";
  protected final String TEXT_769 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_770 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_797 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_798 = "=pstmtUpdate_";
  protected final String TEXT_799 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_800 = " = updatedCount_";
  protected final String TEXT_801 = "+updateFlag_";
  protected final String TEXT_802 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_803 = " == 0) {" + NL + "            \t";
  protected final String TEXT_804 = NL + "\t\t\t\tquery_";
  protected final String TEXT_805 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_806 = NL + "                        ";
  protected final String TEXT_807 = NL + "                            query_";
  protected final String TEXT_808 = " = ";
  protected final String TEXT_809 = ";";
  protected final String TEXT_810 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_811 = ",";
  protected final String TEXT_812 = ".";
  protected final String TEXT_813 = ", ";
  protected final String TEXT_814 = ",insertSQLSplits_";
  protected final String TEXT_815 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_816 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_817 = ".";
  protected final String TEXT_818 = ", pstmtInsert_";
  ...
  protected final String TEXT_826 = " = insertedCount_";
  protected final String TEXT_827 = " + pstmtInsert_";
  protected final String TEXT_828 = ".executeUpdate(); " + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_829 = " = true;";
  protected final String TEXT_830 = NL + "                        throw(e);";
  protected final String TEXT_831 = NL + "                            ";
  protected final String TEXT_832 = " = new ";
  protected final String TEXT_833 = "Struct();";
  protected final String TEXT_834 = NL + "                                ";
  protected final String TEXT_835 = ".";
  protected final String TEXT_836 = " = ";
  protected final String TEXT_837 = ".";
  protected final String TEXT_838 = ";";
  protected final String TEXT_839 = NL + "                            rejectedCount_";
  protected final String TEXT_840 = " = rejectedCount_";
  protected final String TEXT_841 = " + 1;";
  protected final String TEXT_842 = NL + "                            ";
  protected final String TEXT_843 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_848 = NL + "                }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_862 = NL + "    \t\tpstmt_";
  protected final String TEXT_863 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  ...
  protected final String TEXT_870 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_889 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_890 = NL + "            }" + NL + "           \t";
  protected final String TEXT_891 = NL + "            nb_line_";
  protected final String TEXT_892 = "++;";
  protected final String TEXT_893 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_904 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_905 = " <= batchSizeCounter_";
  protected final String TEXT_906 = ") {                ";
  protected final String TEXT_907 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_908 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_921 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_922 = " += countSum_";
  protected final String TEXT_923 = ";" + NL + "            \t    \t";
  protected final String TEXT_924 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_925 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_926 = NL + "                \tint countSum_";
  protected final String TEXT_927 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_928 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_932 = NL + "\t\t\t    \t\tinsertedCount_";
  ...
  protected final String TEXT_938 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_939 = " += countSum_";
  protected final String TEXT_940 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_941 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_942 = NL + "                }";
  protected final String TEXT_943 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_944 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_945 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_946 = " <= commitCounter_";
  protected final String TEXT_947 = ") {" + NL + "                ";
  protected final String TEXT_948 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_949 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_950 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_951 = NL + "                \t\tint countSum_";
  protected final String TEXT_952 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_953 = ": pstmt_";
  protected final String TEXT_954 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_972 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_973 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_974 = NL + "\t                \tint countSum_";
  protected final String TEXT_975 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_976 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_983 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_984 = " += countSum_";
  protected final String TEXT_985 = ";" + NL + "            \t    \t";
  protected final String TEXT_986 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_987 = " += countSum_";
  protected final String TEXT_988 = ";" + NL + "            \t    \t";
  protected final String TEXT_989 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_990 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_991 = NL + "                \tconn_";
  protected final String TEXT_992 = ".commit();                " + NL + "                \tcommitCounter_";
