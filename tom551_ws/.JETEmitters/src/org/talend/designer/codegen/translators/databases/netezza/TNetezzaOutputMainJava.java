...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_195 = ";" + NL + "                " + NL + "            if(updateFlag_";
  protected final String TEXT_196 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_197 = NL + "        \t\t\t    ";
  protected final String TEXT_198 = NL + "        \t\t\t    ";
  protected final String TEXT_199 = NL + "                    insertedCount_";
  protected final String TEXT_200 = " = insertedCount_";
  protected final String TEXT_201 = " + pstmtInsert_";
  protected final String TEXT_202 = ".executeUpdate();" + NL + "             }" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_203 = " = true;";
  protected final String TEXT_204 = NL + "\t\t                ";
  protected final String TEXT_205 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_206 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_218 = NL + "                            rejectedCount_";
  protected final String TEXT_219 = " = rejectedCount_";
  protected final String TEXT_220 = " + 1;";
  protected final String TEXT_221 = NL + "                            ";
  protected final String TEXT_222 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_223 = NL + "                            ";
  protected final String TEXT_224 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_225 = ";";
  protected final String TEXT_226 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_238 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_246 = ".executeUpdate();" + NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_253 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_271 = NL + "        }" + NL + "        nb_line_";
  protected final String TEXT_272 = "++;" + NL + "\t\t\t";
  protected final String TEXT_273 = NL + "    \t";
  protected final String TEXT_274 = NL + "                log4jSb_";
  protected final String TEXT_275 = ".append(";
  protected final String TEXT_276 = ".";
  protected final String TEXT_277 = ");";
  protected final String TEXT_278 = NL + "                \tlog4jSb_";
  protected final String TEXT_279 = ".append(\"|\");";
  protected final String TEXT_280 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_281 = " - Writing the record \" + nb_line_";
  protected final String TEXT_282 = " + \" \" + log4jSb_";
  protected final String TEXT_283 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_284 = ".delete(0,log4jSb_";
  protected final String TEXT_285 = ".length());" + NL + "\t\t";
  ...
  protected final String TEXT_303 = " - Executing the ";
  protected final String TEXT_304 = " batch.\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_306 = ".executeBatch();                \t" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_307 = ".clearBatch();" + NL + "\t\t\t    \t\t";
  protected final String TEXT_308 = NL + "\t\t\t    \t\tlog.debug(\"";
  protected final String TEXT_309 = " - The ";
  protected final String TEXT_310 = " batch execution has succeeded.\");" + NL + "\t\t\t    \t\t";
  protected final String TEXT_311 = NL + "            \t    \t";
  protected final String TEXT_312 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_313 = " += pstmt_";
  protected final String TEXT_314 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_315 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_316 = " += pstmt_";
  protected final String TEXT_317 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_318 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_319 = " += pstmt_";
  protected final String TEXT_320 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_321 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_322 = NL + "\t\t                ";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_324 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_326 = NL + "\t                ";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_328 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_329 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_330 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "\t                ";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_332 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_333 = NL + "                \t";
  protected final String TEXT_334 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_335 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_336 = NL + "                }";
  protected final String TEXT_337 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_338 = NL + "        \t    commitCounter_";
  protected final String TEXT_339 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  ...
  protected final String TEXT_344 = " - Executing the ";
  protected final String TEXT_345 = " batch.\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\tif(batchSizeCounter_";
  protected final String TEXT_347 = " >0){" + NL + "\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_348 = " = 0;" + NL + "                \t\tpstmt_";
  protected final String TEXT_349 = ".executeBatch();" + NL + "                \t\tpstmt_";
  protected final String TEXT_350 = ".clearBatch();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t\t";
  protected final String TEXT_351 = NL + "\t\t\t    \t\tlog.debug(\"";
  protected final String TEXT_352 = " - The ";
  protected final String TEXT_353 = " batch execution has succeeded.\");" + NL + "\t\t\t    \t\t";
  protected final String TEXT_354 = NL + "            \t    \t";
  protected final String TEXT_355 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_356 = " += pstmt_";
  protected final String TEXT_357 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_358 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_359 = " += pstmt_";
  protected final String TEXT_360 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_361 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_362 = " += pstmt_";
  protected final String TEXT_363 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_364 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_365 = NL + "\t\t                ";
  protected final String TEXT_366 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_367 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_369 = NL + "\t\t                ";
  protected final String TEXT_370 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_371 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_373 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  ...
  protected final String TEXT_385 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_386 = " + \" records.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_390 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_391 = NL + "                \tcommitCounter_";
  protected final String TEXT_392 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
