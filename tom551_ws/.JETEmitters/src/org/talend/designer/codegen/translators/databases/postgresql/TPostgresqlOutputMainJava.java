...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_522 = NL + "                            geometryColumnName_";
  protected final String TEXT_523 = " = \"";
  protected final String TEXT_524 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_525 = ") {" + NL + "                                dimension_";
  protected final String TEXT_526 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_527 = ".";
  protected final String TEXT_528 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_529 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_530 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_533 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_534 = " = refSys_";
  protected final String TEXT_535 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_536 = " = refSys_";
  protected final String TEXT_537 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_538 = " == null || ident_";
  protected final String TEXT_539 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_540 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_541 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_542 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_543 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_544 = " = Integer.parseInt(code_";
  protected final String TEXT_545 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_546 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_547 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_548 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_549 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_550 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_551 = ",";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = ", ";
  protected final String TEXT_554 = ",insertSQLSplits_";
  ...
  protected final String TEXT_567 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_568 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_569 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_570 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_571 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_572 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_573 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_574 = NL + "                \tsp_";
  protected final String TEXT_575 = " = conn_";
  protected final String TEXT_576 = ".setSavepoint();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_580 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_581 = NL + "\t                conn_";
  protected final String TEXT_582 = ".releaseSavepoint(sp_";
  protected final String TEXT_583 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_584 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_585 = NL + "\t                conn_";
  protected final String TEXT_586 = ".rollback(sp_";
  protected final String TEXT_587 = ");" + NL + "\t            ";
  protected final String TEXT_588 = NL + "                whetherReject_";
  ...
  protected final String TEXT_651 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_656 = NL + "\t                sp_";
  protected final String TEXT_657 = " = conn_";
  protected final String TEXT_658 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_659 = NL + "                updatedCount_";
  protected final String TEXT_660 = " = updatedCount_";
  protected final String TEXT_661 = " + pstmt_";
  protected final String TEXT_662 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_663 = NL + "                \tconn_";
  protected final String TEXT_664 = ".releaseSavepoint(sp_";
  protected final String TEXT_665 = ");";
  protected final String TEXT_666 = "\t" + NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_667 = NL + "\t                conn_";
  protected final String TEXT_668 = ".rollback(sp_";
  protected final String TEXT_669 = ");" + NL + "\t            ";
  protected final String TEXT_670 = NL + "                whetherReject_";
  ...
  protected final String TEXT_685 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_686 = NL + "                        ";
  protected final String TEXT_687 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_688 = ";";
  protected final String TEXT_689 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_739 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_740 = NL + "\t                    sp_";
  protected final String TEXT_741 = " = conn_";
  protected final String TEXT_742 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_743 = NL + "                    updatedCount_";
  protected final String TEXT_744 = " = updatedCount_";
  protected final String TEXT_745 = " + pstmtUpdate_";
  protected final String TEXT_746 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_747 = NL + "    \t                conn_";
  protected final String TEXT_748 = ".releaseSavepoint(sp_";
  ...
  protected final String TEXT_752 = ".rollback(sp_";
  ...
  protected final String TEXT_774 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_775 = NL + "                        ";
  protected final String TEXT_776 = NL + "                            query_";
  protected final String TEXT_777 = " = ";
  protected final String TEXT_778 = ";";
  protected final String TEXT_779 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_780 = ",";
  protected final String TEXT_781 = ".";
  protected final String TEXT_782 = ", ";
  protected final String TEXT_783 = ",insertSQLSplits_";
  ...
  protected final String TEXT_794 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_795 = NL + "\t                    sp_";
  protected final String TEXT_796 = " = conn_";
  protected final String TEXT_797 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_798 = NL + "                    insertedCount_";
  protected final String TEXT_799 = " = insertedCount_";
  protected final String TEXT_800 = " + pstmtInsert_";
  protected final String TEXT_801 = ".executeUpdate();" + NL + "\t\t\t\t\t";
  protected final String TEXT_802 = NL + "    \t                conn_";
  protected final String TEXT_803 = ".releaseSavepoint(sp_";
  protected final String TEXT_804 = ");" + NL + "    \t            ";
  protected final String TEXT_805 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_806 = NL + "    \t                conn_";
  protected final String TEXT_807 = ".rollback(sp_";
  protected final String TEXT_808 = ");" + NL + "    \t            ";
  protected final String TEXT_809 = NL + "                    whetherReject_";
  protected final String TEXT_810 = " = true;";
  protected final String TEXT_811 = NL + "                        throw(e);";
  ...
  protected final String TEXT_829 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_830 = "++;";
  protected final String TEXT_831 = NL + "            int updateFlag_";
  protected final String TEXT_832 = "=0;";
  protected final String TEXT_833 = NL + "                    ";
  protected final String TEXT_834 = NL + "                        query_";
  protected final String TEXT_835 = " = ";
  protected final String TEXT_836 = ";";
  protected final String TEXT_837 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_838 = ",";
  protected final String TEXT_839 = ".";
  protected final String TEXT_840 = ", ";
  protected final String TEXT_841 = ",updateSQLSplits_";
  protected final String TEXT_842 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_843 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_844 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_845 = ".";
  protected final String TEXT_846 = ", pstmtUpdate_";
  ...
  protected final String TEXT_871 = NL + "        " + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_872 = NL + "\t                sp_";
  protected final String TEXT_873 = " = conn_";
  protected final String TEXT_874 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_875 = NL + "                updateFlag_";
  protected final String TEXT_876 = "=pstmtUpdate_";
  protected final String TEXT_877 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_878 = " = updatedCount_";
  protected final String TEXT_879 = "+updateFlag_";
  protected final String TEXT_880 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_881 = NL + "\t                conn_";
  protected final String TEXT_882 = ".releaseSavepoint(sp_";
  protected final String TEXT_883 = ");" + NL + "\t            ";
  protected final String TEXT_884 = NL + "            if(updateFlag_";
  protected final String TEXT_885 = " == 0) {" + NL + "            \t";
  protected final String TEXT_886 = NL + "\t\t\t\tquery_";
  protected final String TEXT_887 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_908 = NL + "\t                    sp_";
  protected final String TEXT_909 = " = conn_";
  protected final String TEXT_910 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_915 = NL + "    \t                conn_";
  protected final String TEXT_916 = ".releaseSavepoint(sp_";
  protected final String TEXT_917 = ");" + NL + "    \t            ";
  protected final String TEXT_918 = NL + "    \t            }" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_919 = NL + "    \t                conn_";
  protected final String TEXT_920 = ".rollback(sp_";
  protected final String TEXT_921 = ");" + NL + "    \t            ";
  protected final String TEXT_922 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_942 = NL + "                }" + NL + "            nb_line_";
  ...
  protected final String TEXT_957 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_958 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_959 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_960 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_961 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_962 = NL + "\t                sp_";
  protected final String TEXT_963 = " = conn_";
  protected final String TEXT_964 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_965 = NL + "                deletedCount_";
  protected final String TEXT_966 = " = deletedCount_";
  protected final String TEXT_967 = " + pstmt_";
  protected final String TEXT_968 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_969 = NL + "\t                conn_";
  protected final String TEXT_970 = ".releaseSavepoint(sp_";
  protected final String TEXT_971 = ");" + NL + "\t            ";
  protected final String TEXT_972 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_973 = NL + "\t                conn_";
  protected final String TEXT_974 = ".rollback(sp_";
  ...
  protected final String TEXT_997 = NL + "            nb_line_";
  protected final String TEXT_998 = "++;";
  protected final String TEXT_999 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1010 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1011 = " <= batchSizeCounter_";
  protected final String TEXT_1012 = ") {                ";
  protected final String TEXT_1013 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1014 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1015 = ": pstmt_";
  protected final String TEXT_1016 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1017 = " += (countEach_";
  protected final String TEXT_1018 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1057 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1058 = " += (countEach_";
  protected final String TEXT_1059 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1070 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_1087 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1088 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1089 = NL + "                \tconn_";
  protected final String TEXT_1090 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1091 = "=0;" + NL + "                }\t";
