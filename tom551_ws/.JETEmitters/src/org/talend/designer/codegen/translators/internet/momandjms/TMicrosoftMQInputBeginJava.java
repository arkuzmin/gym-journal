...
public class TMicrosoftMQInputBeginJava
{
  ...
  protected final String TEXT_8 = ".open();" + NL + "\t    \tif (msgu_";
  protected final String TEXT_9 = ".isOpen()){" + NL + "\t\t\t\t";
  protected final String TEXT_10 = NL + "\t    " + NL + "\t\t\t\t\t\t";
  protected final String TEXT_11 = ".";
  protected final String TEXT_12 = " = msgu_";
  protected final String TEXT_13 = ".receive();" + NL + "\t\t\t\t\t";
