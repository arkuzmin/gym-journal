...
public class TEXistDeleteBeginJava
{
  ...
  protected final String TEXT_26 = " = 0;" + NL + "\torg.xmldb.api.modules.CollectionManagementService mgtService_";
  protected final String TEXT_27 = " = (org.xmldb.api.modules.CollectionManagementService) col_";
  protected final String TEXT_28 = ".getService(\"CollectionManagementService\",\"1.0\");" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_29 = " = new java.util.ArrayList<java.util.Map<String,String>>();";
  protected final String TEXT_30 = NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_31 = "_";
  protected final String TEXT_32 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_33 = "_";
  protected final String TEXT_34 = ".put(";
  protected final String TEXT_35 = ",";
  protected final String TEXT_36 = ");\t\t" + NL + " \t\tlist_";
  protected final String TEXT_37 = ".add(map_";
  protected final String TEXT_38 = "_";
  protected final String TEXT_39 = ");";
  protected final String TEXT_40 = NL + NL + "\t\tfor(java.util.Map<String, String> map_";
