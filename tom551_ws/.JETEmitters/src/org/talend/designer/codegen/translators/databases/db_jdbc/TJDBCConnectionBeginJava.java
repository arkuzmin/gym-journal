...
public class TJDBCConnectionBeginJava
{
  ...
  protected final String TEXT_43 = NL + "\t\tString password_";
  ...
  protected final String TEXT_58 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_66 = NL + "\tif (null != conn_";
  protected final String TEXT_67 = ") {" + NL + "\t\t";
  protected final String TEXT_68 = NL + "\t}";
  protected final String TEXT_69 = NL + "\t" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_70 = "\", conn_";
  protected final String TEXT_71 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_72 = "\", url_";
  protected final String TEXT_73 = ");" + NL + "\t//globalMap.put(\"user_";
  protected final String TEXT_74 = "\", userName_";
  protected final String TEXT_75 = ");" + NL + "\t//globalMap.put(\"pass_";
  protected final String TEXT_76 = "\", password_";
