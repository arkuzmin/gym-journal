...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_41 = NL + "\t\tString password_";
  ...
  protected final String TEXT_50 = NL + "\t\tString password_";
  ...
  protected final String TEXT_67 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_68 = "\", ";
  protected final String TEXT_69 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_70 = "\",  ";
  protected final String TEXT_71 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_72 = "\",conn_";
  protected final String TEXT_73 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
