...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_153 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}                \t" + NL + "\t            \t    \t";
  protected final String TEXT_154 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_155 = " += countSum_";
  protected final String TEXT_156 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_157 = "                         \t    \t" + NL + "            \t    \t}" + NL + "            \t    \t\t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_160 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_161 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_162 = NL + "\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_164 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_165 = NL + "                \tint countSum_";
  protected final String TEXT_166 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_167 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_168 = " += (countEach_";
  protected final String TEXT_169 = " < 0 ? 0 : countEach_";
  protected final String TEXT_170 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_171 = NL + "            \t    insertedCount_";
  protected final String TEXT_172 = " += countSum_";
  protected final String TEXT_173 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_174 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_175 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_176 = " = 0;    ";
  protected final String TEXT_177 = "    \t\t\t" + NL + "    \t\t";
  protected final String TEXT_178 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_179 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_180 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_181 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_182 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_183 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_184 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_185 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_186 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_187 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_188 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_189 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_190 = NL + "\t";
  protected final String TEXT_191 = "                " + NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_192 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_193 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_195 = " - Executing the ";
  protected final String TEXT_196 = " batch.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_204 = " - The ";
  protected final String TEXT_205 = " batch execution has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_206 = NL + "\t    \t";
  protected final String TEXT_207 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_208 = " += countSum_";
  protected final String TEXT_209 = "; " + NL + "\t    \t";
  protected final String TEXT_210 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_211 = " += countSum_";
  protected final String TEXT_212 = ";" + NL + "\t    \t";
  protected final String TEXT_213 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_214 = " += countSum_";
  protected final String TEXT_215 = ";" + NL + "\t    \t";
  protected final String TEXT_216 = "            \t    " + NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_217 = NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\tlog.fatal(\"";
  ...
  protected final String TEXT_224 = NL + "    \tint countSum_";
  protected final String TEXT_225 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_226 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_227 = " += (countEach_";
  protected final String TEXT_228 = " < 0 ? 0 : countEach_";
  protected final String TEXT_229 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_230 = NL + "    \tinsertedCount_";
  protected final String TEXT_231 = " += countSum_";
  protected final String TEXT_232 = ";" + NL + "    \t";
  protected final String TEXT_233 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_234 = " += countSum_";
  protected final String TEXT_235 = ";" + NL + "    \t";
  protected final String TEXT_236 = NL + "    \tdeletedCount_";
  protected final String TEXT_237 = " += countSum_";
  protected final String TEXT_238 = ";" + NL + "    \t";
  protected final String TEXT_239 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_240 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_241 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_242 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_243 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_244 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_246 = ");   " + NL + "\t\t\t";
  protected final String TEXT_247 = "              " + NL + "        }        ";
  protected final String TEXT_248 = NL;
  protected final String TEXT_249 = NL + "\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_251 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_252 = " + \" records.\");" + NL + "\t\t\t";
  protected final String TEXT_253 = NL + "    \t\tconn_";
  protected final String TEXT_254 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_256 = " - Commit has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_257 = NL + "    \t\t";
  protected final String TEXT_258 = "\t" + NL + "\t\t";
  protected final String TEXT_259 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_260 = " - Closing the connection to the database.\");" + NL + "\t\t";
  protected final String TEXT_261 = NL + "    \tconn_";
  protected final String TEXT_262 = " .close();" + NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_263 = "\", true);" + NL + "\t\t";
  ...
  protected final String TEXT_280 = NL + "\tif (globalMap.get(\"";
  protected final String TEXT_281 = "_NB_LINE\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_282 = "_NB_LINE\",nb_line_";
  protected final String TEXT_283 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_284 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_285 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_286 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_287 = "_NB_LINE_UPDATED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_288 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_289 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_290 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_291 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_292 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_293 = "_NB_LINE_INSERTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_294 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_295 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_296 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_297 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_298 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_299 = "_NB_LINE_DELETED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_300 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_301 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_302 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_303 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_304 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_305 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_306 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_307 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_308 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_309 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_310 = ");" + NL + "    }";
  protected final String TEXT_311 = NL + "    globalMap.put(\"";
  protected final String TEXT_312 = "_NB_LINE\",nb_line_";
  protected final String TEXT_313 = ");" + NL + "    globalMap.put(\"";
  ...
  protected final String TEXT_317 = ");" + NL + "    globalMap.put(\"";
  ...
  protected final String TEXT_324 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_325 = " + \" records.\");";
  protected final String TEXT_326 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_327 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_328 = " + \" records.\");";
  protected final String TEXT_329 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_330 = " - Has deleted \" + nb_line_deleted_";
  protected final String TEXT_331 = " + \" records.\");";
  protected final String TEXT_332 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_333 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_334 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_335 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_336 = " + \" records.\");";
  protected final String TEXT_337 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_338 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_339 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_340 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_341 = " + \" records.\");";
  protected final String TEXT_342 = NL + "\t\tlog.info(\"";
  protected final String TEXT_343 = " - Has rejected \" + nb_line_rejected_";
  protected final String TEXT_344 = " + \"records.\");";
  protected final String TEXT_345 = NL + "\t\tlog.info(\"";
  protected final String TEXT_346 = " - Done.\");";
