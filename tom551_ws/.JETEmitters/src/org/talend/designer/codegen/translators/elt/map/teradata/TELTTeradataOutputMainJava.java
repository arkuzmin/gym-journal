...
public class TELTTeradataOutputMainJava
{
  ...
  protected final String TEXT_122 = "String decryptedPassword_";
  ...
  protected final String TEXT_127 = NL + "\tdecryptedPassword_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = "; ";
  protected final String TEXT_130 = NL + "      " + NL + "    " + NL + "    String dbPwd_";
  protected final String TEXT_131 = " = decryptedPassword_";
  protected final String TEXT_132 = ";" + NL + "\t";
  protected final String TEXT_133 = "\t " + NL + "\t";
  protected final String TEXT_134 = NL + "\t\tlog.info(\"";
  protected final String TEXT_135 = " - Connection attempt to '\" + url_";
  protected final String TEXT_136 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_144 = " - Connection to '\" + url_";
  protected final String TEXT_145 = " + \"' has succeeded.\");" + NL + "\t";
  protected final String TEXT_146 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_147 = " =null;" + NL + "\t";
  protected final String TEXT_148 = NL + NL + "\tString tableName_";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";";
  protected final String TEXT_151 = "\t" + NL + "\t" + NL + "\t" + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_152 = "+\" (";
  protected final String TEXT_153 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_156 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_157 = "+\" FROM (\" + select_query + \") src SET ";
  protected final String TEXT_158 = " \"";
  protected final String TEXT_159 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_160 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".prepareStatement(updateQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_163 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_164 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_165 = NL + "+\"  AND \" + ";
  protected final String TEXT_166 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_169 = NL + "int nb_line_";
  protected final String TEXT_170 = " = 0;" + NL + "int nb_line_update_";
  ...
  protected final String TEXT_176 = " - Executing the SQL query :'\" + insertQuery + \"'.\" );";
  protected final String TEXT_177 = NL + "nb_line_inserted_";
  ...
  protected final String TEXT_181 = " - The SQL query :'\" + insertQuery + \"' has been executed successfully.\");";
  ...
  protected final String TEXT_186 = " - Executing the SQL query :'\" + updateQuery + \"'.\");";
  protected final String TEXT_187 = NL + "nb_line_update_";
  ...
  protected final String TEXT_191 = " - The SQL query :'\" + updateQuery + \"' has been executed successfully.\");";
  protected final String TEXT_192 = NL + "\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_193 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_194 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_196 = " - Executing the SQL query :'\" + deleteQuery +\"'.\");" + NL + "\t\t";
  protected final String TEXT_197 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_198 = " = pstmt_";
  protected final String TEXT_199 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_201 = " - The SQL query :'\" + deleteQuery + \"' has been executed successfully.\");" + NL + "\t\t";
  ...
  protected final String TEXT_210 = " - Closing the connection to the database.\");" + NL + "\t\t";
  ...
  protected final String TEXT_214 = " - Connection to the database closed.\");" + NL + "\t\t";
  protected final String TEXT_215 = NL + "    }";
  protected final String TEXT_216 = NL + "nb_line_";
  protected final String TEXT_217 = " = nb_line_update_";
  protected final String TEXT_218 = " + nb_line_inserted_";
  protected final String TEXT_219 = " + nb_line_deleted_";
  ...
  protected final String TEXT_223 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_224 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_225 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  ...
  protected final String TEXT_230 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_231 = " + \". Inserted records count: \" + nb_line_inserted_";
  protected final String TEXT_232 = " + \". Updated records count: \" + nb_line_update_";
  protected final String TEXT_233 = " + \". Deleted records count: \" + nb_line_deleted_";
  protected final String TEXT_234 = " + \".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_235 = " - Done.\");" + NL + "\t";
