...
public class TNetezzaSCDBeginJava {
  ...
  protected final String TEXT_62 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_63 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_64 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_65 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_66 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_67 = " = calendarYear0_";
  protected final String TEXT_68 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_69 = " = calendar_";
  protected final String TEXT_70 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_71 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_72 = " = calendar_";
  protected final String TEXT_73 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_74 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_75 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_76 = " = null;    ";
  protected final String TEXT_77 = NL + "        String searching_";
  protected final String TEXT_78 = " = \"";
  protected final String TEXT_79 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_80 = " = connection_";
  protected final String TEXT_81 = ".prepareStatement(searching_";
  protected final String TEXT_82 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_83 = " = null;";
  protected final String TEXT_84 = NL + "        String search_";
  protected final String TEXT_85 = " = \"";
  protected final String TEXT_86 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_87 = " = connection_";
  protected final String TEXT_88 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_89 = " = statement_";
  protected final String TEXT_90 = ".executeQuery(search_";
  protected final String TEXT_91 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_92 = ", SCDStruct_";
  protected final String TEXT_93 = "> cache_";
  protected final String TEXT_94 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_95 = ", SCDStruct_";
  protected final String TEXT_96 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_97 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_98 = " sk_";
  protected final String TEXT_99 = " = new SCDSK_";
  protected final String TEXT_100 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_101 = " row_";
  protected final String TEXT_102 = " = new SCDStruct_";
  protected final String TEXT_103 = "();";
  protected final String TEXT_104 = NL + "                    tmpValue_";
  protected final String TEXT_105 = " = resultSet_";
  protected final String TEXT_106 = ".getString(";
  protected final String TEXT_107 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_108 = " != null && tmpValue_";
  protected final String TEXT_109 = ".length() > 0) {";
  protected final String TEXT_110 = NL + "                        ";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = " = tmpValue_";
  protected final String TEXT_113 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_114 = NL + "                            if(tmpValue_";
  protected final String TEXT_115 = " == null) {";
  protected final String TEXT_116 = NL + "                                ";
  protected final String TEXT_117 = ".";
  protected final String TEXT_118 = " = null;" + NL + "                            } else {";
  protected final String TEXT_119 = NL + "                                ";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_122 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_123 = ")) {";
  protected final String TEXT_124 = NL + "                                ";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_127 = "' in '";
  protected final String TEXT_128 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_129 = NL + "                    }";
  protected final String TEXT_130 = NL + "                    dateStr_";
  protected final String TEXT_131 = " = resultSet_";
  protected final String TEXT_132 = ".getString(";
  protected final String TEXT_133 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_134 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_135 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_136 = ")) {";
  protected final String TEXT_137 = NL + "                            ";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = " = new java.util.Date(resultSet_";
  protected final String TEXT_140 = ".getTimestamp(";
  protected final String TEXT_141 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_142 = NL + "                            ";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_145 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  ...
  protected final String TEXT_158 = NL + "            cache_";
  protected final String TEXT_159 = ".put(sk_";
  protected final String TEXT_160 = ", row_";
  protected final String TEXT_161 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_162 = ".close();" + NL + "        statement_";
  protected final String TEXT_163 = ".close();";
  protected final String TEXT_164 = NL + "            System.out.println(\"[";
  protected final String TEXT_165 = "] comparison cache loaded\");";
  protected final String TEXT_166 = NL + "        ";
  protected final String TEXT_167 = " nextSurrogateKey_";
  protected final String TEXT_168 = " = 1;";
  protected final String TEXT_169 = NL + "            if(cache_";
  protected final String TEXT_170 = ".size() > 0) {";
  protected final String TEXT_171 = NL + "        String tmpQuery_";
  protected final String TEXT_172 = " = \"SELECT MAX(";
  protected final String TEXT_173 = ") FROM \" + tableName_";
  protected final String TEXT_174 = " + \"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_175 = " = connection_";
  protected final String TEXT_176 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_177 = " = tmpStmt_";
  protected final String TEXT_178 = ".executeQuery(tmpQuery_";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = NL + "        if(tmpRS_";
  protected final String TEXT_181 = ".next() && tmpRS_";
  protected final String TEXT_182 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_183 = " = tmpRS_";
  protected final String TEXT_184 = ".get";
  protected final String TEXT_185 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_186 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_187 = ".close();";
  protected final String TEXT_188 = NL + "            }            ";
  protected final String TEXT_189 = NL + "    String insertionSQL_";
  protected final String TEXT_190 = " = \"";
  protected final String TEXT_191 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_192 = " = connection_";
  protected final String TEXT_193 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "            insertionStatement_";
  protected final String TEXT_196 = ".setTimestamp(";
  protected final String TEXT_197 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_198 = "\")));";
  protected final String TEXT_199 = NL + "            insertionStatement_";
  protected final String TEXT_200 = ".setNull(";
  protected final String TEXT_201 = ", java.sql.Types.DATE);";
  protected final String TEXT_202 = NL + "            insertionStatement_";
  protected final String TEXT_203 = ".setTimestamp(";
  protected final String TEXT_204 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_205 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_206 = NL + "        String updateSQLForType1_";
  protected final String TEXT_207 = " = \"";
  protected final String TEXT_208 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_209 = " = connection_";
  protected final String TEXT_210 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_211 = ");        ";
  protected final String TEXT_212 = NL + "        String updateSQLForType2_";
  protected final String TEXT_213 = " = \"";
  protected final String TEXT_214 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_215 = " = connection_";
  protected final String TEXT_216 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_217 = ");";
  protected final String TEXT_218 = NL + "            updateForType2_";
  protected final String TEXT_219 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_220 = "\")));";
  protected final String TEXT_221 = NL + "        String updateSQLForType3_";
  protected final String TEXT_222 = " = \"";
  protected final String TEXT_223 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_224 = " = connection_";
  protected final String TEXT_225 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + "    ";
  protected final String TEXT_228 = NL + "        SCDSK_";
  protected final String TEXT_229 = " lookUpKey_";
  protected final String TEXT_230 = " = null;        ";
  protected final String TEXT_231 = NL + "    SCDStruct_";
  protected final String TEXT_232 = " lookUpValue_";
