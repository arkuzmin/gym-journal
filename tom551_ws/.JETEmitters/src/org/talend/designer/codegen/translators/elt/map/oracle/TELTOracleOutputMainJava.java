...
public class TELTOracleOutputMainJava
{
  ...
  protected final String TEXT_39 = "String decryptedPassword_";
  protected final String TEXT_40 = " = null;";
  protected final String TEXT_41 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_42 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_43 = ");";
  protected final String TEXT_44 = NL + "\tdecryptedPassword_";
  ...
  protected final String TEXT_52 = ",dbUser_";
  protected final String TEXT_53 = ",dbPwd_";
  protected final String TEXT_54 = ");";
  protected final String TEXT_55 = NL + "\tString atnParams_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "\tatnParams_";
  protected final String TEXT_58 = " = atnParams_";
  ...
  protected final String TEXT_65 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_66 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_72 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_73 = " =null;" + NL + "\t";
  protected final String TEXT_74 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_75 = "+\"(";
  protected final String TEXT_76 = ") (\"+select_query+\")\";";
  protected final String TEXT_77 = "\t" + NL + "\t    StringBuffer insertStringBuffer_";
  protected final String TEXT_78 = " = new StringBuffer(insertQuery);" + NL + "\t    insertStringBuffer_";
  protected final String TEXT_79 = ".insert(insertQuery.indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_80 = " + \" \");" + NL + "\t    insertQuery =insertStringBuffer_";
  protected final String TEXT_81 = ".toString(); ";
  protected final String TEXT_82 = "   " + NL + "\tpstmt_";
  protected final String TEXT_83 = " = conn_";
  protected final String TEXT_84 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_85 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_86 = "+\" SET (";
  protected final String TEXT_87 = ") = (\"+select_query+\") \"";
  protected final String TEXT_88 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_89 = NL + "\t;";
  protected final String TEXT_90 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_91 = " = new StringBuffer(updateQuery);" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_92 = ".insert(updateQuery.indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_93 = "  + \" \");" + NL + "\t    updateQuery =updateStringBuffer_";
  protected final String TEXT_94 = ".toString(); ";
  protected final String TEXT_95 = NL + "\tpstmt_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_98 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_99 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_100 = NL + "+\"  AND \" + ";
  protected final String TEXT_101 = NL + ";";
  protected final String TEXT_102 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_103 = " = new StringBuffer(deleteQuery);" + NL + "    deleteStringBuffer_";
  protected final String TEXT_104 = ".insert(deleteQuery.indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_105 = "  + \" \" );" + NL + "    deleteQuery =deleteStringBuffer_";
  protected final String TEXT_106 = ".toString();  ";
  protected final String TEXT_107 = NL + "pstmt_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_110 = NL + "\tString mergeQuery = \"MERGE INTO \"+ tableName_";
  protected final String TEXT_111 = " +\" target\"  + \" USING (\" + select_query + \") source ON (\" +" + NL + "\t" + NL + "\t\t\"";
  protected final String TEXT_112 = "\" + \")\" ;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_113 = NL + "\t\t\tmergeQuery += \" WHEN MATCHED THEN UPDATE SET ";
  protected final String TEXT_114 = " \" ;\t" + NL + "\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\tmergeQuery += \"WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\t\tmergeQuery += \"WHERE \" + ";
  protected final String TEXT_117 = ";" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + \"\" ;" + NL + "\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + ";
  protected final String TEXT_121 = " ;" + NL + "\t\t  ";
  protected final String TEXT_122 = NL + "\t\t";
  protected final String TEXT_123 = NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\tmergeQuery += \" WHEN NOT MATCHED THEN INSERT ( ";
  protected final String TEXT_125 = ") VALUES ( ";
  protected final String TEXT_126 = ") \";" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + ";
  protected final String TEXT_129 = " ;" + NL + "\t\t\t";
  protected final String TEXT_130 = "\t" + NL + " \t\t\tpstmt_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".prepareStatement(mergeQuery);" + NL + "\t";
  protected final String TEXT_133 = NL + "int nb_line_";
  protected final String TEXT_134 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_135 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_136 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_137 = " = 0;" + NL + "int nb_line_merged_";
  protected final String TEXT_138 = " = 0;" + NL + "\t";
  protected final String TEXT_139 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_140 = " = pstmt_";
  protected final String TEXT_141 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  ...
  protected final String TEXT_145 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_146 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_147 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_148 = " = pstmt_";
  protected final String TEXT_149 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_150 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_151 = "\t" + NL + "\tSystem.out.println(\"Merge with : \\n\" + mergeQuery +\"\\n\");" + NL + "\t    nb_line_merged_";
  protected final String TEXT_152 = " = pstmt_";
  protected final String TEXT_153 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_merged_";
  protected final String TEXT_154 = " + \" rows merged. \\n\");" + NL + "\t";
  ...
  protected final String TEXT_175 = "_NB_LINE_MERGED\",nb_line_merged_";
