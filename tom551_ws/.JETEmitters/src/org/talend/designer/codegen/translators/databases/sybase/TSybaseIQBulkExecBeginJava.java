...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_36 = NL + "   " + NL + "    java.lang.Class.forName(dirverName);" + NL + "\t";
  ...
  protected final String TEXT_44 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_45 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_46 = ", userName_";
  protected final String TEXT_47 = ", decryptedPassword_";
  protected final String TEXT_48 = ");";
  protected final String TEXT_49 = NL + NL + "\tString tableName_";
  protected final String TEXT_50 = " = userName_";
  protected final String TEXT_51 = " + \".\" + ";
  protected final String TEXT_52 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_53 = " != null && dbschema_";
  protected final String TEXT_54 = ".trim().length() != 0) {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_79 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_80 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_81 = " = tableNameForSearch_";
  protected final String TEXT_82 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_83 = " = tableNameForSearch_";
  protected final String TEXT_84 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_85 = " = dbMetaData_";
  protected final String TEXT_86 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_87 = ", tableNameForSearch_";
  protected final String TEXT_88 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_89 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_90 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_91 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_101 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_102 = " = rsTable_";
  protected final String TEXT_103 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_104 = ".equalsIgnoreCase(";
  protected final String TEXT_105 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_106 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_107 = ") || dbschema_";
  protected final String TEXT_108 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_109 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_119 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_123 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_124 = ".equals(schema_";
  protected final String TEXT_125 = ") || (schema_";
  protected final String TEXT_126 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_127 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_136 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_137 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_138 = " == null || dbschema_";
  protected final String TEXT_139 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_146 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_147 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_148 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_163 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_189 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_196 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_197 = ".execute(\"";
  protected final String TEXT_198 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_199 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_207 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_208 = ".executeUpdate(\"";
  protected final String TEXT_209 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_210 = ".close();";
  protected final String TEXT_211 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_214 = " = stmtTruncCount_";
  protected final String TEXT_215 = ".executeQuery(\"";
  protected final String TEXT_216 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_219 = ".executeUpdate(\"";
  protected final String TEXT_220 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_221 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_222 = " += rsTruncCount_";
  protected final String TEXT_223 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_224 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_225 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_226 = ".close();            ";
  protected final String TEXT_227 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_228 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_229 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_230 = NL + "\t";
  protected final String TEXT_231 = NL + NL + "\t\tStringBuilder loadingCols = new StringBuilder();";
  protected final String TEXT_232 = NL + "    \tloadingCols.append(\"(\");";
  protected final String TEXT_233 = NL + "        loadingCols.append(\"";
  protected final String TEXT_234 = "\" + \" \");";
  protected final String TEXT_235 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_236 = " + \"),\");";
  protected final String TEXT_237 = NL + "        loadingCols.append(\"'\" + ";
  protected final String TEXT_238 = " + \"'\" + \",\");";
  protected final String TEXT_239 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_240 = " + \")\");";
  protected final String TEXT_241 = NL + "        \tloadingCols.append(\"'\" + ";
  protected final String TEXT_242 = " + \"'\");";
  protected final String TEXT_243 = NL + "    loadingCols.append(\")\");";
  protected final String TEXT_244 = " " + NL + "" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_245 = "=conn_";
  protected final String TEXT_246 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_247 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    " + NL + "    //stmt_";
  protected final String TEXT_248 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "        " + NL + "    String strSQL = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_249 = " + loadingCols.toString() ;";
  protected final String TEXT_250 = NL + "\t\tstrSQL +=\" from '\" + ";
  protected final String TEXT_251 = " + \"' \";";
  protected final String TEXT_252 = NL + "\t\tstrSQL +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_253 = " + \"' \";";
  protected final String TEXT_254 = NL + "    ";
  protected final String TEXT_255 = NL + "     strSQL = strSQL + \" row delimited by '\" + ";
  protected final String TEXT_256 = " + \"'\";    " + NL + "\t strSQL=strSQL + \" quotes off\";";
  protected final String TEXT_257 = NL + "\tstrSQL=strSQL + \" quotes on \";";
  protected final String TEXT_258 = NL + "\tstrSQL=strSQL + \" quotes off \";";
  protected final String TEXT_259 = NL + "    strSQL =strSQL + \" escapes off \";" + NL + "    ";
  protected final String TEXT_260 = NL + "\tstrSQL =strSQL + \" skip 1 \";";
  protected final String TEXT_261 = NL + "    " + NL + "    stmt_";
  protected final String TEXT_262 = ".execute(strSQL);" + NL;
  protected final String TEXT_263 = NL + "    if(conn_";
  protected final String TEXT_264 = " != null && !conn_";
  protected final String TEXT_265 = ".isClosed()) {" + NL + "        conn_";
