...
public class TInformixInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_229 = " + \":\" + ";
  protected final String TEXT_230 = " + \"/\" + ";
  protected final String TEXT_231 = " + \":informixserver=\" + ";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\t        String url_";
  protected final String TEXT_234 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_235 = " + \":\" + ";
  protected final String TEXT_236 = " + \"/\" + ";
  protected final String TEXT_237 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_247 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_248 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_249 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_250 = " = dataSources_";
  protected final String TEXT_251 = ".get(";
  protected final String TEXT_252 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_253 = "\", conn_";
  protected final String TEXT_254 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_255 = NL + "\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_257 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_258 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_259 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_260 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_261 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_271 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_272 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_273 = " = stmt_";
  protected final String TEXT_274 = ".executeQuery(dbquery_";
  protected final String TEXT_275 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_276 = " = rs_";
  protected final String TEXT_277 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_278 = " = rsmd_";
  protected final String TEXT_279 = ".getColumnCount();" + NL;
  protected final String TEXT_280 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_281 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_282 = ".setDbmsId(\"";
  protected final String TEXT_283 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_284 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_285 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_286 = ".add(\"";
  protected final String TEXT_287 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_288 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_289 = " = ";
  protected final String TEXT_290 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_291 = "; i <= rsmd_";
  protected final String TEXT_292 = ".getColumnCount()-";
  protected final String TEXT_293 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_294 = ".contains(rsmd_";
  protected final String TEXT_295 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_296 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_297 = ".setName(rsmd_";
  protected final String TEXT_298 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setDbName(rsmd_";
  protected final String TEXT_300 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_302 = "\", rsmd_";
  protected final String TEXT_303 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_304 = ".getPrecision(i), rsmd_";
  protected final String TEXT_305 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setDbType(rsmd_";
  protected final String TEXT_307 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_336 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_337 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_363 = " = (List)rs_";
  protected final String TEXT_364 = ".getObject(";
  protected final String TEXT_365 = "column_index_";
  ...
  protected final String TEXT_371 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_372 = NL + "                                    ";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = " = new Geometry(wktValue);";
  protected final String TEXT_375 = NL + "                                        ";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = ".setEPSG(";
  protected final String TEXT_378 = ");";
  protected final String TEXT_379 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "                                  ";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = "=dcg_";
  protected final String TEXT_383 = ";";
  protected final String TEXT_384 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_385 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_386 = " = ";
  protected final String TEXT_387 = "; i_";
  protected final String TEXT_388 = "  <= rsmd_";
  protected final String TEXT_389 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_401 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = ", rs_";
  protected final String TEXT_404 = ", fixedColumnCount_";
  protected final String TEXT_405 = ",list_";
  ...
  protected final String TEXT_412 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = ", rs_";
  protected final String TEXT_415 = ", fixedColumnCount_";
  protected final String TEXT_416 = ");";
  protected final String TEXT_417 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_418 = ".getObject(";
  protected final String TEXT_419 = "column_index_";
  protected final String TEXT_420 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_421 = ".";
  protected final String TEXT_422 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_434 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_435 = " - Content of the record \" + nb_line_";
  protected final String TEXT_436 = " + \": \" + log4jSb_";
  protected final String TEXT_437 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_438 = ".delete(0,log4jSb_";
