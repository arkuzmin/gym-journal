...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_40 = ", userName_";
  protected final String TEXT_41 = ", password_";
  protected final String TEXT_42 = ");" + NL + "\t";
  protected final String TEXT_43 = NL + "\t\tString atnParams_";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_46 = " = atnParams_";
  protected final String TEXT_47 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_48 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_49 = ".put(\"user\",userName_";
  protected final String TEXT_50 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_51 = ".put(\"password\",password_";
  protected final String TEXT_52 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_53 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_54 = ".getBytes()));" + NL + "\t  " + NL + "\t\tconn_";
  protected final String TEXT_55 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_56 = ", atnParamsPrope_";
  ...
  protected final String TEXT_80 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_81 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_82 = " = tableNameForSearch_";
  protected final String TEXT_83 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_84 = " = tableNameForSearch_";
  protected final String TEXT_85 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_86 = " = dbMetaData_";
  protected final String TEXT_87 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_88 = ", tableNameForSearch_";
  protected final String TEXT_89 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_90 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_91 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_92 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_102 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_107 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_108 = ") || dbschema_";
  protected final String TEXT_109 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_120 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_124 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_125 = ".equals(schema_";
  protected final String TEXT_126 = ") || (schema_";
  protected final String TEXT_127 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_128 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_137 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_138 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_139 = " == null || dbschema_";
  protected final String TEXT_140 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_147 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_148 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_149 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_164 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_179 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_190 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_202 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_208 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_228 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_229 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_230 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_231 = " " + NL;
  protected final String TEXT_232 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_233 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_234 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_235 = " + \";HDR=";
  ...
  protected final String TEXT_240 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_241 = ".execute(bulkInsert_";
  protected final String TEXT_242 = ");" + NL + "" + NL + "\tstmt_";
