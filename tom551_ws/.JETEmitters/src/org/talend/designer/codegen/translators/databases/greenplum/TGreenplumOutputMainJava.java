...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_180 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_213 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_214 = " = deletedCount_";
  ...
  protected final String TEXT_243 = NL + "                log4jSb_";
  protected final String TEXT_244 = ".append(";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = ");";
  protected final String TEXT_247 = NL + "                \tlog4jSb_";
  protected final String TEXT_248 = ".append(\"|\");";
  protected final String TEXT_249 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_250 = " - Writing the record \" + nb_line_";
  protected final String TEXT_251 = " + \" \" + log4jSb_";
  protected final String TEXT_252 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_253 = ".delete(0,log4jSb_";
  protected final String TEXT_254 = ".length());" + NL + "\t\t";
  protected final String TEXT_255 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_266 = NL + "                commitCounter_";
  protected final String TEXT_267 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_268 = "<=commitCounter_";
  protected final String TEXT_269 = ") {" + NL + "                " + NL + "\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_271 = " - Starting to commit \" + commitCounter_";
  protected final String TEXT_272 = " + \" records.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_276 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_277 = NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_278 = "=0;" + NL + "        " + NL + "                }";
