...
public class TSAPCommitMainJava
{
  ...
  protected final String TEXT_20 = NL + "\t\t\tif(dest_";
  protected final String TEXT_21 = " == null){" + NL + "\t\t\t\tdest_";
  protected final String TEXT_22 = " = com.sap.conn.jco.JCoDestinationManager.getDestination(";
  protected final String TEXT_23 = ");" + NL + "\t\t\t}";
  protected final String TEXT_24 = NL + "\tif(dest_";
  protected final String TEXT_25 = " != null)" + NL + "\t{" + NL + "\t\tcom.sap.conn.jco.JCoRepository repository_";
  protected final String TEXT_26 = " = dest_";
  protected final String TEXT_27 = ".getRepository();" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoFunctionTemplate functionTemplate_";
  protected final String TEXT_28 = " = repository_";
  protected final String TEXT_29 = ".getFunctionTemplate(\"BAPI_TRANSACTION_COMMIT\");" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoFunction function_";
  protected final String TEXT_30 = " = functionTemplate_";
  protected final String TEXT_31 = ".getFunction();" + NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\tfunction_";
  protected final String TEXT_32 = ".execute(dest_";
  protected final String TEXT_33 = ");" + NL + "\t\t}catch (java.lang.Exception e_";
  protected final String TEXT_34 = ") {" + NL + "\t\t\tcom.sap.conn.jco.JCoContext.end(dest_";
  protected final String TEXT_35 = ");" + NL + "\t\t    throw new RuntimeException(e_";
  protected final String TEXT_36 = ".getMessage());" + NL + "\t\t}";
  protected final String TEXT_37 = NL + "\t\t";
  protected final String TEXT_38 = NL + "\t\t\t";
  protected final String TEXT_39 = NL + "\t\t    \tcom.sap.mw.jco.JCO.releaseClient(client_";
  protected final String TEXT_40 = ");" + NL + "\t\t    ";
  protected final String TEXT_41 = NL + "\t\t\t\tcom.sap.conn.jco.JCoContext.end(dest_";
