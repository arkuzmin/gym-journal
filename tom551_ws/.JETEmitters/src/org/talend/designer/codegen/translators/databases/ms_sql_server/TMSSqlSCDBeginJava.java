...
public class TMSSqlSCDBeginJava {
  ...
  protected final String TEXT_329 = NL + "    String dbPwd_";
  protected final String TEXT_330 = " = decryptedPassword_";
  protected final String TEXT_331 = ";" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_332 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_333 = ",dbUser_";
  protected final String TEXT_334 = ",dbPwd_";
  protected final String TEXT_335 = ");";
  protected final String TEXT_336 = NL + NL + "    if(dbschema_";
  protected final String TEXT_337 = " == null || dbschema_";
  protected final String TEXT_338 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_339 = " = ";
  protected final String TEXT_340 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_341 = " = dbschema_";
  protected final String TEXT_342 = " + \"].[\" + ";
  protected final String TEXT_343 = ";" + NL + "    }" + NL + "\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_344 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();\t" + NL + "    String tmpValue_";
  protected final String TEXT_345 = " = null;    ";
  protected final String TEXT_346 = NL + "        String searching_";
  protected final String TEXT_347 = " = \"";
  protected final String TEXT_348 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_349 = " = conn_";
  protected final String TEXT_350 = ".prepareStatement(searching_";
  protected final String TEXT_351 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_352 = " = null;";
  protected final String TEXT_353 = NL + "        String search_";
  protected final String TEXT_354 = " = \"";
  protected final String TEXT_355 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_356 = " = conn_";
  protected final String TEXT_357 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_358 = " = statement_";
  protected final String TEXT_359 = ".executeQuery(search_";
  protected final String TEXT_360 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_361 = ", SCDStruct_";
  protected final String TEXT_362 = "> cache_";
  protected final String TEXT_363 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_364 = ", SCDStruct_";
  protected final String TEXT_365 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_366 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_367 = " sk_";
  protected final String TEXT_368 = " = new SCDSK_";
  protected final String TEXT_369 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_370 = " row_";
  protected final String TEXT_371 = " = new SCDStruct_";
  protected final String TEXT_372 = "();";
  protected final String TEXT_373 = NL + "                    tmpValue_";
  protected final String TEXT_374 = " = resultSet_";
  protected final String TEXT_375 = ".getString(";
  protected final String TEXT_376 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_377 = " != null && tmpValue_";
  protected final String TEXT_378 = ".length() > 0) {";
  protected final String TEXT_379 = NL + "                        ";
  protected final String TEXT_380 = ".";
  protected final String TEXT_381 = " = tmpValue_";
  protected final String TEXT_382 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_383 = NL + "                            if(tmpValue_";
  protected final String TEXT_384 = " == null) {";
  protected final String TEXT_385 = NL + "                                ";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = " = null;" + NL + "                            } else {";
  protected final String TEXT_388 = NL + "                                ";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_391 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_392 = ")) {";
  protected final String TEXT_393 = NL + "                                ";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_396 = "' in '";
  protected final String TEXT_397 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_398 = NL + "                    }";
  protected final String TEXT_399 = NL + "                     ";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " = mssqlGTU_";
  protected final String TEXT_402 = ".getDate(resultSet_";
  protected final String TEXT_403 = ".getMetaData(), resultSet_";
  protected final String TEXT_404 = ", ";
  protected final String TEXT_405 = ");";
  protected final String TEXT_406 = NL + "                    if(resultSet_";
  protected final String TEXT_407 = ".getObject(";
  protected final String TEXT_408 = ") != null) {";
  protected final String TEXT_409 = NL + "                        ";
  protected final String TEXT_410 = ".";
  protected final String TEXT_411 = " = resultSet_";
  protected final String TEXT_412 = ".get";
  protected final String TEXT_413 = "(";
  protected final String TEXT_414 = ");" + NL + "                    }";
  protected final String TEXT_415 = NL + "\t\t\t mssqlSCD_Util_";
  protected final String TEXT_416 = ".getSearchResult_";
  protected final String TEXT_417 = "(resultSet_";
  protected final String TEXT_418 = ", sk_";
  protected final String TEXT_419 = ", row_";
  protected final String TEXT_420 = ", tmpValue_";
  protected final String TEXT_421 = ", mssqlGTU_";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL + "            cache_";
  protected final String TEXT_424 = ".put(sk_";
  protected final String TEXT_425 = ", row_";
  protected final String TEXT_426 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_427 = ".close();" + NL + "        statement_";
  protected final String TEXT_428 = ".close();";
  protected final String TEXT_429 = NL + "            System.out.println(\"[";
  protected final String TEXT_430 = "] comparison cache loaded\");";
  protected final String TEXT_431 = NL + "        ";
  protected final String TEXT_432 = " nextSurrogateKey_";
  protected final String TEXT_433 = " = 1;";
  protected final String TEXT_434 = NL + "            if(cache_";
  protected final String TEXT_435 = ".size() > 0) {";
  protected final String TEXT_436 = NL + "        String tmpQuery_";
  protected final String TEXT_437 = " = \"SELECT MAX([";
  protected final String TEXT_438 = "]) FROM [\" + tableName_";
  protected final String TEXT_439 = " + \"]\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_440 = " = conn_";
  protected final String TEXT_441 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_442 = " = tmpStmt_";
  protected final String TEXT_443 = ".executeQuery(tmpQuery_";
  protected final String TEXT_444 = ");";
  protected final String TEXT_445 = NL + "        if(tmpRS_";
  protected final String TEXT_446 = ".next() && tmpRS_";
  protected final String TEXT_447 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_448 = " = tmpRS_";
  protected final String TEXT_449 = ".get";
  protected final String TEXT_450 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_451 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_452 = ".close();";
  protected final String TEXT_453 = NL + "            }            ";
  protected final String TEXT_454 = NL + "    String insertionSQL_";
  protected final String TEXT_455 = " = \"";
  protected final String TEXT_456 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_457 = " = conn_";
  protected final String TEXT_458 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_459 = ");";
  protected final String TEXT_460 = NL + "            insertionStatement_";
  protected final String TEXT_461 = ".setTimestamp(";
  protected final String TEXT_462 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_463 = "\")));";
  protected final String TEXT_464 = NL + "            insertionStatement_";
  protected final String TEXT_465 = ".setNull(";
  protected final String TEXT_466 = ", java.sql.Types.DATE);";
  protected final String TEXT_467 = NL + "            insertionStatement_";
  protected final String TEXT_468 = ".setTimestamp(";
  protected final String TEXT_469 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_470 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_471 = NL + "        String updateSQLForType1_";
  protected final String TEXT_472 = " = \"";
  protected final String TEXT_473 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_474 = " = conn_";
  protected final String TEXT_475 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_476 = ");        ";
  protected final String TEXT_477 = NL + "        String updateSQLForType2_";
  protected final String TEXT_478 = " = \"";
  protected final String TEXT_479 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_480 = " = conn_";
  protected final String TEXT_481 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_482 = ");";
  protected final String TEXT_483 = NL + "            updateForType2_";
  protected final String TEXT_484 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_485 = "\")));";
  protected final String TEXT_486 = NL + "        String updateSQLForType3_";
  protected final String TEXT_487 = " = \"";
  protected final String TEXT_488 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_489 = " = conn_";
  protected final String TEXT_490 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_491 = ");";
  protected final String TEXT_492 = NL + "    ";
  protected final String TEXT_493 = NL + "        SCDSK_";
  protected final String TEXT_494 = " lookUpKey_";
  protected final String TEXT_495 = " = null;        ";
  protected final String TEXT_496 = NL + "    SCDStruct_";
  protected final String TEXT_497 = " lookUpValue_";
