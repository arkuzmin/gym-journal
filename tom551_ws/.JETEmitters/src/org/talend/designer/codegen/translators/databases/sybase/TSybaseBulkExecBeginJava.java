...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_39 = NL + "    String pass_";
  protected final String TEXT_40 = " = decryptedPassword_";
  protected final String TEXT_41 = ";" + NL + "    String host_";
  protected final String TEXT_42 = " = ";
  protected final String TEXT_43 = ";";
  protected final String TEXT_44 = NL + "    \tString port_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";";
  protected final String TEXT_47 = NL + "\t\t\tString url_";
  protected final String TEXT_48 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_49 = " + \":\" + port_";
  protected final String TEXT_50 = " + \"/\" + db_";
  protected final String TEXT_51 = ";";
  protected final String TEXT_52 = NL + "\t\t\tString url_";
  protected final String TEXT_53 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_54 = " + \":\" + port_";
  protected final String TEXT_55 = " + \"/\" + db_";
  protected final String TEXT_56 = " + \"?\" + ";
  protected final String TEXT_57 = ";";
  protected final String TEXT_58 = NL + "   \t \tjava.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "    \tjava.sql.Connection conn_";
  protected final String TEXT_59 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_60 = ", user_";
  protected final String TEXT_61 = ", pass_";
  protected final String TEXT_62 = ");";
  protected final String TEXT_63 = NL + "if(dbschema_";
  ...
  protected final String TEXT_90 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_91 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_92 = " = tableNameForSearch_";
  protected final String TEXT_93 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  ...
  protected final String TEXT_115 = ".equalsIgnoreCase(";
  protected final String TEXT_116 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_117 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_118 = ") || dbschema_";
  protected final String TEXT_119 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_130 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  protected final String TEXT_131 = " = rsTable_";
  protected final String TEXT_132 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_133 = ".equals(";
  protected final String TEXT_134 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_135 = ".equals(schema_";
  protected final String TEXT_136 = ") || (schema_";
  protected final String TEXT_137 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_138 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_147 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_148 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_149 = " == null || dbschema_";
  protected final String TEXT_150 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_153 = " = stmtSchema_";
  protected final String TEXT_154 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_155 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_156 = " = rsSchema_";
  protected final String TEXT_157 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_158 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_159 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_173 = " ==null || dbschema_";
  protected final String TEXT_174 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_175 = ".equals";
  protected final String TEXT_176 = "IgnoreCase";
  protected final String TEXT_177 = "(schema_";
  ...
  protected final String TEXT_212 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_216 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_219 = ".executeUpdate(\"";
  protected final String TEXT_220 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_221 = ".close();";
  protected final String TEXT_222 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_225 = " = stmtTruncCount_";
  protected final String TEXT_226 = ".executeQuery(\"";
  protected final String TEXT_227 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_230 = ".executeUpdate(\"";
  protected final String TEXT_231 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_232 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_233 = " += rsTruncCount_";
  protected final String TEXT_234 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_235 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_236 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_237 = ".close();            ";
  protected final String TEXT_238 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_239 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_240 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_241 = NL + "\t";
  protected final String TEXT_242 = NL + NL + "StringBuilder command_";
  protected final String TEXT_243 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_244 = ".append(";
  protected final String TEXT_245 = " + \" \");";
  protected final String TEXT_246 = NL + "    String tmpTableName_";
  protected final String TEXT_247 = " = tableName_";
  protected final String TEXT_248 = ";" + NL + "    tableName_";
  protected final String TEXT_249 = " = \"tmp_";
  protected final String TEXT_250 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_251 = " != null && dbschema_";
  protected final String TEXT_252 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_253 = "=dbschema_";
  protected final String TEXT_254 = " + \".\" + tableName_";
  protected final String TEXT_255 = ";" + NL + "    }";
  protected final String TEXT_256 = NL + "if(dbschema_";
  protected final String TEXT_257 = " != null && dbschema_";
  protected final String TEXT_258 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_259 = ".append(db_";
  protected final String TEXT_260 = " + \".\" + tableName_";
  protected final String TEXT_261 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_262 = ".append(db_";
  protected final String TEXT_263 = " + \"..\" + tableName_";
  protected final String TEXT_264 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_265 = ".append(\" in \" + ";
  protected final String TEXT_266 = ");" + NL + "String headRow_";
  protected final String TEXT_267 = " = ";
  protected final String TEXT_268 = ";" + NL + "if(headRow_";
  protected final String TEXT_269 = " != null && headRow_";
  protected final String TEXT_270 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_271 = ".append(\" -F \" + headRow_";
  protected final String TEXT_272 = ");" + NL + "}" + NL;
  protected final String TEXT_273 = NL + "\tcommand_";
  protected final String TEXT_274 = ".append(\" -b \" + ";
  protected final String TEXT_275 = ");";
  protected final String TEXT_276 = NL + NL + "command_";
  protected final String TEXT_277 = ".append(\" -t \" + ";
  protected final String TEXT_278 = ");" + NL + "command_";
  protected final String TEXT_279 = ".append(\" -r \" + ";
  protected final String TEXT_280 = ");" + NL + "command_";
  protected final String TEXT_281 = ".append(\" -c -U \" + user_";
  protected final String TEXT_282 = " + \" -P \" + pass_";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + "command_";
  protected final String TEXT_285 = ".append(\" -I \" + ";
  protected final String TEXT_286 = ");";
  protected final String TEXT_287 = NL + "    command_";
  protected final String TEXT_288 = ".append(\" -S \" + ";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "\tcommand_";
  protected final String TEXT_291 = ".append(\" -S \" + host_";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL + "String encoding_";
  protected final String TEXT_294 = " = ";
  protected final String TEXT_295 = ";" + NL + "if(encoding_";
  protected final String TEXT_296 = " != null && encoding_";
  protected final String TEXT_297 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_298 = ".append(\" -J \" + encoding_";
  protected final String TEXT_299 = ");" + NL + "}" + NL;
  protected final String TEXT_300 = NL + "    Runtime runtime_";
  protected final String TEXT_301 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_302 = " = runtime_";
  protected final String TEXT_303 = ".exec(command_";
  protected final String TEXT_304 = ".toString());";
  protected final String TEXT_305 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_308 = ".execute(\"";
  protected final String TEXT_309 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_310 = ".close();            " + NL + "        Runtime runtime_";
  protected final String TEXT_311 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_312 = " = runtime_";
  protected final String TEXT_313 = ".exec(command_";
  protected final String TEXT_314 = ".toString());       ";
  protected final String TEXT_315 = NL + NL + "Thread normal_";
  protected final String TEXT_316 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_317 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_318 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_319 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_320 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_321 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_322 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_323 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_324 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_325 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_326 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_327 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_328 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_329 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_330 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_331 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_332 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_333 = ".interrupt();" + NL + "error_";
  protected final String TEXT_334 = ".interrupt();" + NL;
