...
public class Subprocess_headerJava
{
  ...
  protected final String TEXT_214 = "_ParallelThread(" + NL + "\t\t\t\t\tjava.util.Map<String, Object> globalMap," + NL + "\t\t\t\t\tObject[] lockWrite) {" + NL + "\t\t\t\tsuper(globalMap, lockWrite);" + NL + "\t\t\t}" + NL + "\t\t\tboolean isRunning = false;" + NL + "\t\t\tString iterateId = \"\";" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\tint iterateLoop = 0;" + NL + "\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t\t" + NL + "\t\t\t\tthis.isRunning = true;" + NL + "\t\t\t\tString currentComponent = \"\";" + NL + "\t\t\t\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\ttry{" + NL + "\t";
  protected final String TEXT_217 = NL + "\t\tString currentVirtualComponent = null;";
  protected final String TEXT_218 = NL + "\t";
  protected final String TEXT_219 = NL + "\t\tString iterateId = \".\" + globalMap.get(\"";
  protected final String TEXT_220 = "_THREAD_ID\");" + NL + "\t";
  protected final String TEXT_221 = NL + "\t\tString iterateId = \"\";" + NL + "\t";
  protected final String TEXT_222 = NL + "\t";
  protected final String TEXT_223 = NL + "\t\tint iterateLoop = 0;" + NL + "\t";
  protected final String TEXT_224 = NL + "\tString currentComponent = \"\";" + NL + "\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t" + NL + "\ttry {" + NL + "\t" + NL + "\t\t\tString currentMethodName = new java.lang.Exception().getStackTrace()[0].getMethodName();" + NL + "\t\t\tboolean resumeIt = currentMethodName.equals(resumeEntryMethodName);" + NL + "\t\t\tif( resumeEntryMethodName == null || resumeIt || globalResumeTicket){//start the resume" + NL + "\t\t\t\tglobalResumeTicket = true;" + NL;
  protected final String TEXT_225 = NL + "    \t\t\t//resumeUtil.addLog(\"CHECKPOINT\", \"CONNECTION:";
  protected final String TEXT_226 = ":";
  protected final String TEXT_227 = ":";
  protected final String TEXT_228 = "\", \"\", Thread.currentThread().getId() + \"\", \"\", \"\", \"\", \"\", \"\");" + NL + "    \t\t";
  protected final String TEXT_229 = NL + "\t\t\t\t\t";
  protected final String TEXT_230 = NL + "\t\t";
  protected final String TEXT_231 = "Process(globalMap);";
