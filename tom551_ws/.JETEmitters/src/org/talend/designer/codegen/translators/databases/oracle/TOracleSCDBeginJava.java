...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_41 = NL + "\t\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_52 = ".put(\"user\",";
  protected final String TEXT_53 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_54 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_57 = ".getBytes()));" + NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_58 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_59 = ", atnParamsPrope_";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "        ";
  protected final String TEXT_62 = NL + "    String tableName_";
  protected final String TEXT_63 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_64 = " == null || schema_";
  ...
  protected final String TEXT_79 = ".getMetaData();";
  protected final String TEXT_80 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_81 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_82 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_83 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_84 = " = ((String)";
  protected final String TEXT_85 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_86 = " = schema_";
  protected final String TEXT_87 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_90 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_91 = " = tableName4Search_";
  protected final String TEXT_92 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_93 = " = tableName4Search_";
  protected final String TEXT_94 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_95 = " = dbMetaData_";
  protected final String TEXT_96 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_97 = ", tableName4Search_";
  protected final String TEXT_98 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_99 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_100 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_101 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_102 = ".close();" + NL + "\t            ";
  protected final String TEXT_103 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_109 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_120 = NL + "    " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_121 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_122 = " = null;    ";
  protected final String TEXT_123 = NL + "        String searching_";
  protected final String TEXT_124 = " = \"";
  protected final String TEXT_125 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_126 = " = connection_";
  protected final String TEXT_127 = ".prepareStatement(searching_";
  protected final String TEXT_128 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_129 = " = null;";
  protected final String TEXT_130 = NL + "        String search_";
  protected final String TEXT_131 = " = \"";
  protected final String TEXT_132 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_133 = " = connection_";
  protected final String TEXT_134 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_135 = " = statement_";
  protected final String TEXT_136 = ".executeQuery(search_";
  protected final String TEXT_137 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_138 = ", SCDStruct_";
  protected final String TEXT_139 = "> cache_";
  protected final String TEXT_140 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_141 = ", SCDStruct_";
  protected final String TEXT_142 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_143 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_144 = " sk_";
  protected final String TEXT_145 = " = new SCDSK_";
  protected final String TEXT_146 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_147 = " row_";
  protected final String TEXT_148 = " = new SCDStruct_";
  protected final String TEXT_149 = "();";
  protected final String TEXT_150 = NL + "                    tmpValue_";
  protected final String TEXT_151 = " = resultSet_";
  protected final String TEXT_152 = ".getString(";
  protected final String TEXT_153 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_154 = " != null && tmpValue_";
  protected final String TEXT_155 = ".length() > 0) {";
  protected final String TEXT_156 = NL + "                        ";
  protected final String TEXT_157 = ".";
  protected final String TEXT_158 = " = tmpValue_";
  protected final String TEXT_159 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_160 = NL + "                            if(tmpValue_";
  protected final String TEXT_161 = " == null) {";
  protected final String TEXT_162 = NL + "                                ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = null;" + NL + "                            } else {";
  protected final String TEXT_165 = NL + "                                ";
  protected final String TEXT_166 = ".";
  protected final String TEXT_167 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_168 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_169 = ")) {";
  protected final String TEXT_170 = NL + "                                ";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_173 = "' in '";
  protected final String TEXT_174 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_175 = NL + "                    }";
  protected final String TEXT_176 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_177 = ").getTIMESTAMPTZ(";
  protected final String TEXT_178 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_181 = ").getTIMESTAMPTZ(";
  protected final String TEXT_182 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_185 = NL + "\t                    timestamp_";
  protected final String TEXT_186 = " = resultSet_";
  protected final String TEXT_187 = ".getTimestamp(";
  protected final String TEXT_188 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_189 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = " = new java.util.Date(timestamp_";
  protected final String TEXT_192 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = " = null;" + NL + "\t                    }";
  protected final String TEXT_195 = NL + "                    if(resultSet_";
  protected final String TEXT_196 = ".getObject(";
  protected final String TEXT_197 = ") != null) {";
  protected final String TEXT_198 = NL + "                        ";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = resultSet_";
  protected final String TEXT_201 = ".get";
  protected final String TEXT_202 = "(";
  protected final String TEXT_203 = ");" + NL + "                    }";
  protected final String TEXT_204 = NL + "            cache_";
  protected final String TEXT_205 = ".put(sk_";
  protected final String TEXT_206 = ", row_";
  protected final String TEXT_207 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_208 = ".close();" + NL + "        statement_";
  protected final String TEXT_209 = ".close();";
  protected final String TEXT_210 = NL + "            System.out.println(\"[";
  protected final String TEXT_211 = "] comparison cache loaded\");";
  protected final String TEXT_212 = NL + "        ";
  protected final String TEXT_213 = " nextSurrogateKey_";
  protected final String TEXT_214 = " = 1;";
  protected final String TEXT_215 = NL + "            if(cache_";
  protected final String TEXT_216 = ".size() > 0) {";
  protected final String TEXT_217 = NL + "        String tmpQuery_";
  protected final String TEXT_218 = " = \"SELECT MAX(";
  protected final String TEXT_219 = ") FROM \" + tableName_";
  protected final String TEXT_220 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_221 = " = connection_";
  protected final String TEXT_222 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_223 = " = tmpStmt_";
  protected final String TEXT_224 = ".executeQuery(tmpQuery_";
  protected final String TEXT_225 = ");";
  protected final String TEXT_226 = NL + "        if(tmpRS_";
  protected final String TEXT_227 = ".next() && tmpRS_";
  protected final String TEXT_228 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_229 = " = tmpRS_";
  protected final String TEXT_230 = ".get";
  protected final String TEXT_231 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_232 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_233 = ".close();";
  protected final String TEXT_234 = NL + "            }            ";
  protected final String TEXT_235 = NL + "    String insertionSQL_";
  protected final String TEXT_236 = " = \"";
  protected final String TEXT_237 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_238 = " = connection_";
  protected final String TEXT_239 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_240 = ");";
  protected final String TEXT_241 = NL + "            insertionStatement_";
  protected final String TEXT_242 = ".setTimestamp(";
  protected final String TEXT_243 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_244 = "\")));";
  protected final String TEXT_245 = NL + "            insertionStatement_";
  protected final String TEXT_246 = ".setNull(";
  protected final String TEXT_247 = ", java.sql.Types.DATE);";
  protected final String TEXT_248 = NL + "            insertionStatement_";
  protected final String TEXT_249 = ".setTimestamp(";
  protected final String TEXT_250 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_251 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_252 = NL + "        String updateSQLForType1_";
  protected final String TEXT_253 = " = \"";
  protected final String TEXT_254 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_255 = " = connection_";
  protected final String TEXT_256 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_257 = ");        ";
  protected final String TEXT_258 = NL + "        String updateSQLForType2_";
  protected final String TEXT_259 = " = \"";
  protected final String TEXT_260 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_261 = " = connection_";
  protected final String TEXT_262 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_263 = ");";
  protected final String TEXT_264 = NL + "            updateForType2_";
  protected final String TEXT_265 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_266 = "\")));";
  protected final String TEXT_267 = NL + "        String updateSQLForType3_";
  protected final String TEXT_268 = " = \"";
  protected final String TEXT_269 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_270 = " = connection_";
  protected final String TEXT_271 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_272 = ");";
  protected final String TEXT_273 = NL + "    ";
  protected final String TEXT_274 = NL + "        SCDSK_";
  protected final String TEXT_275 = " lookUpKey_";
  protected final String TEXT_276 = " = null;        ";
  protected final String TEXT_277 = NL + "    SCDStruct_";
  protected final String TEXT_278 = " lookUpValue_";
