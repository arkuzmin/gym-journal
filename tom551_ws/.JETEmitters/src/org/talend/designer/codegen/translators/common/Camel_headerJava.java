...
public class Camel_headerJava
{
  ...
  protected final String TEXT_48 = "\t\t\t" + NL + "\t\t\t\t// CXF endpoint for ";
  protected final String TEXT_49 = NL + "\t\t\t\torg.apache.camel.component.cxf.CxfEndpoint ";
  protected final String TEXT_50 = " = getCxfEndpoint(";
  ...
  protected final String TEXT_61 = ".setCxfBinding(new CXFConsumerBinding(";
  protected final String TEXT_62 = "));";
  protected final String TEXT_63 = NL + "\t\t\t\t";
  protected final String TEXT_64 = ".getFeatures().add(new org.talend.esb.policy.correlation.feature.CorrelationIDFeature());";
  protected final String TEXT_65 = NL + "\t\t\t\t// Add Service Locator Service to ";
  protected final String TEXT_66 = NL + "\t\t\t\tif (null != bundleContext) {" + NL + "\t\t\t\t\torg.talend.esb.servicelocator.cxf.LocatorFeature locatorFeature = new org.talend.esb.servicelocator.cxf.LocatorFeature();" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\t\t\tjava.util.Map<String, String> slCustomProps_";
  protected final String TEXT_68 = " = new java.util.HashMap<String, String>();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\t\tslCustomProps_";
  protected final String TEXT_70 = ".put(";
  protected final String TEXT_71 = ", ";
  protected final String TEXT_72 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\t\t\t\tlocatorFeature.setRequiredEndpointProperties(slCustomProps_";
  protected final String TEXT_75 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t\t\t\tlocatorFeature.setAvailableEndpointProperties(slCustomProps_";
  protected final String TEXT_77 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\t\t";
  protected final String TEXT_79 = NL + NL + "\t\t\t\t\t";
  protected final String TEXT_80 = ".getFeatures().add(locatorFeature);" + NL + "\t\t\t\t}";
  protected final String TEXT_81 = NL + "\t\t\t\t// Add Service Activity Monitor Service to ";
  protected final String TEXT_82 = NL + "\t\t\t\tif (eventFeature != null) {" + NL + "\t\t\t\t\t((org.apache.camel.component.cxf.CxfEndpoint)";
  protected final String TEXT_83 = ").getFeatures().add(new FeatureWrapper(eventFeature));" + NL + "\t\t\t\t}";
  ...
  protected final String TEXT_91 = NL + "\t\t\torg.apache.camel.component.file.remote.RemoteFileEndpoint<?> ";
  protected final String TEXT_92 = " = getFtpEndpoint(";
  ...
  protected final String TEXT_105 = NL + "\t\t\torg.apache.camel.component.mail.MailEndpoint ";
  protected final String TEXT_106 = " = getMailEndpoint(";
  ...
  protected final String TEXT_115 = NL + "\t\t\t\t\t\torg.apache.camel.spi.AggregationRepository repo_";
  protected final String TEXT_116 = " = new ";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\torg.apache.camel.spi.RecoverableAggregationRepository repo_";
  protected final String TEXT_119 = " = new ";
  protected final String TEXT_120 = ";";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_122 = ".setUseRecovery(true);" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_123 = ".setMaximumRedeliveries(";
  protected final String TEXT_124 = ");" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_125 = ".setDeadLetterUri(";
  protected final String TEXT_126 = ");" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_127 = ".setRecoveryInterval(";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "\t\t\t\t\t\t\torg.apache.camel.component.hawtdb.HawtDBAggregationRepository repo_";
  protected final String TEXT_130 = " = new org.apache.camel.component.hawtdb.HawtDBAggregationRepository(\"";
  protected final String TEXT_131 = "\", ";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "\t\t\t\t\t\t\torg.apache.camel.component.hawtdb.HawtDBAggregationRepository repo_";
  protected final String TEXT_134 = " = new org.apache.camel.component.hawtdb.HawtDBAggregationRepository(\"";
  protected final String TEXT_135 = "\");";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_137 = ".setUseRecovery(true);" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_138 = ".setMaximumRedeliveries(";
  protected final String TEXT_139 = ");" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_140 = ".setDeadLetterUri(";
  protected final String TEXT_141 = ");" + NL + "\t\t\t\t\t\t\trepo_";
  protected final String TEXT_142 = ".setRecoveryInterval(";
  ...
  protected final String TEXT_165 = NL + "\t\tMap<String, String> ";
  protected final String TEXT_166 = "NSMap = new HashMap<String, String>();" + NL + "\t\t{";
  protected final String TEXT_167 = NL + "\t\t\t\t";
  protected final String TEXT_168 = "NSMap.put(";
  protected final String TEXT_169 = ", ";
  protected final String TEXT_170 = ");";
  protected final String TEXT_171 = NL + "\t\t}";
  protected final String TEXT_172 = NL + "\t\tMap<String, String> ";
  protected final String TEXT_173 = "NSMap = new HashMap<String, String>();" + NL + "\t\t{";
  protected final String TEXT_174 = NL + "\t\t\t\t";
  protected final String TEXT_175 = "NSMap.put(";
  protected final String TEXT_176 = ", ";
  protected final String TEXT_177 = ");";
  protected final String TEXT_178 = NL + "\t\t}";
  protected final String TEXT_179 = NL + "\t\tMap<String, String> ";
  protected final String TEXT_180 = "NSMap = new HashMap<String, String>();" + NL + "\t\t{";
  protected final String TEXT_181 = NL + "\t\t\t\t";
  protected final String TEXT_182 = "NSMap.put(";
  protected final String TEXT_183 = ", ";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t}";
  protected final String TEXT_186 = NL + "\t\torg.apache.camel.Endpoint endpoint_";
  protected final String TEXT_187 = " = endpoint(\"talend:\"+ ";
  protected final String TEXT_188 = "+ \"?context=\" + ";
  protected final String TEXT_189 = "+\"&propagateHeader=";
  protected final String TEXT_190 = "\");";
  protected final String TEXT_191 = NL + "\t\t\torg.apache.camel.Endpoint endpoint_";
  protected final String TEXT_192 = " = endpoint(\"talend:\"+";
  protected final String TEXT_193 = ".class.getName()+\"?context=\"+\"";
  protected final String TEXT_194 = "&propagateHeader=";
  protected final String TEXT_195 = "\");";
  protected final String TEXT_196 = NL + "{" + NL + "\t\tMap <String, String> propertiesMap = new HashMap<String, String>();";
  protected final String TEXT_197 = NL + "\t\t\t\tpropertiesMap.put(";
  protected final String TEXT_198 = ", propertyToString(";
  protected final String TEXT_199 = "));";
  protected final String TEXT_200 = NL + "\t\tendpoint_";
  protected final String TEXT_201 = ".getCamelContext().setProperties(propertiesMap);" + NL + "}";
