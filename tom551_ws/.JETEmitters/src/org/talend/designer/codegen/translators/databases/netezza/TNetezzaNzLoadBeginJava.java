...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_127 = ";" + NL + "\t\tString tableName_";
  ...
  protected final String TEXT_133 = " - Connection attempt to '\" + url_";
  protected final String TEXT_134 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_135 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\tconn_";
  protected final String TEXT_137 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_138 = ", dbUser_";
  protected final String TEXT_139 = ", dbPwd_";
  protected final String TEXT_140 = ");" + NL + "\t\t";
  protected final String TEXT_141 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_142 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_149 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_155 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_159 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_169 = " - Create table '\" + tableName_";
  protected final String TEXT_170 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_171 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_172 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_173 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_175 = " - Failure on DROP_CREATE action, process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure on DROP_CREATE action, process terminated\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_177 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_178 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_182 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_188 = " - Create table '\" + tableName_";
  protected final String TEXT_189 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_191 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_192 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_194 = " - Table '\" + tableName_";
  protected final String TEXT_195 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName_";
  protected final String TEXT_197 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_199 = " - Table '\" + tableName_";
  protected final String TEXT_200 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_229 = ".close();" + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_230 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_232 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_233 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_235 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_237 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_238 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_240 = NL + "                if(whetherExist_";
  protected final String TEXT_241 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_242 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_246 = " - Droping table '\" + tableName_";
  protected final String TEXT_247 = " + \"'.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_248 = NL + "                    \tstmtDrop_";
  protected final String TEXT_249 = ".execute(\"";
  protected final String TEXT_250 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_252 = " - Drop table '\" + tableName_";
  protected final String TEXT_253 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\tstmtDrop_";
  protected final String TEXT_255 = ".close();" + NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_256 = ")" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_258 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_259 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName_";
  protected final String TEXT_261 = "  + \"'. process terminated\");" + NL + "                    \t" + NL + "                    \telse" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_262 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_263 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_264 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_266 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_276 = " - Drop table '\" + tableName_";
  protected final String TEXT_277 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_279 = ".close();" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_280 = "){" + NL + "                \t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_282 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_283 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_284 = NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_285 = "  + \"'. process terminated\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_287 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_288 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_290 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_293 = " = stmtClearCount_";
  ...
  protected final String TEXT_297 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_299 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_305 = " - Truncate table '\" + tableName_";
  protected final String TEXT_306 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_307 = NL + "            while(rsClearCount_";
  protected final String TEXT_308 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_309 = " = rsClearCount_";
  protected final String TEXT_310 = ".getInt(1);" + NL + "            }" + NL + "            stmtClearCount_";
  protected final String TEXT_311 = ".close();" + NL + "\t\t\tstmtClear_";
  protected final String TEXT_312 = ".close();";
  protected final String TEXT_313 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_314 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_318 = " - Clearing table '\" + tableName_";
  protected final String TEXT_319 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_320 = NL + "            \tdeletedCount_";
  protected final String TEXT_321 = " = stmtClear_";
  protected final String TEXT_322 = ".executeUpdate(\"";
  protected final String TEXT_323 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_325 = " - Clear table '\" + tableName_";
  protected final String TEXT_326 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_327 = NL + "            \tstmtClear_";
  protected final String TEXT_328 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_329 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_331 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_332 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName_";
  protected final String TEXT_334 = "  + \"'. process terminated\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_336 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_337 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_339 = NL + "        conn_";
  protected final String TEXT_340 = ".close();";
  protected final String TEXT_341 = NL;
  protected final String TEXT_342 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_343 = " = new StringBuilder(200);" + NL + "\t//final ";
  protected final String TEXT_344 = " " + NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_345 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_346 = ");";
  protected final String TEXT_347 = NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = "; ";
  protected final String TEXT_350 = NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_351 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_352 = " ";
  protected final String TEXT_353 = ",";
  protected final String TEXT_354 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tif((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_357 = ".append(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_358 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_360 = ".append(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_362 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_366 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\t";
  protected final String TEXT_367 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_368 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_369 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_370 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_371 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_372 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_373 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_374 = NL + "\t\t";
  protected final String TEXT_375 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_376 = " - Loading data into database.\");" + NL + "\t\t";
  protected final String TEXT_377 = NL + "\tnzloadThread_";
  protected final String TEXT_378 = ".start();" + NL + "\tnzloadThread_";
  protected final String TEXT_379 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_380 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_381 = ".toString());" + NL + "\t\t";
  protected final String TEXT_382 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_383 = " - Loaded data finished.\");" + NL + "\t\t";
