...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_208 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_268 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_279 = NL + "                commitCounter_";
  protected final String TEXT_280 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_281 = " <= commitCounter_";
  protected final String TEXT_282 = ") {" + NL + "                " + NL + "                \tconn_";
  protected final String TEXT_283 = ".commit();" + NL + "                \t" + NL + "                \tcommitCounter_";
  protected final String TEXT_284 = "=0;" + NL + "                " + NL + "                }" + NL + "        \t";
