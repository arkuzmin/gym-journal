...
public class TDBOutputEndJava
{
  ...
  protected final String TEXT_21 = "\", true);" + NL + "" + NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_58 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_59 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_60 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_61 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_62 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_72 = "_NB_LINE_DELETED\",nb_line_deleted_";
