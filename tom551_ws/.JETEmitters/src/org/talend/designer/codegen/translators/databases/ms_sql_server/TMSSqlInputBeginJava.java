...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_227 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_228 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_229 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_230 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_231 = ", talendToDBArray_";
  protected final String TEXT_232 = "); ";
  protected final String TEXT_233 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_234 = " = (String)globalMap.get(\"";
  protected final String TEXT_235 = "\");";
  protected final String TEXT_236 = NL + "\t\t    String port_";
  protected final String TEXT_237 = " = ";
  protected final String TEXT_238 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_239 = " = ";
  protected final String TEXT_240 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_241 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_242 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_243 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_244 = " += \":\" + ";
  protected final String TEXT_245 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_246 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_247 = " += \"//\" + ";
  protected final String TEXT_248 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_249 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_250 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "\t\t\t";
  protected final String TEXT_254 = ".";
  protected final String TEXT_255 = " = mssqlGTU_";
  protected final String TEXT_256 = ".getDate(rsmd_";
  protected final String TEXT_257 = ", rs_";
  protected final String TEXT_258 = ", ";
  protected final String TEXT_259 = "column_index_";
  protected final String TEXT_260 = ");" + NL + "\t\t\t";
  protected final String TEXT_261 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_262 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_263 = ".getClob(";
  ...
  protected final String TEXT_267 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_268 = " = tNTextImpl_";
  protected final String TEXT_269 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_270 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_271 = NL + "           \t\ttmpContent_";
  protected final String TEXT_272 = " = rs_";
  protected final String TEXT_273 = ".getString(";
  protected final String TEXT_274 = "column_index_";
  protected final String TEXT_275 = ");";
  protected final String TEXT_276 = NL + "            if(tmpContent_";
  protected final String TEXT_277 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_278 = " .contains(rsmd_";
  protected final String TEXT_279 = ".getColumnTypeName(";
  protected final String TEXT_280 = "column_index_";
  protected final String TEXT_281 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_282 = ".";
  protected final String TEXT_283 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_284 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_285 = ".";
  protected final String TEXT_286 = " = tmpContent_";
  protected final String TEXT_287 = ";" + NL + "                }" + NL + "            } else {";
  protected final String TEXT_288 = NL + "                ";
  protected final String TEXT_289 = ".";
  protected final String TEXT_290 = " = null;" + NL + "            }";
  protected final String TEXT_291 = NL + "    " + NL + "\t";
  protected final String TEXT_292 = NL + "\t\t    int nb_line_";
  protected final String TEXT_293 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_294 = " = null;";
  protected final String TEXT_295 = NL + "\t\t        conn_";
  protected final String TEXT_296 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_297 = "\");";
  protected final String TEXT_298 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_299 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_300 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_301 = " = dataSources_";
  protected final String TEXT_302 = ".get(";
  protected final String TEXT_303 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_304 = "\", conn_";
  protected final String TEXT_305 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_306 = NL + "\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_308 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_309 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_310 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_311 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_312 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_313 = NL + NL + "\t\t    ";
  protected final String TEXT_314 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = ";";
  protected final String TEXT_317 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_318 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_319 = " + \"'.\");";
  protected final String TEXT_320 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_321 = "_QUERY\",dbquery_";
  protected final String TEXT_322 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_323 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_324 = " = stmt_";
  protected final String TEXT_325 = ".executeQuery(dbquery_";
  protected final String TEXT_326 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_327 = " = rs_";
  protected final String TEXT_328 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_329 = " = rsmd_";
  protected final String TEXT_330 = ".getColumnCount();" + NL;
  protected final String TEXT_331 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_332 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_333 = ".setDbmsId(\"";
  protected final String TEXT_334 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_335 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_336 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_337 = ".add(\"";
  protected final String TEXT_338 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_339 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_342 = "; i <= rsmd_";
  protected final String TEXT_343 = ".getColumnCount()-";
  protected final String TEXT_344 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_345 = ".contains(rsmd_";
  protected final String TEXT_346 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_347 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_348 = ".setName(rsmd_";
  protected final String TEXT_349 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_350 = ".setDbName(rsmd_";
  protected final String TEXT_351 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_352 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_353 = "\", rsmd_";
  protected final String TEXT_354 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_355 = ".getPrecision(i), rsmd_";
  protected final String TEXT_356 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_357 = ".setDbType(rsmd_";
  protected final String TEXT_358 = ".getColumnTypeName(i));";
  protected final String TEXT_359 = NL + "                \tdcm_";
  protected final String TEXT_360 = ".setFormat(";
  protected final String TEXT_361 = ");";
  protected final String TEXT_362 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_363 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_364 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_365 = ".setLength(rsmd_";
  protected final String TEXT_366 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_367 = ".setLength(rsmd_";
  protected final String TEXT_368 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_369 = NL + "\t\t\tdcm_";
  protected final String TEXT_370 = ".setLength(rsmd_";
  protected final String TEXT_371 = ".getPrecision(i));";
  protected final String TEXT_372 = NL + "                \tdcm_";
  protected final String TEXT_373 = ".setPrecision(rsmd_";
  protected final String TEXT_374 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_375 = ".setNullable(rsmd_";
  protected final String TEXT_376 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_377 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_378 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_379 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_380 = ".metadatas.add(dcm_";
  protected final String TEXT_381 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_382 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_383 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_384 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_385 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_386 = NL + "\t\t    ";
  protected final String TEXT_387 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_388 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_389 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_390 = NL + "\t\t    while (rs_";
  protected final String TEXT_391 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_392 = "++;" + NL + "\t\t        ";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_394 = " = ";
  protected final String TEXT_395 = " + dcg_";
  protected final String TEXT_396 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_398 = " = ";
  protected final String TEXT_399 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_402 = " < ";
  protected final String TEXT_403 = "column_index_";
  protected final String TEXT_404 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = " = ";
  protected final String TEXT_407 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_414 = " = (List)rs_";
  protected final String TEXT_415 = ".getObject(";
  protected final String TEXT_416 = "column_index_";
  protected final String TEXT_417 = ");";
  protected final String TEXT_418 = NL + "\t\t                         ";
  protected final String TEXT_419 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_420 = ".getObject(";
  protected final String TEXT_421 = "column_index_";
  protected final String TEXT_422 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_423 = NL + "                                    ";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = " = new Geometry(wktValue);";
  protected final String TEXT_426 = NL + "                                        ";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = ".setEPSG(";
  protected final String TEXT_429 = ");";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "                                  ";
  protected final String TEXT_432 = ".";
  protected final String TEXT_433 = "=dcg_";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_436 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_437 = " = ";
  protected final String TEXT_438 = "; i_";
  protected final String TEXT_439 = "  <= rsmd_";
  protected final String TEXT_440 = ".getColumnCount(); i_";
  protected final String TEXT_441 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_442 = ".getColumnTypeName(i_";
  protected final String TEXT_443 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_444 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_445 = ".getClob(i_";
  protected final String TEXT_446 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_447 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_448 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_449 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_450 = ".add(tNTextImpl_";
  protected final String TEXT_451 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_452 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = ", rs_";
  protected final String TEXT_455 = ", fixedColumnCount_";
  protected final String TEXT_456 = ",list_";
  protected final String TEXT_457 = ");";
  protected final String TEXT_458 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_459 = ".";
  protected final String TEXT_460 = ", rs_";
  protected final String TEXT_461 = ", fixedColumnCount_";
  protected final String TEXT_462 = ");";
  protected final String TEXT_463 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = ", rs_";
  protected final String TEXT_466 = ", fixedColumnCount_";
  protected final String TEXT_467 = ");";
  protected final String TEXT_468 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_469 = ".getObject(";
  protected final String TEXT_470 = "column_index_";
  protected final String TEXT_471 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_472 = ".";
  protected final String TEXT_473 = " = new Geometry(sb.toString());";
  protected final String TEXT_474 = NL + "\t\t                          ";
  protected final String TEXT_475 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_476 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_477 = ".append(";
  protected final String TEXT_478 = ".";
  protected final String TEXT_479 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_480 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_481 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_482 = NL + "\t\t\t\t\t";
  protected final String TEXT_483 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_484 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_485 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_486 = " - Content of the record \" + nb_line_";
  protected final String TEXT_487 = " + \": \" + log4jSb_";
  protected final String TEXT_488 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_489 = ".delete(0,log4jSb_";
  protected final String TEXT_490 = ".length());" + NL + "\t\t\t\t\t";
  protected final String TEXT_491 = NL + "\t\t                            ";
  protected final String TEXT_492 = ".";
  protected final String TEXT_493 = " = ";
  protected final String TEXT_494 = ".";
  protected final String TEXT_495 = ";" + NL + "\t\t                            ";
  protected final String TEXT_496 = NL + NL + NL + NL + NL;
