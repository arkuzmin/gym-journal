...
public class TELTSybaseOutputMainJava
{
  ...
  protected final String TEXT_55 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_56 = " =null;" + NL;
  protected final String TEXT_57 = "\t" + NL + "\t\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_58 = "+\" (";
  protected final String TEXT_59 = ") (\"+select_query+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_60 = " = conn_";
  protected final String TEXT_61 = ".prepareStatement(insertQuery);";
  protected final String TEXT_62 = NL + "\t\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_63 = "+\" SET ";
  protected final String TEXT_64 = " \"";
  protected final String TEXT_65 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_66 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_67 = " = conn_";
  protected final String TEXT_68 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_69 = NL + "\t\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_70 = "+\" WHERE EXISTS (\"+ select_query.replaceAll(selectQueryColumnsName, \"*\")+\") \" ";
  protected final String TEXT_71 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_72 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_73 = " = conn_";
  protected final String TEXT_74 = ".prepareStatement(deleteQuery);";
  ...
  protected final String TEXT_80 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_";
  protected final String TEXT_81 = " += nb_line_inserted_";
  protected final String TEXT_82 = " = pstmt_";
  protected final String TEXT_83 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_84 = " + \" rows inserted. \\n\");";
  protected final String TEXT_85 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_";
  protected final String TEXT_86 = " += nb_line_update_";
  protected final String TEXT_87 = " = pstmt_";
  protected final String TEXT_88 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_89 = " + \" rows updated. \\n\");";
