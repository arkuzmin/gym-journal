...
public class TWriteXMLFieldOutMainJava {
  ...
  protected final String TEXT_246 = NL + "\tif(txf_";
  protected final String TEXT_247 = ".getLastException()!=null) {" + NL + "\t\tcurrentComponent = txf_";
  protected final String TEXT_248 = ".getCurrentComponent();" + NL + "\t\tthrow txf_";
  protected final String TEXT_249 = ".getLastException();" + NL + "\t}";
  protected final String TEXT_250 = NL + "\tnb_line_";
  protected final String TEXT_251 = "++;" + NL + "\tvalueMap_";
  protected final String TEXT_252 = ".clear();";
  protected final String TEXT_253 = NL + "\tvalueMap_";
  protected final String TEXT_254 = ".put(\"";
  protected final String TEXT_255 = "\",";
  protected final String TEXT_256 = ");";
  protected final String TEXT_257 = NL + "\tflowValues_";
  protected final String TEXT_258 = " = new java.util.HashMap<String,String>();" + NL + "\tflowValues_";
  protected final String TEXT_259 = ".putAll(valueMap_";
  protected final String TEXT_260 = ");" + NL + "\tflows_";
  protected final String TEXT_261 = ".add(flowValues_";
  protected final String TEXT_262 = ");";
  protected final String TEXT_263 = NL + "\t\tString strTemp_";
  protected final String TEXT_264 = " = \"\";";
  protected final String TEXT_265 = "\t\tstrTemp_";
  protected final String TEXT_266 = " = strTemp_";
  protected final String TEXT_267 = " + valueMap_";
  protected final String TEXT_268 = ".get(\"";
  protected final String TEXT_269 = "\")" + NL + "\t\t\t\t\t\t\t+ valueMap_";
  protected final String TEXT_270 = ".get(\"";
  protected final String TEXT_271 = "\").length();";
  protected final String TEXT_272 = NL + "\tif(strCompCache_";
  protected final String TEXT_273 = "==null){" + NL + "\t\tstrCompCache_";
  protected final String TEXT_274 = "=strTemp_";
  protected final String TEXT_275 = ";" + NL + "\t}else{";
  protected final String TEXT_276 = NL + "\t\t//the data read is different from the data read last time. " + NL + "\t\tif(strCompCache_";
  protected final String TEXT_277 = ".equals(strTemp_";
  protected final String TEXT_278 = ")==false){\t";
  protected final String TEXT_279 = NL + "\t\t\tdoc_";
  protected final String TEXT_280 = ".getRootElement().addAttribute(\"xsi:noNamespaceSchemaLocation\", ";
  protected final String TEXT_281 = ");" + NL + "\t\t    doc_";
  protected final String TEXT_282 = ".getRootElement().addNamespace(\"xsi\", \"http://www.w3.org/2001/XMLSchema-instance\");";
  protected final String TEXT_283 = "  " + NL + "    \t\tnestXMLTool_";
  protected final String TEXT_284 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_285 = ".getRootElement());";
  protected final String TEXT_286 = NL + "    \t\tnestXMLTool_";
  protected final String TEXT_287 = ".removeEmptyElement(doc_";
  protected final String TEXT_288 = ".getRootElement());";
  protected final String TEXT_289 = "\t\t\t" + NL + "\t\t\tjava.io.StringWriter strWriter_";
  protected final String TEXT_290 = " = new java.io.StringWriter();\t" + NL + "\t\t\torg.dom4j.io.XMLWriter output_";
  protected final String TEXT_291 = " = new org.dom4j.io.XMLWriter(strWriter_";
  protected final String TEXT_292 = ", format_";
  protected final String TEXT_293 = ");" + NL + "\t\t\toutput_";
  protected final String TEXT_294 = ".write(doc_";
  protected final String TEXT_295 = ");" + NL + "\t\t    output_";
  protected final String TEXT_296 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\tString removeHeader_";
  protected final String TEXT_298 = " = strWriter_";
  protected final String TEXT_299 = ".toString();" + NL + "\t\t\tif(removeHeader_";
  protected final String TEXT_300 = ".indexOf(\"<?xml\") >=0 ){" + NL + "\t\t\t\tremoveHeader_";
  protected final String TEXT_301 = " = removeHeader_";
  protected final String TEXT_302 = ".substring(removeHeader_";
  protected final String TEXT_303 = ".indexOf(\"?>\")+3);" + NL + "\t\t\t}" + NL + "\t\t\tlistGroupby_";
  protected final String TEXT_304 = ".add(removeHeader_";
  protected final String TEXT_305 = ");";
  protected final String TEXT_306 = NL + "                map_";
  protected final String TEXT_307 = ".put(\"json_";
  protected final String TEXT_308 = "\",strWriter_";
  protected final String TEXT_309 = ".toString());" + NL + "                listGroupby_";
  protected final String TEXT_310 = ".add(map_";
  protected final String TEXT_311 = ");";
  protected final String TEXT_312 = NL + "\t\t    listGroupby_";
  protected final String TEXT_313 = ".add(strWriter_";
  protected final String TEXT_314 = ".toString());";
  protected final String TEXT_315 = NL + "\t\t    doc_";
  protected final String TEXT_316 = ".clearContent();" + NL + "\t\t\tneedRoot_";
  protected final String TEXT_317 = " = true;" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_318 = "=0;i_";
  protected final String TEXT_319 = "<orders_";
  protected final String TEXT_320 = ".length;i_";
  protected final String TEXT_321 = "++){" + NL + "\t\t\t\torders_";
  protected final String TEXT_322 = "[i_";
  protected final String TEXT_323 = "] = 0;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif(groupbyList_";
  protected final String TEXT_324 = " != null && groupbyList_";
  protected final String TEXT_325 = ".size() >= 0){" + NL + "\t\t\t\tgroupbyList_";
  protected final String TEXT_326 = ".clear();" + NL + "\t\t\t}" + NL + "\t\t\tstrCompCache_";
  protected final String TEXT_327 = "=strTemp_";
  protected final String TEXT_328 = ";";
  protected final String TEXT_329 = NL + "\t\t}";
  protected final String TEXT_330 = NL + "\t}" + NL;
  protected final String TEXT_331 = NL + "                map_";
  protected final String TEXT_332 = "  = new java.util.HashMap();";
  protected final String TEXT_333 = NL + "                    map_";
  protected final String TEXT_334 = ".put(\"";
  protected final String TEXT_335 = "\",";
  protected final String TEXT_336 = ".";
  protected final String TEXT_337 = ");";
  protected final String TEXT_338 = NL + "\torg.dom4j.Element subTreeRootParent_";
  protected final String TEXT_339 = " = null;" + NL + "\t" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_340 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_341 = "=false;";
  protected final String TEXT_342 = NL + "\t\troot4Group_";
  protected final String TEXT_343 = " = subTreeRootParent_";
  protected final String TEXT_344 = ";" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_345 = "=root4Group_";
  protected final String TEXT_346 = ";" + NL + "\t}" + NL + "\t// build group xml tree ";
  protected final String TEXT_347 = NL + "\tboolean isNewElememt = false;";
  protected final String TEXT_348 = NL + "\tif(isNewElememt || groupbyList_";
  protected final String TEXT_349 = ".size()<=";
  protected final String TEXT_350 = " || groupbyList_";
  protected final String TEXT_351 = ".get(";
  protected final String TEXT_352 = ")==null";
  protected final String TEXT_353 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_354 = ".get(";
  protected final String TEXT_355 = ").get(";
  protected final String TEXT_356 = ")!=null " + NL + "\t\t? !groupbyList_";
  ...
  protected final String TEXT_363 = NL + "\t\tif(groupbyList_";
  protected final String TEXT_364 = ".size()<=";
  protected final String TEXT_365 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_366 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_367 = ".get(";
  protected final String TEXT_368 = ").clear();" + NL + "        }";
  protected final String TEXT_369 = NL + "\t\tgroupbyList_";
  protected final String TEXT_370 = ".get(";
  protected final String TEXT_371 = ").add(";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "        isNewElememt=true;" + NL + "        if(groupElementList_";
  protected final String TEXT_374 = ".size()<=";
  protected final String TEXT_375 = "){" + NL + "\t\t\tgroupElementList_";
  protected final String TEXT_376 = ".add(group";
  protected final String TEXT_377 = "__";
  protected final String TEXT_378 = ");" + NL + "        }else{" + NL + "        \tgroupElementList_";
  protected final String TEXT_379 = ".set(";
  protected final String TEXT_380 = ",group";
  protected final String TEXT_381 = "__";
  protected final String TEXT_382 = ");" + NL + "        }" + NL + "        " + NL + "\t}else{" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_383 = "=groupElementList_";
  protected final String TEXT_384 = ".get(";
  protected final String TEXT_385 = ");" + NL + "\t}";
  protected final String TEXT_386 = NL + "\t// build loop xml tree";
  protected final String TEXT_387 = NL + "\t\t//the data read is different from the data read last time. " + NL + "\t\tif(strCompCache_";
  protected final String TEXT_388 = ".equals(strTemp_";
  protected final String TEXT_389 = ")==false){";
  protected final String TEXT_390 = NL + NL + "\t\t // write the endtag to the StringWriter:strWriter_tWriteXMLField_1_Out" + NL + "\t\t // close the bufferWriter" + NL + "\t\t // add the data in strWriter_tWriteXMLField_1_Out to listGroupby\t\t\t\t\t\t\t " + NL + "" + NL + "\t\tif (preUnNullMaxIndex_";
  protected final String TEXT_391 = " >= 0) {" + NL + "\t        // output all buffer" + NL + "\t        for (int j_";
  protected final String TEXT_392 = " = 0; j_";
  protected final String TEXT_393 = " <= preUnNullMaxIndex_";
  protected final String TEXT_394 = "; j_";
  protected final String TEXT_395 = "++) {" + NL + "\t            if (startTabs_";
  protected final String TEXT_396 = "[j_";
  protected final String TEXT_397 = "] != null)" + NL + "\t                out_";
  protected final String TEXT_398 = ".write(startTabs_";
  protected final String TEXT_399 = "[j_";
  protected final String TEXT_400 = "]);" + NL + "\t        }" + NL + "\t" + NL + "\t        if (preUnNullMaxIndex_";
  protected final String TEXT_401 = " < preNewTabIndex_";
  protected final String TEXT_402 = " ) {" + NL + "\t\t\t\tfor (int i_";
  protected final String TEXT_403 = " = preNewTabIndex_";
  protected final String TEXT_404 = " - 1; i_";
  protected final String TEXT_405 = " >= 0; i_";
  protected final String TEXT_406 = "--) {" + NL + "                \tif(endTabs_";
  protected final String TEXT_407 = "[i_";
  protected final String TEXT_408 = "]!=null){" + NL + "                \t\tout_";
  protected final String TEXT_409 = ".write(endTabs_";
  protected final String TEXT_410 = "[i_";
  protected final String TEXT_411 = "]);" + NL + "                \t}                \t" + NL + "\t                out_";
  protected final String TEXT_412 = ".write(\"";
  protected final String TEXT_413 = "\");" + NL + "\t                out_";
  protected final String TEXT_414 = ".write(endTabStrs_";
  protected final String TEXT_415 = ".get(i_";
  protected final String TEXT_416 = "));" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            for (int i_";
  protected final String TEXT_417 = " = preUnNullMaxIndex_";
  protected final String TEXT_418 = "; i_";
  protected final String TEXT_419 = " >= 0; i_";
  protected final String TEXT_420 = "--) {" + NL + "                \tif(endTabs_";
  protected final String TEXT_421 = "[i_";
  protected final String TEXT_422 = "]!=null){" + NL + "                \t\tout_";
  protected final String TEXT_423 = ".write(endTabs_";
  protected final String TEXT_424 = "[i_";
  protected final String TEXT_425 = "]);" + NL + "                \t}" + NL + "                \tout_";
  protected final String TEXT_426 = ".write(\"";
  protected final String TEXT_427 = "\");" + NL + "\t                out_";
  protected final String TEXT_428 = ".write(endTabStrs_";
  ...
  protected final String TEXT_432 = " = endTabStrs_";
  protected final String TEXT_433 = ".size() - 1; i_";
  protected final String TEXT_434 = " >= 0; i_";
  protected final String TEXT_435 = "--) {" + NL + "        \tif(endTabs_";
  protected final String TEXT_436 = "[i_";
  protected final String TEXT_437 = "]!=null){" + NL + "        \t\tout_";
  protected final String TEXT_438 = ".write(endTabs_";
  protected final String TEXT_439 = "[i_";
  protected final String TEXT_440 = "]);" + NL + "        \t}" + NL + "\t        out_";
  protected final String TEXT_441 = ".write(\"";
  protected final String TEXT_442 = "\");" + NL + "\t        out_";
  protected final String TEXT_443 = ".write(endTabStrs_";
  protected final String TEXT_444 = ".get(i_";
  protected final String TEXT_445 = "));" + NL + "\t    }";
  protected final String TEXT_446 = NL + "\t\tfor (int i_";
  protected final String TEXT_447 = " = 0; i_";
  protected final String TEXT_448 = " < endTabs_";
  protected final String TEXT_449 = ".length; i_";
  protected final String TEXT_450 = "++) {" + NL + "\t\t\tstartTabs_";
  protected final String TEXT_451 = "[i_";
  protected final String TEXT_452 = "] = null;" + NL + "\t\t\tendTabs_";
  protected final String TEXT_453 = "[i_";
  protected final String TEXT_454 = "] = null;" + NL + "\t\t}" + NL + "//\t\tendTabStrs_";
  protected final String TEXT_455 = ".clear();" + NL + "\t\tout_";
  protected final String TEXT_456 = ".write(\"";
  protected final String TEXT_457 = "\");" + NL + "\t\tout_";
  protected final String TEXT_458 = ".close();" + NL + "\t\tlistGroupby_";
  protected final String TEXT_459 = ".add(strWriter_";
  protected final String TEXT_460 = ".toString());" + NL + "" + NL + "\t\t//create a new StringWriter and BufferWriter" + NL + "\t\t//write the head title to the StringWriter\t\t" + NL + "\t\tstrWriter_";
  protected final String TEXT_461 = " = new java.io.StringWriter();" + NL + "\t\tout_";
  protected final String TEXT_462 = " = new java.io.BufferedWriter(strWriter_";
  protected final String TEXT_463 = ");";
  protected final String TEXT_464 = NL + "\t\tout_";
  protected final String TEXT_465 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_466 = "+\"\\\"?>\");" + NL + "\t\tout_";
  protected final String TEXT_467 = ".write(\"";
  protected final String TEXT_468 = "\");";
  protected final String TEXT_469 = NL + NL + "\t\tneedRoot_";
  protected final String TEXT_470 = " = true;" + NL + "\t\tstrCompCache_";
  protected final String TEXT_471 = "=strTemp_";
  protected final String TEXT_472 = ";" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_473 = " = -1;";
  protected final String TEXT_474 = NL + "\t\t}";
  protected final String TEXT_475 = "\t" + NL + "\t}\t" + NL + "\t" + NL + "\tStringBuffer buf_";
  protected final String TEXT_476 = " = new StringBuffer();" + NL + "\t//init value is 0 not -1, because it will output the root tab when all the row value is null." + NL + "\tint unNullMaxIndex_";
  protected final String TEXT_477 = " = 0;" + NL + "" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_478 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_479 = "=false;";
  protected final String TEXT_480 = NL + "\t\tif( false";
  protected final String TEXT_481 = " || valueMap_";
  protected final String TEXT_482 = ".get(\"";
  protected final String TEXT_483 = "\") != null";
  protected final String TEXT_484 = NL + "\t\t){" + NL + "\t\t\tunNullMaxIndex_";
  protected final String TEXT_485 = " = ";
  protected final String TEXT_486 = ";" + NL + "\t\t}";
  protected final String TEXT_487 = NL + "\t\tendTabs_";
  protected final String TEXT_488 = "[";
  protected final String TEXT_489 = "] = buf_";
  protected final String TEXT_490 = ".toString();" + NL + "\t\tbuf_";
  protected final String TEXT_491 = " = new StringBuffer();";
  protected final String TEXT_492 = NL + "\t}" + NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_493 = NL + "\tboolean isNewElememt = false;" + NL + "\t//The index of group element which is the first new group in groups." + NL + "\tint newTabIndex_";
  ...
  protected final String TEXT_500 = " or not" + NL + "\tif(isNewElememt || groupbyList_";
  protected final String TEXT_501 = ".size()<=";
  protected final String TEXT_502 = " || groupbyList_";
  ...
  protected final String TEXT_508 = ")!=null " + NL + "\t\t? !groupbyList_";
  protected final String TEXT_509 = ".get(";
  protected final String TEXT_510 = ").get(";
  protected final String TEXT_511 = ").equals(";
  protected final String TEXT_512 = ") " + NL + "\t\t: ";
  protected final String TEXT_513 = "!=null )";
  protected final String TEXT_514 = NL + "\t){" + NL + "\t\t// Is the first new element in groups." + NL + "\t\tif(isNewElememt == false && groupbyList_";
  protected final String TEXT_515 = ".size()>";
  protected final String TEXT_516 = "){" + NL + "\t\t\tnewTabIndex_";
  protected final String TEXT_517 = " = ";
  protected final String TEXT_518 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t// count the groupby element" + NL + "\t\tif(groupbyList_";
  protected final String TEXT_519 = ".size()<=";
  protected final String TEXT_520 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_521 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_522 = ".get(";
  protected final String TEXT_523 = ").clear();" + NL + "        }";
  protected final String TEXT_524 = NL + "\t\tgroupbyList_";
  protected final String TEXT_525 = ".get(";
  protected final String TEXT_526 = ").add(";
  protected final String TEXT_527 = ");";
  protected final String TEXT_528 = NL + "        isNewElememt=true;" + NL + "\t}" + NL + "\t" + NL + "\t// subtree XML string generate";
  ...
  protected final String TEXT_536 = NL + "\t// buffer the end tabs to group buffer" + NL + "\tgroupEndBuffer_";
  ...
  protected final String TEXT_542 = " >= 0 && preNewTabIndex_";
  protected final String TEXT_543 = "!=-1) {" + NL + "        //out_";
  protected final String TEXT_544 = ".newLine();//Track code";
  protected final String TEXT_545 = NL + "\t\t// output unNull tabs in start tabs buffer" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_546 = " >= 0) {" + NL + "            for (int i_";
  protected final String TEXT_547 = " = 0; i_";
  protected final String TEXT_548 = " < startTabs_";
  protected final String TEXT_549 = ".length; i_";
  protected final String TEXT_550 = "++) {" + NL + "                if (i_";
  protected final String TEXT_551 = " <= preUnNullMaxIndex_";
  ...
  protected final String TEXT_559 = "] = null;" + NL + "                }" + NL + "            }" + NL + "        }";
  protected final String TEXT_560 = NL + "\t\t//output all start tabs buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_561 = " = 0; i_";
  protected final String TEXT_562 = " < startTabs_";
  protected final String TEXT_563 = ".length; i_";
  protected final String TEXT_564 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_565 = "[i_";
  protected final String TEXT_566 = "] != null) {" + NL + "                out_";
  protected final String TEXT_567 = ".write(startTabs_";
  protected final String TEXT_568 = "[i_";
  protected final String TEXT_569 = "]);" + NL + "            }" + NL + "            startTabs_";
  protected final String TEXT_570 = "[i_";
  protected final String TEXT_571 = "] = null;" + NL + "        }";
  protected final String TEXT_572 = NL + "        // output endtabs" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_573 = " >= preNewTabIndex_";
  protected final String TEXT_574 = NL + "            && preUnNullMaxIndex_";
  protected final String TEXT_575 = " >= ";
  protected final String TEXT_576 = " + newTabIndex_";
  protected final String TEXT_577 = ") {" + NL + "            for (int i_";
  protected final String TEXT_578 = " = preUnNullMaxIndex_";
  protected final String TEXT_579 = "; i_";
  protected final String TEXT_580 = " >= ";
  protected final String TEXT_581 = " + newTabIndex_";
  protected final String TEXT_582 = "; i_";
  protected final String TEXT_583 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_584 = "[i_";
  protected final String TEXT_585 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_586 = ".write(endTabs_";
  protected final String TEXT_587 = "[i_";
  protected final String TEXT_588 = "]);" + NL + "            \t}" + NL + "            \tendTabs_";
  protected final String TEXT_589 = "[i_";
  protected final String TEXT_590 = "] = null;" + NL + "                out_";
  protected final String TEXT_591 = ".write(\"";
  ...
  protected final String TEXT_609 = "] = null;" + NL + "                out_";
  protected final String TEXT_610 = ".write(\"";
  protected final String TEXT_611 = "\");" + NL + "                out_";
  protected final String TEXT_612 = ".write(endTabStrs_";
  protected final String TEXT_613 = NL + "                        .get(i_";
  protected final String TEXT_614 = "));" + NL + "            }";
  protected final String TEXT_615 = NL + "        }";
  protected final String TEXT_616 = NL + "        preNewTabIndex_";
  protected final String TEXT_617 = " = newTabIndex_";
  protected final String TEXT_618 = " + ";
  protected final String TEXT_619 = ";" + NL + "    }" + NL + "" + NL + "    // set new element groupbuffer to startbuffer" + NL + "    for (int i_";
  protected final String TEXT_620 = " = 0; i_";
  protected final String TEXT_621 = " < groupBuffer_";
  protected final String TEXT_622 = ".length; i_";
  protected final String TEXT_623 = "++) {" + NL + "        // when newTabIndex is null, must use the perNewTabIndex" + NL + "        if (i_";
  protected final String TEXT_624 = " >= preNewTabIndex_";
  protected final String TEXT_625 = " - ";
  protected final String TEXT_626 = ") {" + NL + "            startTabs_";
  protected final String TEXT_627 = "[i_";
  protected final String TEXT_628 = " + ";
  protected final String TEXT_629 = "] = groupBuffer_";
  protected final String TEXT_630 = "[i_";
  protected final String TEXT_631 = "];" + NL + "            endTabs_";
  protected final String TEXT_632 = "[i_";
  protected final String TEXT_633 = " + ";
  protected final String TEXT_634 = "] = groupEndBuffer_";
  protected final String TEXT_635 = "[i_";
  protected final String TEXT_636 = "];" + NL + "        }" + NL + "    }";
  protected final String TEXT_637 = NL + "\t//reset the preUnNullMaxIndex" + NL + "\tif(unNullMaxIndex_";
  protected final String TEXT_638 = ">=0){" + NL + "    \tpreUnNullMaxIndex_";
  protected final String TEXT_639 = "=unNullMaxIndex_";
  protected final String TEXT_640 = ";" + NL + "\t}else{" + NL + "\t\tif(preUnNullMaxIndex_";
  protected final String TEXT_641 = ">";
  protected final String TEXT_642 = "){" + NL + "\t\t\tpreUnNullMaxIndex_";
  protected final String TEXT_643 = "=";
  protected final String TEXT_644 = ";" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_645 = NL + "\t// build loop xml tree";
  protected final String TEXT_646 = NL + "\t\tif( false";
  protected final String TEXT_647 = " || valueMap_";
  protected final String TEXT_648 = ".get(\"";
  protected final String TEXT_649 = "\") != null";
  protected final String TEXT_650 = " || true " + NL + "    \t";
  protected final String TEXT_651 = NL + "\t\t){";
  protected final String TEXT_652 = NL + "\t\t// output all buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_653 = " = 0; i_";
  protected final String TEXT_654 = " < startTabs_";
  protected final String TEXT_655 = ".length; i_";
  protected final String TEXT_656 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_657 = "[i_";
  protected final String TEXT_658 = "] != null && startTabs_";
  protected final String TEXT_659 = "[i_";
  protected final String TEXT_660 = "].length() > 0) {" + NL + "                out_";
  protected final String TEXT_661 = ".write(startTabs_";
  protected final String TEXT_662 = "[i_";
  protected final String TEXT_663 = "]);" + NL + "                startTabs_";
  protected final String TEXT_664 = "[i_";
  protected final String TEXT_665 = "] = null;" + NL + "            }" + NL + "        }" + NL + "\t\tout_";
  protected final String TEXT_666 = ".write(buf_";
  protected final String TEXT_667 = ".toString());" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_668 = " = ";
  protected final String TEXT_669 = ";";
  protected final String TEXT_670 = NL + "            preUnNullMaxIndex_";
