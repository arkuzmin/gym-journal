...
public class TSendMailMainJava
{
  ...
  protected final String TEXT_76 = ", new javax.mail.Authenticator(){         " + NL + "      protected javax.mail.PasswordAuthentication getPasswordAuthentication() {";
  ...
  protected final String TEXT_83 = NL + "\t\t\t\t" + NL + "\t\treturn new javax.mail.PasswordAuthentication(";
  protected final String TEXT_84 = ", decryptedPassword_";
  protected final String TEXT_85 = "); " + NL + "      }         " + NL + "    });   ";
  protected final String TEXT_86 = NL + "  javax.mail.Message msg_";
  protected final String TEXT_87 = " = new javax.mail.internet.MimeMessage(session_";
  protected final String TEXT_88 = ");" + NL + "  msg_";
  protected final String TEXT_89 = ".setFrom(new javax.mail.internet.InternetAddress(from_";
  protected final String TEXT_90 = ", ";
  protected final String TEXT_91 = "));" + NL + "  msg_";
  protected final String TEXT_92 = ".setRecipients(javax.mail.Message.RecipientType.TO,javax.mail.internet.InternetAddress.parse(to_";
  protected final String TEXT_93 = ", false));" + NL + "  if (cc_";
  protected final String TEXT_94 = " != null) msg_";
  protected final String TEXT_95 = ".setRecipients(javax.mail.Message.RecipientType.CC, javax.mail.internet.InternetAddress.parse(cc_";
  protected final String TEXT_96 = ", false));" + NL + "  if (bcc_";
  protected final String TEXT_97 = " != null) msg_";
  protected final String TEXT_98 = ".setRecipients(javax.mail.Message.RecipientType.BCC, javax.mail.internet.InternetAddress.parse(bcc_";
  protected final String TEXT_99 = ", false));" + NL + "  msg_";
  protected final String TEXT_100 = ".setSubject(subject_";
  protected final String TEXT_101 = ");" + NL + "" + NL + "  for (int i_";
  protected final String TEXT_102 = " = 0; i_";
  protected final String TEXT_103 = " < headers_";
  protected final String TEXT_104 = ".size(); i_";
  protected final String TEXT_105 = "++) {" + NL + "    java.util.Map<String, String> header_";
  protected final String TEXT_106 = " = headers_";
  protected final String TEXT_107 = ".get(i_";
  protected final String TEXT_108 = ");" + NL + "    msg_";
  protected final String TEXT_109 = ".setHeader(header_";
  protected final String TEXT_110 = ".get(\"KEY\"), header_";
  protected final String TEXT_111 = ".get(\"VALUE\"));    " + NL + "  }  " + NL + "  msg_";
  protected final String TEXT_112 = ".setSentDate(new Date());" + NL + "  msg_";
  protected final String TEXT_113 = ".setHeader(\"X-Priority\", \"";
  protected final String TEXT_114 = "\"); //High->1 Normal->3 Low->5" + NL + "  javax.mail.Multipart mp_";
  protected final String TEXT_115 = " = new javax.mail.internet.MimeMultipart();" + NL + "  javax.mail.internet.MimeBodyPart mbpText_";
  protected final String TEXT_116 = " = new javax.mail.internet.MimeBodyPart();" + NL + "  mbpText_";
  protected final String TEXT_117 = ".setText(message_";
  protected final String TEXT_118 = ",";
  protected final String TEXT_119 = ", \"";
  protected final String TEXT_120 = "\");" + NL + "  mp_";
  protected final String TEXT_121 = ".addBodyPart(mbpText_";
  protected final String TEXT_122 = ");" + NL + "  " + NL + "  javax.mail.internet.MimeBodyPart mbpFile_";
  protected final String TEXT_123 = " = null;" + NL + "  " + NL + "  for (int i_";
  protected final String TEXT_124 = " = 0; i_";
  protected final String TEXT_125 = " < attachments_";
  protected final String TEXT_126 = ".size(); i_";
  protected final String TEXT_127 = "++){" + NL + "    String filename_";
  protected final String TEXT_128 = " = attachments_";
  protected final String TEXT_129 = ".get(i_";
  protected final String TEXT_130 = ");" + NL + "    javax.activation.FileDataSource fds_";
  protected final String TEXT_131 = " = null;" + NL + "    java.io.File file_";
  protected final String TEXT_132 = " = new java.io.File(filename_";
  protected final String TEXT_133 = ");";
  protected final String TEXT_134 = NL + "      if (!file_";
  protected final String TEXT_135 = ".exists()){" + NL + "        continue;" + NL + "      }";
  protected final String TEXT_136 = NL + "    if (file_";
  protected final String TEXT_137 = ".isDirectory()){" + NL + "      java.io.File[] subFiles_";
  protected final String TEXT_138 = " = file_";
  protected final String TEXT_139 = ".listFiles();" + NL + "      " + NL + "      for(java.io.File subFile_";
  protected final String TEXT_140 = " : subFiles_";
  protected final String TEXT_141 = "){" + NL + "        if (subFile_";
  protected final String TEXT_142 = ".isFile()){" + NL + "          fds_";
  protected final String TEXT_143 = " = new javax.activation.FileDataSource(subFile_";
  protected final String TEXT_144 = ".getAbsolutePath());" + NL + "          mbpFile_";
  protected final String TEXT_145 = " = new javax.mail.internet.MimeBodyPart();" + NL + "          mbpFile_";
  protected final String TEXT_146 = ".setDataHandler(new javax.activation.DataHandler(fds_";
  protected final String TEXT_147 = "));" + NL + "          mbpFile_";
  protected final String TEXT_148 = ".setFileName(javax.mail.internet.MimeUtility.encodeText(fds_";
  protected final String TEXT_149 = ".getName()));" + NL + "          if(contentTransferEncoding_";
  protected final String TEXT_150 = ".get(i_";
  protected final String TEXT_151 = ").equalsIgnoreCase(\"base64\")){" + NL + "\t      \tmbpFile_";
  protected final String TEXT_152 = ".setHeader(\"Content-Transfer-Encoding\", \"base64\");" + NL + "\t      }" + NL + "          mp_";
  protected final String TEXT_153 = ".addBodyPart(mbpFile_";
  protected final String TEXT_154 = ");" + NL + "        }" + NL + "      }" + NL + "    }else{" + NL + "      mbpFile_";
  protected final String TEXT_155 = " = new javax.mail.internet.MimeBodyPart();" + NL + "      fds_";
  protected final String TEXT_156 = " = new javax.activation.FileDataSource(filename_";
  protected final String TEXT_157 = ");" + NL + "      mbpFile_";
  protected final String TEXT_158 = ".setDataHandler(new javax.activation.DataHandler(fds_";
  protected final String TEXT_159 = ")); " + NL + "      mbpFile_";
  protected final String TEXT_160 = ".setFileName(javax.mail.internet.MimeUtility.encodeText(fds_";
  protected final String TEXT_161 = ".getName()));" + NL + "      if(contentTransferEncoding_";
  protected final String TEXT_162 = ".get(i_";
  ...
  protected final String TEXT_165 = ".addBodyPart(mbpFile_";
  protected final String TEXT_166 = ");" + NL + "    }" + NL + "  }" + NL + "  // -- set the content --" + NL + "  msg_";
  protected final String TEXT_167 = ".setContent(mp_";
  protected final String TEXT_168 = ");" + NL + "   // add handlers for main MIME types" + NL + " javax.activation.MailcapCommandMap mc_";
  protected final String TEXT_169 = " = ( javax.activation.MailcapCommandMap)javax.activation.CommandMap.getDefaultCommandMap();" + NL + " mc_";
  protected final String TEXT_170 = ".addMailcap(\"text/html;; x-java-content-handler=com.sun.mail.handlers.text_html\");" + NL + " mc_";
  protected final String TEXT_171 = ".addMailcap(\"text/xml;; x-java-content-handler=com.sun.mail.handlers.text_xml\");" + NL + " mc_";
  protected final String TEXT_172 = ".addMailcap(\"text/plain;; x-java-content-handler=com.sun.mail.handlers.text_plain\");" + NL + " mc_";
  protected final String TEXT_173 = ".addMailcap(\"multipart/*;; x-java-content-handler=com.sun.mail.handlers.multipart_mixed\");" + NL + " mc_";
  protected final String TEXT_174 = ".addMailcap(\"message/rfc822;; x-java-content-handler=com.sun.mail.handlers.message_rfc822\");" + NL + " javax.activation.CommandMap.setDefaultCommandMap(mc_";
  protected final String TEXT_175 = ");" + NL + "  // -- Send the message --" + NL + "  javax.mail.Transport.send(msg_";
  protected final String TEXT_176 = ");" + NL + "} catch(java.lang.Exception e){";
  protected final String TEXT_177 = NL + "    throw(e);";
  protected final String TEXT_178 = NL + "    System.err.println(e.toString());";
