...
public class Iterate_subprocess_footerJava
{
  ...
  protected final String TEXT_14 = NL + "\t\t      \t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnIterate(\"";
  protected final String TEXT_15 = "\", RunStat.END);" + NL + "\t\t\t\t\t\t}  " + NL + "\t      \t\t\t";
  protected final String TEXT_16 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_17 = "\", 2, \"exec\" + NB_ITERATE_";
