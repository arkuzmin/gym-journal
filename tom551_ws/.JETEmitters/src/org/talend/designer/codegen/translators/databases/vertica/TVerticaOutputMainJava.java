...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_209 = ";" + NL + "\t\t\tif(updateFlag_";
  protected final String TEXT_210 = " == 0) {" + NL + "\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\tquery_";
  protected final String TEXT_212 = " = new StringBuffer(\"\");" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_220 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_221 = NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_222 = " = insertedCount_";
  protected final String TEXT_223 = " + pstmtInsert_";
  protected final String TEXT_224 = ".executeUpdate(); " + NL + "\t\t\t}" + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_225 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_237 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_238 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_239 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_240 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_242 = NL + "\t\t\t\t}" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_257 = ".toString().trim());" + NL + "\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t";
  protected final String TEXT_259 = NL + "\t\t\tpstmt_";
  protected final String TEXT_260 = ".addBatch();" + NL + "\t\t\t";
  protected final String TEXT_261 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_262 = "++;" + NL + "\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\ttry {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_265 = " = deletedCount_";
  protected final String TEXT_266 = " + pstmt_";
  protected final String TEXT_267 = ".executeUpdate();" + NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_268 = " = true;" + NL + "\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_271 = " = new ";
  protected final String TEXT_272 = "Struct();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_281 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_282 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_283 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_284 = NL + "\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_289 = NL + "\t\t\t   \t\t\tstmtBuilder_";
  protected final String TEXT_290 = ".append(\"|\");" + NL + "\t\t\t\t\t\tstmtBuilder_";
  ...
  protected final String TEXT_297 = " == null){" + NL + "\t\t\t   \t\t\t\tstmtBuilder_";
  protected final String TEXT_298 = ".append(\"\");" + NL + "\t\t\t   \t\t\t}else{" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_299 = ".append(\"|\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_301 = ".append(";
  protected final String TEXT_302 = ".";
  protected final String TEXT_303 = ".replaceAll(\"\\\\|\",\"\\\\\\\\|\"));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_305 = ".append(FormatterUtils.format_Date(";
  protected final String TEXT_306 = ".";
  protected final String TEXT_307 = ", ";
  protected final String TEXT_308 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_310 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_311 = ".";
  protected final String TEXT_312 = ")).toString());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_315 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_316 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_318 = ".";
  protected final String TEXT_319 = " != null) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tBigDecimal decimal_";
  protected final String TEXT_320 = " = new BigDecimal(";
  protected final String TEXT_321 = ".";
  protected final String TEXT_322 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_323 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_324 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_330 = NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  ...
  protected final String TEXT_338 = ".append(\"|\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_340 = ".append(\"";
  protected final String TEXT_341 = "\");" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t" + NL + "\t\t\tnb_line_";
  protected final String TEXT_344 = "++;";
  protected final String TEXT_345 = NL + "\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_346 = "++;";
  protected final String TEXT_347 = NL + "\t\t\tif(!whetherReject_";
  protected final String TEXT_348 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_350 = " = new ";
  protected final String TEXT_351 = "Struct();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_359 = " <= batchSizeCounter_";
  protected final String TEXT_360 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_362 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_363 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_365 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_366 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_368 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_369 = ",template_";
  protected final String TEXT_370 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_371 = ".start();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_372 = ".addStream(bais_";
  protected final String TEXT_373 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_374 = ".execute();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_375 = ".finish();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_376 = NL + "\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_377 = ").executeCopyIn(template_";
  protected final String TEXT_378 = ", bais_";
  protected final String TEXT_379 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_381 = " = null;" + NL + "\t\t\t\t\t\tif (bais_";
  protected final String TEXT_382 = " != null) {" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_383 = ".close();" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_384 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_385 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t\tinsertedCount_";
  protected final String TEXT_388 = " += pstmt_";
  protected final String TEXT_389 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\tupdatedCount_";
  protected final String TEXT_391 = " += pstmt_";
  protected final String TEXT_392 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\tdeletedCount_";
  protected final String TEXT_394 = " += pstmt_";
  protected final String TEXT_395 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_397 = " += vcs_";
  protected final String TEXT_398 = ".getRowCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_400 = " += stmt_";
  protected final String TEXT_401 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_403 = " = 0; \t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_412 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\t\t\t\tboolean isCountResult_";
  protected final String TEXT_414 = " = false;" + NL + "\t\t\t\t\t\t\tif(batchSizeCounter_";
  protected final String TEXT_415 = " > 0){" + NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_416 = ".executeBatch();" + NL + "\t\t\t\t\t\t\t\tisCountResult_";
  protected final String TEXT_417 = " = true;" + NL + "\t\t\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_418 = " = 0;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_419 = NL + "\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_420 = ".executeBatch(); " + NL + "\t\t\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\t\t\tif(isCountResult_";
  protected final String TEXT_422 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\t\tinsertedCount_";
  protected final String TEXT_424 = " += pstmt_";
  protected final String TEXT_425 = ".getUpdateCount();" + NL + "\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\tupdatedCount_";
  protected final String TEXT_427 = " += pstmt_";
  protected final String TEXT_428 = ".getUpdateCount();" + NL + "\t\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\t\tdeletedCount_";
  protected final String TEXT_430 = " += pstmt_";
  protected final String TEXT_431 = ".getUpdateCount();" + NL + "\t\t\t\t\t";
  protected final String TEXT_432 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_434 = " != null && stmtBuilder_";
  protected final String TEXT_435 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_436 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_437 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_438 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_439 = ").executeCopyIn(template_";
  protected final String TEXT_440 = ", bais_";
  protected final String TEXT_441 = ");" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_442 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_443 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_444 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_445 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_446 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_447 = " += stmt_";
  protected final String TEXT_448 = ".getUpdateCount();" + NL + "\t\t\t\t\t\t} // stmtBuilder_";
  protected final String TEXT_449 = " end" + NL + "\t\t\t\t\t";
  protected final String TEXT_450 = NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_452 = NL + "\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_453 = NL + "\t\t\t\t" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_454 = NL + "\t   \t\t\t\tconn_";
  protected final String TEXT_455 = ".commit();" + NL + "\t\t\t\t\tcommitCounter_";
  protected final String TEXT_456 = "=0;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
