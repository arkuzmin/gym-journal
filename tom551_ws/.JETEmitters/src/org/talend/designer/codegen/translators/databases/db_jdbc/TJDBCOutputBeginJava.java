...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_30 = ").getConnection();" + NL + "\t\t\tif (connection_";
  protected final String TEXT_31 = " != null) { " + NL + "\t\t\t\tconnection_";
  ...
  protected final String TEXT_36 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_37 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_38 = ") {" + NL + "\t\t\tconnection_";
  protected final String TEXT_39 = " = dataSources_";
  protected final String TEXT_40 = ".get(";
  protected final String TEXT_41 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_42 = NL + "\t\t\tjava.lang.Class.forName(";
  protected final String TEXT_43 = ");" + NL + "\t\t\tString connectionString_";
  ...
  protected final String TEXT_53 = NL + "  \t\t\t" + NL + "\t\t\t" + NL + "\t\t\tconnection_";
  protected final String TEXT_54 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_67 = NL + "   int batchSize_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_70 = "=0;";
  protected final String TEXT_71 = " " + NL;
  protected final String TEXT_72 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_73 = " = connection_";
  protected final String TEXT_74 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_75 = " = deletedCount_";
  protected final String TEXT_76 = " + statementClear_";
  protected final String TEXT_77 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_78 = ");" + NL + "\t";
  protected final String TEXT_79 = NL + "\t\tString insert_";
  protected final String TEXT_80 = " = \"INSERT INTO \" + ";
  protected final String TEXT_81 = " + \" (";
  protected final String TEXT_82 = ") VALUES (";
  protected final String TEXT_83 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_84 = " = connection_";
  protected final String TEXT_85 = ".prepareStatement(insert_";
  protected final String TEXT_86 = ");" + NL + "\t\t";
  protected final String TEXT_87 = NL + "\t\tString update_";
  protected final String TEXT_88 = " = \"UPDATE \" + ";
  protected final String TEXT_89 = " + \" SET ";
  protected final String TEXT_90 = " WHERE ";
  protected final String TEXT_91 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_92 = " = connection_";
  protected final String TEXT_93 = ".prepareStatement(update_";
  protected final String TEXT_94 = ");" + NL + "\t\t";
  protected final String TEXT_95 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_96 = " = connection_";
  protected final String TEXT_97 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_98 = " + \" WHERE ";
  ...
  protected final String TEXT_103 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_104 = " = connection_";
  protected final String TEXT_105 = ".prepareStatement(insert_";
  protected final String TEXT_106 = ");" + NL + "\t\tString update_";
  protected final String TEXT_107 = " = \"UPDATE \" + ";
  protected final String TEXT_108 = " + \" SET ";
  protected final String TEXT_109 = " WHERE ";
  protected final String TEXT_110 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_111 = " = connection_";
  protected final String TEXT_112 = ".prepareStatement(update_";
  protected final String TEXT_113 = ");" + NL + "\t\t";
  protected final String TEXT_114 = NL + "\t\tString update_";
  protected final String TEXT_115 = " = \"UPDATE \" + ";
  protected final String TEXT_116 = " + \" SET ";
  protected final String TEXT_117 = " WHERE ";
  protected final String TEXT_118 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_119 = " = connection_";
  protected final String TEXT_120 = ".prepareStatement(update_";
  protected final String TEXT_121 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_122 = " = \"INSERT INTO \" + ";
  protected final String TEXT_123 = " + \" (";
  protected final String TEXT_124 = ") VALUES (";
  protected final String TEXT_125 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_126 = " = connection_";
  protected final String TEXT_127 = ".prepareStatement(insert_";
  protected final String TEXT_128 = ");" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\tString delete_";
  protected final String TEXT_130 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_134 = ".prepareStatement(delete_";
  protected final String TEXT_135 = ");" + NL + "\t\t";
  protected final String TEXT_136 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_141 = NL + "\t\t\tupdate_";
  protected final String TEXT_142 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_143 = " = update_";
  protected final String TEXT_144 = ".split(\"\\\\?\");";
  protected final String TEXT_145 = NL + "\t\t\tupdate_";
  protected final String TEXT_146 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_147 = " = update_";
  ...
  protected final String TEXT_151 = NL + "\t\t\tdelete_";
  protected final String TEXT_152 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_153 = " = delete_";
  protected final String TEXT_154 = ".split(\"\\\\?\");";
  protected final String TEXT_155 = NL + "\t\t\treplace_";
  protected final String TEXT_156 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_157 = " = replace_";
  protected final String TEXT_158 = ".split(\"\\\\?\");";
  protected final String TEXT_159 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_160 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_161 = " = insertIgnore_";
  protected final String TEXT_162 = ".split(\"\\\\?\");";
  protected final String TEXT_163 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_164 = " = insert_";
