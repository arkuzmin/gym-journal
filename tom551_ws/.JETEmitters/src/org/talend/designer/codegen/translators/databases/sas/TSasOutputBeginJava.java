...
public class TSasOutputBeginJava {
  ...
  protected final String TEXT_33 = NL + "      " + NL + "    " + NL + "    java.sql.Connection connection_";
  ...
  protected final String TEXT_37 = ");" + NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_45 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_46 = " = connection_";
  protected final String TEXT_47 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_48 = " = deletedCount_";
  protected final String TEXT_49 = " + statementClear_";
  protected final String TEXT_50 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_51 = ");" + NL + "\t";
  protected final String TEXT_52 = NL + "\t\tString insert_";
  protected final String TEXT_53 = " = \"INSERT INTO \" + ";
  protected final String TEXT_54 = " + \" (";
  protected final String TEXT_55 = ") VALUES (";
  protected final String TEXT_56 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_57 = " = connection_";
  protected final String TEXT_58 = ".prepareStatement(insert_";
  protected final String TEXT_59 = ");" + NL + "\t\t";
  protected final String TEXT_60 = NL + "\t\tString update_";
  protected final String TEXT_61 = " = \"UPDATE \" + ";
  protected final String TEXT_62 = " + \" SET ";
  protected final String TEXT_63 = " WHERE ";
  protected final String TEXT_64 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_65 = " = connection_";
  protected final String TEXT_66 = ".prepareStatement(update_";
  protected final String TEXT_67 = ");" + NL + "\t\t";
  protected final String TEXT_68 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_69 = " = connection_";
  protected final String TEXT_70 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_71 = " + \" WHERE ";
  protected final String TEXT_72 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_73 = " = \"INSERT INTO \" + ";
  protected final String TEXT_74 = " + \" (";
  protected final String TEXT_75 = ") VALUES (";
  protected final String TEXT_76 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_77 = " = connection_";
  protected final String TEXT_78 = ".prepareStatement(insert_";
  protected final String TEXT_79 = ");" + NL + "\t\tString update_";
  protected final String TEXT_80 = " = \"UPDATE \" + ";
  protected final String TEXT_81 = " + \" SET ";
  protected final String TEXT_82 = " WHERE ";
  protected final String TEXT_83 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_84 = " = connection_";
  protected final String TEXT_85 = ".prepareStatement(update_";
  ...
  protected final String TEXT_91 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_92 = " = connection_";
  protected final String TEXT_93 = ".prepareStatement(update_";
  protected final String TEXT_94 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_95 = " = \"INSERT INTO \" + ";
  protected final String TEXT_96 = " + \" (";
  protected final String TEXT_97 = ") VALUES (";
  protected final String TEXT_98 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_99 = " = connection_";
  protected final String TEXT_100 = ".prepareStatement(insert_";
  protected final String TEXT_101 = ");" + NL + "\t\t";
  protected final String TEXT_102 = NL + "\t\tString delete_";
  protected final String TEXT_103 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_107 = ".prepareStatement(delete_";
  protected final String TEXT_108 = ");" + NL + "\t\t";
  protected final String TEXT_109 = NL + "        StringBuffer query_";
  protected final String TEXT_110 = " = null;" + NL + "       \t";
  protected final String TEXT_111 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_112 = " = insert_";
  protected final String TEXT_113 = ".split(\"\\\\?\");";
  protected final String TEXT_114 = NL + "\t\t\tupdate_";
  protected final String TEXT_115 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_116 = " = update_";
  protected final String TEXT_117 = ".split(\"\\\\?\");";
  protected final String TEXT_118 = NL + "\t\t\tupdate_";
  protected final String TEXT_119 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_120 = " = update_";
  protected final String TEXT_121 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_122 = " = insert_";
  protected final String TEXT_123 = ".split(\"\\\\?\");";
  protected final String TEXT_124 = NL + "\t\t\tdelete_";
  protected final String TEXT_125 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_126 = " = delete_";
  protected final String TEXT_127 = ".split(\"\\\\?\");";
  protected final String TEXT_128 = NL + "\t\t\treplace_";
  protected final String TEXT_129 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_130 = " = replace_";
  protected final String TEXT_131 = ".split(\"\\\\?\");";
  protected final String TEXT_132 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_133 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_134 = " = insertIgnore_";
  protected final String TEXT_135 = ".split(\"\\\\?\");";
  protected final String TEXT_136 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_137 = " = insert_";
