...
public class TNetezzaBulkExecBeginJava {
  ...
  protected final String TEXT_3 = NL + "\tCharacter OUT_DELIM_";
  protected final String TEXT_4 = " = (";
  protected final String TEXT_5 = ").charAt(0); " + NL + "\tbulkSQL_";
  protected final String TEXT_6 = " += \"INSERT INTO \" + ";
  protected final String TEXT_7 = " + \" \"  " + NL + "            + \" SELECT * FROM EXTERNAL '\"+ ";
  protected final String TEXT_8 = " + \"'\"" + NL + "            + \" USING (DELIM '\"+OUT_DELIM_";
  protected final String TEXT_9 = "+\"' REMOTESOURCE 'JDBC' \"" + NL + "\t\t\t+ \" DATESTYLE '\"+";
  protected final String TEXT_10 = "+\"' DATEDELIM '\"+";
  protected final String TEXT_11 = "+\"' \"" + NL + "\t\t\t+ \" TIMESTYLE '";
  protected final String TEXT_12 = "' TIMEDELIM '\"+";
  protected final String TEXT_13 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_14 = NL + "\t\t\t+ \" ESCAPECHAR '\"+";
  protected final String TEXT_15 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_16 = NL + "\t\t\t+ \"\tMAXERRORS ";
  protected final String TEXT_17 = " SKIPROWS ";
  protected final String TEXT_18 = " LOGDIR '' ";
  protected final String TEXT_19 = ")\";" + NL;
  protected final String TEXT_20 = NL + "        java.sql.Connection con_";
  protected final String TEXT_21 = " = (java.sql.Connection) globalMap.get(\"";
  protected final String TEXT_22 = "\");";
  protected final String TEXT_23 = NL + "\t\tjava.lang.Class.forName(\"org.netezza.Driver\").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_31 = NL + "\t\tjava.sql.Connection con_";
  protected final String TEXT_32 = " = java.sql.DriverManager.getConnection(\"jdbc:netezza://\" + ";
  protected final String TEXT_33 = " + \":\" + ";
  protected final String TEXT_34 = " + \"/\" + ";
  protected final String TEXT_35 = ", ";
  protected final String TEXT_36 = ", decryptedPassword_";
  protected final String TEXT_37 = ");";
  protected final String TEXT_38 = NL + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_39 = " = con_";
  protected final String TEXT_40 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_41 = ".execute(bulkSQL_";
  protected final String TEXT_42 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_43 = ".close();       ";
  protected final String TEXT_44 = NL + "\tcon_";
