...
public class TVerticaSCDBeginJava {
  ...
  protected final String TEXT_35 = ";" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_41 = "!=null&&!\"\".equals(dbschema_";
  protected final String TEXT_42 = ")){" + NL + "    \ttableName_";
  protected final String TEXT_43 = " =dbschema_";
  protected final String TEXT_44 = "+\".\"+tableName_";
  ...
  protected final String TEXT_57 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_58 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_59 = " == null || dbschema_";
  protected final String TEXT_60 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_61 = " = connection_";
  protected final String TEXT_62 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_63 = " = stmtSchema_";
  protected final String TEXT_64 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_65 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_66 = " = rsSchema_";
  protected final String TEXT_67 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_68 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_69 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_77 = ".equals(dbschema_";
  ...
  protected final String TEXT_81 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_82 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_83 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_84 = ".close();" + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_91 = NL + "        " + NL + "    java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_147 = NL + "                    timestamp_";
  protected final String TEXT_148 = " = resultSet_";
  protected final String TEXT_149 = ".getTimestamp(";
  protected final String TEXT_150 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_151 = " != null) {";
  protected final String TEXT_152 = NL + "                        ";
  protected final String TEXT_153 = ".";
  protected final String TEXT_154 = " = new java.util.Date(timestamp_";
  protected final String TEXT_155 = ".getTime());" + NL + "                    } else {";
