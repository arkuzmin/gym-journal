...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_42 = " = decryptedPassword_";
  ...
  protected final String TEXT_49 = " = null;" + NL + "\t\tif(dbschema_";
  protected final String TEXT_50 = " == null || dbschema_";
  ...
  protected final String TEXT_57 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_58 = " = conn_";
  protected final String TEXT_59 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_78 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_79 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_80 = " = tableNameForSearch_";
  protected final String TEXT_81 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_82 = " = tableNameForSearch_";
  protected final String TEXT_83 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_84 = " = dbMetaData_";
  protected final String TEXT_85 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_86 = ", tableNameForSearch_";
  protected final String TEXT_87 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_88 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_89 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_90 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_104 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_105 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_106 = ") || dbschema_";
  protected final String TEXT_107 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_118 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_122 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_123 = ".equals(schema_";
  protected final String TEXT_124 = ") || (schema_";
  protected final String TEXT_125 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_126 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_135 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_136 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_137 = " == null || dbschema_";
  protected final String TEXT_138 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_145 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_146 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_147 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_161 = " ==null || dbschema_";
  protected final String TEXT_162 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_163 = ".equals";
  protected final String TEXT_164 = "IgnoreCase";
  protected final String TEXT_165 = "(schema_";
  ...
  protected final String TEXT_188 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_193 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_196 = ".execute(\"";
  protected final String TEXT_197 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_198 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_204 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_210 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_213 = " = stmtTruncCount_";
  protected final String TEXT_214 = ".executeQuery(\"";
  protected final String TEXT_215 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_218 = ".executeUpdate(\"";
  protected final String TEXT_219 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_220 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_221 = " += rsTruncCount_";
  protected final String TEXT_222 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_223 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_224 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_225 = ".close();            ";
  protected final String TEXT_226 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_227 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_228 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_229 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_230 = " = ";
  protected final String TEXT_231 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_232 = " = fileName_";
  protected final String TEXT_233 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_234 = " = fileName_";
  protected final String TEXT_235 = " + \".log\";" + NL + "\t\tCharacter field_separator_";
  protected final String TEXT_236 = " = (";
  protected final String TEXT_237 = ").charAt(0);" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_238 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_239 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_240 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_241 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_242 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_243 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_244 = ".print(\" DELIMITER \\\"\" + field_separator_";
  protected final String TEXT_245 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_246 = ".println(\" \" + ";
  protected final String TEXT_247 = " +\" ;\" );";
  protected final String TEXT_248 = NL + "\t\tpw_";
  protected final String TEXT_249 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_250 = " + \"(";
  protected final String TEXT_251 = ");\" );";
  protected final String TEXT_252 = NL + "\tbw_";
  protected final String TEXT_253 = ".close();" + NL + "\tpw_";
  protected final String TEXT_254 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_255 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_256 = NL + "\tcommand_";
  protected final String TEXT_257 = ".append(\"dbload \");";
  protected final String TEXT_258 = NL + "\tcommand_";
  protected final String TEXT_259 = ".append(\"./dbload \");";
  protected final String TEXT_260 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_261 = ".append(\"-d \" + dbName_";
  protected final String TEXT_262 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_263 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_264 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_265 = ".append(\"-l \" + logFile_";
  protected final String TEXT_266 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_267 = ".append(\"-e \" + ";
  protected final String TEXT_268 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_269 = ".append(\"-n \" + ";
  protected final String TEXT_270 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_271 = NL + "\tProcess ev_";
  protected final String TEXT_272 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_273 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_274 = ".getInputStream()));";
  protected final String TEXT_275 = NL + NL + "\tProcess ev_";
  protected final String TEXT_276 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_277 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_278 = ".getInputStream()));";
  protected final String TEXT_279 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_280 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_281 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_282 = " = evReader_";
  protected final String TEXT_283 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_284 = ".add(line_";
  protected final String TEXT_285 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_286 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_287 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_288 = ");" + NL + "\tevPara_";
  protected final String TEXT_289 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_290 = ");" + NL + "\tevPara_";
  protected final String TEXT_291 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_292 = "\");" + NL + "\t";
  protected final String TEXT_293 = NL + "\tevPara_";
  protected final String TEXT_294 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_295 = ");";
  protected final String TEXT_296 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_297 = " = new java.io.File (";
  protected final String TEXT_298 = "+\"/bin\");" + NL + "\tdbLoadDirectory_";
  protected final String TEXT_299 = ".exists();" + NL + "\t\t\t\t" + NL + " \tRuntime runtime_";
  protected final String TEXT_300 = " = Runtime.getRuntime();";
  protected final String TEXT_301 = NL + "\tfinal Process ps_";
  protected final String TEXT_302 = " = runtime_";
  protected final String TEXT_303 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_304 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_305 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_306 = ");";
  protected final String TEXT_307 = NL + "\tfinal Process ps_";
  protected final String TEXT_308 = " = runtime_";
  protected final String TEXT_309 = ".exec(command_";
  protected final String TEXT_310 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_311 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_312 = ");";
  protected final String TEXT_313 = NL;
  protected final String TEXT_314 = NL + NL + "Thread normal_";
  protected final String TEXT_315 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_316 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_317 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_318 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_319 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_320 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_321 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_322 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_323 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_324 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_325 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_326 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_327 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_328 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_329 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_330 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_331 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_332 = ".interrupt();" + NL + "error_";
  protected final String TEXT_333 = ".interrupt();" + NL + NL + NL + NL;
