...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_108 = NL + "\t\tString password_";
  protected final String TEXT_109 = " = decryptedPassword_";
  protected final String TEXT_110 = ";" + NL + "\t";
  protected final String TEXT_111 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_112 = " = null;" + NL;
  protected final String TEXT_113 = NL + "\t";
  protected final String TEXT_114 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_115 = ")) {";
  protected final String TEXT_116 = NL + "\t\t";
  protected final String TEXT_117 = NL + "\t\t";
  protected final String TEXT_118 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_119 = "\", conn_";
  protected final String TEXT_120 = ");";
  protected final String TEXT_121 = NL + "\t}";
  protected final String TEXT_122 = NL + "\tif (null != conn_";
  protected final String TEXT_123 = ") {" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t}";
  protected final String TEXT_125 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_126 = "\",conn_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_129 = "\",conn_";
  protected final String TEXT_130 = ".getMetaData().getUserName());";
  protected final String TEXT_131 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_132 = "\", ";
  protected final String TEXT_133 = ");";
  protected final String TEXT_134 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_135 = "\",";
  protected final String TEXT_136 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
  protected final String TEXT_137 = "\",password_";
