...
public class TTeradataFastLoadUtilityMainJava
{
  ...
  protected final String TEXT_99 = ";" + NL + "java.io.File file_";
  protected final String TEXT_100 = " = new java.io.File(";
  protected final String TEXT_101 = "+";
  protected final String TEXT_102 = "+\".script\");" + NL + "java.io.FileWriter fw_";
  protected final String TEXT_103 = " = new java.io.FileWriter(file_";
  protected final String TEXT_104 = ");" + NL;
  protected final String TEXT_105 = NL + "try{" + NL + "StringBuilder script_";
  protected final String TEXT_106 = " = new StringBuilder();" + NL + "fw_";
  protected final String TEXT_107 = ".write(\"SESSIONS 8;\"+ \"";
  protected final String TEXT_108 = "\");" + NL + "fw_";
  protected final String TEXT_109 = ".write(\"SET RECORD VARTEXT \\\"\"+";
  ...
  protected final String TEXT_119 = ".write(\"LOGON \"+";
  protected final String TEXT_120 = "+\"/\"+";
  protected final String TEXT_121 = "+\",\"+decryptedPassword_";
  protected final String TEXT_122 = "+\";\"+ \"";
  protected final String TEXT_123 = "\");";
  protected final String TEXT_124 = NL + "fw_";
  protected final String TEXT_125 = ".write(\"DELETE FROM \"+ ";
  protected final String TEXT_126 = " + \".\" + ";
  protected final String TEXT_127 = " + \" ALL;\"+ \"";
  protected final String TEXT_128 = "\");";
  protected final String TEXT_129 = NL + "fw_";
  protected final String TEXT_130 = ".write(\"DEFINE \"+ \"";
  protected final String TEXT_131 = "\");";
  protected final String TEXT_132 = NL + "\t\tfw_";
  protected final String TEXT_133 = ".write(\"";
  protected final String TEXT_134 = "\"+\" (VARCHAR(";
  protected final String TEXT_135 = ")),\"+ \"";
  protected final String TEXT_136 = "\");" + NL + "\t";
  protected final String TEXT_137 = NL + "\t\t\tfw_";
  protected final String TEXT_138 = ".write(\"";
  protected final String TEXT_139 = "\"+\" (VARCHAR(";
  protected final String TEXT_140 = "))\"+ \"";
  protected final String TEXT_141 = "\");" + NL + "\t";
  protected final String TEXT_142 = NL + "fw_";
  protected final String TEXT_143 = ".write(\"FILE=\"+";
  protected final String TEXT_144 = "+\";\"+ \"";
  protected final String TEXT_145 = "\");" + NL + "fw_";
  protected final String TEXT_146 = ".write(\"BEGIN LOADING \"+ ";
  protected final String TEXT_147 = " + \".\" + ";
  protected final String TEXT_148 = "+\" \"+";
  protected final String TEXT_149 = "+\" CHECKPOINT ";
  protected final String TEXT_150 = ";\"+ \"";
  protected final String TEXT_151 = "\");" + NL + "fw_";
  protected final String TEXT_152 = ".write(\"ERRLIMIT ";
  protected final String TEXT_153 = ";\"+ \"";
  protected final String TEXT_154 = "\");";
  protected final String TEXT_155 = NL + "fw_";
  protected final String TEXT_156 = ".write(\"INSERT INTO \"+ ";
  ...
  protected final String TEXT_163 = ".write(\"END LOADING;\"+ \"";
  protected final String TEXT_164 = "\");" + NL + "fw_";
  protected final String TEXT_165 = ".write(\"LOGOFF;\"+ \"";
  protected final String TEXT_166 = "\");" + NL;
  protected final String TEXT_167 = NL + "fw_";
  protected final String TEXT_168 = ".close();" + NL;
  protected final String TEXT_169 = NL + "String sb_";
  protected final String TEXT_170 = "= new String(\"fastload -c \"+";
  protected final String TEXT_171 = "+\" < \\\"\"+";
  protected final String TEXT_172 = "+";
  protected final String TEXT_173 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_174 = "+\"\\\" 2>&1\");";
  protected final String TEXT_175 = "\t" + NL + "String sb_";
  protected final String TEXT_176 = "= new String(\"fastload < \\\"\"+";
  protected final String TEXT_177 = "+";
  protected final String TEXT_178 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_179 = "+\"\\\" 2>&1\");";
  protected final String TEXT_180 = NL + "\tlog.info(\"";
  protected final String TEXT_181 = " - Executing '\" + sb_";
  protected final String TEXT_182 = " + \"'.\");";
  protected final String TEXT_183 = NL + "final Process process_";
  protected final String TEXT_184 = " = Runtime.getRuntime().exec(new String[]{\"cmd\",\"/c\",sb_";
  protected final String TEXT_185 = "}); ";
  protected final String TEXT_186 = NL + "final Process process_";
  protected final String TEXT_187 = " = Runtime.getRuntime().exec(new String[]{\"sh\",\"-c\",sb_";
  protected final String TEXT_188 = "});";
  protected final String TEXT_189 = NL + "Thread normal_";
  protected final String TEXT_190 = " = new Thread() {" + NL + "    public void run() {" + NL + "    \ttry {" + NL + "    \t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_191 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_193 = " - \" + ioe.getMessage());" + NL + "\t\t\t";
  ...
  protected final String TEXT_197 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_199 = " - \" + ioe.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t   ioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_201 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_202 = ".waitFor();" + NL + "" + NL + "normal_";
  protected final String TEXT_203 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_204 = ".interrupt();";
  protected final String TEXT_205 = NL + "\tlog.info(\"";
  protected final String TEXT_206 = " - Excute '\" + sb_";
  protected final String TEXT_207 = " + \"' has succeeded.\");";
  ...
  protected final String TEXT_214 = NL + "\t\t\tlog.fatal(\"";
  protected final String TEXT_215 = " - Fastload returned exit code \"+process_";
  protected final String TEXT_216 = ".exitValue());" + NL + "\t\t";
  protected final String TEXT_217 = NL + "\t\tthrow new RuntimeException(\"Fastload returned exit code \"+process_";
  protected final String TEXT_218 = ".exitValue());" + NL + "\t}";
  protected final String TEXT_219 = NL;
  protected final String TEXT_220 = NL + "   \tlog.info(\"";
  protected final String TEXT_221 = " - Has finished.\");";
  protected final String TEXT_222 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_223 = ".delete();" + NL + "\t}catch(Exception e_";
