...
public class TInformixSCDBeginJava {
  ...
  protected final String TEXT_39 = ";" + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_44 = NL + "\tif(connection_";
  protected final String TEXT_45 = ".getAutoCommit()) {" + NL + "\t    connection_";
  protected final String TEXT_46 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_47 = NL + "    String tableName_";
  protected final String TEXT_48 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_49 = " == null || schema_";
  protected final String TEXT_50 = ".trim().length() == 0) {" + NL + "        tableName_";
  ...
  protected final String TEXT_178 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_179 = " + \"-01-01 12:00:00\").getTime()));";
