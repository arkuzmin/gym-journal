...
public class TJavaDBRowBeginJava
{
  ...
  protected final String TEXT_35 = " = true;" + NL + "    \t\t}" + NL + "    \t\tcatch(java.lang.Exception e) {" + NL + "    \t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t}    \t\t\t\t" + NL + "    \t}" + NL + "    \tif(!isServerUp_";
  protected final String TEXT_36 = ")" + NL + "    \t{" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  ...
  protected final String TEXT_49 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_50 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_53 = ",properties_";
  protected final String TEXT_54 = ");" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_55 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_56 = " = false;" + NL;
  protected final String TEXT_57 = NL + NL + "int commitEvery_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_60 = " = 0;" + NL + "" + NL + "conn_";
  protected final String TEXT_61 = ".setAutoCommit(false);";
