...
public class TJavaDBOutputBeginJava {
  ...
  protected final String TEXT_46 = ") {" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\"); " + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  ...
  protected final String TEXT_69 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_70 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_73 = ",properties_";
  protected final String TEXT_74 = ");" + NL + "resourceMap.put(\"conn_";
  protected final String TEXT_75 = "\", conn_";
  protected final String TEXT_76 = ");" + NL + "conn_";
  protected final String TEXT_77 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_103 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_104 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_115 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_122 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_123 = " = deletedCount_";
  protected final String TEXT_124 = " + stmtClear_";
  protected final String TEXT_125 = ".executeUpdate(\"";
  protected final String TEXT_126 = "\");";
  protected final String TEXT_127 = NL + "\t    String insert_";
  protected final String TEXT_128 = " = \"INSERT INTO \\\"\" + ";
  ...
  protected final String TEXT_133 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_145 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_163 = " = \"UPDATE \\\"\" + ";
  ...
  protected final String TEXT_173 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".prepareStatement(insert_";
  protected final String TEXT_176 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_177 = NL + "\t    String delete_";
  protected final String TEXT_178 = " = \"DELETE  FROM \\\"\" + ";
  ...
  protected final String TEXT_182 = ".prepareStatement(delete_";
  protected final String TEXT_183 = ");" + NL + "\t    ";
  protected final String TEXT_184 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_193 = NL + "\t\t\tupdate_";
  protected final String TEXT_194 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_195 = " = update_";
  protected final String TEXT_196 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_197 = " = insert_";
  protected final String TEXT_198 = ".split(\"\\\\?\");";
  protected final String TEXT_199 = NL + "\t\t\tdelete_";
  protected final String TEXT_200 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_201 = " = delete_";
  protected final String TEXT_202 = ".split(\"\\\\?\");";
  protected final String TEXT_203 = NL + "\t\t\treplace_";
  protected final String TEXT_204 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_205 = " = replace_";
  protected final String TEXT_206 = ".split(\"\\\\?\");";
  protected final String TEXT_207 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_208 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_209 = " = insertIgnore_";
  protected final String TEXT_210 = ".split(\"\\\\?\");";
  protected final String TEXT_211 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_212 = " = insert_";
  protected final String TEXT_213 = ".split(\"\\\\?\");";
  protected final String TEXT_214 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_215 = " = ";
  protected final String TEXT_216 = ";" + NL + "        " + NL + "        int commitCounter_";
