...
public class TInformixConnectionBeginJava
{
  ...
  protected final String TEXT_56 = NL + "\t\tString password_";
  protected final String TEXT_57 = " = decryptedPassword_";
  protected final String TEXT_58 = ";" + NL + "\t";
  protected final String TEXT_59 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_60 = " = null;" + NL;
  protected final String TEXT_61 = NL + "\t";
  protected final String TEXT_62 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_63 = ")) {";
  protected final String TEXT_64 = NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\t";
  protected final String TEXT_66 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_67 = "\", conn_";
  protected final String TEXT_68 = ");";
  protected final String TEXT_69 = NL + "\t}";
  protected final String TEXT_70 = NL + "\tif (null != conn_";
  protected final String TEXT_71 = ") {" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t}";
  protected final String TEXT_73 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_74 = "\",conn_";
  protected final String TEXT_75 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
