...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_6 = "Thread extends TalendThread {//implements routines.system.TalendThreadPool.PropertySettable" + NL + "\t" + NL + "\t\t\t\tclass ThreadedMap extends java.util.HashMap<String, Object> {" + NL + "\t\t\t" + NL + "\t\t\t\t\tprivate static final long serialVersionUID = 0L;" + NL + "\t\t" + NL + "\t\t\t\t\tpublic ThreadedMap(java.util.Map<String, Object> globalMap) {" + NL + "\t\t\t\t\t\tsuper(globalMap);" + NL + "\t\t\t\t\t}" + NL + "\t\t" + NL + "\t\t\t\t\t@Override" + NL + "\t\t\t\t\tpublic Object put(String key, Object value) {" + NL + "\t\t\t\t\t\t";
