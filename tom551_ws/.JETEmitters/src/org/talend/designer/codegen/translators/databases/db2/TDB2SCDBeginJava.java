...
public class TDB2SCDBeginJava {
  ...
  protected final String TEXT_8 = " = (String) globalMap.get(\"tableschema_";
  ...
  protected final String TEXT_13 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_14 = " + \":\" + ";
  protected final String TEXT_15 = " + \"/\" + ";
  protected final String TEXT_16 = ";    ";
  protected final String TEXT_17 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_18 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/\" + ";
  protected final String TEXT_21 = " + \":\" + ";
  protected final String TEXT_22 = ";";
  protected final String TEXT_23 = NL + "        java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t\t";
  ...
  protected final String TEXT_32 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_33 = ", ";
  protected final String TEXT_34 = ", decryptedPassword_";
  protected final String TEXT_35 = ");" + NL + "        String schema_";
  protected final String TEXT_36 = " = ";
  protected final String TEXT_37 = ";" + NL + "\t    ";
  protected final String TEXT_38 = "    " + NL + "\tString tableName_";
  protected final String TEXT_39 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_40 = " == null || schema_";
  protected final String TEXT_41 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_42 = " = ";
  protected final String TEXT_43 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_44 = " = schema_";
  protected final String TEXT_45 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_46 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_47 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_48 = " = null;    ";
  protected final String TEXT_49 = NL + "        String searching_";
  protected final String TEXT_50 = " = \"";
  protected final String TEXT_51 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_52 = " = connection_";
  protected final String TEXT_53 = ".prepareStatement(searching_";
  protected final String TEXT_54 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_55 = " = null;";
  protected final String TEXT_56 = NL + "        String search_";
  protected final String TEXT_57 = " = \"";
  protected final String TEXT_58 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_59 = " = connection_";
  protected final String TEXT_60 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_61 = " = statement_";
  protected final String TEXT_62 = ".executeQuery(search_";
  protected final String TEXT_63 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_64 = ", SCDStruct_";
  protected final String TEXT_65 = "> cache_";
  protected final String TEXT_66 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_67 = ", SCDStruct_";
  protected final String TEXT_68 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_69 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_70 = " sk_";
  protected final String TEXT_71 = " = new SCDSK_";
  protected final String TEXT_72 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_73 = " row_";
  protected final String TEXT_74 = " = new SCDStruct_";
  protected final String TEXT_75 = "();";
  protected final String TEXT_76 = NL + "                    tmpValue_";
  protected final String TEXT_77 = " = resultSet_";
  protected final String TEXT_78 = ".getString(";
  protected final String TEXT_79 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_80 = " != null && tmpValue_";
  protected final String TEXT_81 = ".length() > 0) {";
  protected final String TEXT_82 = NL + "                        ";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = " = tmpValue_";
  protected final String TEXT_85 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_86 = NL + "                            if(tmpValue_";
  protected final String TEXT_87 = " == null) {";
  protected final String TEXT_88 = NL + "                                ";
  protected final String TEXT_89 = ".";
  protected final String TEXT_90 = " = null;" + NL + "                            } else {";
  protected final String TEXT_91 = NL + "                                ";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_94 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_95 = ")) {";
  protected final String TEXT_96 = NL + "                                ";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_99 = "' in '";
  protected final String TEXT_100 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_101 = NL + "                    }";
  protected final String TEXT_102 = NL + "                    timestamp_";
  protected final String TEXT_103 = " = resultSet_";
  ...
  protected final String TEXT_114 = NL + "                    if(resultSet_";
  protected final String TEXT_115 = ".getObject(";
  ...
  protected final String TEXT_123 = NL + "            cache_";
  protected final String TEXT_124 = ".put(sk_";
  protected final String TEXT_125 = ", row_";
  protected final String TEXT_126 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_127 = ".close();" + NL + "        statement_";
  protected final String TEXT_128 = ".close();";
  protected final String TEXT_129 = NL + "            System.out.println(\"[";
  protected final String TEXT_130 = "] comparison cache loaded\");";
  protected final String TEXT_131 = NL + "        ";
  protected final String TEXT_132 = " nextSurrogateKey_";
  protected final String TEXT_133 = " = 1;";
  protected final String TEXT_134 = NL + "            if(cache_";
  protected final String TEXT_135 = ".size() > 0) {";
  protected final String TEXT_136 = NL + "        String tmpQuery_";
  protected final String TEXT_137 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_138 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_139 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_140 = " = connection_";
  protected final String TEXT_141 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_142 = " = tmpStmt_";
  protected final String TEXT_143 = ".executeQuery(tmpQuery_";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "        if(tmpRS_";
  protected final String TEXT_146 = ".next() && tmpRS_";
  protected final String TEXT_147 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_148 = " = tmpRS_";
  protected final String TEXT_149 = ".get";
  protected final String TEXT_150 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_151 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_152 = ".close();";
  protected final String TEXT_153 = NL + "            }            ";
  protected final String TEXT_154 = NL + "    String insertionSQL_";
  protected final String TEXT_155 = " = \"";
  protected final String TEXT_156 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_157 = " = connection_";
  protected final String TEXT_158 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_159 = ");";
  protected final String TEXT_160 = NL + "            insertionStatement_";
  protected final String TEXT_161 = ".setTimestamp(";
  protected final String TEXT_162 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_163 = "\")));";
  protected final String TEXT_164 = NL + "            insertionStatement_";
  protected final String TEXT_165 = ".setNull(";
  protected final String TEXT_166 = ", java.sql.Types.DATE);";
  protected final String TEXT_167 = NL + "            insertionStatement_";
  protected final String TEXT_168 = ".setTimestamp(";
  protected final String TEXT_169 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_170 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_171 = NL + "        String updateSQLForType1_";
  protected final String TEXT_172 = " = \"";
  protected final String TEXT_173 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_174 = " = connection_";
  protected final String TEXT_175 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_176 = ");        ";
  protected final String TEXT_177 = NL + "        String updateSQLForType2_";
  protected final String TEXT_178 = " = \"";
  protected final String TEXT_179 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_180 = " = connection_";
  protected final String TEXT_181 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "            updateForType2_";
  protected final String TEXT_184 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_185 = "\")));";
  protected final String TEXT_186 = NL + "        String updateSQLForType3_";
  protected final String TEXT_187 = " = \"";
  protected final String TEXT_188 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_189 = " = connection_";
  protected final String TEXT_190 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "        SCDSK_";
  protected final String TEXT_193 = " lookUpKey_";
  protected final String TEXT_194 = " = null;        ";
  protected final String TEXT_195 = NL + "    SCDStruct_";
