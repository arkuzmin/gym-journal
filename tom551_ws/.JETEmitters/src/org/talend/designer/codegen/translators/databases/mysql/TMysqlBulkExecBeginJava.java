...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_58 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_59 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_60 = " = tableNameForSearch_";
  protected final String TEXT_61 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_62 = " = tableNameForSearch_";
  ...
  protected final String TEXT_66 = ", tableNameForSearch_";
  ...
  protected final String TEXT_80 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_81 = " = rsTable_";
  protected final String TEXT_82 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_83 = ".equalsIgnoreCase(";
  protected final String TEXT_84 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_85 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_86 = ") || dbschema_";
  protected final String TEXT_87 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_88 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_89 = ".close();";
  protected final String TEXT_90 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_91 = " = conn_";
  protected final String TEXT_92 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_93 = " = dbMetaData_";
  protected final String TEXT_94 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_95 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_96 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_97 = " = rsTable_";
  protected final String TEXT_98 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  protected final String TEXT_99 = " = rsTable_";
  protected final String TEXT_100 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_101 = ".equals(";
  protected final String TEXT_102 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_103 = ".equals(schema_";
  protected final String TEXT_104 = ") || (schema_";
  protected final String TEXT_105 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_106 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_115 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_116 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_117 = " == null || dbschema_";
  protected final String TEXT_118 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_121 = " = stmtSchema_";
  protected final String TEXT_122 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_123 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_124 = " = rsSchema_";
  protected final String TEXT_125 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_126 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_127 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_128 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_129 = " = rsTable_";
  protected final String TEXT_130 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_134 = "IgnoreCase";
  protected final String TEXT_135 = "(";
  protected final String TEXT_136 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_137 = ".equals";
  protected final String TEXT_138 = "IgnoreCase";
  ...
  protected final String TEXT_142 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_143 = ".equals";
  protected final String TEXT_144 = "IgnoreCase";
  protected final String TEXT_145 = "(schema_";
  ...
  protected final String TEXT_157 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_168 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_173 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_176 = ".execute(\"";
  protected final String TEXT_177 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_178 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_206 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_207 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_208 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_209 = " " + NL + "String lines_separator_";
  protected final String TEXT_210 = " = ";
  protected final String TEXT_211 = ";" + NL + "String field_separator_";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = ";" + NL + "String escaped_str_";
  protected final String TEXT_214 = " = ";
  protected final String TEXT_215 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ";" + NL + "String file_";
  protected final String TEXT_218 = " = ";
  protected final String TEXT_219 = ";" + NL + "file_";
  protected final String TEXT_220 = " = file_";
  protected final String TEXT_221 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  protected final String TEXT_222 = " = null;";
  protected final String TEXT_223 = NL + "        int keyCount_";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_226 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }        " + NL + "        tableName_";
  protected final String TEXT_227 = " = \"tmp_";
  protected final String TEXT_228 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtTmpCreate_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".createStatement();" + NL + "        stmtTmpCreate_";
  protected final String TEXT_231 = ".execute(\"";
  protected final String TEXT_232 = ")\");" + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_235 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_236 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_237 = ".execute(" + NL + "            \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_238 = " + \"' \"  " + NL + "            + \" INTO TABLE \" + tableName_";
  protected final String TEXT_239 = NL + "            + \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_240 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "            + \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_241 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_242 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "            + \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_243 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_244 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "            + \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_245 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_246 = "\"    ";
  protected final String TEXT_247 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_248 = NL + "\t\t\t+ \" ";
  protected final String TEXT_249 = "=CAST(@";
  protected final String TEXT_250 = "_";
  protected final String TEXT_251 = " AS UNSIGNED)\"";
  protected final String TEXT_252 = NL + "\t\t\t+ \",\"\t";
  protected final String TEXT_253 = "          " + NL + "        );" + NL + "        tableName_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "        String tmpTableName_";
  protected final String TEXT_256 = " = \"tmp_";
  protected final String TEXT_257 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_260 = ".executeUpdate(\"";
  protected final String TEXT_261 = "\");" + NL + "        tableName_";
  protected final String TEXT_262 = " = tmpTableName_";
  protected final String TEXT_263 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_266 = ".execute(\"";
  protected final String TEXT_267 = "\");";
  protected final String TEXT_268 = NL + "        replace_";
  protected final String TEXT_269 = " = \"REPLACE\";";
  protected final String TEXT_270 = NL + "        replace_";
  protected final String TEXT_271 = " = \"IGNORE\";";
  protected final String TEXT_272 = NL + "        replace_";
  protected final String TEXT_273 = " = \"\";";
  protected final String TEXT_274 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_275 = "=conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_277 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_278 = ");" + NL + "    stmt_";
  protected final String TEXT_279 = ".execute(" + NL + "        \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_280 = " + \"' \" " + NL + "        + replace_";
  protected final String TEXT_281 = " " + NL + "        + \" INTO TABLE \" + tableName_";
  protected final String TEXT_282 = NL + "        + \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_283 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_284 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_285 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_286 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_287 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "        + \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_288 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_289 = "\"  ";
  protected final String TEXT_290 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_291 = NL + "\t\t+ \" ";
  protected final String TEXT_292 = "=CAST(@";
  protected final String TEXT_293 = "_";
  protected final String TEXT_294 = " AS UNSIGNED)\"";
  protected final String TEXT_295 = NL + "\t\t+ \",\"\t";
  protected final String TEXT_296 = "         " + NL + "    );";
  protected final String TEXT_297 = NL + "conn_";
