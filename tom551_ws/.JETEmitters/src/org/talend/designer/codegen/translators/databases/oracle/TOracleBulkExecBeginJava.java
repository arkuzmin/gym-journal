...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_68 = NL + "    password_";
  protected final String TEXT_69 = " = decryptedPassword_";
  protected final String TEXT_70 = ";" + NL + "        ";
  protected final String TEXT_71 = NL + "\t\turl_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";        " + NL + "\t\tserviceUrl_";
  protected final String TEXT_74 = " = url_";
  protected final String TEXT_75 = ".substring(url_";
  protected final String TEXT_76 = ".indexOf(\"@\")+1); " + NL + "\t\t";
  protected final String TEXT_77 = NL + "\t    serviceUrl_";
  protected final String TEXT_78 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_79 = " + \")(port=\" + ";
  protected final String TEXT_80 = " + \"))(connect_data=(SID=\" + dbname_";
  protected final String TEXT_81 = " + \")))\";" + NL + "        url_";
  protected final String TEXT_82 = " = \"jdbc:oracle:thin:@\" + host_";
  protected final String TEXT_83 = " + \":\" + ";
  protected final String TEXT_84 = " + \":\" + dbname_";
  protected final String TEXT_85 = ";";
  protected final String TEXT_86 = NL + "        serviceUrl_";
  protected final String TEXT_87 = " = \"(description=(address=(protocol=tcp)(host=\" + host_";
  protected final String TEXT_88 = " + \")(port=\" + ";
  protected final String TEXT_89 = " + \"))(connect_data=(service_name=\" + dbname_";
  protected final String TEXT_90 = " + \")))\";" + NL + "        url_";
  protected final String TEXT_91 = " = \"jdbc:oracle:thin:@\" + serviceUrl_";
  protected final String TEXT_92 = ";";
  protected final String TEXT_93 = NL + "        serviceUrl_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = ";" + NL + "        url_";
  protected final String TEXT_96 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_97 = "; ";
  protected final String TEXT_98 = NL + "\t";
  protected final String TEXT_99 = NL + "    \tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");\t";
  protected final String TEXT_100 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");\t" + NL + "\t";
  protected final String TEXT_101 = NL + "\tconn_";
  protected final String TEXT_102 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_103 = ",username_";
  protected final String TEXT_104 = ",password_";
  protected final String TEXT_105 = ");";
  protected final String TEXT_106 = NL + "\tString atnParams_";
  protected final String TEXT_107 = " = ";
  protected final String TEXT_108 = ";" + NL + "\tatnParams_";
  protected final String TEXT_109 = " = atnParams_";
  ...
  protected final String TEXT_112 = ".put(\"user\",username_";
  protected final String TEXT_113 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_114 = ".put(\"password\",password_";
  protected final String TEXT_115 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_116 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  ...
  protected final String TEXT_122 = NL + "String tableName_";
  protected final String TEXT_123 = " = null;" + NL + "if(\"ORACLE_RAC\".equals(\"";
  ...
  protected final String TEXT_132 = NL + "    String tmpTableName_";
  protected final String TEXT_133 = " = tableName_";
  protected final String TEXT_134 = ";" + NL + "    tableName_";
  protected final String TEXT_135 = " = \"t_";
  protected final String TEXT_136 = "\" + \"_\" + pid + Thread.currentThread().getId();  ";
  ...
  protected final String TEXT_152 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_187 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_188 = ") || dbschema_";
  protected final String TEXT_189 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_197 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_198 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_199 = " = rsTable_";
  protected final String TEXT_200 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  protected final String TEXT_201 = " = rsTable_";
  protected final String TEXT_202 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_203 = ".equals(";
  protected final String TEXT_204 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_205 = ".equals(schema_";
  protected final String TEXT_206 = ") || (schema_";
  protected final String TEXT_207 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_208 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_247 = "(schema_";
  ...
  protected final String TEXT_268 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_275 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_282 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_286 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_292 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_293 = " = conn_";
  protected final String TEXT_294 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_295 = " = stmtTruncCount_";
  protected final String TEXT_296 = ".executeQuery(\"";
  protected final String TEXT_297 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_300 = ".executeUpdate(\"";
  protected final String TEXT_301 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_302 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_303 = " += rsTruncCount_";
  protected final String TEXT_304 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_305 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_306 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_307 = ".close();            ";
  protected final String TEXT_308 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_309 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_310 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_311 = NL + "\t";
  protected final String TEXT_312 = NL + "\tString ctlf_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = ";" + NL + "\tString logf_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = "+\".log\";" + NL + "\t";
  protected final String TEXT_317 = NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_318 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_319 = ".append(\"OPTIONS (\");";
  protected final String TEXT_320 = NL + "    \t\toptionClause_";
  protected final String TEXT_321 = ".append(\", \");" + NL + "    \t\t";
  protected final String TEXT_322 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_323 = ".append(\"";
  protected final String TEXT_324 = "=(";
  protected final String TEXT_325 = ")\");" + NL + "    \t\t\t\t";
  protected final String TEXT_326 = NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_327 = ".append(\"";
  protected final String TEXT_328 = "=";
  protected final String TEXT_329 = "\");" + NL + "    \t\t\t\t";
  protected final String TEXT_330 = NL + "    \t\t\tif(";
  protected final String TEXT_331 = ".split(\",\").length>1){" + NL + "    \t\t\t\toptionClause_";
  protected final String TEXT_332 = ".append(\"";
  protected final String TEXT_333 = "=(\"+";
  protected final String TEXT_334 = "+\")\");" + NL + "    \t\t\t}else{" + NL + "    \t\t\t\toptionClause_";
  ...
  protected final String TEXT_350 = NL + "\t\t    \toptionClause_";
  protected final String TEXT_351 = ".append(\"";
  protected final String TEXT_352 = "=\"+";
  protected final String TEXT_353 = ");" + NL + "\t\t    \t";
  protected final String TEXT_354 = NL + "    optionClause_";
  protected final String TEXT_355 = ".append(\")\");";
  protected final String TEXT_356 = NL + "    String dataf_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = " + Thread.currentThread().getId();" + NL + "    " + NL + "    String ctlf_";
  protected final String TEXT_359 = " = dataf_";
  protected final String TEXT_360 = " + \".ctl\";" + NL + "    " + NL + "    String badf_";
  protected final String TEXT_361 = " = dataf_";
  protected final String TEXT_362 = " + \".bad\";" + NL + "    " + NL + "    String dscf_";
  protected final String TEXT_363 = " = dataf_";
  protected final String TEXT_364 = " + \".dsc\";" + NL + "    " + NL + "    String logf_";
  protected final String TEXT_365 = " = dataf_";
  protected final String TEXT_366 = " + \".log\";" + NL + "    " + NL + "    dataf_";
  protected final String TEXT_367 = " = ";
  protected final String TEXT_368 = ";" + NL + "    " + NL + "    java.io.File badFile_";
  protected final String TEXT_369 = " = new java.io.File(badf_";
  protected final String TEXT_370 = ");" + NL + "    " + NL + "    if(badFile_";
  protected final String TEXT_371 = ".exists()){" + NL + "    \t" + NL + "        badFile_";
  protected final String TEXT_372 = ".delete();" + NL + "    \t" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_373 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_374 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_375 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_376 = " ,false) ;" + NL + "    " + NL + "    pw_";
  protected final String TEXT_377 = ".println(optionClause_";
  protected final String TEXT_378 = ".toString());" + NL + "  " + NL + "    pw_";
  protected final String TEXT_379 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_380 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_381 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_382 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_383 = " + \"'\");" + NL + "        ";
  protected final String TEXT_384 = NL + "\t\tbw_";
  protected final String TEXT_385 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_386 = NL + "    " + NL + "    " + NL + "    ";
  protected final String TEXT_387 = NL + "        bw_";
  protected final String TEXT_388 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_389 = " + \"'\\\"\");";
  protected final String TEXT_390 = NL + "        bw_";
  protected final String TEXT_391 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_392 = " + \"\\\"\");";
  protected final String TEXT_393 = NL + "        bw_";
  protected final String TEXT_394 = ".write(\" \\\"var \" + ";
  protected final String TEXT_395 = " + \"\\\"\");";
  protected final String TEXT_396 = NL + "    pw_";
  protected final String TEXT_397 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_398 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_399 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_400 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_401 = " + \"'\");";
  protected final String TEXT_402 = NL + "        pw_";
  protected final String TEXT_403 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_404 = NL + "        bw_";
  protected final String TEXT_405 = ".write(";
  protected final String TEXT_406 = ");";
  protected final String TEXT_407 = NL + "\t\t\tpw_";
  protected final String TEXT_408 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_409 = ");" + NL + "\t\t\tpw_";
  protected final String TEXT_410 = ".println(\"INSERT\");";
  protected final String TEXT_411 = NL + "            pw_";
  protected final String TEXT_412 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_413 = ");" + NL + "            pw_";
  protected final String TEXT_414 = ".println(\"";
  protected final String TEXT_415 = "\");";
  protected final String TEXT_416 = NL + "                pw_";
  protected final String TEXT_417 = ".println(\"WHEN \" + ";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "            bw_";
  protected final String TEXT_420 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_421 = "\");";
  protected final String TEXT_422 = NL + "            bw_";
  protected final String TEXT_423 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_424 = " + \"\\\"\");";
  protected final String TEXT_425 = NL + "                bw_";
  protected final String TEXT_426 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_427 = NL + "                bw_";
  protected final String TEXT_428 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_429 = NL + "            bw_";
  protected final String TEXT_430 = ".write(\"'\" + ";
  protected final String TEXT_431 = " + \"'\");";
  protected final String TEXT_432 = NL + "                bw_";
  protected final String TEXT_433 = ".write(\" AND '\" + ";
  protected final String TEXT_434 = " + \"'\");";
  protected final String TEXT_435 = NL + "            pw_";
  protected final String TEXT_436 = ".println(\"\");";
  protected final String TEXT_437 = NL + "            pw_";
  protected final String TEXT_438 = ".println(\"\");";
  protected final String TEXT_439 = NL + "            pw_";
  protected final String TEXT_440 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_441 = NL + "\t        pw_";
  protected final String TEXT_442 = ".println(\"";
  protected final String TEXT_443 = "\");";
  protected final String TEXT_444 = NL + "    bw_";
  protected final String TEXT_445 = ".close();" + NL + "    pw_";
  protected final String TEXT_446 = ".close();";
  protected final String TEXT_447 = NL + NL + "String command_";
  protected final String TEXT_448 = " = \"sqlldr '\" + username_";
  protected final String TEXT_449 = " + \"/\" + password_";
  protected final String TEXT_450 = " + \"@\" + serviceUrl_";
  protected final String TEXT_451 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_452 = " + \"' LOG='\" + logf_";
  protected final String TEXT_453 = " + \"'\";" + NL;
  protected final String TEXT_454 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_455 = " = conn_";
  protected final String TEXT_456 = ".createStatement();" + NL + "    stmtCreateTmp_";
  protected final String TEXT_457 = ".execute(\"";
  protected final String TEXT_458 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_459 = ".close();" + NL + "\t";
  protected final String TEXT_460 = NL + "    final Process process_";
  protected final String TEXT_461 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_462 = ");";
  protected final String TEXT_463 = NL + "\t\tjava.util.ArrayList<String> envParam_";
  protected final String TEXT_464 = "=new java.util.ArrayList<String>();" + NL + "\t\tjava.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_465 = " = System.getenv();" + NL + "\t\tfor (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_466 = ".entrySet())" + NL + "\t\t{" + NL + "\t\t   envParam_";
  protected final String TEXT_467 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "\t\t}";
  protected final String TEXT_468 = NL + "\t\tenvParam_";
  protected final String TEXT_469 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_470 = "\");";
  protected final String TEXT_471 = NL + "\t\tenvParam_";
  protected final String TEXT_472 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_473 = "\");";
  protected final String TEXT_474 = NL + "\t\t\tenvParam_";
  protected final String TEXT_475 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_476 = "\");";
  protected final String TEXT_477 = NL + "        envParam_";
  protected final String TEXT_478 = ".add(\"";
  protected final String TEXT_479 = "=";
  protected final String TEXT_480 = "\");";
  protected final String TEXT_481 = NL + "    final Process process_";
  protected final String TEXT_482 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_483 = ",envParam_";
  protected final String TEXT_484 = ".toArray(new String[0]));";
  protected final String TEXT_485 = " " + NL + "" + NL + "//System.out.println(command_";
  protected final String TEXT_486 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_487 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_488 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t        ";
  protected final String TEXT_489 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_490 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_491 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_492 = "_OUTPUT\") + \"\\n\" + line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_493 = NL + "\t\t        }" + NL + "\t\t    } finally {" + NL + "\t\t         reader.close();" + NL + "\t\t    }" + NL + "\t    }catch(java.io.IOException ioe) {" + NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_494 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_495 = " = new Thread() {" + NL + "    public void run() {" + NL + "\t   try {" + NL + "\t\t   java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_496 = ".getErrorStream()));" + NL + "\t\t   String line = \"\";" + NL + "\t\t   try {" + NL + "\t\t\t   while((line = reader.readLine()) != null) {" + NL + "\t\t\t   \t  globalMap.put(\"";
  protected final String TEXT_497 = "_SQLLOAD_ERROR\", \"true\");\t" + NL + "\t\t\t       ";
  protected final String TEXT_498 = NL + "\t\t\t\t\t   System.err.println(line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_499 = NL + "\t\t\t\t\t   globalMap.put(\"";
  protected final String TEXT_500 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_501 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_502 = NL + "\t\t\t   }" + NL + "\t\t    } finally {" + NL + "\t\t\t    reader.close();" + NL + "\t\t    }" + NL + "\t    } catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "        }" + NL + "\t}" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_503 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_504 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_505 = " = process_";
  protected final String TEXT_506 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_507 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_508 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_509 = "_SQLLOAD_ERROR\"))) {" + NL + "\tthrow new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_510 = "\" , globalMap);" + NL + "} " + NL + "\t" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_511 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_512 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_513 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_514 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_515 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_516 = " = 0;" + NL + "" + NL + "/*\t1.get log file all lines count\t" + NL + "\t2.get \"Total logical records read\" line number from file end.\t" + NL + "\t3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_517 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_518 = " =0;//log file lines count" + NL + "//1" + NL + "class LogUtil_";
  protected final String TEXT_519 = "{" + NL + "\tpublic int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "\t\tint number=0;" + NL + "\t\tjava.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "\t\tString tempLine = br.readLine();" + NL + "\t\tif(tempLine!=null){" + NL + "\t\t\tString str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "\t\t\tboolean isNumber= pattern.matcher(str_number).matches();" + NL + "\t\t\tif(isNumber){" + NL + "\t\t\t\tnumber = Integer.parseInt(str_number);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn number;" + NL + "\t}" + NL + "}" + NL + "int lastTableLine_";
  protected final String TEXT_520 = " = 0;//Line Number of the last table name" + NL + "while ((tempLine_";
  protected final String TEXT_521 = " = lr_";
  protected final String TEXT_522 = ".readLine() )!= null) {" + NL + "\tcountLines_";
  protected final String TEXT_523 = "++;" + NL + "\tif(tempLine_";
  protected final String TEXT_524 = ".toUpperCase().indexOf((";
  protected final String TEXT_525 = ").toUpperCase())>-1){" + NL + "\t\tlastTableLine_";
  protected final String TEXT_526 = " = countLines_";
  protected final String TEXT_527 = ";" + NL + "\t}" + NL + "}" + NL + "lr_";
  protected final String TEXT_528 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_529 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_530 = "));" + NL + "for (int i_";
  protected final String TEXT_531 = "=0; i_";
  protected final String TEXT_532 = "<= lastTableLine_";
  protected final String TEXT_533 = "; i_";
  protected final String TEXT_534 = "++) {" + NL + "\tlr_";
  protected final String TEXT_535 = ".readLine();" + NL + "}" + NL + "\tboolean isNumber_";
  protected final String TEXT_536 = "=false;" + NL + "\ttempLine_";
  protected final String TEXT_537 = " = lr_";
  protected final String TEXT_538 = ".readLine();" + NL + "\tint emptyLineNum_";
  protected final String TEXT_539 = " =0;//The number of empty block" + NL + "\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "for (int i_";
  protected final String TEXT_540 = "=lastTableLine_";
  protected final String TEXT_541 = "+2; i_";
  protected final String TEXT_542 = "<= countLines_";
  protected final String TEXT_543 = "; i_";
  protected final String TEXT_544 = "++) {" + NL + "\ttempLine_";
  protected final String TEXT_545 = " = lr_";
  protected final String TEXT_546 = ".readLine();" + NL + "\tif(tempLine_";
  protected final String TEXT_547 = ".trim().length()>0){" + NL + "\t\tif(emptyLineNum_";
  protected final String TEXT_548 = "==2){" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t\tisFirstEmptyLine = false;" + NL + "\t\tcontinue;//skip rows now empty" + NL + "\t}else if (!isFirstEmptyLine){//skip empty rows " + NL + "\t\tisFirstEmptyLine = true;" + NL + "\t\temptyLineNum_";
  protected final String TEXT_549 = "++;" + NL + "\t}" + NL + "}" + NL + "\tLogUtil_";
  protected final String TEXT_550 = " lu_";
  protected final String TEXT_551 = " = new LogUtil_";
  protected final String TEXT_552 = "();" + NL + "\tnb_line_data_";
  protected final String TEXT_553 = " = lu_";
  protected final String TEXT_554 = ".getNumber(lr_";
  protected final String TEXT_555 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_556 = " = lu_";
  protected final String TEXT_557 = ".getNumber(lr_";
  protected final String TEXT_558 = ");//get the number of reject data line" + NL + "\tnb_line_discarded_";
  protected final String TEXT_559 = " = lu_";
  protected final String TEXT_560 = ".getNumber(lr_";
  protected final String TEXT_561 = ");//get the number of discarded data line" + NL + "\tnb_line_inserted_";
  protected final String TEXT_562 = " = nb_line_data_";
  protected final String TEXT_563 = " - nb_line_bad_";
  protected final String TEXT_564 = " - nb_line_discarded_";
  protected final String TEXT_565 = ";" + NL + "lr_";
  protected final String TEXT_566 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_567 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_568 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_569 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_570 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_571 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_572 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_573 = "_RETURN_CODE\", exitCode_";
