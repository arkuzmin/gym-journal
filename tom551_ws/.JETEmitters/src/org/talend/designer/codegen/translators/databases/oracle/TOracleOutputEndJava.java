...
public class TOracleOutputEndJava
{
  ...
  protected final String TEXT_131 = " .close();" + NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_132 = "\", true);" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_134 = " - Connection to the database closed.\");" + NL + "\t\t";
  protected final String TEXT_135 = NL + "    \t";
  protected final String TEXT_136 = NL + NL + NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_193 = " - Has inserted \"+nb_line_inserted_";
  protected final String TEXT_194 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_195 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_196 = " - Has updated \"+nb_line_update_";
  protected final String TEXT_197 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_198 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_199 = " - Has deleted \"+nb_line_deleted_";
  protected final String TEXT_200 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_201 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_202 = " - Has updated \"+nb_line_update_";
  protected final String TEXT_203 = " + \" records.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_204 = " - Has inserted \"+nb_line_inserted_";
  protected final String TEXT_205 = " + \" records.\");";
  protected final String TEXT_206 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_207 = " - Has inserted \"+nb_line_inserted_";
  protected final String TEXT_208 = " + \" records.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_209 = " - Has updated \"+nb_line_update_";
  protected final String TEXT_210 = " + \" records.\");" + NL + "    ";
  protected final String TEXT_211 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_212 = " - Has rejected \"+nb_line_rejected_";
  protected final String TEXT_213 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_214 = NL + "\t\tlog.info(\"";
  protected final String TEXT_215 = " - Done.\");" + NL + "\t";
