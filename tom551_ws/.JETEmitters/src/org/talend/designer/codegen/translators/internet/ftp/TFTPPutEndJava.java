...
public class TFTPPutEndJava
{
  ...
  protected final String TEXT_20 = NL + "\t}" + NL + "\t" + NL + "\tmsg_";
  ...
  protected final String TEXT_57 = "_NB_FILE\",nb_file_";
  protected final String TEXT_58 = ");";
  protected final String TEXT_59 = NL + "\tlog.info(\"";
  protected final String TEXT_60 = " - Uploaded files count: \" + nb_file_";
  protected final String TEXT_61 = " +  \".\");" + NL + "\tlog.info(\"";
  protected final String TEXT_62 = " - Done.\");\t";
