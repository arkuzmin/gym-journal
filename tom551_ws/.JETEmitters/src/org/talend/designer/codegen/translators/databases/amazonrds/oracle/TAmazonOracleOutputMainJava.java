...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_46 = ".toUpperCase()";
  ...
  protected final String TEXT_53 = " - Create table '\" + tableName_";
  protected final String TEXT_54 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_61 = " - Creating table '\" + tableName_";
  protected final String TEXT_62 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_64 = ".execute(((\"";
  protected final String TEXT_65 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_77 = " - Create table '\" + tableName_";
  protected final String TEXT_78 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "            stmtCreate_";
  protected final String TEXT_80 = ".close();";
  protected final String TEXT_81 = "\t         " + NL + "\t\t    " + NL + "\t\t    ";
  protected final String TEXT_82 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_83 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_90 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_91 = " = conn_";
  protected final String TEXT_92 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_93 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_94 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_95 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_96 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_97 = ")== null){";
  protected final String TEXT_98 = "              ";
  protected final String TEXT_99 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_102 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_103 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_104 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_105 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_106 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_111 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_112 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_113 = " = tableNameForSearch_";
  protected final String TEXT_114 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_115 = " = tableNameForSearch_";
  protected final String TEXT_116 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_117 = " = dbMetaData_";
  protected final String TEXT_118 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_119 = ", tableNameForSearch_";
  protected final String TEXT_120 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_121 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_122 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_123 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_134 = " = rsTable_";
  protected final String TEXT_135 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_136 = ".equals";
  protected final String TEXT_137 = "IgnoreCase";
  protected final String TEXT_138 = "(";
  protected final String TEXT_139 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_140 = ".equals";
  protected final String TEXT_141 = "IgnoreCase";
  ...
  protected final String TEXT_168 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_169 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_178 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_179 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_180 = " == null || dbschema_";
  protected final String TEXT_181 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_184 = " = stmtSchema_";
  protected final String TEXT_185 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_186 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_187 = " = rsSchema_";
  protected final String TEXT_188 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_189 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_190 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_191 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_192 = " = rsTable_";
  protected final String TEXT_193 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_194 = " = rsTable_";
  protected final String TEXT_195 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_205 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_246 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_251 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_255 = " - Droping table '\" + tableName_";
  protected final String TEXT_256 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_257 = NL + "                    stmtDrop_";
  protected final String TEXT_258 = ".execute(\"";
  protected final String TEXT_259 = "\");" + NL + "\t    \t    \t";
  protected final String TEXT_260 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - Drop table '\" + tableName_";
  protected final String TEXT_262 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_263 = NL + "                    stmtDrop_";
  protected final String TEXT_264 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_284 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_289 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_295 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_301 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_332 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_333 = " = conn_";
  protected final String TEXT_334 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_341 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_350 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_366 = "\")+\") VALUES (";
  protected final String TEXT_367 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = ")+\")\";";
  protected final String TEXT_370 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_371 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_372 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", \"";
  protected final String TEXT_375 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = ")+\")\";";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_379 = " = insert_";
  protected final String TEXT_380 = ".toUpperCase();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_420 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_427 = ".toUpperCase();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_483 = ".toUpperCase();" + NL + "\t\t\t\t\t\tupdate_";
  protected final String TEXT_484 = " = update_";
  protected final String TEXT_485 = ".toUpperCase();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_518 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_519 = ".";
  protected final String TEXT_520 = ")+\")\";";
  protected final String TEXT_521 = NL + "\t\t\t\t\t\t\tString insert_";
  protected final String TEXT_522 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_523 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_524 = ".";
  protected final String TEXT_525 = ", \"";
  protected final String TEXT_526 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_532 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_546 = ".toUpperCase();" + NL + "\t\t\t\t\t\t\tupdate_";
  protected final String TEXT_547 = " = update_";
  protected final String TEXT_548 = ".toUpperCase();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_558 = NL + "\t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_574 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_575 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_580 = ".toUpperCase();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_687 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_688 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_689 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_690 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_691 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_692 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_693 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_694 = " = insertedCount_";
  protected final String TEXT_695 = " + pstmt_";
  protected final String TEXT_696 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_758 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_759 = "++;" + NL + "    \t\t";
  protected final String TEXT_760 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_761 = "++;" + NL + "    \t\t";
  protected final String TEXT_762 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_763 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_764 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_765 = " = updatedCount_";
  protected final String TEXT_766 = " + pstmt_";
  protected final String TEXT_767 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_860 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_861 = NL + "                }" + NL + "    \t\t} else {";
  ...
  protected final String TEXT_881 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_882 = " = insertedCount_";
  protected final String TEXT_883 = " + pstmtInsert_";
  protected final String TEXT_884 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_889 = "Struct();";
  protected final String TEXT_890 = NL + "                                ";
  protected final String TEXT_891 = ".";
  protected final String TEXT_892 = " = ";
  protected final String TEXT_893 = ".";
  protected final String TEXT_894 = ";";
  protected final String TEXT_895 = NL + "                            rejectedCount_";
  protected final String TEXT_896 = " = rejectedCount_";
  protected final String TEXT_897 = " + 1;";
  protected final String TEXT_898 = NL + "                            ";
  protected final String TEXT_899 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_904 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_905 = "++;" + NL + "    \t\t";
  protected final String TEXT_906 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_912 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_913 = ",";
  protected final String TEXT_914 = ".";
  protected final String TEXT_915 = ", ";
  protected final String TEXT_916 = ",updateSQLSplits_";
  ...
  protected final String TEXT_944 = "_QUERY\", query_";
  protected final String TEXT_945 = ".toString().trim());";
  protected final String TEXT_946 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_947 = " = pstmtUpdate_";
  protected final String TEXT_948 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_949 = " = updatedCount_";
  protected final String TEXT_950 = "+updateFlag_";
  protected final String TEXT_951 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_952 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_953 = NL + "\t\t\t\tquery_";
  protected final String TEXT_954 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_955 = NL + "                        ";
  protected final String TEXT_956 = NL + "                            query_";
  protected final String TEXT_957 = " = ";
  protected final String TEXT_958 = ";";
  protected final String TEXT_959 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_960 = ",";
  protected final String TEXT_961 = ".";
  protected final String TEXT_962 = ", ";
  protected final String TEXT_963 = ",insertSQLSplits_";
  ...
  protected final String TEXT_975 = " = insertedCount_";
  protected final String TEXT_976 = " + pstmtInsert_";
  protected final String TEXT_977 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_997 = NL + "                }" + NL + "            nb_line_";
  ...
  protected final String TEXT_1013 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_1014 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_1015 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_1016 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_1017 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1018 = " = deletedCount_";
  protected final String TEXT_1019 = " + pstmt_";
  protected final String TEXT_1020 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_1054 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1055 = " <= batchSizeCounter_";
  protected final String TEXT_1056 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1057 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1058 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1059 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1060 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1061 = " = pstmt_";
  protected final String TEXT_1062 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  ...
  protected final String TEXT_1069 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1070 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1071 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1072 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1073 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1074 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1075 = " <= commitCounter_";
  protected final String TEXT_1076 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_1077 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_1078 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1079 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1080 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1081 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1082 = " = pstmt_";
  protected final String TEXT_1083 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  ...
  protected final String TEXT_1090 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1091 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1092 = ":0);" + NL + "\t                ";
  protected final String TEXT_1093 = NL + "                \tconn_";
  protected final String TEXT_1094 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1095 = "=0;" + NL + "                }\t";
