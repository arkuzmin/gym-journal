...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_187 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_201 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_212 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_230 = NL + "    \t\tpstmt_";
  protected final String TEXT_231 = ".addBatch();" + NL + "\t\t\t";
  protected final String TEXT_232 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_233 = "++;";
  protected final String TEXT_234 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_235 = " = deletedCount_";
  protected final String TEXT_236 = " + pstmt_";
  protected final String TEXT_237 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_238 = " = true;";
  ...
  protected final String TEXT_248 = NL + "                        rejectedCount_";
  protected final String TEXT_249 = " = rejectedCount_";
  protected final String TEXT_250 = " + 1;";
  protected final String TEXT_251 = NL + "                        ";
  protected final String TEXT_252 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_253 = NL + "                        ";
  protected final String TEXT_254 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_255 = ";";
  protected final String TEXT_256 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_257 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_258 = NL + "            nb_line_";
  protected final String TEXT_259 = "++;";
  protected final String TEXT_260 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_271 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_272 = " <= batchSizeCounter_";
  protected final String TEXT_273 = ") {                ";
  protected final String TEXT_274 = "                                                " + NL + "\t\t\t\t\tint[] status_";
  protected final String TEXT_275 = " = null;" + NL + "\t\t\t\t\tint countSum_";
  protected final String TEXT_276 = " = 0;" + NL + "\t                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_277 = " = 0;" + NL + "\t\t\t\t\t\tstatus_";
  protected final String TEXT_278 = " = pstmt_";
  protected final String TEXT_279 = ".executeBatch();" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_280 = ": status_";
  protected final String TEXT_281 = ") {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_282 = " += (countEach_";
  protected final String TEXT_283 = " < 0 ? 0 : countEach_";
  protected final String TEXT_284 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t                \t";
  protected final String TEXT_285 = NL + "\t                \t\tthrow(e);" + NL + "\t                \t";
  protected final String TEXT_286 = NL + "\t                \tfor(int countEach_";
  protected final String TEXT_287 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_288 = " += (countEach_";
  protected final String TEXT_289 = " < 0 ? 0 : countEach_";
  protected final String TEXT_290 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                \tSystem.err.println(e.getMessage());" + NL + "\t                \t";
  protected final String TEXT_291 = NL + "\t                }" + NL + "\t                try {" + NL + "        \t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_292 = " = pstmt_";
  protected final String TEXT_293 = ".getUpdateCount();" + NL + "\t\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t                \t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_294 = " = tmp_batchUpdateCount_";
  protected final String TEXT_295 = " > countSum_";
  protected final String TEXT_296 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_297 = " : countSum_";
  protected final String TEXT_298 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_299 = NL + "\t    \t    \t\tinsertedCount_";
  protected final String TEXT_300 = " += tmp_batchUpdateCount_";
  protected final String TEXT_301 = "; " + NL + "\t    \t    \t";
  protected final String TEXT_302 = NL + "\t    \t    \t\tupdatedCount_";
  protected final String TEXT_303 = " += tmp_batchUpdateCount_";
  protected final String TEXT_304 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_305 = NL + "\t    \t    \t    deletedCount_";
  protected final String TEXT_306 = " += tmp_batchUpdateCount_";
  protected final String TEXT_307 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_308 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_309 = NL + "                commitCounter_";
  protected final String TEXT_310 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_311 = " <= commitCounter_";
  protected final String TEXT_312 = ") {" + NL + "                    connection_";
  protected final String TEXT_313 = ".commit();" + NL + "                    commitCounter_";
