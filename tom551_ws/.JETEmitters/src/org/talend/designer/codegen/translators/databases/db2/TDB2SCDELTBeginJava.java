...
public class TDB2SCDELTBeginJava {
  ...
  protected final String TEXT_39 = " = null;" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_43 = " = schema_";
  protected final String TEXT_44 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_45 = ";" + NL + "        sourceTable_";
  protected final String TEXT_46 = " = schema_";
  protected final String TEXT_47 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_48 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "        sourceTable_";
  ...
  protected final String TEXT_78 = ".getString(\"TABLE_NAME\");" + NL + "                String qSchema_";
  protected final String TEXT_79 = " = rsTable_";
  protected final String TEXT_80 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_81 = ".equals(";
  protected final String TEXT_82 = ") " + NL + "                \t&& (qSchema_";
  protected final String TEXT_83 = ".equals(schema_";
  protected final String TEXT_84 = ") || ((schema_";
  protected final String TEXT_85 = " == null || schema_";
  protected final String TEXT_86 = ".trim().length() ==0) && dbUser_";
  protected final String TEXT_87 = ".equalsIgnoreCase(qSchema_";
  ...
  protected final String TEXT_117 = "] table action ";
  protected final String TEXT_118 = " done\\n\");";
  protected final String TEXT_119 = NL + "        String updateForType1_";
  protected final String TEXT_120 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_121 = " + \"\\\" d SET (";
  protected final String TEXT_122 = ") = (SELECT ";
  ...
  protected final String TEXT_126 = ")) WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_127 = " + \"\\\" t WHERE ";
  protected final String TEXT_128 = " AND (";
  protected final String TEXT_129 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_132 = ".executeUpdate(updateForType1_";
  protected final String TEXT_133 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_134 = ".close();";
  protected final String TEXT_135 = NL + "            System.out.println(\"[";
  protected final String TEXT_136 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_137 = " + \"\\ndone\");";
  protected final String TEXT_138 = NL + "        String updateForType2_";
  protected final String TEXT_139 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_140 = " + \"\\\" d SET \\\"";
  protected final String TEXT_141 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_142 = "\"))) + \"'";
  protected final String TEXT_143 = ", \\\"";
  protected final String TEXT_144 = "\\\" = 0";
  protected final String TEXT_145 = " WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_146 = " + " + NL + "        \"\\\" t WHERE ";
  protected final String TEXT_147 = " AND (";
  protected final String TEXT_148 = ")) AND d.\\\"";
  protected final String TEXT_149 = "\\\" IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_152 = ".executeUpdate(updateForType2_";
  protected final String TEXT_153 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_154 = ".close();";
  protected final String TEXT_155 = NL + "            System.out.println(\"[";
  protected final String TEXT_156 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_157 = " + \"\\ndone\");";
  protected final String TEXT_158 = NL + "        String insertForType2_";
  protected final String TEXT_159 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_160 = " + \"\\\"(";
  protected final String TEXT_161 = "\\\"";
  protected final String TEXT_162 = "\\\", ";
  protected final String TEXT_163 = ") SELECT ";
  protected final String TEXT_164 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_165 = " + \", ";
  protected final String TEXT_166 = "t.";
  protected final String TEXT_167 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_168 = "\"))) + \"', CAST(NULL AS ";
  protected final String TEXT_169 = ")";
  protected final String TEXT_170 = ", 1";
  protected final String TEXT_171 = ", d.\\\"";
  protected final String TEXT_172 = "\\\" + 1";
  protected final String TEXT_173 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_174 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_175 = " + \"\\\" d WHERE ";
  protected final String TEXT_176 = " AND (";
  protected final String TEXT_177 = ") AND d.\\\"";
  protected final String TEXT_178 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_179 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_182 = ".executeUpdate(insertForType2_";
  protected final String TEXT_183 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_184 = ".close();";
  protected final String TEXT_185 = NL + "            System.out.println(\"[";
  protected final String TEXT_186 = "] type2 new active row slq\\n\" + insertForType2_";
  ...
  protected final String TEXT_193 = ") SELECT ";
  protected final String TEXT_194 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_195 = " + \", ";
  protected final String TEXT_196 = "t.";
  protected final String TEXT_197 = "\"";
  protected final String TEXT_198 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_199 = "\"))) + \"', CAST(NULL AS ";
  protected final String TEXT_200 = ")\"";
  protected final String TEXT_201 = NL + "    + \"";
  protected final String TEXT_202 = ", 1";
  protected final String TEXT_203 = ", 1";
  protected final String TEXT_204 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_205 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_206 = " + \"\\\" d ON ";
  protected final String TEXT_207 = " WHERE (";
  protected final String TEXT_208 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_211 = ".executeUpdate(insert_";
  protected final String TEXT_212 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_213 = ".close();";
  protected final String TEXT_214 = NL + "        System.out.println(\"[";
  protected final String TEXT_215 = "] new rows sql\\n\" + insert_";
