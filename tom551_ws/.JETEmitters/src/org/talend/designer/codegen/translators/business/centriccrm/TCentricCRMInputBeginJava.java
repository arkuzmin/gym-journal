...
public class TCentricCRMInputBeginJava
{
  ...
  protected final String TEXT_16 = NL + "\t       " + NL + "       crm";
  ...
  protected final String TEXT_20 = ");" + NL + "       java.util.ArrayList meta";
  protected final String TEXT_21 = " = new java.util.ArrayList();    " + NL + "       ";
  protected final String TEXT_22 = NL + "\t\tmeta";
  protected final String TEXT_23 = ".add(\"";
  protected final String TEXT_24 = "\");";
  protected final String TEXT_25 = "      " + NL + "     \tcrm";
  protected final String TEXT_26 = ".setTransactionMeta(meta";
  protected final String TEXT_27 = ");" + NL + "        org.aspcfs.apps.transfer.DataRecord ";
  protected final String TEXT_28 = " = new org.aspcfs.apps.transfer.DataRecord();";
  protected final String TEXT_29 = NL + "        ";
  protected final String TEXT_30 = ".setName(\"";
  protected final String TEXT_31 = "\");";
  protected final String TEXT_32 = NL + "        ";
  protected final String TEXT_33 = ".setAction(org.aspcfs.apps.transfer.DataRecord.SELECT);";
  protected final String TEXT_34 = NL + "        ";
  protected final String TEXT_35 = ".addField(";
  protected final String TEXT_36 = ",";
  protected final String TEXT_37 = ");" + NL + "\t";
  protected final String TEXT_38 = "      " + NL + "        crm";
  protected final String TEXT_39 = ".load(";
  protected final String TEXT_40 = ");" + NL + "        if(crm";
  protected final String TEXT_41 = ".getStatus()==1)" + NL + "        {" + NL + "       \t\tSystem.out.println(crm";
  protected final String TEXT_42 = ".getLastResponse());" + NL + "       \t}" + NL + "        java.util.Iterator iter";
  protected final String TEXT_43 = " = crm";
  protected final String TEXT_44 = ".getRecords(";
  protected final String TEXT_45 = ".class.getName()).iterator();" + NL + "         while (iter";
  protected final String TEXT_46 = ".hasNext()) {" + NL + "       \t\tObject o = iter";
  protected final String TEXT_47 = ".next();" + NL + "      \t\t";
  protected final String TEXT_48 = " tempObj=(";
  protected final String TEXT_49 = ")o;" + NL + "      \t\t";
  protected final String TEXT_50 = NL + " \t\t\t" + NL + " \t\t\t";
  protected final String TEXT_51 = ".";
  protected final String TEXT_52 = "=tempObj.get";
