...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_53 = ";" + NL + "    " + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_57 = ");" + NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_65 = NL + "       int batchSize_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_68 = "=0;";
  protected final String TEXT_69 = NL + "int count_";
  protected final String TEXT_70 = "=0;";
  protected final String TEXT_71 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_74 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_75 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_81 = " - Drop table '\" + tableName_";
  protected final String TEXT_82 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "            stmtDrop_";
  protected final String TEXT_84 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_88 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_156 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_167 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_168 = " = dbMetaData_";
  protected final String TEXT_169 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_170 = ", tableNameForSearch_";
  protected final String TEXT_171 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_172 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_173 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_174 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_190 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_271 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_306 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_312 = " - Drop table '\" + tableName_";
  protected final String TEXT_313 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_314 = NL + "                    stmtDrop_";
  protected final String TEXT_315 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_319 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_339 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_340 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_346 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_352 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_356 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_357 = " = conn_";
  protected final String TEXT_358 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_359 = " = stmtTruncCount_";
  protected final String TEXT_360 = ".executeQuery(\"";
  protected final String TEXT_361 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_365 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_374 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_383 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_384 = " = conn_";
  protected final String TEXT_385 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_386 = " = stmtTruncCount_";
  protected final String TEXT_387 = ".executeQuery(\"";
  protected final String TEXT_388 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_392 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_393 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\tconn_";
  protected final String TEXT_396 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_401 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_417 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_418 = NL + "\t    String update_";
  protected final String TEXT_419 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_434 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_446 = " = \"UPDATE \" + ";
  protected final String TEXT_447 = " + \" SET ";
  protected final String TEXT_448 = " WHERE ";
  protected final String TEXT_449 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_450 = " = conn_";
  protected final String TEXT_451 = ".prepareStatement(update_";
  protected final String TEXT_452 = ");" + NL + "\t    String insert_";
  protected final String TEXT_453 = " = \"INSERT INTO \" + ";
  protected final String TEXT_454 = " + \" (";
  protected final String TEXT_455 = ") VALUES (";
  protected final String TEXT_456 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_460 = NL + "\t    String delete_";
  protected final String TEXT_461 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_465 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_479 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_480 = " = insert_";
  protected final String TEXT_481 = ".split(\"\\\\?\");";
  protected final String TEXT_482 = NL + "\t\t\tdelete_";
  protected final String TEXT_483 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_484 = " = delete_";
  protected final String TEXT_485 = ".split(\"\\\\?\");";
  protected final String TEXT_486 = NL + "\t\t\treplace_";
  protected final String TEXT_487 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_488 = " = replace_";
  protected final String TEXT_489 = ".split(\"\\\\?\");";
  protected final String TEXT_490 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_491 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_492 = " = insertIgnore_";
  protected final String TEXT_493 = ".split(\"\\\\?\");";
  protected final String TEXT_494 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_500 = " =null;" + NL + "\t";
  ...
  protected final String TEXT_508 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_509 = " = null;";
  protected final String TEXT_510 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_511 = " = null;";
  protected final String TEXT_512 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_518 = NL + NL + NL;
