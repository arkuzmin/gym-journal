...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_37 = ").charAt(0) + \"' \";";
  ...
  protected final String TEXT_79 = NL + "\t\tjava.lang.Class.forName(\"com.paraccel.Driver\").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_88 = " = java.sql.DriverManager.getConnection(\"jdbc:paraccel://\" + ";
  protected final String TEXT_89 = " + \":\" + ";
  protected final String TEXT_90 = " + \"/\" + ";
  protected final String TEXT_91 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_92 = "+\"&protocolVersion=3\", ";
  ...
  protected final String TEXT_99 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_100 = ".execute(\"";
  protected final String TEXT_101 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_102 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_119 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_120 = " = tableNameForSearch_";
  protected final String TEXT_121 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_122 = " = tableNameForSearch_";
  protected final String TEXT_123 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_124 = " = dbMetaData_";
  protected final String TEXT_125 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_126 = ", tableNameForSearch_";
  protected final String TEXT_127 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_128 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_129 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_130 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_144 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_145 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_158 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_162 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_163 = ".equals(schema_";
  protected final String TEXT_164 = ") || (schema_";
  protected final String TEXT_165 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_166 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_228 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_235 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_236 = ".execute(\"";
  protected final String TEXT_237 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_238 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_266 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_267 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_268 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_269 = NL + "\t";
  protected final String TEXT_270 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_273 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_276 = ".execute(xpxSQL_";
  protected final String TEXT_277 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_278 = ".close();    ";
  protected final String TEXT_279 = NL + "    stmtBulk_";
  protected final String TEXT_280 = ".execute(bulkSQL_";
  protected final String TEXT_281 = ");" + NL + "    stmtBulk_";
