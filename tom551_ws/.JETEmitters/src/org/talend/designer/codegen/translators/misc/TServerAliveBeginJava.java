...
public class TServerAliveBeginJava
{
  ...
  protected final String TEXT_27 = NL + "            " + NL + "            properties_";
  protected final String TEXT_28 = ".put(\"java.net.socks.password\", decryptedPassword_";
  protected final String TEXT_29 = ");";
  protected final String TEXT_30 = NL + "        java.net.Socket server_";
  protected final String TEXT_31 = " = new java.net.Socket();" + NL + "        java.net.InetSocketAddress address_";
  protected final String TEXT_32 = " = new java.net.InetSocketAddress(";
  protected final String TEXT_33 = ", ";
  protected final String TEXT_34 = ");" + NL + "        server_";
  protected final String TEXT_35 = ".connect(address_";
  protected final String TEXT_36 = ", ";
  protected final String TEXT_37 = " * 1000);" + NL + "        server_";
  protected final String TEXT_38 = ".close();" + NL + "        globalMap.put(\"";
  protected final String TEXT_39 = "_SERVER_ALIVE_RESULT\",true);" + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_40 = "_SERVER_ALIVE_RESULT\",false);" + NL + "    }";
