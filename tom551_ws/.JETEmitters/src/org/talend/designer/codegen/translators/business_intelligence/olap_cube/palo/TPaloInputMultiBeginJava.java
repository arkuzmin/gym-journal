...
public class TPaloInputMultiBeginJava
{
  ...
  protected final String TEXT_32 = ");" + NL + "" + NL + "org.talend.jpalo.palocubes pCBs_";
  protected final String TEXT_33 = " = pDB_";
  protected final String TEXT_34 = ".getCubes(org.talend.jpalo.palocubes.";
  protected final String TEXT_35 = ");" + NL + "org.talend.jpalo.palocube pCB_";
  protected final String TEXT_36 = " = pCBs_";
  protected final String TEXT_37 = ".getCube(";
  protected final String TEXT_38 = ");" + NL;
  protected final String TEXT_39 = NL + "String strDimensionElementArray_";
  protected final String TEXT_40 = "[][] = new String[";
  protected final String TEXT_41 = "][];";
  protected final String TEXT_42 = NL + "\tstrDimensionElementArray_";
  protected final String TEXT_43 = "[";
  protected final String TEXT_44 = "] = new String[]{";
  protected final String TEXT_45 = "};";
  protected final String TEXT_46 = NL + "\tjava.util.ArrayList<org.talend.jpalo.paloelements> alPaloElements_";
  protected final String TEXT_47 = "= new java.util.ArrayList<org.talend.jpalo.paloelements>();" + NL + "\tfor(org.talend.jpalo.palodimension plDim_";
  protected final String TEXT_48 = " : pCB_";
  protected final String TEXT_49 = ".getDimensions().getDimensions()){" + NL + "\t\talPaloElements_";
  protected final String TEXT_50 = ".add(plDim_";
  protected final String TEXT_51 = ".getElements());" + NL + "\t}" + NL + "\torg.talend.jpalo.palodata pDT_";
  protected final String TEXT_52 = " = new org.talend.jpalo.palodata(pConn_";
  protected final String TEXT_53 = ",pDB_";
  protected final String TEXT_54 = ",pCB_";
  protected final String TEXT_55 = ",alPaloElements_";
  protected final String TEXT_56 = ", strDimensionElementArray_";
  protected final String TEXT_57 = ", ";
  protected final String TEXT_58 = ");" + NL + "\tint iRowCount_";
  protected final String TEXT_59 = "=0;" + NL + "\twhile(pDT_";
  protected final String TEXT_60 = ".getResults()){" + NL + "\t";
