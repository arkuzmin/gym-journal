...
public class TAmazonOracleRowBeginJava
{
  ...
  protected final String TEXT_34 = NL + NL + "\tString dbPwd_";
  ...
  protected final String TEXT_53 = ".getBytes()));" + NL + "\tconn_";
  ...
  protected final String TEXT_59 = NL + "        if(conn_";
  protected final String TEXT_60 = ".getAutoCommit()) {" + NL + "            conn_";
  protected final String TEXT_61 = ".setAutoCommit(false);" + NL + "        }        " + NL + "        int commitEvery_";
  ...
  protected final String TEXT_68 = ".prepareStatement(";
  protected final String TEXT_69 = ");\t";
  protected final String TEXT_70 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_71 = " = conn_";
  protected final String TEXT_72 = ".createStatement();";
  protected final String TEXT_73 = NL + "String query_";
  protected final String TEXT_74 = " = \"\";" + NL + "boolean whetherReject_";
  protected final String TEXT_75 = " = false;" + NL;
  protected final String TEXT_76 = NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_77 = " = 0;";
  protected final String TEXT_78 = NL + "\t\tint nb_line_update_";
  protected final String TEXT_79 = " = 0;";
  protected final String TEXT_80 = NL + "\t\tint nb_line_deleted_";
