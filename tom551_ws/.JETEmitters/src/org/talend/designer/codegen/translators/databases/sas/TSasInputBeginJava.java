...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:sasiom://\"+";
  protected final String TEXT_229 = "+\":\"+";
  protected final String TEXT_230 = ";";
  protected final String TEXT_231 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_232 = "\");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  ...
  protected final String TEXT_242 = NL + "\t\t\tString dbPwd_";
  protected final String TEXT_243 = " = decryptedPassword_";
  protected final String TEXT_244 = ";" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_245 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\tproperty_";
  protected final String TEXT_246 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_247 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_248 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_249 = ");" + NL + "\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\tconn_";
  protected final String TEXT_251 = " = java.sql.DriverManager.getConnection(url_";
  ...
  protected final String TEXT_256 = "column_index_";
  protected final String TEXT_257 = ")!=null&&(rs_";
  protected final String TEXT_258 = ".getString(";
  protected final String TEXT_259 = "column_index_";
  protected final String TEXT_260 = ")).length()>0){" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_265 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  protected final String TEXT_266 = NL + "\t\t\t\t\tif((rs_";
  protected final String TEXT_267 = ".getString(";
  protected final String TEXT_268 = "column_index_";
  protected final String TEXT_269 = "))==null){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_272 = ".";
  protected final String TEXT_273 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_274 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_275 = ".getString(";
  protected final String TEXT_276 = "column_index_";
  protected final String TEXT_277 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_278 = ".";
  protected final String TEXT_279 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_280 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  protected final String TEXT_281 = NL + "\t\t\t  " + NL + "\t\t\t}\t\t";
  protected final String TEXT_282 = NL + "    " + NL + "\t";
  protected final String TEXT_283 = NL + "\t\t    int nb_line_";
  protected final String TEXT_284 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_285 = " = null;";
  protected final String TEXT_286 = NL + "\t\t        conn_";
  protected final String TEXT_287 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_288 = "\");";
  protected final String TEXT_289 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_290 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_291 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_292 = " = dataSources_";
  protected final String TEXT_293 = ".get(";
  protected final String TEXT_294 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_295 = "\", conn_";
  protected final String TEXT_296 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_297 = NL + "\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_299 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_300 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_301 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_302 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_303 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_304 = NL + NL + "\t\t    ";
  protected final String TEXT_305 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_306 = " = ";
  protected final String TEXT_307 = ";";
  protected final String TEXT_308 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_309 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_310 = " + \"'.\");";
  protected final String TEXT_311 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_312 = "_QUERY\",dbquery_";
  protected final String TEXT_313 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_314 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_315 = " = stmt_";
  protected final String TEXT_316 = ".executeQuery(dbquery_";
  protected final String TEXT_317 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_318 = " = rs_";
  protected final String TEXT_319 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_320 = " = rsmd_";
  protected final String TEXT_321 = ".getColumnCount();" + NL;
  protected final String TEXT_322 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_323 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_324 = ".setDbmsId(\"";
  protected final String TEXT_325 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_326 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_327 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_328 = ".add(\"";
  protected final String TEXT_329 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_330 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_333 = "; i <= rsmd_";
  protected final String TEXT_334 = ".getColumnCount()-";
  protected final String TEXT_335 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_336 = ".contains(rsmd_";
  protected final String TEXT_337 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_338 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_339 = ".setName(rsmd_";
  protected final String TEXT_340 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_341 = ".setDbName(rsmd_";
  protected final String TEXT_342 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_343 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_344 = "\", rsmd_";
  protected final String TEXT_345 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_346 = ".getPrecision(i), rsmd_";
  protected final String TEXT_347 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_348 = ".setDbType(rsmd_";
  protected final String TEXT_349 = ".getColumnTypeName(i));";
  protected final String TEXT_350 = NL + "                \tdcm_";
  protected final String TEXT_351 = ".setFormat(";
  protected final String TEXT_352 = ");";
  protected final String TEXT_353 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_354 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_355 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_356 = ".setLength(rsmd_";
  protected final String TEXT_357 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_358 = ".setLength(rsmd_";
  protected final String TEXT_359 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_360 = NL + "\t\t\tdcm_";
  protected final String TEXT_361 = ".setLength(rsmd_";
  protected final String TEXT_362 = ".getPrecision(i));";
  protected final String TEXT_363 = NL + "                \tdcm_";
  protected final String TEXT_364 = ".setPrecision(rsmd_";
  protected final String TEXT_365 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_366 = ".setNullable(rsmd_";
  protected final String TEXT_367 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_368 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_369 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_370 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_371 = ".metadatas.add(dcm_";
  protected final String TEXT_372 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_373 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_374 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_375 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_376 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_377 = NL + "\t\t    ";
  protected final String TEXT_378 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_379 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_380 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_381 = NL + "\t\t    while (rs_";
  protected final String TEXT_382 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_383 = "++;" + NL + "\t\t        ";
  protected final String TEXT_384 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_385 = " = ";
  protected final String TEXT_386 = " + dcg_";
  protected final String TEXT_387 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_405 = " = (List)rs_";
  protected final String TEXT_406 = ".getObject(";
  protected final String TEXT_407 = "column_index_";
  protected final String TEXT_408 = ");";
  protected final String TEXT_409 = NL + "\t\t                         ";
  protected final String TEXT_410 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_411 = ".getObject(";
  protected final String TEXT_412 = "column_index_";
  protected final String TEXT_413 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_414 = NL + "                                    ";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = " = new Geometry(wktValue);";
  protected final String TEXT_417 = NL + "                                        ";
  protected final String TEXT_418 = ".";
  protected final String TEXT_419 = ".setEPSG(";
  protected final String TEXT_420 = ");";
  protected final String TEXT_421 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_422 = NL + "                                  ";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = "=dcg_";
  protected final String TEXT_425 = ";";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_427 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_428 = " = ";
  protected final String TEXT_429 = "; i_";
  protected final String TEXT_430 = "  <= rsmd_";
  protected final String TEXT_431 = ".getColumnCount(); i_";
  protected final String TEXT_432 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_433 = ".getColumnTypeName(i_";
  protected final String TEXT_434 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_435 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_436 = ".getClob(i_";
  protected final String TEXT_437 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_438 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_439 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_440 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_441 = ".add(tNTextImpl_";
  protected final String TEXT_442 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_443 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_444 = ".";
  protected final String TEXT_445 = ", rs_";
  protected final String TEXT_446 = ", fixedColumnCount_";
  protected final String TEXT_447 = ",list_";
  protected final String TEXT_448 = ");";
  protected final String TEXT_449 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_450 = ".";
  protected final String TEXT_451 = ", rs_";
  protected final String TEXT_452 = ", fixedColumnCount_";
  protected final String TEXT_453 = ");";
  protected final String TEXT_454 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_455 = ".";
  protected final String TEXT_456 = ", rs_";
  protected final String TEXT_457 = ", fixedColumnCount_";
  protected final String TEXT_458 = ");";
  protected final String TEXT_459 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_460 = ".getObject(";
  protected final String TEXT_461 = "column_index_";
  protected final String TEXT_462 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_463 = ".";
  protected final String TEXT_464 = " = new Geometry(sb.toString());";
  protected final String TEXT_465 = NL + "\t\t                          ";
  protected final String TEXT_466 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_468 = ".append(";
  protected final String TEXT_469 = ".";
  protected final String TEXT_470 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_471 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_472 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_476 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_477 = " - Content of the record \" + nb_line_";
  protected final String TEXT_478 = " + \": \" + log4jSb_";
  protected final String TEXT_479 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_480 = ".delete(0,log4jSb_";
  protected final String TEXT_481 = ".length());" + NL + "\t\t\t\t\t";
