...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_229 = ";";
  protected final String TEXT_230 = NL + "\t\t\t    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_242 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_243 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_244 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_245 = " = dataSources_";
  protected final String TEXT_246 = ".get(";
  protected final String TEXT_247 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_248 = "\", conn_";
  protected final String TEXT_249 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_250 = NL + "\t\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_252 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_253 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_254 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_255 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_256 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_257 = NL + NL + "\t\t    ";
  protected final String TEXT_258 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_259 = " = ";
  protected final String TEXT_260 = ";";
  protected final String TEXT_261 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_262 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_263 = " + \"'.\");";
  protected final String TEXT_264 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_265 = "_QUERY\",dbquery_";
  protected final String TEXT_266 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_290 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_291 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setName(rsmd_";
  protected final String TEXT_293 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_302 = ".getColumnTypeName(i));";
  protected final String TEXT_303 = NL + "                \tdcm_";
  protected final String TEXT_304 = ".setFormat(";
  protected final String TEXT_305 = ");";
  protected final String TEXT_306 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_307 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_308 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_309 = ".setLength(rsmd_";
  protected final String TEXT_310 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_311 = ".setLength(rsmd_";
  protected final String TEXT_312 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_313 = NL + "\t\t\tdcm_";
  protected final String TEXT_314 = ".setLength(rsmd_";
  protected final String TEXT_315 = ".getPrecision(i));";
  protected final String TEXT_316 = NL + "                \tdcm_";
  protected final String TEXT_317 = ".setPrecision(rsmd_";
  protected final String TEXT_318 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setNullable(rsmd_";
  protected final String TEXT_320 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_322 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_323 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_324 = ".metadatas.add(dcm_";
  protected final String TEXT_325 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_326 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_327 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_328 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_329 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_330 = NL + "\t\t    ";
  protected final String TEXT_331 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_332 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_363 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_364 = ".getObject(";
  protected final String TEXT_365 = "column_index_";
  protected final String TEXT_366 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_367 = NL + "                                    ";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_379 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_380 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_402 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_412 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_413 = ".getObject(";
  protected final String TEXT_414 = "column_index_";
  protected final String TEXT_415 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_425 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_428 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_429 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_430 = " - Content of the record \" + nb_line_";
  protected final String TEXT_431 = " + \": \" + log4jSb_";
  protected final String TEXT_432 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_433 = ".delete(0,log4jSb_";
  protected final String TEXT_434 = ".length());" + NL + "\t\t\t\t\t";
