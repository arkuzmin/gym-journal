...
public class TVerticaInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_239 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_240 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_241 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_242 = " = dataSources_";
  protected final String TEXT_243 = ".get(";
  protected final String TEXT_244 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_245 = "\", conn_";
  protected final String TEXT_246 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_247 = NL + "\t\t\t\t";
  protected final String TEXT_248 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_249 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_250 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_251 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_252 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_253 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_263 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_264 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_265 = " = stmt_";
  protected final String TEXT_266 = ".executeQuery(dbquery_";
  protected final String TEXT_267 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_268 = " = rs_";
  protected final String TEXT_269 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_270 = " = rsmd_";
  protected final String TEXT_271 = ".getColumnCount();" + NL;
  protected final String TEXT_272 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_273 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_274 = ".setDbmsId(\"";
  protected final String TEXT_275 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_276 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_277 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_278 = ".add(\"";
  protected final String TEXT_279 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_280 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_281 = " = ";
  protected final String TEXT_282 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_283 = "; i <= rsmd_";
  protected final String TEXT_284 = ".getColumnCount()-";
  protected final String TEXT_285 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_286 = ".contains(rsmd_";
  protected final String TEXT_287 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_288 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setName(rsmd_";
  protected final String TEXT_290 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setDbName(rsmd_";
  protected final String TEXT_292 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_294 = "\", rsmd_";
  protected final String TEXT_295 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_296 = ".getPrecision(i), rsmd_";
  protected final String TEXT_297 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_298 = ".setDbType(rsmd_";
  protected final String TEXT_299 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_355 = " = (List)rs_";
  protected final String TEXT_356 = ".getObject(";
  protected final String TEXT_357 = "column_index_";
  protected final String TEXT_358 = ");";
  protected final String TEXT_359 = NL + "\t\t                         ";
  protected final String TEXT_360 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  ...
  protected final String TEXT_376 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_377 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_409 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_410 = ".getObject(";
  protected final String TEXT_411 = "column_index_";
  protected final String TEXT_412 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_422 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_425 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_426 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_427 = " - Content of the record \" + nb_line_";
  protected final String TEXT_428 = " + \": \" + log4jSb_";
