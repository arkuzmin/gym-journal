...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_247 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_248 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_249 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_250 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_251 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_252 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_260 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  ...
  protected final String TEXT_286 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_298 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_327 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_328 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_359 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_360 = ".getObject(";
  protected final String TEXT_361 = "column_index_";
  protected final String TEXT_362 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_363 = NL + "                                    ";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_375 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_376 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_381 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_382 = ".getColumnTypeName(i_";
  protected final String TEXT_383 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_384 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_385 = ".getClob(i_";
  protected final String TEXT_386 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_387 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_388 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_389 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_390 = ".add(tNTextImpl_";
  protected final String TEXT_391 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_392 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_408 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_409 = ".getObject(";
  protected final String TEXT_410 = "column_index_";
  protected final String TEXT_411 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_425 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_426 = " - Content of the record \" + nb_line_";
  protected final String TEXT_427 = " + \": \" + log4jSb_";
  protected final String TEXT_428 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_429 = ".delete(0,log4jSb_";
