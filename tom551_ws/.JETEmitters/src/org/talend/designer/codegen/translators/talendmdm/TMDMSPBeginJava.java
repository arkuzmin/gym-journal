...
public class TMDMSPBeginJava
{
  ...
  protected final String TEXT_33 = "\");" + NL + "" + NL + "\torg.talend.mdm.webservice.WSExecuteStoredProcedure wsExeProc_";
  protected final String TEXT_34 = " = new org.talend.mdm.webservice.WSExecuteStoredProcedure();" + NL + "\twsExeProc_";
  protected final String TEXT_35 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_36 = ");" + NL + "\torg.talend.mdm.webservice.WSStoredProcedurePK wsStoredProcPK_";
  protected final String TEXT_37 = " = new org.talend.mdm.webservice.WSStoredProcedurePK();" + NL + "\twsStoredProcPK_";
  protected final String TEXT_38 = ".setPk(";
  protected final String TEXT_39 = ");" + NL + "\twsExeProc_";
  protected final String TEXT_40 = ".setWsStoredProcedurePK(wsStoredProcPK_";
