...
public class TJDBCOutputEndJava
{
  ...
  protected final String TEXT_59 = ".close();" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_60 = "\", true);" + NL + "\t";
  protected final String TEXT_61 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_62 = "=nb_line_deleted_";
  protected final String TEXT_63 = "+ deletedCount_";
  protected final String TEXT_64 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_65 = "=nb_line_update_";
  protected final String TEXT_66 = " + updatedCount_";
  protected final String TEXT_67 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_68 = "=nb_line_inserted_";
  protected final String TEXT_69 = " + insertedCount_";
  protected final String TEXT_70 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_71 = "=nb_line_rejected_";
  protected final String TEXT_72 = " + rejectedCount_";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = NL + "\tif (globalMap.get(\"";
  protected final String TEXT_75 = "_NB_LINE\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_76 = "_NB_LINE\",nb_line_";
  protected final String TEXT_77 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_78 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_79 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_80 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_81 = "_NB_LINE_UPDATED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_82 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_83 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_84 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_85 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_86 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_87 = "_NB_LINE_INSERTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_88 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_89 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_90 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_91 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_92 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_93 = "_NB_LINE_DELETED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_94 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_95 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_96 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_97 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_98 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_99 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  ...
  protected final String TEXT_102 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
