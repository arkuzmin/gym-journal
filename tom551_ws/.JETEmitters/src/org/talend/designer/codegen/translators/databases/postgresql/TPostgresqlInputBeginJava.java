...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_238 = NL + "\t\t    int nb_line_";
  protected final String TEXT_239 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_240 = " = null;";
  protected final String TEXT_241 = NL + "\t\t        conn_";
  protected final String TEXT_242 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_243 = "\");";
  protected final String TEXT_244 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_245 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_246 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_247 = " = dataSources_";
  protected final String TEXT_248 = ".get(";
  protected final String TEXT_249 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_250 = "\", conn_";
  protected final String TEXT_251 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_252 = NL + "\t\t\t\t";
  protected final String TEXT_253 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_254 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_255 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_256 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_257 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_258 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_266 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_267 = "_QUERY\",dbquery_";
  protected final String TEXT_268 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_292 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_304 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_333 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_334 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  ...
  protected final String TEXT_365 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_366 = ".getObject(";
  protected final String TEXT_367 = "column_index_";
  protected final String TEXT_368 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_369 = NL + "                                    ";
  protected final String TEXT_370 = ".";
  protected final String TEXT_371 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_382 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_414 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_415 = ".getObject(";
  protected final String TEXT_416 = "column_index_";
  protected final String TEXT_417 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_418 = ".";
  protected final String TEXT_419 = " = new Geometry(sb.toString());";
  protected final String TEXT_420 = NL + "\t\t                          ";
  protected final String TEXT_421 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_423 = ".append(";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_427 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_430 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_431 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_432 = " - Content of the record \" + nb_line_";
  protected final String TEXT_433 = " + \": \" + log4jSb_";
  protected final String TEXT_434 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_435 = ".delete(0,log4jSb_";
  protected final String TEXT_436 = ".length());" + NL + "\t\t\t\t\t";
