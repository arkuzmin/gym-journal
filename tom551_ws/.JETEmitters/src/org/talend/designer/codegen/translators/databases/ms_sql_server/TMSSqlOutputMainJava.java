...
public class TMSSqlOutputMainJava {
  ...
  protected final String TEXT_165 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_189 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_211 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_214 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_218 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_223 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_224 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_225 = " = tableNameForSearch_";
  protected final String TEXT_226 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_227 = " = tableNameForSearch_";
  protected final String TEXT_228 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_232 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_233 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_234 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_235 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_274 = ".toUpperCase()";
  protected final String TEXT_275 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_280 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_281 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_290 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_291 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_292 = " == null || dbschema_";
  protected final String TEXT_293 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_296 = " = stmtSchema_";
  protected final String TEXT_297 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_298 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_299 = " = rsSchema_";
  protected final String TEXT_300 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_301 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_302 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_316 = " ==null || dbschema_";
  protected final String TEXT_317 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_318 = ".equals";
  protected final String TEXT_319 = "IgnoreCase";
  protected final String TEXT_320 = "(schema_";
  ...
  protected final String TEXT_337 = NL + "                if(!whetherExist_";
  protected final String TEXT_338 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_342 = " - Creating table '\" + tableName_";
  protected final String TEXT_343 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_345 = ".execute(((\"";
  protected final String TEXT_346 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_358 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_365 = ".createStatement();" + NL + "\t    \t    \t";
  protected final String TEXT_366 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_367 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_373 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_380 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_396 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_407 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_413 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_435 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_453 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_462 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_499 = NL + "\t\tpstmt_";
  protected final String TEXT_500 = " = null;         " + NL + "        // [%connection%][psmt][tableName]" + NL + "        String keyPsmt_";
  protected final String TEXT_501 = " = conn_";
  protected final String TEXT_502 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_503 = " + \"]\";" + NL + "\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_504 = ")== null){" + NL + "\t\t\tpstmt_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".prepareStatement(insert_";
  protected final String TEXT_507 = ");\t\t" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_508 = ", pstmt_";
  protected final String TEXT_509 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_510 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_516 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_523 = " + \"] SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_539 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_547 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_569 = "\"); " + NL + "        pstmtInsert_";
  ...
  protected final String TEXT_611 = ".prepareStatement(update_";
  ...
  protected final String TEXT_616 = NL + "        String delete_";
  protected final String TEXT_617 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_622 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_631 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_632 = ".";
  protected final String TEXT_633 = ", \"";
  protected final String TEXT_634 = "\")+\") VALUES (";
  protected final String TEXT_635 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_636 = ".";
  protected final String TEXT_637 = ")+\")\";";
  protected final String TEXT_638 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_639 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_640 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_641 = ".";
  protected final String TEXT_642 = ", \"";
  protected final String TEXT_643 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_644 = ".";
  protected final String TEXT_645 = ")+\")\";";
  protected final String TEXT_646 = NL + "        pstmt_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_649 = " + \"] WHERE ";
  ...
  protected final String TEXT_684 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_685 = " = buffersSize_";
  protected final String TEXT_686 = ";";
  protected final String TEXT_687 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_688 = " = buffersSize_";
  protected final String TEXT_689 = ";";
  protected final String TEXT_690 = NL + NL + "\t\t";
  protected final String TEXT_691 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_692 = " ) {" + NL + "        \tstmt_";
  protected final String TEXT_693 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_694 = " +\"] ON\");" + NL + "        }";
  protected final String TEXT_695 = NL + "        whetherReject_";
  protected final String TEXT_696 = " = false;";
  protected final String TEXT_697 = NL + "            try {";
  ...
  protected final String TEXT_729 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_730 = " = true;";
  protected final String TEXT_731 = NL + "                    throw(e);";
  ...
  protected final String TEXT_748 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_749 = NL + "            }";
  protected final String TEXT_750 = NL + "\t\t     \tint counter";
  protected final String TEXT_751 = " = rowCount";
  protected final String TEXT_752 = " * ";
  protected final String TEXT_753 = " + 1;" + NL + "\t\t     \t" + NL + "\t\t     \t ";
  protected final String TEXT_754 = NL + "\t\t                        counter";
  protected final String TEXT_755 = "++;" + NL + "\t\t                        ";
  protected final String TEXT_756 = NL + "\t\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_757 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_758 = ".";
  protected final String TEXT_759 = ", pstmt_";
  protected final String TEXT_760 = ", counter";
  protected final String TEXT_761 = "-1, \"";
  protected final String TEXT_762 = "\");" + NL + "\t\t\t\t\t\t\t\tcounter";
  protected final String TEXT_763 = "+=count_dyn_";
  protected final String TEXT_764 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_765 = NL + "\t\t             " + NL + "\t\t                sInsertColValue";
  protected final String TEXT_766 = " = new BufferLine_";
  ...
  protected final String TEXT_775 = "  " + NL + "\t\t                ); " + NL + "\t\t               " + NL + "\t\t                sInsertColValueList";
  protected final String TEXT_776 = ".add(sInsertColValue";
  protected final String TEXT_777 = ");" + NL + "\t\t    " + NL + "\t\t                rowCount";
  protected final String TEXT_778 = "++;" + NL + "\t\t";
  protected final String TEXT_779 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_780 = "++;" + NL + "\t\t";
  protected final String TEXT_781 = "\t         " + NL + "\t\t                if(rowCount";
  ...
  protected final String TEXT_786 = ".executeUpdate();" + NL + "\t\t                    sInsertColValueList";
  protected final String TEXT_787 = ".clear();" + NL + "\t\t                    rowCount";
  protected final String TEXT_788 = " = 0;" + NL + "\t\t                    counter";
  protected final String TEXT_789 = "=1;" + NL + "\t\t                }   " + NL + "\t\t    " + NL + "\t\t    \t" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_790 = NL + "            try {";
  ...
  protected final String TEXT_830 = NL + "    \t\tpstmt_";
  protected final String TEXT_831 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_832 = "++;" + NL + "    \t\t";
  protected final String TEXT_833 = NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_834 = "++;" + NL + "    \t\t";
  protected final String TEXT_835 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_836 = NL + "            try {";
  protected final String TEXT_837 = "   " + NL + "                nb_line_";
  protected final String TEXT_838 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_839 = " = updatedCount_";
  protected final String TEXT_840 = " + pstmt_";
  protected final String TEXT_841 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_842 = " = true;";
  protected final String TEXT_843 = NL + "                    throw(e);";
  ...
  protected final String TEXT_856 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_857 = NL + "                        ";
  protected final String TEXT_858 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_866 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_867 = " = pstmt_";
  protected final String TEXT_868 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_869 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_870 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_871 = " = rs_";
  protected final String TEXT_872 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_873 = " > 0) {";
  ...
  protected final String TEXT_879 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_880 = ",";
  protected final String TEXT_881 = ".";
  protected final String TEXT_882 = ", ";
  protected final String TEXT_883 = ",updateSQLSplits_";
  protected final String TEXT_884 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_885 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_886 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_916 = NL + "            try {";
  protected final String TEXT_917 = "   " + NL + "                    updatedCount_";
  protected final String TEXT_918 = " = updatedCount_";
  protected final String TEXT_919 = " + pstmtUpdate_";
  protected final String TEXT_920 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_939 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_940 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_941 = NL + "            try {";
  protected final String TEXT_942 = NL + "                        ";
  protected final String TEXT_943 = NL + "                            query_";
  protected final String TEXT_944 = " = ";
  protected final String TEXT_945 = ";";
  protected final String TEXT_946 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  ...
  protected final String TEXT_952 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_953 = ".";
  protected final String TEXT_954 = ", pstmtInsert_";
  protected final String TEXT_955 = ", ";
  protected final String TEXT_956 = ", \"";
  protected final String TEXT_957 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_958 = NL + "                    globalMap.put(\"";
  protected final String TEXT_959 = "_QUERY\", query_";
  protected final String TEXT_960 = ".toString().trim());";
  protected final String TEXT_961 = NL + "            try {";
  ...
  protected final String TEXT_965 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_966 = " = true;";
  protected final String TEXT_967 = NL + "                        throw(e);";
  protected final String TEXT_968 = NL + "                            ";
  protected final String TEXT_969 = " = new ";
  protected final String TEXT_970 = "Struct();";
  protected final String TEXT_971 = NL + "                                ";
  protected final String TEXT_972 = ".";
  protected final String TEXT_973 = " = ";
  protected final String TEXT_974 = ".";
  protected final String TEXT_975 = ";";
  protected final String TEXT_976 = NL + "                            rejectedCount_";
  protected final String TEXT_977 = " = rejectedCount_";
  protected final String TEXT_978 = " + 1;";
  protected final String TEXT_979 = NL + "                            ";
  protected final String TEXT_980 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_981 = NL + "                            ";
  protected final String TEXT_982 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_983 = ";";
  protected final String TEXT_984 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_985 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_986 = "++;";
  protected final String TEXT_987 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_994 = NL + "\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_995 = ",";
  protected final String TEXT_996 = ".";
  protected final String TEXT_997 = ", ";
  protected final String TEXT_998 = ",updateSQLSplits_";
  ...
  protected final String TEXT_1028 = NL + "            try {";
  protected final String TEXT_1029 = "   " + NL + "                updateFlag_";
  protected final String TEXT_1030 = "=pstmtUpdate_";
  protected final String TEXT_1031 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1032 = " = updatedCount_";
  protected final String TEXT_1033 = "+updateFlag_";
  protected final String TEXT_1034 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_1035 = " == 0) {" + NL + "            \t";
  protected final String TEXT_1036 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1037 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1046 = ",insertSQLSplits_";
  protected final String TEXT_1047 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1048 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1049 = ".";
  protected final String TEXT_1050 = ", pstmtInsert_";
  protected final String TEXT_1051 = ", ";
  protected final String TEXT_1052 = ", \"";
  protected final String TEXT_1053 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1054 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1055 = "_QUERY\", query_";
  protected final String TEXT_1056 = ".toString().trim());";
  ...
  protected final String TEXT_1060 = ".executeUpdate(); " + NL + "\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1061 = " = true;";
  protected final String TEXT_1062 = NL + "                        throw(e);";
  protected final String TEXT_1063 = NL + "                            ";
  protected final String TEXT_1064 = " = new ";
  protected final String TEXT_1065 = "Struct();";
  protected final String TEXT_1066 = NL + "                                ";
  protected final String TEXT_1067 = ".";
  protected final String TEXT_1068 = " = ";
  protected final String TEXT_1069 = ".";
  protected final String TEXT_1070 = ";";
  protected final String TEXT_1071 = NL + "                            rejectedCount_";
  protected final String TEXT_1072 = " = rejectedCount_";
  protected final String TEXT_1073 = " + 1;";
  protected final String TEXT_1074 = NL + "                            ";
  protected final String TEXT_1075 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1076 = NL + "                            ";
  protected final String TEXT_1077 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1078 = ";";
  protected final String TEXT_1079 = NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_1080 = NL + "                }" + NL + "            nb_line_";
  protected final String TEXT_1081 = "++;";
  protected final String TEXT_1082 = NL + "            try {";
  ...
  protected final String TEXT_1092 = NL + "                globalMap.put(\"";
  protected final String TEXT_1093 = "_QUERY\", query_";
  protected final String TEXT_1094 = ".toString().trim());";
  protected final String TEXT_1095 = NL + "         \t";
  protected final String TEXT_1096 = NL + "    \t\tpstmt_";
  protected final String TEXT_1097 = ".addBatch();" + NL + "    \t\t";
  ...
  protected final String TEXT_1101 = NL + "            try {";
  protected final String TEXT_1102 = "   " + NL + "                deletedCount_";
  protected final String TEXT_1103 = " = deletedCount_";
  protected final String TEXT_1104 = " + pstmt_";
  protected final String TEXT_1105 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_1124 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_1131 = NL + "        " + NL + "        java.sql.ResultSet rs_";
  protected final String TEXT_1132 = " = pstmt_";
  protected final String TEXT_1133 = ".executeQuery();" + NL + "        int checkCount_";
  protected final String TEXT_1134 = " = -1;" + NL + "        while(rs_";
  protected final String TEXT_1135 = ".next()) {" + NL + "            checkCount_";
  protected final String TEXT_1136 = " = rs_";
  protected final String TEXT_1137 = ".getInt(1);" + NL + "        }" + NL + "                " + NL + "        if (checkCount_";
  ...
  protected final String TEXT_1144 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1145 = ".";
  protected final String TEXT_1146 = ", pstmtInsert_";
  ...
  protected final String TEXT_1153 = NL + "            try {";
  protected final String TEXT_1154 = "   " + NL + "                insertedCount_";
  protected final String TEXT_1155 = " = insertedCount_";
  protected final String TEXT_1156 = " + pstmtInsert_";
  protected final String TEXT_1157 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  ...
  protected final String TEXT_1162 = "Struct();";
  protected final String TEXT_1163 = NL + "                    ";
  protected final String TEXT_1164 = ".";
  protected final String TEXT_1165 = " = ";
  protected final String TEXT_1166 = ".";
  protected final String TEXT_1167 = ";";
  protected final String TEXT_1168 = NL + "                \trejectedCount_";
  protected final String TEXT_1169 = " = rejectedCount_";
  protected final String TEXT_1170 = " + 1;" + NL + "                \t";
  protected final String TEXT_1171 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1172 = NL + "                    ";
  protected final String TEXT_1173 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1174 = ";";
  protected final String TEXT_1175 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1176 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_1177 = "++;";
  protected final String TEXT_1178 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1189 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1190 = " <= batchSizeCounter_";
  protected final String TEXT_1191 = ") {                ";
  protected final String TEXT_1192 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1193 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1194 = ": pstmt_";
  protected final String TEXT_1195 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1196 = " == -2 || countEach_";
  protected final String TEXT_1197 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1198 = " += countEach_";
  protected final String TEXT_1199 = ";" + NL + "\t\t\t\t\t\t}             \t" + NL + "            \t    \t";
  protected final String TEXT_1200 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1201 = " += countSum_";
  protected final String TEXT_1202 = ";" + NL + "            \t    \t";
  protected final String TEXT_1203 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1204 = " += countSum_";
  protected final String TEXT_1205 = ";" + NL + "            \t    \t";
  protected final String TEXT_1206 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1207 = " += countSum_";
  protected final String TEXT_1208 = ";" + NL + "            \t    \t";
  protected final String TEXT_1209 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1210 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1211 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1212 = NL + "                \tint countSum_";
  protected final String TEXT_1213 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1214 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1215 = " += (countEach_";
  protected final String TEXT_1216 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1217 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1218 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1219 = " += countSum_";
  protected final String TEXT_1220 = ";" + NL + "            \t    \t";
  protected final String TEXT_1221 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1222 = " += countSum_";
  protected final String TEXT_1223 = ";" + NL + "            \t    \t";
  protected final String TEXT_1224 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_1231 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1232 = " <= commitCounter_";
  protected final String TEXT_1233 = ") {" + NL + "                ";
  protected final String TEXT_1234 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1235 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1236 = ": pstmt_";
  protected final String TEXT_1237 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1238 = " == -2 || countEach_";
  protected final String TEXT_1239 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1240 = " += countEach_";
  ...
  protected final String TEXT_1251 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1252 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1253 = NL + "                \tint countSum_";
  protected final String TEXT_1254 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1255 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1256 = " += (countEach_";
  protected final String TEXT_1257 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1258 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1259 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1260 = " += countSum_";
  protected final String TEXT_1261 = ";" + NL + "            \t    \t";
  protected final String TEXT_1262 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1263 = " += countSum_";
  protected final String TEXT_1264 = ";" + NL + "            \t    \t";
  protected final String TEXT_1265 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1266 = " += countSum_";
  protected final String TEXT_1267 = ";" + NL + "            \t    \t";
  protected final String TEXT_1268 = "     " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1269 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1270 = NL + "                \tconn_";
  protected final String TEXT_1271 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1272 = "=0;" + NL + "                }\t";
  protected final String TEXT_1273 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_1274 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_1275 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_1276 = " +\"] OFF\");" + NL + "        }";
