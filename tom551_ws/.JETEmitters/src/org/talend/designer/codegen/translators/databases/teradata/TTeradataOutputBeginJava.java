...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_138 = ".getMetaData() != null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_139 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_140 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_141 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_142 = NL + "\t";
  protected final String TEXT_143 = NL + "    String dbname_";
  protected final String TEXT_144 = " = ";
  protected final String TEXT_145 = ";" + NL + "    java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");       " + NL + "    String dbProperties_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\tString url_";
  protected final String TEXT_148 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_149 = " == null || dbProperties_";
  protected final String TEXT_150 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_151 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_152 = ";     " + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_153 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_154 = " + \"/\" + ";
  protected final String TEXT_155 = ";" + NL + "\t}       " + NL + "    String dbUser_";
  ...
  protected final String TEXT_170 = " - Connection attempt to '\" + url_";
  protected final String TEXT_171 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_172 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_173 = "       " + NL + "    java.sql.Connection conn_";
  protected final String TEXT_174 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_175 = ",dbUser_";
  protected final String TEXT_176 = ",dbPwd_";
  protected final String TEXT_177 = ");" + NL + "\t";
  protected final String TEXT_178 = NL + "\t\tlog.info(\"";
  protected final String TEXT_179 = " - Connection to '\" + url_";
  protected final String TEXT_180 = " + \"' has succeeded.\");" + NL + "\t";
  protected final String TEXT_181 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_182 = "\", conn_";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "        conn_";
  protected final String TEXT_185 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_186 = " = ";
  protected final String TEXT_187 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_188 = " = 0;        ";
  protected final String TEXT_189 = NL + "String dbschema_";
  protected final String TEXT_190 = " = dbname_";
  protected final String TEXT_191 = ";" + NL + "if(dbname_";
  protected final String TEXT_192 = " == null || dbname_";
  protected final String TEXT_193 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_194 = " = ";
  protected final String TEXT_195 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_196 = " = dbname_";
  ...
  protected final String TEXT_205 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_211 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_238 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_242 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_258 = " - Create table '\" + tableName_";
  protected final String TEXT_259 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_411 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_465 = " - Create table '\" + tableName_";
  protected final String TEXT_466 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_467 = NL + "                stmtCreate_";
  protected final String TEXT_468 = ".close();";
  protected final String TEXT_469 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_470 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_476 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_482 = "- Clear table '\" + tableName_";
  protected final String TEXT_483 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_484 = NL + "            stmtClear_";
  ...
  protected final String TEXT_495 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_504 = " - Truncate table '\" + tableName_";
  protected final String TEXT_505 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_506 = NL + "            while(rsTruncCount_";
  protected final String TEXT_507 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_511 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_512 = ".close();            ";
  protected final String TEXT_513 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_514 = " = conn_";
  protected final String TEXT_515 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_516 = " = stmtTruncCount_";
  protected final String TEXT_517 = ".executeQuery(\"";
  protected final String TEXT_518 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_521 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_522 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_523 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_524 = NL + "\t\t\t";
  protected final String TEXT_525 = NL + "\t\t\tconn_";
  protected final String TEXT_526 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_527 = NL + "            stmtTrunc_";
  protected final String TEXT_528 = ".executeUpdate(\"";
  protected final String TEXT_529 = "\");" + NL + "   \t    \t";
  protected final String TEXT_530 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_531 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_532 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_533 = NL + "             while(rsTruncCount_";
  protected final String TEXT_534 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_535 = " += rsTruncCount_";
  protected final String TEXT_536 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_537 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_538 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_539 = ".close();";
  ...
  protected final String TEXT_558 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_566 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_575 = NL + "\t    String update_";
  protected final String TEXT_576 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_577 = " + \"\\\" SET ";
  protected final String TEXT_578 = " WHERE ";
  protected final String TEXT_579 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_606 = NL + "\t\t\tupdate_";
  protected final String TEXT_607 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_608 = " = update_";
  protected final String TEXT_609 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_610 = " = insert_";
  protected final String TEXT_611 = ".split(\"\\\\?\");";
  protected final String TEXT_612 = NL + "\t\t\tdelete_";
  protected final String TEXT_613 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_614 = " = delete_";
  protected final String TEXT_615 = ".split(\"\\\\?\");";
  protected final String TEXT_616 = NL + "\t\t\treplace_";
  protected final String TEXT_617 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_618 = " = replace_";
  protected final String TEXT_619 = ".split(\"\\\\?\");";
  protected final String TEXT_620 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_621 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_622 = " = insertIgnore_";
  ...
  protected final String TEXT_627 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_628 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_629 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_630 = " =null;" + NL + "\t";
  protected final String TEXT_631 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_632 = " = null;" + NL + "\t\t";
  protected final String TEXT_633 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_634 = " = null;";
  protected final String TEXT_635 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_636 = " =  null;";
  protected final String TEXT_637 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_638 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_639 = " = null;";
  protected final String TEXT_640 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_644 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
