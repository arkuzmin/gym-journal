...
public class TFileOutputPositionalEndJava
{
  ...
  protected final String TEXT_17 = NL + "\tif(isFileGenerated_";
  protected final String TEXT_18 = " && nb_line_";
  protected final String TEXT_19 = " == 0){" + NL + "\t\tcreateFile";
  protected final String TEXT_20 = ".delete();" + NL + "\t}\t\t";
