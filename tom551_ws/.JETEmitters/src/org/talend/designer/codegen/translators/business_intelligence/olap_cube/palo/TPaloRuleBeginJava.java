...
public class TPaloRuleBeginJava
{
  ...
  protected final String TEXT_27 = NL + NL + NL + "org.talend.jpalo.palodatabases pDBs_";
  ...
  protected final String TEXT_34 = " + \"' not found. exiting...\");" + NL + "}" + NL + "" + NL + "" + NL + "org.talend.jpalo.palocubes pCBs_";
  protected final String TEXT_35 = " = pDB_";
  protected final String TEXT_36 = ".getCubes(org.talend.jpalo.palocubes.";
  protected final String TEXT_37 = ");" + NL + "org.talend.jpalo.palocube pCB_";
  protected final String TEXT_38 = " = pCBs_";
  protected final String TEXT_39 = ".getCube(";
  protected final String TEXT_40 = ");" + NL + "" + NL + "if(pCB_";
  protected final String TEXT_41 = " == null){" + NL + "\t throw new RuntimeException (\"Cube '\" + ";
  protected final String TEXT_42 = " + \"' not found in database '\" + ";
  protected final String TEXT_43 = " + \"'. exiting...\" );" + NL + "}" + NL + "" + NL + "org.talend.jpalo.palorules pRLs_";
  protected final String TEXT_44 = " = pCB_";
  protected final String TEXT_45 = ".getCubeRules();" + NL;
  protected final String TEXT_46 = NL + "\t\ttry{" + NL + "\t\t\tpRLs_";
  protected final String TEXT_47 = ".addRule(";
  protected final String TEXT_48 = ", true, \"tPaloRule_\"+ pRLs_";
  protected final String TEXT_49 = ".getNumberOfRules(),  ";
  protected final String TEXT_50 = ", ";
  protected final String TEXT_51 = ");" + NL + "\t\t}catch(PaloAPIException e){" + NL + "\t\t\tSystem.err.println (\"data manipulation failed: \" + e.getLocalizedMessage());" + NL + "\t\t}" + NL;
  protected final String TEXT_52 = NL + "\t\t\t// Check if Rule exists" + NL + "\t\t\tif(null==pRLs_";
  protected final String TEXT_53 = ".getRule(";
  protected final String TEXT_54 = "))" + NL + "\t\t\t\tpRLs_";
  protected final String TEXT_55 = ".addRule(";
  protected final String TEXT_56 = ", true, ";
  protected final String TEXT_57 = ",  ";
  protected final String TEXT_58 = ", ";
  protected final String TEXT_59 = ");";
  protected final String TEXT_60 = NL + "\t\tpRLs_";
  protected final String TEXT_61 = ".deleteRule(";
  protected final String TEXT_62 = ");";
  protected final String TEXT_63 = NL + "\t\torg.talend.jpalo.palorule pRL_";
  protected final String TEXT_64 = " = pRLs_";
  protected final String TEXT_65 = ".getRule(";
  protected final String TEXT_66 = ");" + NL + "\t\tif(null!=pRL_";
  protected final String TEXT_67 = "){" + NL + "\t\t\tpRL_";
  protected final String TEXT_68 = ".setDefinition(";
  protected final String TEXT_69 = ");" + NL + "\t\t\tpRL_";
  protected final String TEXT_70 = ".setComment(";
  protected final String TEXT_71 = ");" + NL + "\t\t\tpRL_";
  protected final String TEXT_72 = ".setActivated(";
  protected final String TEXT_73 = ");" + NL + "\t\t\tpRL_";
  protected final String TEXT_74 = ".modifyRule();" + NL + "\t\t}";
  protected final String TEXT_75 = NL + "\t\tif(pConn_";
  protected final String TEXT_76 = " != null){" + NL + "\t\t\tpConn_";
  protected final String TEXT_77 = ".logout();" + NL + "\t\t}";
