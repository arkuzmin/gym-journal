...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_32 = NL + "    Character field_separator_";
  protected final String TEXT_33 = " = (";
  protected final String TEXT_34 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_35 = " += \"";
  protected final String TEXT_36 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_37 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_38 = " += \"NULL AS '\" + ";
  protected final String TEXT_39 = " + \"' \";";
  protected final String TEXT_40 = NL + "        Character text_enclosure_";
  protected final String TEXT_41 = " = (";
  protected final String TEXT_42 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_43 = " += \"CSV ";
  protected final String TEXT_44 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_45 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_46 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_47 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  ...
  protected final String TEXT_53 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_54 = "\");" + NL + "\t ";
  protected final String TEXT_55 = NL + "\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t";
  ...
  protected final String TEXT_64 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_77 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_98 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_99 = " = dbMetaData_";
  protected final String TEXT_100 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_101 = ", tableNameForSearch_";
  protected final String TEXT_102 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_103 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_104 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_105 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_109 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_110 = " = dbMetaData_";
  protected final String TEXT_111 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_112 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_113 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_114 = " = rsTable_";
  protected final String TEXT_115 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_116 = " = rsTable_";
  protected final String TEXT_117 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_118 = ".equalsIgnoreCase(";
  protected final String TEXT_119 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_120 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_121 = ") || dbschema_";
  protected final String TEXT_122 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_123 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_133 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_137 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_138 = ".equals(schema_";
  protected final String TEXT_139 = ") || (schema_";
  protected final String TEXT_140 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_141 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_150 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_151 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_152 = " == null || dbschema_";
  protected final String TEXT_153 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_156 = " = stmtSchema_";
  protected final String TEXT_157 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_158 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_159 = " = rsSchema_";
  protected final String TEXT_160 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_161 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_162 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_177 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_178 = ".equals";
  protected final String TEXT_179 = "IgnoreCase";
  protected final String TEXT_180 = "(schema_";
  ...
  protected final String TEXT_244 = NL + "        int keyCount_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_247 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_248 = " = tableName_";
  protected final String TEXT_249 = ";" + NL + "        tableName_";
  protected final String TEXT_250 = " = \"tmp_";
  protected final String TEXT_251 = "_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_254 = ".execute(\"";
  protected final String TEXT_255 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_256 = ".close();" + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_259 = ".execute(bulkSQL_";
  protected final String TEXT_260 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_261 = ".close();" + NL + "        tableName_";
  protected final String TEXT_262 = " = tmpTableName_";
  protected final String TEXT_263 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_264 = " = \"tmp_";
  protected final String TEXT_265 = "_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_268 = ".executeUpdate(\"";
  protected final String TEXT_269 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_270 = ".close();" + NL + "        tableName_";
  protected final String TEXT_271 = " = tmpTableName_";
  protected final String TEXT_272 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_275 = ".execute(\"";
  protected final String TEXT_276 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_277 = ".close();";
  protected final String TEXT_278 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_281 = ".execute(bulkSQL_";
  protected final String TEXT_282 = ");" + NL + "    stmtBulk_";
