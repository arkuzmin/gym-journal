...
abstract class  Manager {
    ...
    public String getConnection() {
        ...
        javaCode.append("java.sql.Connection conn_" + cid + "= java.sql.DriverManager.getConnection(" + getConnectionURL() + "," + userName + ", decryptedPassword_" + cid + ");\r\n");
...
class MysqlManager extends Manager {
    ...
    private boolean useExistingConnection;
    private String connection;        
    public MysqlManager(String host, String port, String dbName, String tableName, String userName, boolean useExistingConnection, String connection, boolean temporary, String cid) {
        super(dbName, tableName, userName, cid);
        this.host = host;
        this.port = port;
        this.useExistingConnection = useExistingConnection;
...
class ManagerFactory {
    ...
    public Manager createManager(String dbType, INode node) {
        ...
        if(("ACCESS").equals(dbType)) {
            ...
            manager = new MysqlManager(host, port, dbName, tableName, userName, useExistingConnection, connection, temporary, cid);
