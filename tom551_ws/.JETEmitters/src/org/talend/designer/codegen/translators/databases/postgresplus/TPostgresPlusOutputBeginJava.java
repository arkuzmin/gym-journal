...
public class TPostgresPlusOutputBeginJava {
  ...
  protected final String TEXT_57 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_63 = ");" + NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_94 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_95 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_96 = " == null || dbschema_";
  protected final String TEXT_97 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_100 = " = stmtSchema_";
  protected final String TEXT_101 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_102 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_103 = " = rsSchema_";
  protected final String TEXT_104 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_105 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_106 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_113 = ") " + NL + "                \t&& (schema_";
  protected final String TEXT_114 = ".equals(dbschema_";
  protected final String TEXT_115 = ") || ((dbschema_";
  protected final String TEXT_116 = " == null || dbschema_";
  protected final String TEXT_117 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_118 = ".equals(schema_";
  ...
  protected final String TEXT_132 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_141 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_144 = " = deletedCount_";
  protected final String TEXT_145 = " + stmtClear_";
  protected final String TEXT_146 = ".executeUpdate(\"";
  protected final String TEXT_147 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_148 = ".close();";
  protected final String TEXT_149 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_152 = " = stmtTruncCount_";
  protected final String TEXT_153 = ".executeQuery(\"";
  protected final String TEXT_154 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_157 = ".executeUpdate(\"";
  protected final String TEXT_158 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_159 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_160 = " += rsTruncCount_";
  protected final String TEXT_161 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_162 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_163 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_183 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_193 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_201 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_216 = " = \"DELETE FROM \\\"\" + tableName_";
