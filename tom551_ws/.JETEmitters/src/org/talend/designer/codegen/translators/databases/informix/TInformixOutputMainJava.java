...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_424 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_483 = ".prepareStatement(delete_";
  protected final String TEXT_484 = ");" + NL + "\t    ";
  protected final String TEXT_485 = NL + "       \t";
  protected final String TEXT_486 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_508 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_509 = " = insertIgnore_";
  protected final String TEXT_510 = ".split(\"\\\\?\");";
  protected final String TEXT_511 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_523 = " = false;";
  protected final String TEXT_524 = NL + "                    ";
  protected final String TEXT_525 = NL + "                        query_";
  protected final String TEXT_526 = " = ";
  protected final String TEXT_527 = ";";
  protected final String TEXT_528 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_529 = ",";
  protected final String TEXT_530 = ".";
  protected final String TEXT_531 = ", ";
  protected final String TEXT_532 = ",insertSQLSplits_";
  protected final String TEXT_533 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_534 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_535 = ".";
  protected final String TEXT_536 = ", pstmt_";
  protected final String TEXT_537 = ", ";
  protected final String TEXT_538 = ", \"";
  protected final String TEXT_539 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_540 = NL + "                globalMap.put(\"";
  protected final String TEXT_541 = "_QUERY\", query_";
  protected final String TEXT_542 = ".toString().trim());";
  protected final String TEXT_543 = NL + "            ";
  protected final String TEXT_544 = NL + "    \t\tpstmt_";
  protected final String TEXT_545 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_553 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_568 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_578 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_579 = ",";
  protected final String TEXT_580 = ".";
  protected final String TEXT_581 = ", ";
  protected final String TEXT_582 = ",updateSQLSplits_";
  protected final String TEXT_583 = ");";
  protected final String TEXT_584 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_614 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_622 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_637 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_638 = NL + "                        ";
  protected final String TEXT_639 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_640 = ";";
  protected final String TEXT_641 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_646 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_647 = " = pstmt_";
  protected final String TEXT_648 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_649 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_650 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_651 = " = rs_";
  protected final String TEXT_652 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_653 = " > 0) {";
  protected final String TEXT_654 = NL + "                        ";
  protected final String TEXT_655 = NL + "                            query_";
  protected final String TEXT_656 = " = ";
  protected final String TEXT_657 = ";";
  protected final String TEXT_658 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_659 = ",";
  protected final String TEXT_660 = ".";
  protected final String TEXT_661 = ", ";
  protected final String TEXT_662 = ",updateSQLSplits_";
  ...
  protected final String TEXT_691 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_692 = " = updatedCount_";
  protected final String TEXT_693 = " + pstmtUpdate_";
  protected final String TEXT_694 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_709 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_714 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_723 = ",insertSQLSplits_";
  protected final String TEXT_724 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_725 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_734 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_735 = " = insertedCount_";
  protected final String TEXT_736 = " + pstmtInsert_";
  protected final String TEXT_737 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_757 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_796 = NL + "                globalMap.put(\"";
  protected final String TEXT_797 = "_QUERY\", query_";
  protected final String TEXT_798 = ".toString().trim());";
  protected final String TEXT_799 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_800 = "=pstmtUpdate_";
  protected final String TEXT_801 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_802 = " = updatedCount_";
  protected final String TEXT_803 = " + updateFlag_";
  protected final String TEXT_804 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_805 = " == 0) {" + NL + "            \t";
  protected final String TEXT_806 = NL + "\t\t\t\tquery_";
  protected final String TEXT_807 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_816 = ",insertSQLSplits_";
  protected final String TEXT_817 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_818 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_819 = ".";
  protected final String TEXT_820 = ", pstmtInsert_";
  ...
  protected final String TEXT_827 = NL + "                    insertedCount_";
  protected final String TEXT_828 = " = insertedCount_";
  protected final String TEXT_829 = " + pstmtInsert_";
  protected final String TEXT_830 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_841 = NL + "                            rejectedCount_";
  protected final String TEXT_842 = " = rejectedCount_";
  protected final String TEXT_843 = " + 1;";
  protected final String TEXT_844 = NL + "                            ";
  protected final String TEXT_845 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_850 = NL + "                }" + NL + "                " + NL + "            nb_line_";
  ...
  protected final String TEXT_866 = ".addBatch();" + NL + "\t\t\t";
  protected final String TEXT_867 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_868 = "++;";
  protected final String TEXT_869 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_870 = " = deletedCount_";
  protected final String TEXT_871 = " + pstmt_";
  protected final String TEXT_872 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_895 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_906 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_907 = " <= batchSizeCounter_";
  protected final String TEXT_908 = ") {                ";
  protected final String TEXT_909 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_910 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_911 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_912 = ": pstmt_";
  protected final String TEXT_913 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_914 = " += (countEach_";
  protected final String TEXT_915 = " < 0 ? 0 : countEach_";
  protected final String TEXT_916 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_917 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_918 = " += countSum_";
  protected final String TEXT_919 = ";" + NL + "            \t    \t";
  protected final String TEXT_920 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_921 = " += countSum_";
  protected final String TEXT_922 = ";" + NL + "            \t    \t";
  protected final String TEXT_923 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_924 = " += countSum_";
  protected final String TEXT_925 = ";" + NL + "            \t    \t";
  protected final String TEXT_926 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_927 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_928 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_929 = NL + "                }";
  protected final String TEXT_930 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_931 = NL + "            commitCounter_";
  protected final String TEXT_932 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_933 = "<=commitCounter_";
  protected final String TEXT_934 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_935 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_936 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
