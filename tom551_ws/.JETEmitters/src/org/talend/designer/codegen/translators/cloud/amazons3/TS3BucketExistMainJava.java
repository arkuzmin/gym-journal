...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_45 = NL + "boolean bucketExist_";
  protected final String TEXT_46 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_47 = " = conn_";
  protected final String TEXT_48 = ".doesBucketExist(";
  protected final String TEXT_49 = ");" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_50 = "){";
  protected final String TEXT_51 = NL + "\t\tthrow(e_";
  protected final String TEXT_52 = ");";
  protected final String TEXT_53 = NL + "\t\tSystem.err.println(e_";
  protected final String TEXT_54 = ".getMessage());";
  protected final String TEXT_55 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_56 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_57 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_58 = NL + "\t}" + NL + "globalMap.put(\"";
  protected final String TEXT_59 = "_BUCKET_NAME\", ";
  protected final String TEXT_60 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_61 = "_BUCKET_EXIST\", bucketExist_";
