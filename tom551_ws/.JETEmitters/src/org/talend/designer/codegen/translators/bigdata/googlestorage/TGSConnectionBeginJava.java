...
public class TGSConnectionBeginJava
{
  ...
  protected final String TEXT_11 = ");" + NL + "\torg.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_12 = " = " + NL + "\t\tnew org.jets3t.service.impl.rest.httpclient.GoogleStorageService(credentials_";
  protected final String TEXT_13 = ");" + NL + "\tservice_";
  protected final String TEXT_14 = ".getAccountOwner();" + NL + "\tglobalMap.put(\"service_\" + \"";
  protected final String TEXT_15 = "\",service_";
