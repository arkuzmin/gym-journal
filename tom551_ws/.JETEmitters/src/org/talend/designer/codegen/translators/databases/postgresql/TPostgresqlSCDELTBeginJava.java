...
public class TPostgresqlSCDELTBeginJava {
  ...
  protected final String TEXT_30 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_31 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_32 = " != null && schema_";
  protected final String TEXT_33 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_34 = " = schema_";
  protected final String TEXT_35 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_36 = ";" + NL + "        sourceTable_";
  protected final String TEXT_37 = " = schema_";
  protected final String TEXT_38 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_39 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_40 = " = ";
  protected final String TEXT_41 = ";" + NL + "        sourceTable_";
  ...
  protected final String TEXT_67 = " = \"public\";" + NL + "            if(schema_";
  ...
  protected final String TEXT_81 = ".getString(\"TABLE_NAME\");" + NL + "                String schemaName_";
  protected final String TEXT_82 = " = rsTable_";
  protected final String TEXT_83 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_84 = ".equals(";
  protected final String TEXT_85 = ") " + NL + "                \t&& (schemaName_";
  protected final String TEXT_86 = ".equals(schema_";
  protected final String TEXT_87 = ") || ((schema_";
  protected final String TEXT_88 = " == null || schema_";
  protected final String TEXT_89 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_90 = ".equals(schemaName_";
  ...
  protected final String TEXT_128 = NL + "        String updateForType1_";
  protected final String TEXT_129 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_130 = " + \"\\\" d SET ";
  protected final String TEXT_131 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_132 = " + \"\\\" t WHERE ";
  protected final String TEXT_133 = " AND (";
  protected final String TEXT_134 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_137 = ".executeUpdate(updateForType1_";
  protected final String TEXT_138 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_139 = ".close();";
  protected final String TEXT_140 = NL + "            System.out.println(\"[";
  protected final String TEXT_141 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_142 = " + \"\\ndone\");";
  protected final String TEXT_143 = NL + "        String updateForType2_";
  protected final String TEXT_144 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_145 = " + \"\\\" d SET \\\"";
  protected final String TEXT_146 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_147 = "\"))) + \"'";
  protected final String TEXT_148 = ", \\\"";
  protected final String TEXT_149 = "\\\" = 0";
  protected final String TEXT_150 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_151 = " + \"\\\" t WHERE ";
  ...
  protected final String TEXT_161 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_162 = " + \"\\ndone\");";
  protected final String TEXT_163 = NL + "        String insertForType2_";
  protected final String TEXT_164 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_165 = " + \"\\\"(";
  protected final String TEXT_166 = "\\\"";
  protected final String TEXT_167 = "\\\", ";
  protected final String TEXT_168 = ") SELECT ";
  protected final String TEXT_169 = "NEXTVAL('\" + ";
  protected final String TEXT_170 = " + \"'), ";
  protected final String TEXT_171 = "t.";
  protected final String TEXT_172 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_173 = "\"))) + \"', NULL";
  protected final String TEXT_174 = ", 1";
  protected final String TEXT_175 = ", d.\\\"";
  protected final String TEXT_176 = "\\\" + 1";
  protected final String TEXT_177 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_178 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_179 = " + \"\\\" d WHERE ";
  protected final String TEXT_180 = " AND (";
  protected final String TEXT_181 = ") AND d.\\\"";
  protected final String TEXT_182 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_183 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_186 = ".executeUpdate(insertForType2_";
  protected final String TEXT_187 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_188 = ".close();";
  protected final String TEXT_189 = NL + "            System.out.println(\"[";
  protected final String TEXT_190 = "] type2 new active row sql\\n\" + insertForType2_";
  ...
  protected final String TEXT_197 = ") SELECT ";
  protected final String TEXT_198 = "NEXTVAL('\" + ";
  protected final String TEXT_199 = " + \"'), ";
  protected final String TEXT_200 = "t.";
  protected final String TEXT_201 = "\"";
  protected final String TEXT_202 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_203 = "\"))) + \"', NULL\"";
  protected final String TEXT_204 = NL + "    + \"";
  protected final String TEXT_205 = ", 1";
  protected final String TEXT_206 = ", 1";
  protected final String TEXT_207 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_208 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_209 = " + \"\\\" d ON ";
  protected final String TEXT_210 = " WHERE (";
  protected final String TEXT_211 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_214 = ".executeUpdate(insert_";
  protected final String TEXT_215 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_216 = ".close();";
  protected final String TEXT_217 = NL + "        System.out.println(\"[";
  protected final String TEXT_218 = "] new rows sql\\n\" + insert_";
