...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_388 = NL + "                update_";
  protected final String TEXT_389 = " = update_";
  ...
  protected final String TEXT_430 = ".toUpperCase();" + NL + "                update_";
  protected final String TEXT_431 = " = update_";
  ...
  protected final String TEXT_435 = ".prepareStatement((\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_442 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_467 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_474 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_475 = ".";
  protected final String TEXT_476 = ", \"";
  protected final String TEXT_477 = "\")+\" WHERE ";
  protected final String TEXT_478 = "\";";
  protected final String TEXT_479 = NL + "                insert_";
  protected final String TEXT_480 = " = insert_";
  protected final String TEXT_481 = ".toUpperCase();" + NL + "                update_";
  ...
  protected final String TEXT_492 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_541 = NL + "                        query_";
  protected final String TEXT_542 = " = ";
  protected final String TEXT_543 = ";";
  protected final String TEXT_544 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_545 = ",";
  protected final String TEXT_546 = ".";
  protected final String TEXT_547 = ", ";
  protected final String TEXT_548 = ",insertSQLSplits_";
  ...
  protected final String TEXT_561 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_562 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_563 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_564 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_565 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_566 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_567 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_568 = " = insertedCount_";
  protected final String TEXT_569 = " + pstmt_";
  protected final String TEXT_570 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_585 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_595 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_596 = ",";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = ", ";
  protected final String TEXT_599 = ",updateSQLSplits_";
  protected final String TEXT_600 = ");";
  protected final String TEXT_601 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_602 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ", pstmt_";
  ...
  protected final String TEXT_626 = NL + "                globalMap.put(\"";
  protected final String TEXT_627 = "_QUERY\", query_";
  protected final String TEXT_628 = ".toString().trim());";
  protected final String TEXT_629 = NL + "    \t\t";
  protected final String TEXT_630 = NL + "    \t\tpstmt_";
  protected final String TEXT_631 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_632 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_633 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_634 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_635 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_636 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_637 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_638 = " = updatedCount_";
  protected final String TEXT_639 = " + pstmt_";
  protected final String TEXT_640 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_655 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_656 = NL + "                        ";
  protected final String TEXT_657 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_658 = ";";
  protected final String TEXT_659 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_664 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_665 = " = pstmt_";
  protected final String TEXT_666 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_667 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_668 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_669 = " = rs_";
  protected final String TEXT_670 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_671 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_672 = NL + "                        ";
  protected final String TEXT_673 = NL + "                            query_";
  protected final String TEXT_674 = " = ";
  protected final String TEXT_675 = ";";
  protected final String TEXT_676 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_677 = ",";
  protected final String TEXT_678 = ".";
  protected final String TEXT_679 = ", ";
  protected final String TEXT_680 = ",updateSQLSplits_";
  ...
  protected final String TEXT_709 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_710 = " = updatedCount_";
  protected final String TEXT_711 = " + pstmtUpdate_";
  protected final String TEXT_712 = ".executeUpdate(); " + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_732 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_755 = ".executeUpdate();" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_775 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_776 = "++;" + NL + "    \t\t";
  protected final String TEXT_777 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_783 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_784 = ",";
  protected final String TEXT_785 = ".";
  protected final String TEXT_786 = ", ";
  protected final String TEXT_787 = ",updateSQLSplits_";
  protected final String TEXT_788 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_789 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_790 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_791 = ".";
  protected final String TEXT_792 = ", pstmtUpdate_";
  ...
  protected final String TEXT_817 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_818 = "=pstmtUpdate_";
  protected final String TEXT_819 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_820 = " = updatedCount_";
  protected final String TEXT_821 = " + updateFlag_";
  protected final String TEXT_822 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_823 = " == 0) {" + NL + "            \t";
  protected final String TEXT_824 = NL + "\t\t\t\tquery_";
  protected final String TEXT_825 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_845 = NL + "                    insertedCount_";
  protected final String TEXT_846 = " = insertedCount_";
  protected final String TEXT_847 = " + pstmtInsert_";
  protected final String TEXT_848 = ".executeUpdate();" + NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_849 = " = true;";
  protected final String TEXT_850 = NL + "                        throw(e);";
  ...
  protected final String TEXT_863 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_868 = NL + "                }" + NL + "    " + NL + "            nb_line_";
  ...
  protected final String TEXT_885 = ".addBatch();" + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_886 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_887 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_888 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_889 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_890 = " = deletedCount_";
  protected final String TEXT_891 = " + pstmt_";
  protected final String TEXT_892 = ".executeUpdate();" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_913 = NL + "            nb_line_";
  protected final String TEXT_914 = "++;" + NL + "    \t";
  protected final String TEXT_915 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_926 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_927 = " <= batchSizeCounter_";
  protected final String TEXT_928 = ") {                ";
  protected final String TEXT_929 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_930 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_931 = ": pstmt_";
  protected final String TEXT_932 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_933 = " += (countEach_";
  protected final String TEXT_934 = " < 0 ? 0 : countEach_";
  protected final String TEXT_935 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "            \t    \t";
  protected final String TEXT_936 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_937 = " += countSum_";
  protected final String TEXT_938 = ";" + NL + "            \t    \t";
  protected final String TEXT_939 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_940 = " += countSum_";
  protected final String TEXT_941 = ";" + NL + "            \t    \t";
  protected final String TEXT_942 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_946 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_947 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_948 = NL + "                \tint countSum_";
  protected final String TEXT_949 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_950 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_951 = " += (countEach_";
  protected final String TEXT_952 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_957 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_958 = " += countSum_";
  protected final String TEXT_959 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_960 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_961 = " += countSum_";
  protected final String TEXT_962 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_963 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_964 = NL + "                }";
  protected final String TEXT_965 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_966 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_967 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_968 = " <= commitCounter_";
  protected final String TEXT_969 = ") {" + NL + "                ";
  protected final String TEXT_970 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_971 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_986 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_987 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  ...
  protected final String TEXT_1003 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1004 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1005 = NL + "                \tconn_";
  protected final String TEXT_1006 = ".commit();                " + NL + "                \tcommitCounter_";
