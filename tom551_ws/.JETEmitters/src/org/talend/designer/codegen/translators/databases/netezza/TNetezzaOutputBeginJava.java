...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_168 = NL + NL + "\tString dbPwd_";
  protected final String TEXT_169 = " = decryptedPassword_";
  protected final String TEXT_170 = ";" + NL + "" + NL + "\t";
  protected final String TEXT_171 = "\t " + NL + "\t";
  protected final String TEXT_172 = NL + "\t\tlog.info(\"";
  protected final String TEXT_173 = " - Connection attempt to '\" + url_";
  protected final String TEXT_174 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_175 = " + \"'.\");" + NL + "\t";
  protected final String TEXT_176 = "\t" + NL + "\tconn_";
  protected final String TEXT_177 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_178 = ", dbUser_";
  protected final String TEXT_179 = ", dbPwd_";
  protected final String TEXT_180 = ");" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_181 = "\", conn_";
  protected final String TEXT_182 = ");" + NL + "\t";
  protected final String TEXT_183 = NL + "\t\tlog.info(\"";
  protected final String TEXT_184 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_191 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_197 = " - Drop table '\" + tableName_";
  protected final String TEXT_198 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_209 = " - Create table '\" + tableName_";
  protected final String TEXT_210 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_221 = " - Creata table '\" + tableName_";
  ...
  protected final String TEXT_254 = " - Droping tableName_";
  ...
  protected final String TEXT_262 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_274 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_277 = " = stmtClearCount_";
  ...
  protected final String TEXT_283 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_289 = " - Truncate table '\" + tableName_";
  protected final String TEXT_290 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL + "            while(rsClearCount_";
  protected final String TEXT_292 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_293 = " += rsClearCount_";
  protected final String TEXT_294 = ".getInt(1);" + NL + "            }";
  ...
  protected final String TEXT_299 = " - Clearing table '\" + tableName_";
  protected final String TEXT_300 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_301 = NL + "            deletedCount_";
  protected final String TEXT_302 = " = deletedCount_";
  protected final String TEXT_303 = " + stmtClear_";
  ...
  protected final String TEXT_311 = NL + "    \tconn_";
  protected final String TEXT_312 = ".setAutoCommit(false);";
  protected final String TEXT_313 = "      \t    " + NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_314 = " = conn_";
  protected final String TEXT_315 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_316 = "+\" (";
  protected final String TEXT_317 = ") VALUES (";
  protected final String TEXT_318 = ")\");\t        " + NL + "\t        ";
  protected final String TEXT_319 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_320 = " = conn_";
  protected final String TEXT_321 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_327 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_328 = " + \" WHERE ";
  protected final String TEXT_329 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_330 = " = conn_";
  protected final String TEXT_331 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_332 = " + \" (";
  protected final String TEXT_333 = ") VALUES (";
  protected final String TEXT_334 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_335 = " = conn_";
  protected final String TEXT_336 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_342 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_343 = " + \" SET ";
  protected final String TEXT_344 = " WHERE ";
  protected final String TEXT_345 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_348 = " + \" (";
  protected final String TEXT_349 = ") VALUES (";
  protected final String TEXT_350 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_351 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_352 = " = conn_";
  protected final String TEXT_353 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_354 = " + \" WHERE ";
  protected final String TEXT_355 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_356 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_359 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_360 = NL + "\t   int batchSize_";
  protected final String TEXT_361 = " = ";
  protected final String TEXT_362 = ";" + NL + "\t   int batchSizeCounter_";
