...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_227 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_228 = ");";
  protected final String TEXT_229 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_230 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_231 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_232 = "),Integer.parseInt(";
  protected final String TEXT_233 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_234 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_235 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_236 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_237 = " && timeOut_";
  protected final String TEXT_238 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_239 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_240 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_241 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_242 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_243 = NL + "\t\t\t\tString url_";
  protected final String TEXT_244 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_245 = ";";
  protected final String TEXT_246 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_247 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_248 = " + \":\" + ";
  protected final String TEXT_249 = " + \"/\" + ";
  protected final String TEXT_250 = ";";
  protected final String TEXT_251 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_252 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_253 = " + \":\" + ";
  protected final String TEXT_254 = " + \"/\" + ";
  protected final String TEXT_255 = ";";
  protected final String TEXT_256 = NL + "\t\t\t    java.lang.Class.forName(\"";
  protected final String TEXT_257 = "\").newInstance();" + NL + "\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t        String dbUser_";
  protected final String TEXT_259 = " = ";
  protected final String TEXT_260 = ";" + NL + "\t\t        ";
  protected final String TEXT_261 = NL + "\t\t        ";
  protected final String TEXT_262 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_263 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_264 = ");";
  protected final String TEXT_265 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = "; ";
  protected final String TEXT_268 = NL + "\t\t        String dbPwd_";
  protected final String TEXT_269 = " = decryptedPassword_";
  protected final String TEXT_270 = ";" + NL + "\t\t        conn_";
  protected final String TEXT_271 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_272 = ",dbUser_";
  protected final String TEXT_273 = ",dbPwd_";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + "    " + NL + "\t";
  protected final String TEXT_276 = NL + "\t\t    int nb_line_";
  protected final String TEXT_277 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_278 = " = null;";
  protected final String TEXT_279 = NL + "\t\t        conn_";
  protected final String TEXT_280 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_281 = "\");";
  protected final String TEXT_282 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_283 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_284 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_285 = " = dataSources_";
  protected final String TEXT_286 = ".get(";
  protected final String TEXT_287 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_288 = "\", conn_";
  protected final String TEXT_289 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_290 = NL + "\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_292 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_293 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_294 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_295 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_296 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_297 = NL + NL + "\t\t    ";
  protected final String TEXT_298 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_299 = " = ";
  protected final String TEXT_300 = ";";
  protected final String TEXT_301 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_302 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_303 = " + \"'.\");";
  protected final String TEXT_304 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_305 = "_QUERY\",dbquery_";
  protected final String TEXT_306 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_307 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_312 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_313 = " = rsmd_";
  protected final String TEXT_314 = ".getColumnCount();" + NL;
  protected final String TEXT_315 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_316 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_317 = ".setDbmsId(\"";
  protected final String TEXT_318 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_319 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_320 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_321 = ".add(\"";
  protected final String TEXT_322 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_323 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_324 = " = ";
  protected final String TEXT_325 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_326 = "; i <= rsmd_";
  protected final String TEXT_327 = ".getColumnCount()-";
  protected final String TEXT_328 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_329 = ".contains(rsmd_";
  protected final String TEXT_330 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_331 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_332 = ".setName(rsmd_";
  protected final String TEXT_333 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setDbName(rsmd_";
  protected final String TEXT_335 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_337 = "\", rsmd_";
  protected final String TEXT_338 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_339 = ".getPrecision(i), rsmd_";
  protected final String TEXT_340 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_341 = ".setDbType(rsmd_";
  protected final String TEXT_342 = ".getColumnTypeName(i));";
  protected final String TEXT_343 = NL + "                \tdcm_";
  protected final String TEXT_344 = ".setFormat(";
  protected final String TEXT_345 = ");";
  protected final String TEXT_346 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_347 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_348 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_349 = ".setLength(rsmd_";
  protected final String TEXT_350 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_351 = ".setLength(rsmd_";
  protected final String TEXT_352 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_353 = NL + "\t\t\tdcm_";
  protected final String TEXT_354 = ".setLength(rsmd_";
  protected final String TEXT_355 = ".getPrecision(i));";
  protected final String TEXT_356 = NL + "                \tdcm_";
  protected final String TEXT_357 = ".setPrecision(rsmd_";
  protected final String TEXT_358 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_359 = ".setNullable(rsmd_";
  protected final String TEXT_360 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_361 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_362 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_363 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_364 = ".metadatas.add(dcm_";
  protected final String TEXT_365 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_366 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_367 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_368 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_369 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_370 = NL + "\t\t    ";
  protected final String TEXT_371 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_372 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_373 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_374 = NL + "\t\t    while (rs_";
  protected final String TEXT_375 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_376 = "++;" + NL + "\t\t        ";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_378 = " = ";
  protected final String TEXT_379 = " + dcg_";
  protected final String TEXT_380 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_398 = " = (List)rs_";
  protected final String TEXT_399 = ".getObject(";
  protected final String TEXT_400 = "column_index_";
  protected final String TEXT_401 = ");";
  protected final String TEXT_402 = NL + "\t\t                         ";
  protected final String TEXT_403 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_404 = ".getObject(";
  protected final String TEXT_405 = "column_index_";
  protected final String TEXT_406 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_407 = NL + "                                    ";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_419 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_420 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_427 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_428 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_429 = ".getClob(i_";
  protected final String TEXT_430 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_431 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_432 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_433 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_434 = ".add(tNTextImpl_";
  protected final String TEXT_435 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_436 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_452 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_453 = ".getObject(";
  protected final String TEXT_454 = "column_index_";
  protected final String TEXT_455 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_456 = ".";
  protected final String TEXT_457 = " = new Geometry(sb.toString());";
  protected final String TEXT_458 = NL + "\t\t                          ";
  protected final String TEXT_459 = NL + "\t\t                    }" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_461 = ".append(";
  protected final String TEXT_462 = ".";
  protected final String TEXT_463 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_465 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_466 = NL + "\t\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_468 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_469 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_470 = " - Content of the record \" + nb_line_";
  protected final String TEXT_471 = " + \": \" + log4jSb_";
  protected final String TEXT_472 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_473 = ".delete(0,log4jSb_";
  protected final String TEXT_474 = ".length());" + NL + "\t\t\t\t\t";
