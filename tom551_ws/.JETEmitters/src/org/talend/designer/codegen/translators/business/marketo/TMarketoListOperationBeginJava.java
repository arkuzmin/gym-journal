...
public class TMarketoListOperationBeginJava
{
  ...
  protected final String TEXT_14 = NL + "\t\t\t\torg.talend.marketo.Client client_";
  protected final String TEXT_15 = " = new org.talend.marketo.Client(";
  protected final String TEXT_16 = ",decryptedPassword_";
  protected final String TEXT_17 = ",";
  protected final String TEXT_18 = ");" + NL + "\t\t\t\tclient_";
  protected final String TEXT_19 = ".setTimeout(";
  protected final String TEXT_20 = ");" + NL + "\t\t\t\tjava.util.List<com.marketo.www.mktows.LeadKey> leadKeyList_";
  protected final String TEXT_21 = " = new java.util.ArrayList<com.marketo.www.mktows.LeadKey>();" + NL + "\t\t\t\tcom.marketo.www.mktows.ResultListOperation resultListOperation_";
