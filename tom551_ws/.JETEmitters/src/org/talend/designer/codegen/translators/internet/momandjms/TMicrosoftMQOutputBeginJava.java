...
public class TMicrosoftMQOutputBeginJava
{
  ...
  protected final String TEXT_8 = ".createIfNotExists(true);" + NL + "\t\t\t\tmsgu_";
  protected final String TEXT_9 = ".open();" + NL + "\t\t\t\tresourceMap.put(\"msgu_";
  protected final String TEXT_10 = "\", msgu_";
  protected final String TEXT_11 = ");" + NL + "\t\t\t}catch(java.net.UnknownHostException ex_";
  protected final String TEXT_12 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_13 = NL + "\t\t\t\t\tthrow ex_";
  protected final String TEXT_14 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_15 = NL + "\t\t\t\t\tSystem.err.println(\"Unknown host :\" + ex_";
  protected final String TEXT_16 = ".getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_17 = NL + "\t\t\t}catch(ionic.Msmq.MessageQueueException e_";
  protected final String TEXT_18 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_19 = NL + "\t\t\t\t\tthrow e_";
  protected final String TEXT_20 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_21 = NL + "\t\t\t\t\tSystem.out.println(\"Queue creation failure: \" +e_";
