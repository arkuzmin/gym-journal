...
public class TGreenplumGPLoadBeginJava {
  ...
  protected final String TEXT_139 = NL + "        String dbPwd_";
  ...
  protected final String TEXT_145 = " - Connection attempt to '\" + url_";
  protected final String TEXT_146 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_154 = " - Connection to '\" + url_";
  ...
  protected final String TEXT_161 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_167 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_182 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_183 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_184 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_185 = " - Table '\" + tableName4Load_";
  protected final String TEXT_186 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_188 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_190 = " - Table '\" + tableName4Load_";
  protected final String TEXT_191 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_193 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_194 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_198 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_204 = " - Create table '\" + tableName_";
  protected final String TEXT_205 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_207 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_209 = " - Table '\" + tableName4Load_";
  protected final String TEXT_210 = " + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_212 = "  + \"' already exists. process terminated\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_214 = " - Table '\" + tableName4Load_";
  protected final String TEXT_215 = " + \"' already exists. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_242 = ".equals(dbschema_";
  ...
  protected final String TEXT_255 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_261 = " - Create table '\" + tableName_";
  protected final String TEXT_262 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_263 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_264 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_266 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_267 = "  + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_269 = "  + \"'. process terminated\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_271 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_272 = "  + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_273 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_274 = NL + "                if(whetherExist_";
  protected final String TEXT_275 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_276 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_280 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_286 = " - Drop table '\" + tableName_";
  protected final String TEXT_287 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_288 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_289 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_291 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_292 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_293 = NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_294 = "  + \"'. process terminated  \");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_296 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_297 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_299 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_303 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_309 = " - Create table '\" + tableName_";
  protected final String TEXT_310 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_311 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_312 = "){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_314 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_315 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_317 = "  + \"'. process terminated\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_319 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_320 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_322 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_323 = " = conn_";
  protected final String TEXT_324 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_325 = " = stmtClearCount_";
  ...
  protected final String TEXT_331 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_337 = " - Truncate table '\" + tableName_";
  protected final String TEXT_338 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_339 = NL + "            while(rsClearCount_";
  protected final String TEXT_340 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_341 = " = rsClearCount_";
  protected final String TEXT_342 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_343 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_344 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_348 = " - Clearing table '\" + tableName_";
  protected final String TEXT_349 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_350 = NL + "            \tdeletedCount_";
  protected final String TEXT_351 = " = stmtClear_";
  protected final String TEXT_352 = ".executeUpdate(\"";
  protected final String TEXT_353 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_355 = "- Clear table '\" + tableName_";
  protected final String TEXT_356 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_357 = NL + "            \tstmtClear_";
  protected final String TEXT_358 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_359 = "){" + NL + "\t\t\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_361 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_362 = " + \"'. process terminated\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_364 = "  + \"'. process terminated\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_366 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_367 = " + \"'. process terminated \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_369 = NL + "        conn_";
  protected final String TEXT_370 = ".close();";
  protected final String TEXT_371 = NL;
  protected final String TEXT_372 = NL + "\t\tString delim_";
  protected final String TEXT_373 = " = ";
  protected final String TEXT_374 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_377 = " = ";
  protected final String TEXT_378 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_379 = " = \"\\t\".equals(delim_";
  protected final String TEXT_380 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_381 = ";" + NL + "\t\t" + NL + "\t\tjava.io.PrintWriter gpctrl_";
  protected final String TEXT_382 = " = new java.io.PrintWriter(new java.io.FileOutputStream(";
  protected final String TEXT_383 = ", false), true);" + NL + "\t\tgpctrl_";
  protected final String TEXT_384 = ".println(\"---\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_385 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_386 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_387 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_388 = ".println(\"USER: \" + ";
  protected final String TEXT_389 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_390 = ".println(\"HOST: \" + ";
  protected final String TEXT_391 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_392 = ".println(\"PORT: \" + ";
  protected final String TEXT_393 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_394 = ".println(\"GPLOAD:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_395 = ".println(\"  INPUT:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_396 = ".println(\"    - SOURCE:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_397 = ".println(\"        FILE:\");" + NL + "\t\t";
  protected final String TEXT_398 = NL + "\t\tgpctrl_";
  protected final String TEXT_399 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_400 = "));" + NL + "\t\t";
  protected final String TEXT_401 = NL + "\t\tgpctrl_";
  protected final String TEXT_402 = ".println(\"          - \" + ";
  protected final String TEXT_403 = ");" + NL + "\t\t";
  protected final String TEXT_404 = NL + "\t\tgpctrl_";
  protected final String TEXT_405 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_406 = " + \"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_407 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_408 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_409 = NL + "\t\tgpctrl_";
  protected final String TEXT_410 = ".println(\"    - FORMAT: csv\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_411 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_412 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_413 = NL + "\t\tgpctrl_";
  protected final String TEXT_414 = ".println(\"    - FORMAT: text\");" + NL + "\t\t";
  protected final String TEXT_415 = NL + "\t\t";
  protected final String TEXT_416 = NL + "\t\tgpctrl_";
  protected final String TEXT_417 = ".println(\"    - HEADER: true\");" + NL + "\t\t";
  protected final String TEXT_418 = NL + "\t\tgpctrl_";
  protected final String TEXT_419 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_420 = ");" + NL + "\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_422 = ".println(\"    - ";
  protected final String TEXT_423 = ": \" + ";
  protected final String TEXT_424 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\tgpctrl_";
  protected final String TEXT_426 = ".println(\"  OUTPUT: \");" + NL + "\t\tgpctrl_";
  protected final String TEXT_427 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_428 = "+\"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_429 = ".println(\"    - MODE: ";
  protected final String TEXT_430 = "\");" + NL + "\t\t";
  protected final String TEXT_431 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_432 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_434 = ".println(\"      - ";
  protected final String TEXT_435 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_437 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_439 = ".println(\"      - ";
  protected final String TEXT_440 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_441 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_442 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_443 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_444 = NL + "\t\tgpctrl_";
  protected final String TEXT_445 = ".close();" + NL + "\t\t";
  protected final String TEXT_446 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_447 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_448 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_449 = ",";
  protected final String TEXT_450 = "};" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_451 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_452 = NL + "\t\t\t\t\tlog.fatal(\"";
  protected final String TEXT_453 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_455 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_456 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_457 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_458 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_459 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_461 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_462 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_463 = NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_465 = " - Loading data into database.\");" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\tgploadThread_";
  protected final String TEXT_467 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_468 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_469 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_470 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_471 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_472 = ");" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_474 = " - Loaded records count:\" + insertedCount_";
  protected final String TEXT_475 = " + \".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_476 = " - Has finished.\");" + NL + "\t\t";
