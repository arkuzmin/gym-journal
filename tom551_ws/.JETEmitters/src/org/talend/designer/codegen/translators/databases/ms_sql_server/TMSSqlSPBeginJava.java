...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_42 = NL + "//java.sql.Statement stmt_";
  protected final String TEXT_43 = " = conn_";
  protected final String TEXT_44 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_45 = ".execute(\"SET NOCOUNT ON\");" + NL + "" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_46 = " = conn_";
  protected final String TEXT_47 = ".prepareCall(\"{";
  protected final String TEXT_48 = "call \" + ";
  protected final String TEXT_49 = " + \"(";
  protected final String TEXT_50 = ")}\"";
  protected final String TEXT_51 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_52 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_53 = ";" + NL + "String tmpString_";
