...
public class TSybaseOutputEndJava
{
  ...
  protected final String TEXT_67 = " .close();" + NL + "\t\tresourceMap.put(\"finish_";
  ...
  protected final String TEXT_98 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_99 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_100 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_101 = "_NB_LINE_DELETED\") == null) {" + NL + "    \tglobalMap.put(\"";
  ...
  protected final String TEXT_104 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_105 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_106 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_107 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_108 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_109 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_110 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
