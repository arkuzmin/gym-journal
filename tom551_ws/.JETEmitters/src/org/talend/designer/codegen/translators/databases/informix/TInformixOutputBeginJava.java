...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_61 = NL + NL + "\tString dbPwd_";
  protected final String TEXT_62 = " = decryptedPassword_";
  protected final String TEXT_63 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_67 = ");" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_68 = "\", conn_";
  protected final String TEXT_69 = ");" + NL;
  protected final String TEXT_70 = NL;
  protected final String TEXT_71 = NL + "\tif(conn_";
  protected final String TEXT_72 = ".getAutoCommit()) {" + NL + "\t    conn_";
  protected final String TEXT_73 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_74 = NL + NL + "if(dbschema_";
  protected final String TEXT_75 = " == null || dbschema_";
  protected final String TEXT_76 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_79 = " = dbschema_";
  protected final String TEXT_80 = " + \".\" + ";
  protected final String TEXT_81 = ";    " + NL + "}" + NL;
  protected final String TEXT_82 = NL + "\tint count_";
  ...
  protected final String TEXT_86 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_87 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_88 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_94 = " - Drop table '\" + tableName_";
  protected final String TEXT_95 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "            stmtDrop_";
  protected final String TEXT_97 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_101 = " - Creating table '\" + tableName_";
  protected final String TEXT_102 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_104 = ".execute(((\"";
  protected final String TEXT_105 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_117 = " - Create table '\" + tableName_";
  protected final String TEXT_118 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_125 = " - Creating table '\" + tableName_";
  protected final String TEXT_126 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_128 = ".execute(((\"";
  protected final String TEXT_129 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = ", \"";
  protected final String TEXT_132 = "\"))+\")";
  protected final String TEXT_133 = "\")";
  protected final String TEXT_134 = ".toUpperCase()";
  ...
  protected final String TEXT_154 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_157 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_158 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_159 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_160 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_161 = ")== null){";
  protected final String TEXT_162 = "              ";
  protected final String TEXT_163 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_166 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_167 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_168 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_169 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_170 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_203 = ") " + NL + "\t                \t&& (schema_";
  ...
  protected final String TEXT_207 = ") || dbschema_";
  protected final String TEXT_208 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_209 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_213 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_214 = " = dbMetaData_";
  protected final String TEXT_215 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_216 = " = false;" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_232 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_233 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_245 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_248 = " = stmtSchema_";
  protected final String TEXT_249 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_250 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_251 = " = rsSchema_";
  protected final String TEXT_252 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_253 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_254 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_269 = ".trim().length() ==0) && defaultSchema_";
  ...
  protected final String TEXT_284 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_285 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_290 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_294 = " - Creating table '\" + tableName_";
  protected final String TEXT_295 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_297 = ".execute(((\"";
  protected final String TEXT_298 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_310 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_315 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_319 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_325 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_332 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_341 = ".toUpperCase()";
  ...
  protected final String TEXT_348 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_352 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_353 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_354 = "            ";
  protected final String TEXT_355 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_359 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_365 = "- Clear table '\" + tableName_";
  protected final String TEXT_366 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_367 = NL + "            stmtClear_";
  protected final String TEXT_368 = ".close();";
  protected final String TEXT_369 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_370 = " = conn_";
  protected final String TEXT_371 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_372 = " = stmtTruncCount_";
  protected final String TEXT_373 = ".executeQuery(\"";
  protected final String TEXT_374 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_378 = " - Trancating table '\" + tableName_";
  protected final String TEXT_379 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\tconn_";
  protected final String TEXT_382 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_387 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_392 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_393 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_394 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_405 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_406 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\tconn_";
  protected final String TEXT_409 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_414 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_415 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_416 = NL + "             while(rsTruncCount_";
  protected final String TEXT_417 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_421 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_441 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_447 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_454 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_455 = " = conn_";
  protected final String TEXT_456 = ".prepareStatement(update_";
  ...
  protected final String TEXT_462 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = ".prepareStatement(update_";
  ...
  protected final String TEXT_469 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_480 = NL + "        StringBuffer query_";
  protected final String TEXT_481 = " = null;" + NL + "       \t";
  protected final String TEXT_482 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_504 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_510 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_511 = " = ";
  protected final String TEXT_512 = ";" + NL + "        " + NL + "        int commitCounter_";
