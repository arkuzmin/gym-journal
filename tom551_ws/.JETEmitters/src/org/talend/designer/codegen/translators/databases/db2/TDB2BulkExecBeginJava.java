...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_47 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString fileName_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "\t\t";
  protected final String TEXT_50 = NL;
  protected final String TEXT_51 = NL + "\t\tString sqlLoadPending_";
  protected final String TEXT_52 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tjava.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_53 = " = conn_";
  protected final String TEXT_54 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_55 = ");" + NL + "        callStmtLoadPending_";
  protected final String TEXT_56 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_57 = " + \"\\\"\");" + NL + "        try {" + NL + "        \tcallStmtLoadPending_";
  protected final String TEXT_58 = ".execute();   " + NL + "        } catch (java.sql.SQLException e) { " + NL + "        \t//when table not in load pending mode will throw exception." + NL + "        \t//and do nothing." + NL + "        }" + NL + "        callStmtLoadPending_";
  ...
  protected final String TEXT_234 = NL + "Character field_separator_";
  protected final String TEXT_235 = " = (";
  protected final String TEXT_236 = ").charAt(0);";
  protected final String TEXT_237 = NL + "        String action_";
  protected final String TEXT_238 = " = \"";
  protected final String TEXT_239 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_240 = " = null;" + NL + "        String sql_";
  protected final String TEXT_241 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tString param_";
  protected final String TEXT_242 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_243 = " + \"\\\" OF ";
  protected final String TEXT_244 = " DEL MODIFIED BY COLDEL\"+ field_separator_";
  protected final String TEXT_245 = " +" + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_246 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_247 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_248 = " +\"\\\" ";
  protected final String TEXT_249 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_250 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_251 = " + \"\\\" ";
  protected final String TEXT_252 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".prepareCall(sql_";
  protected final String TEXT_255 = ");" + NL + "        callStmt_";
  protected final String TEXT_256 = ".setString(1, param_";
  protected final String TEXT_257 = ");" + NL + "        callStmt_";
  protected final String TEXT_258 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_259 = ".close();";
  protected final String TEXT_260 = NL + "            int keyCount_";
  protected final String TEXT_261 = " = ";
  protected final String TEXT_262 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_263 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_264 = " = tableName_";
  protected final String TEXT_265 = ";" + NL + "            tableName_";
  protected final String TEXT_266 = " = \"tmp_";
  protected final String TEXT_267 = "\" + \"_\" + pid + Thread.currentThread().getId(); " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_268 = " = conn_";
  protected final String TEXT_269 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_270 = ".execute(\"";
  protected final String TEXT_271 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_272 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_273 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_274 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\t\tString param_";
  protected final String TEXT_275 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_276 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_277 = " DEL MODIFIED BY COLDEL\" + field_separator_";
  protected final String TEXT_278 = " +" + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_279 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_280 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_281 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_282 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_283 = " + \"\\\" ";
  protected final String TEXT_284 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_285 = " = conn_";
  protected final String TEXT_286 = ".prepareCall(sql_";
  protected final String TEXT_287 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_288 = ".setString(1, param_";
  protected final String TEXT_289 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_290 = ".execute();        " + NL + "        \tcallStmt_";
  protected final String TEXT_291 = ".close();            " + NL + "                    \t\t\t" + NL + "            tableName_";
  protected final String TEXT_292 = " = tmpTableName_";
  protected final String TEXT_293 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_294 = " = \"tmp_";
  protected final String TEXT_295 = "\"+ \"_\" + pid + Thread.currentThread().getId();             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".createStatement();" + NL + "                        " + NL + "            stmtUpdateBulk_";
  protected final String TEXT_298 = ".executeUpdate(\"";
  protected final String TEXT_299 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_300 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_301 = " = \"tmp_";
  protected final String TEXT_302 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_303 = " = conn_";
  protected final String TEXT_304 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_305 = ".execute(\"";
  protected final String TEXT_306 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_307 = ".close();";
  protected final String TEXT_308 = NL + NL + NL + NL + NL + NL;
