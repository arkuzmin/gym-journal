...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_41 = NL + NL + "    String dbPwd_";
  protected final String TEXT_42 = " = decryptedPassword_";
  protected final String TEXT_43 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_44 = NL + "\t\tString url_";
  protected final String TEXT_45 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_46 = " + \":\" + ";
  protected final String TEXT_47 = " + \"/\" + ";
  protected final String TEXT_48 = "; ";
  protected final String TEXT_49 = NL + "\t\tString url_";
  protected final String TEXT_50 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_59 = ");" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_60 = "\", conn_";
  protected final String TEXT_61 = ");";
  protected final String TEXT_62 = NL + "        conn_";
  protected final String TEXT_63 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";        " + NL + "        int commitCounter_";
  protected final String TEXT_66 = " = 0;       ";
  protected final String TEXT_67 = NL;
  protected final String TEXT_68 = NL + "   int batchSize_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_71 = "=0;";
  protected final String TEXT_72 = " " + NL + "" + NL + "if(dbschema_";
  protected final String TEXT_73 = " != null && dbschema_";
  protected final String TEXT_74 = ".trim().length() != 0) {" + NL + "\ttableName_";
  protected final String TEXT_75 = " = dbschema_";
  protected final String TEXT_76 = " + \".\" + ";
  protected final String TEXT_77 = ";" + NL + "} ";
  protected final String TEXT_78 = NL + "int count_";
  ...
  protected final String TEXT_82 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_83 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_84 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_90 = " - Drop table '\" + tableName_";
  protected final String TEXT_91 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_92 = NL + "            stmtDrop_";
  protected final String TEXT_93 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_97 = " - Creating table '\" + tableName_";
  protected final String TEXT_98 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_100 = ".execute(((\"";
  protected final String TEXT_101 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = ", \"";
  protected final String TEXT_104 = "\"))+\")";
  protected final String TEXT_105 = "\")";
  protected final String TEXT_106 = ".toUpperCase()";
  ...
  protected final String TEXT_113 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_121 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_130 = ".toUpperCase()";
  ...
  protected final String TEXT_137 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_142 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_143 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_144 = "+\"][\"+";
  protected final String TEXT_145 = "+\"][\"+";
  protected final String TEXT_146 = "+\"][\"+";
  protected final String TEXT_147 = "+\"][\"+";
  protected final String TEXT_148 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_149 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_150 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_153 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_154 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_155 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_156 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_157 = ")== null){";
  protected final String TEXT_158 = "              ";
  protected final String TEXT_159 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_162 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_163 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_164 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_165 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_166 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_171 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_172 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_173 = " = tableNameForSearch_";
  protected final String TEXT_174 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_175 = " = tableNameForSearch_";
  protected final String TEXT_176 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_177 = " = dbMetaData_";
  protected final String TEXT_178 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_179 = ", tableNameForSearch_";
  protected final String TEXT_180 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_181 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_182 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_183 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_222 = ".toUpperCase()";
  ...
  protected final String TEXT_229 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_281 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_286 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".createStatement();" + NL + "        \t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_290 = " - Creating table '\" + tableName_";
  protected final String TEXT_291 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_293 = ".execute(((\"";
  protected final String TEXT_294 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_306 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_310 = NL + "                if(whetherExist_";
  protected final String TEXT_311 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_315 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_321 = " - Drop table '\" + tableName_";
  ...
  protected final String TEXT_328 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_344 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_351 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_355 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_361 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_374 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_383 = " - Truncate table '\" + tableName_";
  protected final String TEXT_384 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_385 = NL + "            while(rsTruncCount_";
  protected final String TEXT_386 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_387 = " += rsTruncCount_";
  protected final String TEXT_388 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_389 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_390 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_401 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_410 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_423 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_433 = ".prepareStatement(update_";
  protected final String TEXT_434 = ");" + NL + "\t    ";
  protected final String TEXT_435 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_436 = " = conn_";
  protected final String TEXT_437 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_464 = ") VALUES (";
  protected final String TEXT_465 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_466 = " = conn_";
  protected final String TEXT_467 = ".prepareStatement(insert_";
  protected final String TEXT_468 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_469 = NL + "\t    String delete_";
  protected final String TEXT_470 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_474 = ".prepareStatement(delete_";
  protected final String TEXT_475 = ");" + NL + "\t    ";
  protected final String TEXT_476 = NL + "        StringBuffer query_";
  protected final String TEXT_477 = " = null;" + NL + "       \t";
  protected final String TEXT_478 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_479 = " = insert_";
  ...
  protected final String TEXT_486 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_487 = " = update_";
  protected final String TEXT_488 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_489 = " = insert_";
  protected final String TEXT_490 = ".split(\"\\\\?\");";
  protected final String TEXT_491 = NL + "\t\t\tdelete_";
  protected final String TEXT_492 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_493 = " = delete_";
  protected final String TEXT_494 = ".split(\"\\\\?\");";
  protected final String TEXT_495 = NL + "\t\t\treplace_";
  protected final String TEXT_496 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_497 = " = replace_";
  protected final String TEXT_498 = ".split(\"\\\\?\");";
  protected final String TEXT_499 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_500 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_501 = " = insertIgnore_";
  ...
  protected final String TEXT_506 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_509 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_510 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_511 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_512 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_513 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_514 = " =null;" + NL + "\t";
  protected final String TEXT_515 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_516 = " = null;" + NL + "\t\t";
  protected final String TEXT_517 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_518 = " = null;";
  protected final String TEXT_519 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_520 = " =  null;";
  protected final String TEXT_521 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_522 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_523 = " = null;";
  protected final String TEXT_524 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_525 = " = null;";
  protected final String TEXT_526 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_530 = NL + "\t\t \tString[] insertSQLSplits_";
