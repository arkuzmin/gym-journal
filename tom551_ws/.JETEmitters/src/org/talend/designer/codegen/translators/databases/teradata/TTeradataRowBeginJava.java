...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_134 = " - Connection attempt to '\" + url_";
  protected final String TEXT_135 = " + \"' with the username '\" + dbUser_";
  ...
  protected final String TEXT_139 = ",dbUser_";
  protected final String TEXT_140 = ",dbPwd_";
  protected final String TEXT_141 = ");" + NL + "\t    ";
  protected final String TEXT_142 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_143 = " - Connection to '\" + url_";
  protected final String TEXT_144 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_145 = NL + "\t\t";
  protected final String TEXT_146 = NL;
  protected final String TEXT_147 = NL + "        conn_";
  protected final String TEXT_148 = ".setAutoCommit(false);        " + NL + "        int commitEvery_";
  ...
  protected final String TEXT_159 = NL + "String query_";
