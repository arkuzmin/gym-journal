...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_65 = NL + "      " + NL + "    " + NL + "    String dbPwd_";
  protected final String TEXT_66 = " = decryptedPassword_";
  protected final String TEXT_67 = ";    " + NL + "\tjava.lang.Class.forName(\"";
  protected final String TEXT_68 = "\");" + NL + "\tconn_";
  protected final String TEXT_69 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_70 = ", dbUser_";
  protected final String TEXT_71 = ", dbPwd_";
  protected final String TEXT_72 = ");" + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_73 = "\", conn_";
  protected final String TEXT_74 = ");" + NL + "\t";
  protected final String TEXT_75 = NL + "        conn_";
  protected final String TEXT_76 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_79 = " = 0;";
  protected final String TEXT_80 = NL + "   int batchSize_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_83 = "=0;";
  protected final String TEXT_84 = NL + " ";
  protected final String TEXT_85 = NL + "int count_";
  protected final String TEXT_86 = "=0;";
  protected final String TEXT_87 = NL + "    \t";
  protected final String TEXT_88 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_89 = " = conn_";
  protected final String TEXT_90 = ".createStatement();" + NL + "        \t";
  protected final String TEXT_91 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_92 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_98 = " - Drop table '\" + tableName_";
  protected final String TEXT_99 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "            stmtDrop_";
  protected final String TEXT_101 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_105 = " - Creating table '\" + tableName_";
  protected final String TEXT_106 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_108 = ".execute(((\"";
  protected final String TEXT_109 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = ", \"";
  protected final String TEXT_112 = "\"))+\")";
  protected final String TEXT_113 = "\")";
  protected final String TEXT_114 = ".toUpperCase()";
  ...
  protected final String TEXT_121 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_138 = ".toUpperCase()";
  ...
  protected final String TEXT_150 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_151 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_152 = "+\"][\"+";
  protected final String TEXT_153 = "+\"][\"+";
  protected final String TEXT_154 = "+\"][\"+";
  protected final String TEXT_155 = "+\"][\"+";
  protected final String TEXT_156 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_157 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_158 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_161 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_162 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_163 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_164 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_165 = ")== null){";
  protected final String TEXT_166 = "              ";
  protected final String TEXT_167 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_170 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_171 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_172 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_173 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_174 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_179 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_180 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_181 = " = tableNameForSearch_";
  protected final String TEXT_182 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_183 = " = tableNameForSearch_";
  protected final String TEXT_184 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_185 = " = dbMetaData_";
  protected final String TEXT_186 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_187 = ", tableNameForSearch_";
  protected final String TEXT_188 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_189 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_190 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_191 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_212 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_230 = ".toUpperCase()";
  ...
  protected final String TEXT_236 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_237 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_246 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_247 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_248 = " == null || dbschema_";
  protected final String TEXT_249 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_256 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_257 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_258 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_272 = " ==null || dbschema_";
  protected final String TEXT_273 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_274 = ".equals";
  protected final String TEXT_275 = "IgnoreCase";
  protected final String TEXT_276 = "(schema_";
  ...
  protected final String TEXT_285 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_286 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_287 = " = rsTable_";
  protected final String TEXT_288 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_289 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_298 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_314 = " - Create table '\" + tableName_";
  protected final String TEXT_315 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_316 = NL + "                    stmtCreate_";
  protected final String TEXT_317 = ".close();            " + NL + "                }                ";
  protected final String TEXT_318 = NL + "                if(whetherExist_";
  protected final String TEXT_319 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_323 = " - Droping table '\" + tableName_";
  protected final String TEXT_324 = " + \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_325 = NL + "                    stmtDrop_";
  protected final String TEXT_326 = ".execute(\"";
  protected final String TEXT_327 = "\");" + NL + "\t    \t    \t";
  protected final String TEXT_328 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_329 = " - Drop table '\" + tableName_";
  protected final String TEXT_330 = "+ \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_331 = NL + "                    stmtDrop_";
  protected final String TEXT_332 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_352 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_356 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_357 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_358 = "            ";
  protected final String TEXT_359 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_363 = " - Clearing table '\" + tableName_";
  protected final String TEXT_364 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_365 = NL + "            stmtClear_";
  protected final String TEXT_366 = ".executeUpdate(\"";
  protected final String TEXT_367 = "\");" + NL + "   \t    \t";
  protected final String TEXT_368 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_369 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_382 = " - Trancating table '\" + tableName_";
  protected final String TEXT_383 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\t";
  protected final String TEXT_385 = NL + "\t\t\tconn_";
  protected final String TEXT_386 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_391 = " - Truncate table '\" + tableName_";
  protected final String TEXT_392 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_409 = " - Truncating reuse stroage table '\" + tableName_";
  protected final String TEXT_410 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\tconn_";
  protected final String TEXT_413 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_414 = NL + "            stmtTrunc_";
  protected final String TEXT_415 = ".executeUpdate(\"";
  protected final String TEXT_416 = "\");" + NL + "   \t    \t";
  protected final String TEXT_417 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_418 = " - Truncate reuse stroage table '\" + tableName_";
  protected final String TEXT_419 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_427 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_428 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_430 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_431 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_432 = ".append (\"`\" +  ";
  protected final String TEXT_433 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_434 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_439 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_440 = " + \"` (";
  protected final String TEXT_441 = ") VALUES (";
  protected final String TEXT_442 = ")\";";
  protected final String TEXT_443 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_444 = " += \tduplidateClause_";
  protected final String TEXT_445 = ".toString();";
  protected final String TEXT_446 = NL + "\t\t\t\t";
  protected final String TEXT_447 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_448 = " = new StringBuffer(insert_";
  protected final String TEXT_449 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_450 = ".insert(insert_";
  protected final String TEXT_451 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_452 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_453 = " =insertStringBuffer_";
  ...
  protected final String TEXT_462 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_465 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_466 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_467 = ",insert_";
  protected final String TEXT_468 = ",keyPsmt_";
  protected final String TEXT_469 = ");";
  protected final String TEXT_470 = NL + "\t        \t        ";
  protected final String TEXT_471 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_472 = " {" + NL + "    \t            ";
  protected final String TEXT_473 = NL + "                            ";
  protected final String TEXT_474 = " ";
  protected final String TEXT_475 = ";                ";
  protected final String TEXT_476 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_477 = "(";
  protected final String TEXT_478 = NL + "                                ,";
  protected final String TEXT_479 = NL + "                            ";
  protected final String TEXT_480 = " ";
  protected final String TEXT_481 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_482 = NL + "                                this.";
  protected final String TEXT_483 = " = ";
  protected final String TEXT_484 = ";              ";
  protected final String TEXT_485 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_486 = "> exInsertColValueList";
  protected final String TEXT_487 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_488 = " exInsertColValue";
  protected final String TEXT_489 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_490 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_491 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_492 = ".append(\"(";
  protected final String TEXT_493 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_494 = "-1) extendInsertValueStmt_";
  protected final String TEXT_495 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_496 = " = \"INSERT INTO `\"+";
  protected final String TEXT_497 = "+\"` (";
  protected final String TEXT_498 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_499 = ".toString();";
  protected final String TEXT_500 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_501 = " += \tduplidateClause_";
  ...
  protected final String TEXT_515 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_516 = " = \"";
  protected final String TEXT_517 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_518 = " =  \"";
  protected final String TEXT_519 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_520 = " = 0;\t ";
  protected final String TEXT_521 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_522 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_529 = NL + "\t\t        int batchSize_";
  protected final String TEXT_530 = " = ";
  protected final String TEXT_531 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_532 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_546 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_564 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  ...
  protected final String TEXT_571 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_572 = " = new StringBuffer(insert_";
  protected final String TEXT_573 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_574 = ".insert(insert_";
  protected final String TEXT_575 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_576 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_577 = " =insertStringBuffer_";
  protected final String TEXT_578 = ".toString(); ";
  ...
  protected final String TEXT_583 = " = \"UPDATE `\" + ";
  protected final String TEXT_584 = " + \"` SET ";
  protected final String TEXT_585 = " WHERE ";
  protected final String TEXT_586 = "\";" + NL + "\t    ";
  protected final String TEXT_587 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_588 = " = new StringBuffer(update_";
  protected final String TEXT_589 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_590 = ".insert(update_";
  protected final String TEXT_591 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_592 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_593 = " =updateStringBuffer_";
  ...
  protected final String TEXT_600 = " = \"UPDATE `\" + ";
  protected final String TEXT_601 = " + \"` SET ";
  protected final String TEXT_602 = " WHERE ";
  protected final String TEXT_603 = "\";" + NL + "\t    ";
  protected final String TEXT_604 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_605 = " = new StringBuffer(update_";
  protected final String TEXT_606 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_607 = ".insert(update_";
  protected final String TEXT_608 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_609 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_610 = " =updateStringBuffer_";
  protected final String TEXT_611 = ".toString(); ";
  protected final String TEXT_612 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_613 = " = conn_";
  protected final String TEXT_614 = ".prepareStatement(update_";
  ...
  protected final String TEXT_633 = " = \"DELETE  FROM `\" + ";
  ...
  protected final String TEXT_648 = NL + "\t    String replace_";
  protected final String TEXT_649 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_650 = " + \"` (";
  protected final String TEXT_651 = ") VALUES (";
  protected final String TEXT_652 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_653 = " = conn_";
  protected final String TEXT_654 = ".prepareStatement(replace_";
  protected final String TEXT_655 = ");" + NL + "\t    ";
  protected final String TEXT_656 = NL + "\t    String insertIgnore_";
  protected final String TEXT_657 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_658 = " + \"` (";
  protected final String TEXT_659 = ") VALUES (";
  protected final String TEXT_660 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_661 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_665 = NL + "\t    String insert_";
  protected final String TEXT_666 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_667 = " + \"` (";
  protected final String TEXT_668 = ") VALUES (";
  protected final String TEXT_669 = ")\";" + NL + "\t    ";
  protected final String TEXT_670 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_671 = " = new StringBuffer(insert_";
  protected final String TEXT_672 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_673 = ".insert(insert_";
  protected final String TEXT_674 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_675 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_676 = " =insertStringBuffer_";
  protected final String TEXT_677 = ".toString(); ";
  protected final String TEXT_678 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_679 = " = conn_";
  protected final String TEXT_680 = ".prepareStatement(insert_";
  protected final String TEXT_681 = ");" + NL + "\t    ";
  protected final String TEXT_682 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_688 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_689 = " = update_";
  ...
  protected final String TEXT_693 = " = update_";
  protected final String TEXT_694 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_695 = " = insert_";
  protected final String TEXT_696 = ".split(\"\\\\?\");";
  protected final String TEXT_697 = NL + "\t\t\tdelete_";
  protected final String TEXT_698 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_699 = " = delete_";
  protected final String TEXT_700 = ".split(\"\\\\?\");";
  protected final String TEXT_701 = NL + "\t\t\treplace_";
  protected final String TEXT_702 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_703 = " = replace_";
  protected final String TEXT_704 = ".split(\"\\\\?\");";
  protected final String TEXT_705 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_706 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_707 = " = insertIgnore_";
  protected final String TEXT_708 = ".split(\"\\\\?\");";
  protected final String TEXT_709 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_710 = " = insert_";
  protected final String TEXT_711 = ".split(\"\\\\?\");";
  protected final String TEXT_712 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_713 = " {" + NL + "    \t            ";
  protected final String TEXT_714 = NL + "                            ";
  protected final String TEXT_715 = " ";
  protected final String TEXT_716 = ";                ";
  protected final String TEXT_717 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_718 = ";" + NL + "\t\t\t";
  protected final String TEXT_719 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_720 = "(";
  protected final String TEXT_721 = NL + "                                ,";
  protected final String TEXT_722 = NL + "                            ";
  protected final String TEXT_723 = " ";
  protected final String TEXT_724 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_725 = NL + "\t\t\t";
  protected final String TEXT_726 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_727 = NL + "                                this.";
  protected final String TEXT_728 = " = ";
  protected final String TEXT_729 = ";              ";
  protected final String TEXT_730 = NL + "\t\t\t\tthis.";
  protected final String TEXT_731 = "=";
  protected final String TEXT_732 = ";" + NL + "\t\t\t";
  protected final String TEXT_733 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_734 = "> exInsertColValueList";
  protected final String TEXT_735 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_736 = " exInsertColValue";
  protected final String TEXT_737 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_738 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_739 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_740 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_741 = "=1;";
  protected final String TEXT_742 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_743 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_744 = "=0;";
  protected final String TEXT_745 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_746 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_747 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_748 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_749 = "=0;" + NL + "\t";
  protected final String TEXT_750 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_751 = " = null;" + NL + "\t\t";
  protected final String TEXT_752 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_753 = " = null;";
  protected final String TEXT_754 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_755 = " =  null;";
  protected final String TEXT_756 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_757 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_761 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_762 = " = null;";
  protected final String TEXT_763 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
