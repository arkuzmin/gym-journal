...
public class TSybaseBulkExecEndJava {
  ...
  protected final String TEXT_6 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_7 = " != null && dbschema_";
  protected final String TEXT_8 = ".trim().length() != 0) {" + NL + "    \t\ttmpTableName_";
  protected final String TEXT_9 = "=dbschema_";
  protected final String TEXT_10 = " + \".\" + tmpTableName_";
  protected final String TEXT_11 = ";" + NL + "    \t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_12 = " = conn_";
  protected final String TEXT_13 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_14 = ".executeUpdate(\"";
  protected final String TEXT_15 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_16 = ".close();" + NL + "        tableName_";
  protected final String TEXT_17 = " = tmpTableName_";
  protected final String TEXT_18 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_19 = " = conn_";
  protected final String TEXT_20 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_21 = ".execute(\"";
  protected final String TEXT_22 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_23 = ".close();         ";
  protected final String TEXT_24 = NL;
  protected final String TEXT_25 = NL + "\t    if(conn_";
  protected final String TEXT_26 = " != null && !conn_";
  protected final String TEXT_27 = ".isClosed()) {" + NL + "\t        conn_";
