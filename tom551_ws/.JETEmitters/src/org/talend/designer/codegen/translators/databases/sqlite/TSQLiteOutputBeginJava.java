...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_32 = ");" + NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_79 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_84 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_85 = " = conn_";
  protected final String TEXT_86 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_87 = " = deletedCount_";
  protected final String TEXT_88 = " + stmtClear_";
  ...
  protected final String TEXT_99 = NL + "\t    String update_";
  protected final String TEXT_100 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_101 = " + \"\\\" SET ";
  protected final String TEXT_102 = " WHERE ";
  protected final String TEXT_103 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_104 = " = conn_";
  protected final String TEXT_105 = ".prepareStatement(update_";
  protected final String TEXT_106 = ");" + NL + "\t    ";
  protected final String TEXT_107 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_110 = " + \"\\\" WHERE ";
  protected final String TEXT_111 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_112 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_113 = " + \"\\\" (";
  protected final String TEXT_114 = ") VALUES (";
  protected final String TEXT_115 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_116 = " = conn_";
  protected final String TEXT_117 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_122 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".prepareStatement(update_";
