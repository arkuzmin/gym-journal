...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_39 = " += \"NULL AS '\" + ";
  protected final String TEXT_40 = " + \"' \";";
  protected final String TEXT_41 = NL + "        Character text_enclosure_";
  protected final String TEXT_42 = " = (";
  protected final String TEXT_43 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_44 = " += \"CSV ";
  protected final String TEXT_45 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_46 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_47 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_48 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_49 = " + \"' \";";
  protected final String TEXT_50 = NL + "        bulkSQL_";
  protected final String TEXT_51 = " += \"ESCAPE AS '\" + ";
  ...
  protected final String TEXT_59 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_60 = "\");" + NL + "\t ";
  protected final String TEXT_61 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_70 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_137 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_141 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_142 = ".equals(schema_";
  protected final String TEXT_143 = ") || (schema_";
  protected final String TEXT_144 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_145 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_154 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_155 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_156 = " == null || dbschema_";
  protected final String TEXT_157 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_164 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_165 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_166 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_181 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_182 = ".equals";
  protected final String TEXT_183 = "IgnoreCase";
  protected final String TEXT_184 = "(schema_";
  ...
  protected final String TEXT_219 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_223 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_229 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_232 = " = stmtTruncCount_";
  protected final String TEXT_233 = ".executeQuery(\"";
  protected final String TEXT_234 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_237 = ".executeUpdate(\"";
  protected final String TEXT_238 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_239 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_240 = " += rsTruncCount_";
  protected final String TEXT_241 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_242 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_243 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_244 = ".close();            ";
  protected final String TEXT_245 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_246 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_247 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_248 = NL + "\t";
  protected final String TEXT_249 = NL + "        int keyCount_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_252 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_253 = " = tableName_";
  protected final String TEXT_254 = ";" + NL + "        tableName_";
  protected final String TEXT_255 = " = \"tmp_";
  protected final String TEXT_256 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_259 = ".execute(\"";
  protected final String TEXT_260 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_261 = ".close();";
  protected final String TEXT_262 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_263 = " =conn_";
  protected final String TEXT_264 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_265 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_266 = ".close();" + NL + "   \t\t";
  protected final String TEXT_267 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_268 = " = conn_";
  protected final String TEXT_269 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_270 = ".execute(bulkSQL_";
  protected final String TEXT_271 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_272 = ".close();" + NL + "        tableName_";
  protected final String TEXT_273 = " = tmpTableName_";
  protected final String TEXT_274 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_275 = " = \"tmp_";
  protected final String TEXT_276 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_277 = " = conn_";
  protected final String TEXT_278 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_279 = ".executeUpdate(\"";
  protected final String TEXT_280 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_281 = ".close();" + NL + "        tableName_";
  protected final String TEXT_282 = " = tmpTableName_";
  protected final String TEXT_283 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_286 = ".execute(\"";
  protected final String TEXT_287 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_288 = ".close();";
  protected final String TEXT_289 = NL + "\t    ";
  protected final String TEXT_290 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_291 = " =conn_";
  protected final String TEXT_292 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_293 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_294 = ".close();" + NL + "   \t\t";
  protected final String TEXT_295 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_298 = ".execute(bulkSQL_";
  protected final String TEXT_299 = ");" + NL + "    stmtBulk_";
