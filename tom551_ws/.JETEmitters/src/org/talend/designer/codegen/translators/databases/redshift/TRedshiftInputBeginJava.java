...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_228 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_229 = " = new java.io.FileWriter(";
  protected final String TEXT_230 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_231 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\torg.postgresql.Driver.setLogLevel(";
  protected final String TEXT_232 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_233 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_234 = " + \":\" + ";
  protected final String TEXT_235 = " + \"/\" + ";
  protected final String TEXT_236 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_237 = "+\"&protocolVersion=3\";";
  protected final String TEXT_238 = NL + "\t\t\t\tconn_";
  protected final String TEXT_239 = ".setAutoCommit(false);";
  protected final String TEXT_240 = NL + "                stmt_";
  protected final String TEXT_241 = ".setFetchSize(";
  ...
  protected final String TEXT_259 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_260 = " != null) {" + NL + "\t\t\t\t\t\tif(conn_";
  protected final String TEXT_261 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_262 = " - Uses an existing connection as \" + conn_";
  protected final String TEXT_263 = ".getMetaData().getUserName() + \". Connection URL: \" + conn_";
  protected final String TEXT_264 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_265 = NL + NL + "\t\t    ";
  protected final String TEXT_266 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_267 = " = ";
  protected final String TEXT_268 = ";";
  protected final String TEXT_269 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_270 = " - Executing the query: '\" + dbquery_";
  protected final String TEXT_271 = " + \"'.\");";
  protected final String TEXT_272 = NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_273 = "_QUERY\",dbquery_";
  protected final String TEXT_274 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_275 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_276 = " = stmt_";
  protected final String TEXT_277 = ".executeQuery(dbquery_";
  protected final String TEXT_278 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_279 = " = rs_";
  protected final String TEXT_280 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_281 = " = rsmd_";
  protected final String TEXT_282 = ".getColumnCount();" + NL;
  protected final String TEXT_283 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_284 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_285 = ".setDbmsId(\"";
  protected final String TEXT_286 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_287 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_288 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_289 = ".add(\"";
  protected final String TEXT_290 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_291 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_292 = " = ";
  protected final String TEXT_293 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_294 = "; i <= rsmd_";
  protected final String TEXT_295 = ".getColumnCount()-";
  protected final String TEXT_296 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_297 = ".contains(rsmd_";
  protected final String TEXT_298 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_299 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_300 = ".setName(rsmd_";
  protected final String TEXT_301 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setDbName(rsmd_";
  protected final String TEXT_303 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_305 = "\", rsmd_";
  protected final String TEXT_306 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_307 = ".getPrecision(i), rsmd_";
  protected final String TEXT_308 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setDbType(rsmd_";
  protected final String TEXT_310 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_366 = " = (List)rs_";
  ...
  protected final String TEXT_421 = ".getObject(";
  protected final String TEXT_422 = "column_index_";
  protected final String TEXT_423 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = " = new Geometry(sb.toString());";
