...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_73 = NL + "\t\tresourceMap.put(\"conn_";
  protected final String TEXT_74 = "\", conn_";
  protected final String TEXT_75 = ");" + NL + "\t";
  protected final String TEXT_76 = NL + "        conn_";
  protected final String TEXT_77 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";            " + NL + "        int commitCounter_";
  ...
  protected final String TEXT_85 = " " + NL + "" + NL + "if(dbschema_";
  ...
  protected final String TEXT_93 = NL + "\tint count_";
  ...
  protected final String TEXT_99 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_105 = " - Drop table '\" + tableName_";
  protected final String TEXT_106 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "            stmtDrop_";
  protected final String TEXT_108 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_121 = ".toUpperCase()";
  ...
  protected final String TEXT_128 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_136 = " - Creating table '\" + tableName_";
  protected final String TEXT_137 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_139 = ".execute(((\"";
  protected final String TEXT_140 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = ", \"";
  protected final String TEXT_143 = "\"))+\")";
  protected final String TEXT_144 = "\")";
  protected final String TEXT_145 = ".toUpperCase()";
  ...
  protected final String TEXT_152 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_174 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_177 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_178 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_179 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_180 = " = true;" + NL + "\t\t\t\t} catch (java.lang.Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_181 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_219 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_237 = ".toUpperCase()";
  ...
  protected final String TEXT_244 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_295 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_296 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_359 = " - Create table '\" + tableName_";
  ...
  protected final String TEXT_363 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_364 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  ...
  protected final String TEXT_370 = " - Clearing table '\" + tableName_";
  ...
  protected final String TEXT_376 = "- Clear table '\" + tableName_";
  ...
  protected final String TEXT_389 = " - Trancating table '\" + tableName_";
  ...
  protected final String TEXT_398 = " - Truncate table '\" + tableName_";
  ...
  protected final String TEXT_416 = " - Truncating reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_425 = " - Truncate reuse stroage table '\" + tableName_";
  ...
  protected final String TEXT_444 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_445 = " = null;    " + NL + "\t\tString keyPsmt_";
  protected final String TEXT_446 = " = conn_";
  protected final String TEXT_447 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_448 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_449 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_450 = ",insert_";
  protected final String TEXT_451 = ",keyPsmt_";
  ...
  protected final String TEXT_463 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_484 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_495 = NL + "        String delete_";
  protected final String TEXT_496 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_514 = NL + "    \t" + NL + "    class BufferLine_";
  protected final String TEXT_515 = " {";
  protected final String TEXT_516 = NL + "                ";
  protected final String TEXT_517 = " ";
  protected final String TEXT_518 = ";                ";
  protected final String TEXT_519 = "   " + NL + "    " + NL + "        public BufferLine_";
  protected final String TEXT_520 = "(";
  protected final String TEXT_521 = NL + "                    ,";
  protected final String TEXT_522 = NL + "                ";
  protected final String TEXT_523 = " ";
  protected final String TEXT_524 = " " + NL + "        ){";
  protected final String TEXT_525 = NL + "                    this.";
  protected final String TEXT_526 = " = ";
  protected final String TEXT_527 = ";              ";
  protected final String TEXT_528 = "   \t                " + NL + "        }" + NL + "    }" + NL + "    " + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_529 = "> sInsertColValueList";
  protected final String TEXT_530 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_531 = " sInsertColValue";
  protected final String TEXT_532 = " = null; " + NL + "    " + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_533 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_534 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_535 = ".append(\"(";
  protected final String TEXT_536 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_537 = "-1) extendInsertValueStmt_";
  protected final String TEXT_538 = ".append(\",\");" + NL + "    }" + NL + "   " + NL + "\tString insert_";
  protected final String TEXT_539 = " = \"INSERT INTO \"+";
  protected final String TEXT_540 = "+\" (";
  protected final String TEXT_541 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_542 = ".toString();" + NL + "\t" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_543 = " =  conn_";
  protected final String TEXT_544 = ".prepareStatement(insert_";
  protected final String TEXT_545 = ");" + NL + "      " + NL + "    String insertColName";
  ...
  protected final String TEXT_585 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_586 = " = conn_";
  protected final String TEXT_587 = ".createStatement();";
  protected final String TEXT_588 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_589 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_590 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_591 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_592 = NL + "     \t\tstmt_";
  protected final String TEXT_593 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_594 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_595 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_596 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_597 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_598 = " =null;" + NL + "\t";
  protected final String TEXT_599 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_606 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_607 = " = null;";
  protected final String TEXT_608 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_609 = " = null;";
  protected final String TEXT_610 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_611 = " = null;";
  protected final String TEXT_612 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_613 = " = null;";
  protected final String TEXT_614 = NL + "\t\t \tString[] insertSQLSplits_";
