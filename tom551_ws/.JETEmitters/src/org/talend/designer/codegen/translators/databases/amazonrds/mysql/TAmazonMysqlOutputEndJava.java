...
public class TAmazonMysqlOutputEndJava {
  ...
  protected final String TEXT_158 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_159 = NL + "                \tint countSum_";
  protected final String TEXT_160 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_161 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_162 = " += (countEach_";
  protected final String TEXT_163 = " < 0 ? 0 : countEach_";
  protected final String TEXT_164 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_165 = NL + "            \t    insertedCount_";
  protected final String TEXT_166 = " += countSum_";
  protected final String TEXT_167 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_168 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_169 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_170 = " = 0;    ";
  protected final String TEXT_171 = "    \t\t\t" + NL + "    \t\t";
  protected final String TEXT_172 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_173 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_174 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_175 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_176 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_177 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_178 = ".close();" + NL + "            " + NL + "        }        ";
  ...
  protected final String TEXT_183 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_184 = NL + "\t";
  protected final String TEXT_185 = "                " + NL + "    try {" + NL + "\t\t\tint countSum_";
  protected final String TEXT_186 = " = 0;" + NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_187 = ": pstmt_";
  protected final String TEXT_188 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_189 = " += (countEach_";
  protected final String TEXT_190 = " < 0 ? 0 : ";
  protected final String TEXT_191 = ");" + NL + "\t\t\t}       \t" + NL + "\t    \t";
  protected final String TEXT_192 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_193 = " += countSum_";
  protected final String TEXT_194 = "; " + NL + "\t    \t";
  protected final String TEXT_195 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_196 = " += countSum_";
  protected final String TEXT_197 = ";" + NL + "\t    \t";
  protected final String TEXT_198 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_199 = " += countSum_";
  protected final String TEXT_200 = ";" + NL + "\t    \t";
  protected final String TEXT_201 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  ...
  protected final String TEXT_212 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_213 = " += countSum_";
  protected final String TEXT_214 = ";" + NL + "    \t";
  protected final String TEXT_215 = NL + "    \tdeletedCount_";
  protected final String TEXT_216 = " += countSum_";
  protected final String TEXT_217 = ";" + NL + "    \t";
  protected final String TEXT_218 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_219 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_220 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_221 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_223 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  ...
  protected final String TEXT_231 = " .close();" + NL + "    \tresourceMap.put(\"finish_";
  ...
  protected final String TEXT_246 = NL + "\tif (globalMap.get(\"";
  protected final String TEXT_247 = "_NB_LINE\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_248 = "_NB_LINE\",nb_line_";
  protected final String TEXT_249 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_250 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_251 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_252 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_253 = "_NB_LINE_UPDATED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_254 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_255 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_256 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_257 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_258 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_259 = "_NB_LINE_INSERTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_260 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_261 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_262 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_263 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_264 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_265 = "_NB_LINE_DELETED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_266 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_267 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_268 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_269 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_270 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_271 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_272 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_273 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_274 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_275 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_276 = ");" + NL + "    }";
  protected final String TEXT_277 = NL + "    globalMap.put(\"";
  protected final String TEXT_278 = "_NB_LINE\",nb_line_";
  protected final String TEXT_279 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_280 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_281 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_282 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_283 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_284 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_285 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_286 = "_NB_LINE_REJECTED\", nb_line_rejected_";
