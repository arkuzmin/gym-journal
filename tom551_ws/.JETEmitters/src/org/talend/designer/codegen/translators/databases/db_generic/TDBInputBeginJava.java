...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_228 = " = \"jdbc:odbc:\"+";
  protected final String TEXT_229 = ";";
  protected final String TEXT_230 = NL + "\t\t        String url_";
  protected final String TEXT_231 = " = \"jdbc:odbc:\"+";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\t        String url_";
  protected final String TEXT_234 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_235 = " + \":\" + ";
  protected final String TEXT_236 = " + \":\" + ";
  protected final String TEXT_237 = ";";
  protected final String TEXT_238 = NL + "\t\t        String url_";
  protected final String TEXT_239 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_240 = "+\":\"+";
  protected final String TEXT_241 = "+\"/\"+";
  protected final String TEXT_242 = ";";
  protected final String TEXT_243 = NL + "\t\t        String url_";
  protected final String TEXT_244 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_245 = " + \":\" + ";
  protected final String TEXT_246 = " + \"/\" + ";
  protected final String TEXT_247 = ";";
  protected final String TEXT_248 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_249 = "\");" + NL + "\t\t\t";
  protected final String TEXT_250 = NL + "\t        String userName_";
  ...
  protected final String TEXT_260 = NL + "\t        String password_";
  protected final String TEXT_261 = " = decryptedPassword_";
  protected final String TEXT_262 = ";" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_263 = " = ";
  protected final String TEXT_264 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_265 = " == null || dbProperties_";
  protected final String TEXT_266 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_267 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_268 = ",userName_";
  protected final String TEXT_269 = ",password_";
  protected final String TEXT_270 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_271 = " = dbProperties_";
  protected final String TEXT_272 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_273 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_274 = ".put(\"user\",userName_";
  protected final String TEXT_275 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_276 = ".put(\"password\",password_";
  protected final String TEXT_277 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_278 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_279 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  protected final String TEXT_280 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_281 = ", atnParamsPrope_";
  protected final String TEXT_282 = ");" + NL + "\t\t\t}";
  protected final String TEXT_283 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_284 = " = rs_";
  protected final String TEXT_285 = ".getTimestamp(";
  protected final String TEXT_286 = "column_index_";
  protected final String TEXT_287 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_288 = " != null) {";
  protected final String TEXT_289 = NL + "                ";
  protected final String TEXT_290 = ".";
  protected final String TEXT_291 = " = new java.util.Date(timestamp_";
  protected final String TEXT_292 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_293 = NL + "                ";
  protected final String TEXT_294 = ".";
  protected final String TEXT_295 = " =  null;" + NL + "            }";
  protected final String TEXT_296 = NL + "\t\t\tObject value_";
  protected final String TEXT_297 = " = rs_";
  protected final String TEXT_298 = ".get";
  protected final String TEXT_299 = "(";
  protected final String TEXT_300 = "column_index_";
  protected final String TEXT_301 = ");" + NL + "\t\t\tif(value_";
  protected final String TEXT_302 = " != null) {";
  protected final String TEXT_303 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_304 = " = new ";
  protected final String TEXT_305 = "(";
  protected final String TEXT_306 = ".parse";
  protected final String TEXT_307 = "(value_";
  protected final String TEXT_308 = ".toString()));";
  protected final String TEXT_309 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_310 = " = new ";
  protected final String TEXT_311 = "(";
  protected final String TEXT_312 = ".parse";
  protected final String TEXT_313 = "(value_";
  protected final String TEXT_314 = ".toString()));";
  protected final String TEXT_315 = NL + "\t\t\t\t";
  protected final String TEXT_316 = ".";
  protected final String TEXT_317 = " = (";
  protected final String TEXT_318 = ")value_";
  protected final String TEXT_319 = ";" + NL + "\t\t\t} else {";
  protected final String TEXT_320 = NL + "\t\t\t\t\t";
  protected final String TEXT_321 = ".";
  protected final String TEXT_322 = " = null;";
  protected final String TEXT_323 = NL + "\t\t\t\t\tthrow new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_324 = NL + "\t\t\t}";
  protected final String TEXT_325 = NL + "\t\t\ttry {" + NL + "            \ttmpContent_";
  protected final String TEXT_326 = " = rs_";
  protected final String TEXT_327 = ".getString(";
  protected final String TEXT_328 = "column_index_";
  protected final String TEXT_329 = ");" + NL + "\t\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t\tif (\"No data found\".equals(e.getMessage())) {" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_330 = " = \"\";" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow e;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "            if(tmpContent_";
  protected final String TEXT_331 = " != null) {";
  protected final String TEXT_332 = NL + "                ";
  protected final String TEXT_333 = ".";
  protected final String TEXT_334 = " = tmpContent_";
  ...
  protected final String TEXT_340 = NL + "\t\t    int nb_line_";
  protected final String TEXT_341 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_342 = " = null;";
  protected final String TEXT_343 = NL + "\t\t        conn_";
  protected final String TEXT_344 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_345 = "\");";
  protected final String TEXT_346 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_347 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_348 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_349 = " = dataSources_";
  protected final String TEXT_350 = ".get(";
  protected final String TEXT_351 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_370 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_371 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_372 = " = stmt_";
  protected final String TEXT_373 = ".executeQuery(dbquery_";
  protected final String TEXT_374 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_375 = " = rs_";
  protected final String TEXT_376 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_377 = " = rsmd_";
  protected final String TEXT_378 = ".getColumnCount();" + NL;
  protected final String TEXT_379 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_380 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_381 = ".setDbmsId(\"";
  protected final String TEXT_382 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_383 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_384 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_385 = ".add(\"";
  protected final String TEXT_386 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_387 = NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_388 = " = ";
  protected final String TEXT_389 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_390 = "; i <= rsmd_";
  protected final String TEXT_391 = ".getColumnCount()-";
  protected final String TEXT_392 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_393 = ".contains(rsmd_";
  protected final String TEXT_394 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_395 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_396 = ".setName(rsmd_";
  protected final String TEXT_397 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_398 = ".setDbName(rsmd_";
  protected final String TEXT_399 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_400 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_401 = "\", rsmd_";
  protected final String TEXT_402 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_403 = ".getPrecision(i), rsmd_";
  protected final String TEXT_404 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_405 = ".setDbType(rsmd_";
  protected final String TEXT_406 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_449 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_450 = " < ";
  protected final String TEXT_451 = "column_index_";
  ...
  protected final String TEXT_462 = " = (List)rs_";
  protected final String TEXT_463 = ".getObject(";
  protected final String TEXT_464 = "column_index_";
  protected final String TEXT_465 = ");";
  protected final String TEXT_466 = NL + "\t\t                         ";
  protected final String TEXT_467 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_468 = ".getObject(";
  protected final String TEXT_469 = "column_index_";
  protected final String TEXT_470 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_471 = NL + "                                    ";
  protected final String TEXT_472 = ".";
  protected final String TEXT_473 = " = new Geometry(wktValue);";
  protected final String TEXT_474 = NL + "                                        ";
  protected final String TEXT_475 = ".";
  protected final String TEXT_476 = ".setEPSG(";
  protected final String TEXT_477 = ");";
  protected final String TEXT_478 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_479 = NL + "                                  ";
  protected final String TEXT_480 = ".";
  protected final String TEXT_481 = "=dcg_";
  protected final String TEXT_482 = ";";
  protected final String TEXT_483 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_484 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_485 = " = ";
  protected final String TEXT_486 = "; i_";
  protected final String TEXT_487 = "  <= rsmd_";
  protected final String TEXT_488 = ".getColumnCount(); i_";
  protected final String TEXT_489 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_490 = ".getColumnTypeName(i_";
  protected final String TEXT_491 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_492 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_493 = ".getClob(i_";
  protected final String TEXT_494 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_495 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_496 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_497 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_498 = ".add(tNTextImpl_";
  protected final String TEXT_499 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_500 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_501 = ".";
  protected final String TEXT_502 = ", rs_";
  protected final String TEXT_503 = ", fixedColumnCount_";
  protected final String TEXT_504 = ",list_";
  protected final String TEXT_505 = ");";
  protected final String TEXT_506 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_507 = ".";
  protected final String TEXT_508 = ", rs_";
  protected final String TEXT_509 = ", fixedColumnCount_";
  protected final String TEXT_510 = ");";
  protected final String TEXT_511 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_512 = ".";
  protected final String TEXT_513 = ", rs_";
  protected final String TEXT_514 = ", fixedColumnCount_";
  protected final String TEXT_515 = ");";
  protected final String TEXT_516 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_517 = ".getObject(";
  protected final String TEXT_518 = "column_index_";
  protected final String TEXT_519 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_520 = ".";
  protected final String TEXT_521 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_528 = NL + "\t\t\t\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_529 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_530 = NL + "\t\t\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_532 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_533 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_534 = " - Content of the record \" + nb_line_";
  protected final String TEXT_535 = " + \": \" + log4jSb_";
  protected final String TEXT_536 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_537 = ".delete(0,log4jSb_";
  protected final String TEXT_538 = ".length());" + NL + "\t\t\t\t\t";
