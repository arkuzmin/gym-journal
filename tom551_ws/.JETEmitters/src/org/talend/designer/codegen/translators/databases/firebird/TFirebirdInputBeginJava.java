...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_228 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_327 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_328 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_329 = NL + "\t\t    ";
  protected final String TEXT_330 = NL + "\t\t\t    StringBuffer log4jSb_";
  protected final String TEXT_331 = " = new StringBuffer();" + NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_332 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_333 = NL + "\t\t    while (rs_";
  protected final String TEXT_334 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_335 = "++;" + NL + "\t\t        ";
  protected final String TEXT_336 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_337 = " = ";
  protected final String TEXT_338 = " + dcg_";
  protected final String TEXT_339 = ".getColumnCount(); " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_341 = " = ";
  protected final String TEXT_342 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_345 = " < ";
  protected final String TEXT_346 = "column_index_";
  protected final String TEXT_347 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_348 = ".";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_362 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_363 = ".getObject(";
  protected final String TEXT_364 = "column_index_";
  protected final String TEXT_365 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_366 = NL + "                                    ";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = " = new Geometry(wktValue);";
  ...
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_379 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_395 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = ", rs_";
  protected final String TEXT_398 = ", fixedColumnCount_";
  protected final String TEXT_399 = ",list_";
  ...
  protected final String TEXT_411 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_412 = ".getObject(";
  protected final String TEXT_413 = "column_index_";
  protected final String TEXT_414 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_424 = ".append(\"|\");\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_427 = " - Retrieving the record \" + nb_line_";
  protected final String TEXT_428 = " + \".\");" + NL + "\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_429 = " - Content of the record \" + nb_line_";
  protected final String TEXT_430 = " + \": \" + log4jSb_";
  protected final String TEXT_431 = ");" + NL + "\t\t\t\t\t\tlog4jSb_";
  protected final String TEXT_432 = ".delete(0,log4jSb_";
