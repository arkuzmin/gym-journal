...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_40 = ".setAutoCommit(false);        " + NL + "        int commitEvery_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";    " + NL + "        int commitCounter_";
  protected final String TEXT_43 = " = 0;    ";
  protected final String TEXT_44 = NL + NL + "if (dbschema_";
  ...
  protected final String TEXT_50 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_51 = " = conn_";
  protected final String TEXT_52 = ".prepareStatement(";
  protected final String TEXT_53 = ");\t";
  protected final String TEXT_54 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".createStatement();";
  protected final String TEXT_57 = NL + "    stmt_";
