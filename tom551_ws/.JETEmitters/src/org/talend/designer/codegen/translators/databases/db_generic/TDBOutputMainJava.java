...
public class TDBOutputMainJava {
  ...
  protected final String TEXT_218 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_219 = " == 0) {" + NL + "            \t";
  protected final String TEXT_220 = NL + "\t\t\t\tquery_";
  protected final String TEXT_221 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_229 = NL + "                    insertedCount_";
  protected final String TEXT_230 = " = insertedCount_";
  protected final String TEXT_231 = " + pstmtInsert_";
  protected final String TEXT_232 = ".executeUpdate(query_";
  protected final String TEXT_233 = ".toString().trim());";
  protected final String TEXT_234 = NL + "                    insertedCount_";
  protected final String TEXT_235 = " = insertedCount_";
  protected final String TEXT_236 = " + pstmtInsert_";
  protected final String TEXT_237 = ".executeUpdate();";
  protected final String TEXT_238 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_239 = " = true;";
  protected final String TEXT_240 = NL + "                        throw(e);";
  ...
  protected final String TEXT_249 = NL + "                            rejectedCount_";
  protected final String TEXT_250 = " = rejectedCount_";
  protected final String TEXT_251 = " + 1;";
  protected final String TEXT_252 = NL + "                            ";
  protected final String TEXT_253 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_254 = NL + "                            ";
  protected final String TEXT_255 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_256 = ";" + NL + "                           ";
  protected final String TEXT_257 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_258 = NL + "                }" + NL + "            nb_line_";
  ...
  protected final String TEXT_267 = NL + "            try {" + NL + "\t\t\t";
  ...
  protected final String TEXT_271 = ".executeUpdate(query_";
  protected final String TEXT_272 = ".toString().trim());" + NL + "\t\t\t";
  ...
  protected final String TEXT_276 = ".executeUpdate();" + NL + "\t\t\t";
  protected final String TEXT_277 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_297 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_298 = "++;" + NL + "    \t";
  protected final String TEXT_299 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_310 = NL + "            commitCounter_";
  protected final String TEXT_311 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_312 = " <= commitCounter_";
  protected final String TEXT_313 = ") {" + NL + "            " + NL + "            \tconn_";
  protected final String TEXT_314 = ".commit();" + NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_315 = "=0;" + NL + "            }\t" + NL + "    \t";
