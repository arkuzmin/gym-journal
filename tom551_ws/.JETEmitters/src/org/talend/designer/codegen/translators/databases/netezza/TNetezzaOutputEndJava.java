...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_64 = ".commit();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_66 = " - Commit has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_67 = NL + "    \t\t";
  protected final String TEXT_68 = "\t" + NL + "\t\t";
  protected final String TEXT_69 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_70 = " - Closing the connection to the database.\");" + NL + "\t\t";
  protected final String TEXT_71 = NL + "\t\tconn_";
  protected final String TEXT_72 = " .close();" + NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_73 = "\", true);" + NL + "\t\t";
  protected final String TEXT_74 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_75 = " - Connection to the database closed.\");" + NL + "\t\t";
  protected final String TEXT_76 = NL + "    \t";
  protected final String TEXT_77 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_78 = "=nb_line_deleted_";
  protected final String TEXT_79 = "+ deletedCount_";
  protected final String TEXT_80 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_81 = "=nb_line_update_";
  protected final String TEXT_82 = " + updatedCount_";
  protected final String TEXT_83 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_84 = "=nb_line_inserted_";
  protected final String TEXT_85 = " + insertedCount_";
  protected final String TEXT_86 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_87 = "=nb_line_rejected_";
  protected final String TEXT_88 = " + rejectedCount_";
  protected final String TEXT_89 = ";";
  protected final String TEXT_90 = NL + "\tif (globalMap.get(\"";
  protected final String TEXT_91 = "_NB_LINE\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_92 = "_NB_LINE\",nb_line_";
  protected final String TEXT_93 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_94 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_95 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_96 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_97 = "_NB_LINE_UPDATED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_98 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_99 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_100 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_101 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_102 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_103 = "_NB_LINE_INSERTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_104 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_105 = ");" + NL + "    } else {" + NL + "    \tglobalMap.put(\"";
  protected final String TEXT_106 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_109 = "_NB_LINE_DELETED\") == null) {" + NL + "    \tglobalMap.put(\"";
  ...
  protected final String TEXT_112 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_113 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_114 = ");" + NL + "    }" + NL + "    if (globalMap.get(\"";
  protected final String TEXT_115 = "_NB_LINE_REJECTED\") == null) {" + NL + "    \tglobalMap.put(\"";
  ...
  protected final String TEXT_118 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_119 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_134 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_135 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_136 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_137 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_138 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_139 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_140 = " - Has deleted \" + nb_line_deleted_";
  protected final String TEXT_141 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_142 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_143 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_144 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_145 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_146 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_147 = NL + "\t  \tlog.info(\"";
  protected final String TEXT_148 = " - Has updated \" + nb_line_update_";
  protected final String TEXT_149 = " + \" records.\");" + NL + "\t  \tlog.info(\"";
  protected final String TEXT_150 = " - Has inserted \" + nb_line_inserted_";
  protected final String TEXT_151 = " + \" records.\");" + NL + "\t";
  protected final String TEXT_152 = NL + "\t\tlog.info(\"";
  protected final String TEXT_153 = " - Has rejected \" + nb_line_rejected_";
  protected final String TEXT_154 = " + \"records.\");" + NL + "\t";
  protected final String TEXT_155 = NL + "\t\tlog.info(\"";
  protected final String TEXT_156 = " - Done.\");" + NL + "\t";
