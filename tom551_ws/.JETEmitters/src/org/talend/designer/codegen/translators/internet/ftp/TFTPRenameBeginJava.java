...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_21 = " implements com.jcraft.jsch.UserInfo, com.jcraft.jsch.UIKeyboardInteractive {";
  ...
  protected final String TEXT_67 = NL + NL + "    session_";
  ...
  protected final String TEXT_98 = ");" + NL + "    list";
  protected final String TEXT_99 = ".add(map";
  protected final String TEXT_100 = ");       ";
  protected final String TEXT_101 = NL + NL + "  for (java.util.Map<String, String> map";
  protected final String TEXT_102 = " : list";
  protected final String TEXT_103 = ") {" + NL;
  protected final String TEXT_104 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_105 = " =null;" + NL;
  protected final String TEXT_106 = NL + "    ftp_";
  protected final String TEXT_107 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_108 = "\");" + NL + "  \t";
  protected final String TEXT_109 = NL + "  \t\tString rootDir_";
  protected final String TEXT_110 = " = ftp_";
  protected final String TEXT_111 = ".pwd();" + NL + "  \t";
  protected final String TEXT_112 = "    " + NL + "    ftp_";
  protected final String TEXT_113 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_114 = ".setRemoteHost(";
  protected final String TEXT_115 = ");" + NL + "    ftp_";
  protected final String TEXT_116 = ".setRemotePort(";
  protected final String TEXT_117 = ");" + NL;
  protected final String TEXT_118 = NL + "      ftp_";
  protected final String TEXT_119 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_120 = NL + "      ftp_";
  protected final String TEXT_121 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_122 = NL + "    ftp_";
  protected final String TEXT_123 = ".setControlEncoding(";
  ...
  protected final String TEXT_133 = NL + "\tftp_";
  protected final String TEXT_134 = ".login(";
  protected final String TEXT_135 = ", decryptedPassword_";
  protected final String TEXT_136 = ");";
  protected final String TEXT_137 = NL + "  java.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_138 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL;
  protected final String TEXT_139 = "    " + NL + "    java.util.Map<String,String> map";
  protected final String TEXT_140 = " = new java.util.HashMap<String,String>();  " + NL + "    map";
  protected final String TEXT_141 = ".put(";
  protected final String TEXT_142 = ",";
  protected final String TEXT_143 = ");" + NL + "    list";
  protected final String TEXT_144 = ".add(map";
  protected final String TEXT_145 = ");       ";
  protected final String TEXT_146 = "  " + NL + "  String remotedir";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "  ftp_";
  protected final String TEXT_149 = ".chdir(remotedir";
  protected final String TEXT_150 = ");" + NL + "" + NL + "  for (java.util.Map<String, String> map";
