...
public class TFirebirdOutputBeginJava {
  ...
  protected final String TEXT_46 = ";" + NL + "    " + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_51 = ");" + NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_89 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_101 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
