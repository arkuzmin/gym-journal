...
public class TOracleBulkExecEndJava {
  ...
  protected final String TEXT_6 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_13 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtTmpDrop_";
