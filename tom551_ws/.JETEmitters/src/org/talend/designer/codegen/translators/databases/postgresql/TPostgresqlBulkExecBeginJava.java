...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_21 = "_\" + pid + Thread.currentThread().getId(); //tableName not end. will add pid + Thread.currentThread().getId() when create a temp table for update.";
  ...
  protected final String TEXT_33 = NL + "    Character field_separator_";
  protected final String TEXT_34 = " = (";
  protected final String TEXT_35 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_36 = " += \"";
  protected final String TEXT_37 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_38 = " + \"' \";" + NL + "\t";
  protected final String TEXT_39 = NL + "\t\tbulkSQL_";
  protected final String TEXT_40 = " += \"NULL AS '\" + ";
  protected final String TEXT_41 = " + \"' \";" + NL + "\t";
  protected final String TEXT_42 = NL + "\t\tbulkSQL_";
  protected final String TEXT_43 = " += \"NULL AS '\" + ";
  protected final String TEXT_44 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_45 = NL + "        Character text_enclosure_";
  protected final String TEXT_46 = " = (";
  protected final String TEXT_47 = ").charAt(0);";
  protected final String TEXT_48 = NL + "            \tbulkSQL_";
  protected final String TEXT_49 = " += \"CSV ";
  protected final String TEXT_50 = " QUOTE AS '\" + ";
  protected final String TEXT_51 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_52 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_53 = " += \"CSV ";
  protected final String TEXT_54 = " QUOTE AS \" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_55 = ".toString())?\"E\":\"\") + \"'\" +(\"'\".equals(text_enclosure_";
  protected final String TEXT_56 = ")?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_57 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_59 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_60 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_61 = NL + "\t        \tbulkSQL_";
  protected final String TEXT_62 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_63 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_64 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_65 = " + \"' \"; ";
  protected final String TEXT_66 = NL + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_67 = " += \"CSV ";
  protected final String TEXT_68 = " QUOTE AS '\" +  ";
  protected final String TEXT_69 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_71 = " += \"CSV ";
  protected final String TEXT_72 = " QUOTE AS '\" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_73 = ".toString())?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_74 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_76 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_77 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_78 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_79 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_80 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_81 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_82 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_83 = " += \"";
  protected final String TEXT_84 = "\";";
  protected final String TEXT_85 = " " + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_90 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_99 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_112 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_168 = ".getString(\"TABLE_NAME\");" + NL + "\t                String bkSchema_";
  ...
  protected final String TEXT_172 = ") " + NL + "\t                \t&& (bkSchema_";
  protected final String TEXT_173 = ".equals(schema_";
  protected final String TEXT_174 = ") || (schema_";
  protected final String TEXT_175 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_176 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_185 = " = false;" + NL + "\t            String defaultSchema_";
  protected final String TEXT_186 = " = \"public\";" + NL + "\t            if(dbschema_";
  protected final String TEXT_187 = " == null || dbschema_";
  protected final String TEXT_188 = ".trim().length() == 0) {" + NL + "\t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_189 = " = conn_";
  protected final String TEXT_190 = ".createStatement();" + NL + "\t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_191 = " = stmtSchema_";
  protected final String TEXT_192 = ".executeQuery(\"select current_schema() \");" + NL + "\t            \twhile(rsSchema_";
  protected final String TEXT_193 = ".next()){" + NL + "\t            \t\tdefaultSchema_";
  protected final String TEXT_194 = " = rsSchema_";
  protected final String TEXT_195 = ".getString(\"current_schema\");" + NL + "\t            \t}" + NL + "\t            \trsSchema_";
  protected final String TEXT_196 = ".close();" + NL + "\t            \tstmtSchema_";
  protected final String TEXT_197 = ".close();" + NL + "\t            }" + NL + "\t            while(rsTable_";
  protected final String TEXT_198 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_199 = " = rsTable_";
  protected final String TEXT_200 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_215 = "(schema_";
  ...
  protected final String TEXT_227 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  ...
  protected final String TEXT_236 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_250 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_256 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_260 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_263 = " = stmtTruncCount_";
  protected final String TEXT_264 = ".executeQuery(\"";
  protected final String TEXT_265 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_268 = ".executeUpdate(\"";
  protected final String TEXT_269 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_270 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_271 = " += rsTruncCount_";
  protected final String TEXT_272 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_273 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_274 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_275 = ".close();            ";
  protected final String TEXT_276 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_277 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_278 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_279 = NL + "\t";
  protected final String TEXT_280 = NL + "        int keyCount_";
  protected final String TEXT_281 = " = ";
  protected final String TEXT_282 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_283 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_284 = " = tableName_";
  protected final String TEXT_285 = ";" + NL + "        tableName_";
  protected final String TEXT_286 = " = \"tmp_";
  protected final String TEXT_287 = "\" + \"_\" + pid + Thread.currentThread().getId() ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_290 = ".execute(\"";
  protected final String TEXT_291 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_292 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_293 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_294 = " =conn_";
  protected final String TEXT_295 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_296 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_297 = ".close();" + NL + "   \t\t";
  protected final String TEXT_298 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_299 = " = conn_";
  protected final String TEXT_300 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_301 = ".execute(bulkSQL_";
  protected final String TEXT_302 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_303 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_304 = " = tmpTableName_";
  protected final String TEXT_305 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_306 = " = \"tmp_";
  protected final String TEXT_307 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_308 = " = conn_";
  protected final String TEXT_309 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_310 = ".executeUpdate(\"";
  protected final String TEXT_311 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_312 = ".close();" + NL + "        tableName_";
  protected final String TEXT_313 = " = tmpTableName_";
  protected final String TEXT_314 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_317 = ".execute(\"";
  protected final String TEXT_318 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_319 = ".close();";
  protected final String TEXT_320 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_321 = " =conn_";
  protected final String TEXT_322 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_323 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_324 = ".close();";
  protected final String TEXT_325 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_328 = ".execute(bulkSQL_";
  protected final String TEXT_329 = ");" + NL + "    stmtBulk_";
