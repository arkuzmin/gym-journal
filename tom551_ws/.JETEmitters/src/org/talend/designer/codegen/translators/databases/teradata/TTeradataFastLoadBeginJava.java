...
public class TTeradataFastLoadBeginJava
{
  ...
  protected final String TEXT_130 = NL + "String dbPwd_";
  ...
  protected final String TEXT_145 = " + \"' has succeeded.\");";
  protected final String TEXT_146 = NL;
  protected final String TEXT_147 = NL + "java.sql.Statement stmtClear_";
  protected final String TEXT_148 = " = conn_";
  protected final String TEXT_149 = ".createStatement();" + NL + "deletedCount_";
  protected final String TEXT_150 = " = deletedCount_";
  protected final String TEXT_151 = " + stmtClear_";
  protected final String TEXT_152 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL;
  protected final String TEXT_155 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_156 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_157 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_158 = " =null;" + NL;
  protected final String TEXT_159 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_160 = " =null;" + NL + "\t";
  protected final String TEXT_161 = NL + "\t String tableName_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = ";" + NL + "\t String dbname_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "\t " + NL + "\tif(dbname_";
  protected final String TEXT_166 = " == null || dbname_";
  protected final String TEXT_167 = ".trim().length() == 0) {" + NL + "    \ttableName_";
  protected final String TEXT_168 = " = ";
  protected final String TEXT_169 = ";" + NL + "\t} else {" + NL + "    \ttableName_";
  protected final String TEXT_170 = " = dbname_";
  protected final String TEXT_171 = " + \".\" + ";
  protected final String TEXT_172 = ";" + NL + "\t}";
  protected final String TEXT_173 = "\t" + NL + "\t" + NL + "pstmt_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".prepareStatement(\"INSERT INTO \"+tableName_";
  protected final String TEXT_176 = "+\" (";
  protected final String TEXT_177 = ") VALUES (";
  protected final String TEXT_178 = ")\");" + NL + "" + NL + "\t";
  protected final String TEXT_179 = NL + "\t" + NL + "pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(\"UPDATE \"+tableName_";
  ...
  protected final String TEXT_187 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_188 = " + \" WHERE ";
  protected final String TEXT_189 = "\");\t" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(\"INSERT INTO \"+tableName_";
  protected final String TEXT_192 = "+\" (";
  protected final String TEXT_193 = ") VALUES (";
  protected final String TEXT_194 = ")\");" + NL + "" + NL + "pstmtUpdate_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".prepareStatement(\"UPDATE \"+tableName_";
  protected final String TEXT_197 = "+\" SET ";
  protected final String TEXT_198 = " WHERE ";
  protected final String TEXT_199 = "\");" + NL + "\t" + NL + "\t";
  protected final String TEXT_200 = NL + NL + "pstmtUpdate_";
  ...
  protected final String TEXT_205 = "\");" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".prepareStatement(\"INSERT INTO \"+tableName_";
  ...
  protected final String TEXT_213 = ".prepareStatement(\"DELETE  FROM \"+tableName_";
  protected final String TEXT_214 = "+\" WHERE ";
  protected final String TEXT_215 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_216 = NL + "\tint commitCounter_";
  protected final String TEXT_217 = " = 0;";
  protected final String TEXT_218 = NL + NL + "int commitEvery_";
  protected final String TEXT_219 = " = ";
  protected final String TEXT_220 = ";" + NL + "" + NL + "conn_";
  protected final String TEXT_221 = ".setAutoCommit(false);";
