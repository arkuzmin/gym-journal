...
public class TGreenplumSCDBeginJava {
  ...
  protected final String TEXT_32 = " = null;" + NL + "    if(dbSchema_";
  ...
  protected final String TEXT_61 = ">();" + NL + "        while(resultSet_";
  ...
  protected final String TEXT_69 = NL + "                    tmpValue_";
  protected final String TEXT_70 = " = resultSet_";
  protected final String TEXT_71 = ".getString(";
  protected final String TEXT_72 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_73 = " != null && tmpValue_";
  protected final String TEXT_74 = ".length() > 0) {";
  protected final String TEXT_75 = NL + "                        ";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = " = tmpValue_";
  protected final String TEXT_78 = ".charAt(0);" + NL + "                    } else {";
  ...
  protected final String TEXT_91 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_92 = "' in '";
  protected final String TEXT_93 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_94 = NL + "                    }";
  protected final String TEXT_95 = NL + "                    timestamp_";
  protected final String TEXT_96 = " = resultSet_";
  protected final String TEXT_97 = ".getTimestamp(";
  protected final String TEXT_98 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_99 = " != null) {";
  protected final String TEXT_100 = NL + "                        ";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = " = new java.util.Date(timestamp_";
  protected final String TEXT_103 = ".getTime());" + NL + "                    } else {";
  ...
  protected final String TEXT_116 = NL + "            cache_";
  protected final String TEXT_117 = ".put(sk_";
  protected final String TEXT_118 = ", row_";
  protected final String TEXT_119 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_120 = ".close();" + NL + "        statement_";
  protected final String TEXT_121 = ".close();";
  protected final String TEXT_122 = NL + "            System.out.println(\"[";
  protected final String TEXT_123 = "] comparison cache loaded\");";
  ...
  protected final String TEXT_128 = ".size() > 0) {";
  protected final String TEXT_129 = NL + "        String tmpQuery_";
  protected final String TEXT_130 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_131 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_132 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_133 = " = connection_";
  protected final String TEXT_134 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_135 = " = tmpStmt_";
  protected final String TEXT_136 = ".executeQuery(tmpQuery_";
  protected final String TEXT_137 = ");";
  protected final String TEXT_138 = NL + "        if(tmpRS_";
  protected final String TEXT_139 = ".next() && tmpRS_";
  protected final String TEXT_140 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_141 = " = tmpRS_";
  protected final String TEXT_142 = ".get";
  protected final String TEXT_143 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_144 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_145 = ".close();";
  protected final String TEXT_146 = NL + "            }            ";
  protected final String TEXT_147 = NL + "    String insertionSQL_";
  protected final String TEXT_148 = " = \"";
  protected final String TEXT_149 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_150 = " = connection_";
  protected final String TEXT_151 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_152 = ");";
  protected final String TEXT_153 = NL + "            insertionStatement_";
  protected final String TEXT_154 = ".setTimestamp(";
  protected final String TEXT_155 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_156 = "\")));";
  protected final String TEXT_157 = NL + "            insertionStatement_";
  protected final String TEXT_158 = ".setNull(";
  protected final String TEXT_159 = ", java.sql.Types.DATE);";
  protected final String TEXT_160 = NL + "            insertionStatement_";
  protected final String TEXT_161 = ".setTimestamp(";
  protected final String TEXT_162 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_163 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_164 = NL + "        String updateSQLForType1_";
  protected final String TEXT_165 = " = \"";
  protected final String TEXT_166 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_167 = " = connection_";
  protected final String TEXT_168 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_169 = ");        ";
  protected final String TEXT_170 = NL + "        String updateSQLForType2_";
  protected final String TEXT_171 = " = \"";
  protected final String TEXT_172 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_173 = " = connection_";
  protected final String TEXT_174 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "            updateForType2_";
  protected final String TEXT_177 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_178 = "\")));";
  protected final String TEXT_179 = NL + "        String updateSQLForType3_";
  protected final String TEXT_180 = " = \"";
  protected final String TEXT_181 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_182 = " = connection_";
  protected final String TEXT_183 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "    ";
  protected final String TEXT_186 = NL + "        SCDSK_";
  protected final String TEXT_187 = " lookUpKey_";
  protected final String TEXT_188 = " = null;        ";
  protected final String TEXT_189 = NL + "    SCDStruct_";
  protected final String TEXT_190 = " lookUpValue_";
