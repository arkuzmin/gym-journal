...
package gym_journal.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url = "jdbc:mysql://localhost:3306/gym_journal_db?noDatetimeStringSync=true";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "gymadmin", "Q111111q");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT    `exercise_category`.`CATEGORY_ID`,    `exercise_category`.`NAME`,    `exercise_category`.`DESCRIPTION` FROM `exercise_category`");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"K:/TOM551/TOS_MDM-Studio-r118616-V5.5.1/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"gym_journal/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 32625 characters generated by Talend Open Studio for MDM on the August 26,
 * 2014 1:56:40 PM MSK
 ************************************************************************************************/
